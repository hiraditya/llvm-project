...
; CHECK-NEXT:    tbnz w8, #2, .LBB1_20
; CHECK-NEXT:  // %bb.5: // %else5
; CHECK-NEXT:    tbnz w8, #3, .LBB1_21
; CHECK-NEXT:  .LBB1_6: // %else8
; CHECK-NEXT:    tbnz w8, #4, .LBB1_22
; CHECK-NEXT:  .LBB1_7: // %else11
; CHECK-NEXT:    tbnz w8, #5, .LBB1_23
; CHECK-NEXT:  .LBB1_8: // %else14
; CHECK-NEXT:    tbnz w8, #6, .LBB1_24
; CHECK-NEXT:  .LBB1_9: // %else17
; CHECK-NEXT:    tbnz w8, #7, .LBB1_25
; CHECK-NEXT:  .LBB1_10: // %else20
; CHECK-NEXT:    // implicit-def: $q2
; CHECK-NEXT:    tbnz w8, #8, .LBB1_26
; CHECK-NEXT:  .LBB1_11: // %else23
; CHECK-NEXT:    tbnz w8, #9, .LBB1_27
...
; CHECK-NEXT:    tbnz w8, #2, .LBB2_12
; CHECK-NEXT:  // %bb.5: // %else5
; CHECK-NEXT:    tbnz w8, #3, .LBB2_13
; CHECK-NEXT:  .LBB2_6: // %else8
; CHECK-NEXT:    // implicit-def: $q2
; CHECK-NEXT:    tbnz w8, #4, .LBB2_14
; CHECK-NEXT:  .LBB2_7: // %else11
; CHECK-NEXT:    tbnz w8, #5, .LBB2_15
; CHECK-NEXT:  .LBB2_8: // %else14
; CHECK-NEXT:    tbnz w8, #6, .LBB2_16
; CHECK-NEXT:  .LBB2_9: // %else17
; CHECK-NEXT:    tbz w8, #7, .LBB2_11
; CHECK-NEXT:  .LBB2_10: // %cond.load19
; CHECK-NEXT:    add x8, x0, #28
; CHECK-NEXT:    ld1 { v2.s }[3], [x8]
; CHECK-NEXT:  .LBB2_11: // %else20
; CHECK-NEXT:    uzp1 v0.4s, v1.4s, v2.4s
; CHECK-NEXT:    uzp2 v1.4s, v1.4s, v2.4s
; CHECK-NEXT:    ret
; CHECK-NEXT:  .LBB2_12: // %cond.load4
; CHECK-NEXT:    add x9, x0, #8
; CHECK-NEXT:    ld1 { v1.s }[2], [x9]
; CHECK-NEXT:    tbz w8, #3, .LBB2_6
; CHECK-NEXT:  .LBB2_13: // %cond.load7
; CHECK-NEXT:    add x9, x0, #12
; CHECK-NEXT:    ld1 { v1.s }[3], [x9]
; CHECK-NEXT:    // implicit-def: $q2
; CHECK-NEXT:    tbz w8, #4, .LBB2_7
; CHECK-NEXT:  .LBB2_14: // %cond.load10
; CHECK-NEXT:    add x9, x0, #16
; CHECK-NEXT:    ld1 { v2.s }[0], [x9]
; CHECK-NEXT:    tbz w8, #5, .LBB2_8
; CHECK-NEXT:  .LBB2_15: // %cond.load13
; CHECK-NEXT:    add x9, x0, #20
; CHECK-NEXT:    ld1 { v2.s }[1], [x9]
; CHECK-NEXT:    tbz w8, #6, .LBB2_9
; CHECK-NEXT:  .LBB2_16: // %cond.load16
; CHECK-NEXT:    add x9, x0, #24
; CHECK-NEXT:    ld1 { v2.s }[2], [x9]
; CHECK-NEXT:    tbnz w8, #7, .LBB2_10
; CHECK-NEXT:    b .LBB2_11
...
; CHECK-NEXT:    // implicit-def: $q2
; CHECK-NEXT:    tbnz w8, #2, .LBB3_8
; CHECK-NEXT:  // %bb.5: // %else5
; CHECK-NEXT:    tbz w8, #3, .LBB3_7
; CHECK-NEXT:  .LBB3_6: // %cond.load7
; CHECK-NEXT:    add x8, x0, #24
; CHECK-NEXT:    ld1 { v2.d }[1], [x8]
; CHECK-NEXT:  .LBB3_7: // %else8
; CHECK-NEXT:    zip1 v0.2d, v1.2d, v2.2d
; CHECK-NEXT:    zip2 v1.2d, v1.2d, v2.2d
; CHECK-NEXT:    ret
; CHECK-NEXT:  .LBB3_8: // %cond.load4
; CHECK-NEXT:    add x9, x0, #16
; CHECK-NEXT:    ld1 { v2.d }[0], [x9]
; CHECK-NEXT:    tbnz w8, #3, .LBB3_6
; CHECK-NEXT:    b .LBB3_7
