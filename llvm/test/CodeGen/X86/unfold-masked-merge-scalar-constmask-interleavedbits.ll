...
; CHECK-NOBMI-NEXT:    andl $-21846, %eax # imm = 0xAAAA
...
; CHECK-BMI-NEXT:    andl $-21846, %eax # imm = 0xAAAA
...
; CHECK-NOBMI-NEXT:    andl $-1431655766, %eax # imm = 0xAAAAAAAA
; CHECK-NOBMI-NEXT:    orl %edi, %eax
; CHECK-NOBMI-NEXT:    retq
;
...
; CHECK-BMI-NEXT:    andl $-1431655766, %eax # imm = 0xAAAAAAAA
; CHECK-BMI-NEXT:    orl %edi, %eax
; CHECK-BMI-NEXT:    retq
