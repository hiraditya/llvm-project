...
; CHECK-NOBMI-NEXT:    pand %xmm0, %xmm4
; CHECK-NOBMI-NEXT:    pand %xmm1, %xmm3
; CHECK-NOBMI-NEXT:    pxor %xmm0, %xmm0
; CHECK-NOBMI-NEXT:    pcmpeqd %xmm0, %xmm3
; CHECK-NOBMI-NEXT:    pcmpeqd %xmm0, %xmm4
; CHECK-NOBMI-NEXT:    movdqa %xmm4, %xmm0
; CHECK-NOBMI-NEXT:    shufps {{.*#+}} xmm0 = xmm0[1,3],xmm3[1,3]
; CHECK-NOBMI-NEXT:    shufps {{.*#+}} xmm4 = xmm4[0,2],xmm3[0,2]
; CHECK-NOBMI-NEXT:    andps %xmm4, %xmm0
; CHECK-NOBMI-NEXT:    retq
;
...
; CHECK-NOBMI-NEXT:    movdqa %xmm4, %xmm6
; CHECK-NOBMI-NEXT:    pxor %xmm1, %xmm6
; CHECK-NOBMI-NEXT:    movdqa %xmm6, %xmm1
; CHECK-NOBMI-NEXT:    pcmpgtd %xmm4, %xmm1
; CHECK-NOBMI-NEXT:    pxor %xmm5, %xmm3
; CHECK-NOBMI-NEXT:    movdqa %xmm3, %xmm5
; CHECK-NOBMI-NEXT:    pxor %xmm0, %xmm5
; CHECK-NOBMI-NEXT:    movdqa %xmm5, %xmm0
; CHECK-NOBMI-NEXT:    pcmpgtd %xmm3, %xmm0
; CHECK-NOBMI-NEXT:    movdqa %xmm0, %xmm7
; CHECK-NOBMI-NEXT:    shufps {{.*#+}} xmm7 = xmm7[0,2],xmm1[0,2]
; CHECK-NOBMI-NEXT:    pcmpeqd %xmm4, %xmm6
; CHECK-NOBMI-NEXT:    pcmpeqd %xmm3, %xmm5
; CHECK-NOBMI-NEXT:    shufps {{.*#+}} xmm5 = xmm5[1,3],xmm6[1,3]
; CHECK-NOBMI-NEXT:    andps %xmm5, %xmm7
; CHECK-NOBMI-NEXT:    shufps {{.*#+}} xmm0 = xmm0[1,3],xmm1[1,3]
; CHECK-NOBMI-NEXT:    orps %xmm7, %xmm0
; CHECK-NOBMI-NEXT:    xorps %xmm2, %xmm0
; CHECK-NOBMI-NEXT:    retq
;
