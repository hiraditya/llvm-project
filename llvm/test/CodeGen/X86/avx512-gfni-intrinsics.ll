...
; X86NOBW-NEXT:    vgf2p8affineinvqb $4, %xmm1, %xmm0, %xmm5 # EVEX TO VEX Compression encoding: [0xc4,0xe3,0xf9,0xcf,0xe9,0x04]
; X86NOBW-NEXT:    vgf2p8affineinvqb $5, %xmm1, %xmm0, %xmm4 # EVEX TO VEX Compression encoding: [0xc4,0xe3,0xf9,0xcf,0xe1,0x05]
...
; X86NOBW-NEXT:    vpand %xmm5, %xmm0, %xmm1 # EVEX TO VEX Compression encoding: [0xc5,0xf9,0xdb,0xcd]
; X86NOBW-NEXT:    vpternlogq $226, %xmm2, %xmm0, %xmm4 # encoding: [0x62,0xf3,0xfd,0x08,0x25,0xe2,0xe2]
; X86NOBW-NEXT:    # xmm4 = xmm2 ^ (xmm0 & (xmm4 ^ xmm2))
; X86NOBW-NEXT:    vmovdqa %xmm3, %xmm0 # EVEX TO VEX Compression encoding: [0xc5,0xf9,0x6f,0xc3]
; X86NOBW-NEXT:    vmovdqa %xmm4, %xmm2 # EVEX TO VEX Compression encoding: [0xc5,0xf9,0x6f,0xd4]
...
; X64NOBW-NEXT:    vgf2p8affineinvqb $4, %xmm1, %xmm0, %xmm5 # EVEX TO VEX Compression encoding: [0xc4,0xe3,0xf9,0xcf,0xe9,0x04]
; X64NOBW-NEXT:    vgf2p8affineinvqb $5, %xmm1, %xmm0, %xmm4 # EVEX TO VEX Compression encoding: [0xc4,0xe3,0xf9,0xcf,0xe1,0x05]
...
; X64NOBW-NEXT:    vpand %xmm5, %xmm0, %xmm1 # EVEX TO VEX Compression encoding: [0xc5,0xf9,0xdb,0xcd]
; X64NOBW-NEXT:    vpternlogq $226, %xmm2, %xmm0, %xmm4 # encoding: [0x62,0xf3,0xfd,0x08,0x25,0xe2,0xe2]
; X64NOBW-NEXT:    # xmm4 = xmm2 ^ (xmm0 & (xmm4 ^ xmm2))
; X64NOBW-NEXT:    vmovdqa %xmm3, %xmm0 # EVEX TO VEX Compression encoding: [0xc5,0xf9,0x6f,0xc3]
; X64NOBW-NEXT:    vmovdqa %xmm4, %xmm2 # EVEX TO VEX Compression encoding: [0xc5,0xf9,0x6f,0xd4]
...
; X86NOBW-NEXT:    vgf2p8affineinvqb $4, %ymm1, %ymm0, %ymm5 # EVEX TO VEX Compression encoding: [0xc4,0xe3,0xfd,0xcf,0xe9,0x04]
; X86NOBW-NEXT:    vgf2p8affineinvqb $5, %ymm1, %ymm0, %ymm4 # EVEX TO VEX Compression encoding: [0xc4,0xe3,0xfd,0xcf,0xe1,0x05]
; X86NOBW-NEXT:    vpternlogd $255, %zmm0, %zmm0, %zmm0 {%k1} {z} # encoding: [0x62,0xf3,0x7d,0xc9,0x25,0xc0,0xff]
; X86NOBW-NEXT:    # zmm0 {%k1} {z} = -1
; X86NOBW-NEXT:    vpmovdb %zmm0, %xmm0 # encoding: [0x62,0xf2,0x7e,0x48,0x31,0xc0]
; X86NOBW-NEXT:    vpternlogd $255, %zmm1, %zmm1, %zmm1 {%k2} {z} # encoding: [0x62,0xf3,0x75,0xca,0x25,0xc9,0xff]
; X86NOBW-NEXT:    # zmm1 {%k2} {z} = -1
; X86NOBW-NEXT:    vpmovdb %zmm1, %xmm1 # encoding: [0x62,0xf2,0x7e,0x48,0x31,0xc9]
; X86NOBW-NEXT:    vinserti128 $1, %xmm1, %ymm0, %ymm0 # EVEX TO VEX Compression encoding: [0xc4,0xe3,0x7d,0x38,0xc1,0x01]
; X86NOBW-NEXT:    vpand %ymm5, %ymm0, %ymm1 # EVEX TO VEX Compression encoding: [0xc5,0xfd,0xdb,0xcd]
; X86NOBW-NEXT:    vpternlogq $226, %ymm2, %ymm0, %ymm4 # encoding: [0x62,0xf3,0xfd,0x28,0x25,0xe2,0xe2]
; X86NOBW-NEXT:    # ymm4 = ymm2 ^ (ymm0 & (ymm4 ^ ymm2))
; X86NOBW-NEXT:    vmovdqa %ymm3, %ymm0 # EVEX TO VEX Compression encoding: [0xc5,0xfd,0x6f,0xc3]
; X86NOBW-NEXT:    vmovdqa %ymm4, %ymm2 # EVEX TO VEX Compression encoding: [0xc5,0xfd,0x6f,0xd4]
; X86NOBW-NEXT:    retl # encoding: [0xc3]
;
...
; X64NOBW-NEXT:    vgf2p8affineinvqb $4, %ymm1, %ymm0, %ymm5 # EVEX TO VEX Compression encoding: [0xc4,0xe3,0xfd,0xcf,0xe9,0x04]
; X64NOBW-NEXT:    vgf2p8affineinvqb $5, %ymm1, %ymm0, %ymm4 # EVEX TO VEX Compression encoding: [0xc4,0xe3,0xfd,0xcf,0xe1,0x05]
; X64NOBW-NEXT:    vpternlogd $255, %zmm0, %zmm0, %zmm0 {%k1} {z} # encoding: [0x62,0xf3,0x7d,0xc9,0x25,0xc0,0xff]
; X64NOBW-NEXT:    # zmm0 {%k1} {z} = -1
; X64NOBW-NEXT:    vpmovdb %zmm0, %xmm0 # encoding: [0x62,0xf2,0x7e,0x48,0x31,0xc0]
; X64NOBW-NEXT:    vpternlogd $255, %zmm1, %zmm1, %zmm1 {%k2} {z} # encoding: [0x62,0xf3,0x75,0xca,0x25,0xc9,0xff]
; X64NOBW-NEXT:    # zmm1 {%k2} {z} = -1
; X64NOBW-NEXT:    vpmovdb %zmm1, %xmm1 # encoding: [0x62,0xf2,0x7e,0x48,0x31,0xc9]
; X64NOBW-NEXT:    vinserti128 $1, %xmm1, %ymm0, %ymm0 # EVEX TO VEX Compression encoding: [0xc4,0xe3,0x7d,0x38,0xc1,0x01]
; X64NOBW-NEXT:    vpand %ymm5, %ymm0, %ymm1 # EVEX TO VEX Compression encoding: [0xc5,0xfd,0xdb,0xcd]
; X64NOBW-NEXT:    vpternlogq $226, %ymm2, %ymm0, %ymm4 # encoding: [0x62,0xf3,0xfd,0x28,0x25,0xe2,0xe2]
; X64NOBW-NEXT:    # ymm4 = ymm2 ^ (ymm0 & (ymm4 ^ ymm2))
; X64NOBW-NEXT:    vmovdqa %ymm3, %ymm0 # EVEX TO VEX Compression encoding: [0xc5,0xfd,0x6f,0xc3]
; X64NOBW-NEXT:    vmovdqa %ymm4, %ymm2 # EVEX TO VEX Compression encoding: [0xc5,0xfd,0x6f,0xd4]
; X64NOBW-NEXT:    retq # encoding: [0xc3]
...
; X86NOBW-NEXT:    vpternlogq $226, %zmm2, %zmm5, %zmm3 # encoding: [0x62,0xf3,0xd5,0x48,0x25,0xda,0xe2]
; X86NOBW-NEXT:    # zmm3 = zmm2 ^ (zmm5 & (zmm3 ^ zmm2))
; X86NOBW-NEXT:    vmovdqa64 %zmm3, %zmm2 # encoding: [0x62,0xf1,0xfd,0x48,0x6f,0xd3]
; X86NOBW-NEXT:    retl # encoding: [0xc3]
;
...
; X64NOBW-NEXT:    vgf2p8affineinvqb $4, %zmm1, %zmm0, %zmm5 # encoding: [0x62,0xf3,0xfd,0x48,0xcf,0xe9,0x04]
; X64NOBW-NEXT:    vgf2p8affineinvqb $5, %zmm1, %zmm0, %zmm4 # encoding: [0x62,0xf3,0xfd,0x48,0xcf,0xe1,0x05]
; X64NOBW-NEXT:    vpternlogd $255, %zmm0, %zmm0, %zmm0 {%k4} {z} # encoding: [0x62,0xf3,0x7d,0xcc,0x25,0xc0,0xff]
; X64NOBW-NEXT:    # zmm0 {%k4} {z} = -1
; X64NOBW-NEXT:    vpmovdb %zmm0, %xmm0 # encoding: [0x62,0xf2,0x7e,0x48,0x31,0xc0]
; X64NOBW-NEXT:    vpternlogd $255, %zmm1, %zmm1, %zmm1 {%k3} {z} # encoding: [0x62,0xf3,0x75,0xcb,0x25,0xc9,0xff]
; X64NOBW-NEXT:    # zmm1 {%k3} {z} = -1
; X64NOBW-NEXT:    vpmovdb %zmm1, %xmm1 # encoding: [0x62,0xf2,0x7e,0x48,0x31,0xc9]
; X64NOBW-NEXT:    vinserti128 $1, %xmm1, %ymm0, %ymm0 # EVEX TO VEX Compression encoding: [0xc4,0xe3,0x7d,0x38,0xc1,0x01]
...
; X64NOBW-NEXT:    vinserti128 $1, %xmm6, %ymm1, %ymm1 # EVEX TO VEX Compression encoding: [0xc4,0xe3,0x75,0x38,0xce,0x01]
; X64NOBW-NEXT:    vinserti64x4 $1, %ymm0, %zmm1, %zmm0 # encoding: [0x62,0xf3,0xf5,0x48,0x3a,0xc0,0x01]
; X64NOBW-NEXT:    vpandq %zmm5, %zmm0, %zmm1 # encoding: [0x62,0xf1,0xfd,0x48,0xdb,0xcd]
; X64NOBW-NEXT:    vpternlogq $226, %zmm2, %zmm0, %zmm4 # encoding: [0x62,0xf3,0xfd,0x48,0x25,0xe2,0xe2]
; X64NOBW-NEXT:    # zmm4 = zmm2 ^ (zmm0 & (zmm4 ^ zmm2))
; X64NOBW-NEXT:    vmovdqa64 %zmm3, %zmm0 # encoding: [0x62,0xf1,0xfd,0x48,0x6f,0xc3]
; X64NOBW-NEXT:    vmovdqa64 %zmm4, %zmm2 # encoding: [0x62,0xf1,0xfd,0x48,0x6f,0xd4]
; X64NOBW-NEXT:    retq # encoding: [0xc3]
...
; X86NOBW-NEXT:    vgf2p8affineqb $4, %xmm1, %xmm0, %xmm5 # EVEX TO VEX Compression encoding: [0xc4,0xe3,0xf9,0xce,0xe9,0x04]
; X86NOBW-NEXT:    vgf2p8affineqb $5, %xmm1, %xmm0, %xmm4 # EVEX TO VEX Compression encoding: [0xc4,0xe3,0xf9,0xce,0xe1,0x05]
; X86NOBW-NEXT:    vpternlogd $255, %zmm0, %zmm0, %zmm0 {%k1} {z} # encoding: [0x62,0xf3,0x7d,0xc9,0x25,0xc0,0xff]
; X86NOBW-NEXT:    # zmm0 {%k1} {z} = -1
; X86NOBW-NEXT:    vpmovdb %zmm0, %xmm0 # encoding: [0x62,0xf2,0x7e,0x48,0x31,0xc0]
; X86NOBW-NEXT:    vpand %xmm5, %xmm0, %xmm1 # EVEX TO VEX Compression encoding: [0xc5,0xf9,0xdb,0xcd]
...
; X64NOBW-NEXT:    vgf2p8affineqb $4, %xmm1, %xmm0, %xmm5 # EVEX TO VEX Compression encoding: [0xc4,0xe3,0xf9,0xce,0xe9,0x04]
; X64NOBW-NEXT:    vgf2p8affineqb $5, %xmm1, %xmm0, %xmm4 # EVEX TO VEX Compression encoding: [0xc4,0xe3,0xf9,0xce,0xe1,0x05]
; X64NOBW-NEXT:    vpternlogd $255, %zmm0, %zmm0, %zmm0 {%k1} {z} # encoding: [0x62,0xf3,0x7d,0xc9,0x25,0xc0,0xff]
; X64NOBW-NEXT:    # zmm0 {%k1} {z} = -1
; X64NOBW-NEXT:    vpmovdb %zmm0, %xmm0 # encoding: [0x62,0xf2,0x7e,0x48,0x31,0xc0]
; X64NOBW-NEXT:    vpand %xmm5, %xmm0, %xmm1 # EVEX TO VEX Compression encoding: [0xc5,0xf9,0xdb,0xcd]
...
; X86NOBW-NEXT:    vgf2p8affineqb $4, %ymm1, %ymm0, %ymm5 # EVEX TO VEX Compression encoding: [0xc4,0xe3,0xfd,0xce,0xe9,0x04]
; X86NOBW-NEXT:    vgf2p8affineqb $5, %ymm1, %ymm0, %ymm4 # EVEX TO VEX Compression encoding: [0xc4,0xe3,0xfd,0xce,0xe1,0x05]
; X86NOBW-NEXT:    vpternlogd $255, %zmm0, %zmm0, %zmm0 {%k1} {z} # encoding: [0x62,0xf3,0x7d,0xc9,0x25,0xc0,0xff]
; X86NOBW-NEXT:    # zmm0 {%k1} {z} = -1
; X86NOBW-NEXT:    vpmovdb %zmm0, %xmm0 # encoding: [0x62,0xf2,0x7e,0x48,0x31,0xc0]
; X86NOBW-NEXT:    vpternlogd $255, %zmm1, %zmm1, %zmm1 {%k2} {z} # encoding: [0x62,0xf3,0x75,0xca,0x25,0xc9,0xff]
...
; X64NOBW-NEXT:    vgf2p8affineqb $4, %ymm1, %ymm0, %ymm5 # EVEX TO VEX Compression encoding: [0xc4,0xe3,0xfd,0xce,0xe9,0x04]
; X64NOBW-NEXT:    vgf2p8affineqb $5, %ymm1, %ymm0, %ymm4 # EVEX TO VEX Compression encoding: [0xc4,0xe3,0xfd,0xce,0xe1,0x05]
; X64NOBW-NEXT:    vpternlogd $255, %zmm0, %zmm0, %zmm0 {%k1} {z} # encoding: [0x62,0xf3,0x7d,0xc9,0x25,0xc0,0xff]
; X64NOBW-NEXT:    # zmm0 {%k1} {z} = -1
; X64NOBW-NEXT:    vpmovdb %zmm0, %xmm0 # encoding: [0x62,0xf2,0x7e,0x48,0x31,0xc0]
; X64NOBW-NEXT:    vpternlogd $255, %zmm1, %zmm1, %zmm1 {%k2} {z} # encoding: [0x62,0xf3,0x75,0xca,0x25,0xc9,0xff]
...
; X64NOBW-NEXT:    vgf2p8affineqb $4, %zmm1, %zmm0, %zmm5 # encoding: [0x62,0xf3,0xfd,0x48,0xce,0xe9,0x04]
; X64NOBW-NEXT:    vgf2p8affineqb $5, %zmm1, %zmm0, %zmm4 # encoding: [0x62,0xf3,0xfd,0x48,0xce,0xe1,0x05]
; X64NOBW-NEXT:    vpternlogd $255, %zmm0, %zmm0, %zmm0 {%k4} {z} # encoding: [0x62,0xf3,0x7d,0xcc,0x25,0xc0,0xff]
; X64NOBW-NEXT:    # zmm0 {%k4} {z} = -1
; X64NOBW-NEXT:    vpmovdb %zmm0, %xmm0 # encoding: [0x62,0xf2,0x7e,0x48,0x31,0xc0]
; X64NOBW-NEXT:    vpternlogd $255, %zmm1, %zmm1, %zmm1 {%k3} {z} # encoding: [0x62,0xf3,0x75,0xcb,0x25,0xc9,0xff]
...
; X86NOBW-NEXT:    vpmovdb %zmm1, %xmm1 # encoding: [0x62,0xf2,0x7e,0x48,0x31,0xc9]
; X86NOBW-NEXT:    vpternlogq $226, %xmm2, %xmm1, %xmm0 # encoding: [0x62,0xf3,0xf5,0x08,0x25,0xc2,0xe2]
; X86NOBW-NEXT:    # xmm0 = xmm2 ^ (xmm1 & (xmm0 ^ xmm2))
; X86NOBW-NEXT:    vzeroupper # encoding: [0xc5,0xf8,0x77]
; X86NOBW-NEXT:    retl # encoding: [0xc3]
;
...
; X64NOBW-NEXT:    # zmm1 {%k1} {z} = -1
; X64NOBW-NEXT:    vpmovdb %zmm1, %xmm1 # encoding: [0x62,0xf2,0x7e,0x48,0x31,0xc9]
; X64NOBW-NEXT:    vpternlogq $226, %xmm2, %xmm1, %xmm0 # encoding: [0x62,0xf3,0xf5,0x08,0x25,0xc2,0xe2]
; X64NOBW-NEXT:    # xmm0 = xmm2 ^ (xmm1 & (xmm0 ^ xmm2))
; X64NOBW-NEXT:    vzeroupper # encoding: [0xc5,0xf8,0x77]
; X64NOBW-NEXT:    retq # encoding: [0xc3]
  %1 = bitcast i16 %mask to <16 x i1>
...
; X86NOBW-NEXT:    vpternlogq $226, %ymm2, %ymm1, %ymm0 # encoding: [0x62,0xf3,0xf5,0x28,0x25,0xc2,0xe2]
; X86NOBW-NEXT:    # ymm0 = ymm2 ^ (ymm1 & (ymm0 ^ ymm2))
; X86NOBW-NEXT:    retl # encoding: [0xc3]
;
...
; X64NOBW-NEXT:    vpternlogq $226, %ymm2, %ymm1, %ymm0 # encoding: [0x62,0xf3,0xf5,0x28,0x25,0xc2,0xe2]
; X64NOBW-NEXT:    # ymm0 = ymm2 ^ (ymm1 & (ymm0 ^ ymm2))
; X64NOBW-NEXT:    retq # encoding: [0xc3]
  %1 = bitcast i32 %mask to <32 x i1>
...
; X86NOBW-NEXT:    vinserti64x4 $1, %ymm1, %zmm3, %zmm1 # encoding: [0x62,0xf3,0xe5,0x48,0x3a,0xc9,0x01]
; X86NOBW-NEXT:    vpternlogq $226, %zmm2, %zmm1, %zmm0 # encoding: [0x62,0xf3,0xf5,0x48,0x25,0xc2,0xe2]
; X86NOBW-NEXT:    # zmm0 = zmm2 ^ (zmm1 & (zmm0 ^ zmm2))
; X86NOBW-NEXT:    retl # encoding: [0xc3]
;
...
; X64NOBW-NEXT:    vinserti64x4 $1, %ymm1, %zmm3, %zmm1 # encoding: [0x62,0xf3,0xe5,0x48,0x3a,0xc9,0x01]
; X64NOBW-NEXT:    vpternlogq $226, %zmm2, %zmm1, %zmm0 # encoding: [0x62,0xf3,0xf5,0x48,0x25,0xc2,0xe2]
; X64NOBW-NEXT:    # zmm0 = zmm2 ^ (zmm1 & (zmm0 ^ zmm2))
; X64NOBW-NEXT:    retq # encoding: [0xc3]
  %1 = bitcast i64 %mask to <64 x i1>
