...
; ALL:       ## %bb.0:
; ALL-NEXT:    vfmadd213ps {{.*#+}} zmm1 = (zmm0 * zmm1) + zmm2
...
; ALL:       ## %bb.0:
; ALL-NEXT:    vfmsub213ps {{.*#+}} zmm1 = (zmm0 * zmm1) - zmm2
; ALL-NEXT:    vmovaps %zmm1, %zmm0
; ALL-NEXT:    retq
  %x = fmul contract <16 x float> %a0, %a1
...
; ALL:       ## %bb.0:
; ALL-NEXT:    vfnmadd213ps {{.*#+}} zmm1 = -(zmm0 * zmm1) + zmm2
; ALL-NEXT:    vmovaps %zmm1, %zmm0
; ALL-NEXT:    retq
  %x = fmul contract <16 x float> %a0, %a1
...
; ALL:       ## %bb.0:
; ALL-NEXT:    vfnmsub213ps {{.*#+}} zmm1 = -(zmm0 * zmm1) - zmm2
; ALL-NEXT:    vmovaps %zmm1, %zmm0
; ALL-NEXT:    retq
  %x = fmul contract <16 x float> %a0, %a1
...
; ALL:       ## %bb.0:
; ALL-NEXT:    vfmadd213pd {{.*#+}} zmm1 = (zmm0 * zmm1) + zmm2
...
; ALL:       ## %bb.0:
; ALL-NEXT:    vfmsub213pd {{.*#+}} zmm1 = (zmm0 * zmm1) - zmm2
; ALL-NEXT:    vmovapd %zmm1, %zmm0
; ALL-NEXT:    retq
  %x = fmul contract <8 x double> %a0, %a1
...
; ALL:       ## %bb.0:
; ALL-NEXT:    vfmsub213sd {{.*#+}} xmm1 = (xmm0 * xmm1) - xmm2
; ALL-NEXT:    vmovapd %xmm1, %xmm0
; ALL-NEXT:    retq
...
; ALL-NEXT:    vfmsub231sd {{.*#+}} xmm2 = (xmm0 * xmm1) - xmm2
; ALL-NEXT:    vmovapd %xmm2, %xmm0
; ALL-NEXT:    retq
...
; ALL:       ## %bb.0:
; ALL-NEXT:    vmovsd {{.*#+}} xmm2 = mem[0],zero
; ALL-NEXT:    vfmsub213sd {{.*#+}} xmm2 = (xmm0 * xmm2) - xmm1
; ALL-NEXT:    vmovapd %xmm2, %xmm0
; ALL-NEXT:    retq
  %a2 = load double , ptr%a2_ptr
...
; ALL:       ## %bb.0:
; ALL-NEXT:    vbroadcastss {{.*#+}} zmm2 = [1.00000001E-1,1.00000001E-1,1.00000001E-1,1.00000001E-1,1.00000001E-1,1.00000001E-1,1.00000001E-1,1.00000001E-1,1.00000001E-1,1.00000001E-1,1.00000001E-1,1.00000001E-1,1.00000001E-1,1.00000001E-1,1.00000001E-1,1.00000001E-1]
; ALL-NEXT:    vfmadd213ps {{.*#+}} zmm2 = (zmm0 * zmm2) + zmm1
...
; ALL:       ## %bb.0:
; ALL-NEXT:    vbroadcastss {{.*#+}} zmm2 = [1.00000001E-1,1.00000001E-1,1.00000001E-1,1.00000001E-1,1.00000001E-1,1.00000001E-1,1.00000001E-1,1.00000001E-1,1.00000001E-1,1.00000001E-1,1.00000001E-1,1.00000001E-1,1.00000001E-1,1.00000001E-1,1.00000001E-1,1.00000001E-1]
; ALL-NEXT:    vfmadd231ps {{.*#+}} zmm2 = (zmm0 * zmm1) + zmm2
; ALL-NEXT:    vmovaps %zmm2, %zmm0
; ALL-NEXT:    retq
