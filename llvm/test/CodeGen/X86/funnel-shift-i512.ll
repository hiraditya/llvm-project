...
; AVX2-NEXT:    movq {{[0-9]+}}(%rsp), %r13
; AVX2-NEXT:    cmoveq %rbx, %r13
; AVX2-NEXT:    movq {{[0-9]+}}(%rsp), %rbx
; AVX2-NEXT:    cmoveq %rbp, %rbx
; AVX2-NEXT:    testb $-128, %cl
; AVX2-NEXT:    cmovneq %r9, %rdx
; AVX2-NEXT:    movq %r9, %rbp
; AVX2-NEXT:    cmovneq %rsi, %rbp
...
; AVX512VL-NEXT:    shldq %cl, %r15, %r8
; AVX512VL-NEXT:    movq %rdi, %rax
; AVX512VL-NEXT:    movq %rdx, %rdi
; AVX512VL-NEXT:    shldq %cl, %r9, %rdi
...
; AVX512VBMI-NEXT:    cmoveq %rbx, %r11
...
; AVX512VBMI-NEXT:    shldq %cl, %r15, %r8
; AVX512VBMI-NEXT:    movq %rdi, %rax
; AVX512VBMI-NEXT:    movq %rdx, %rdi
; AVX512VBMI-NEXT:    shldq %cl, %r9, %rdi
...
; SSE-NEXT:    cmovneq %r15, %rcx
; SSE-NEXT:    cmoveq %r15, %rdx
; SSE-NEXT:    testb $64, %al
; SSE-NEXT:    cmoveq %r8, %r10
; SSE-NEXT:    cmoveq %r14, %r8
...
; SSE-NEXT:    shrdq %cl, %r14, %r15
; SSE-NEXT:    shrdq %cl, %r8, %r14
; SSE-NEXT:    shrdq %cl, %r10, %r8
; SSE-NEXT:    movq %rdi, %rax
; SSE-NEXT:    movq %r8, 56(%rdi)
; SSE-NEXT:    movq %r14, 48(%rdi)
; SSE-NEXT:    movq %r15, 40(%rdi)
; SSE-NEXT:    movq %r12, 32(%rdi)
; SSE-NEXT:    movq %r9, 24(%rdi)
...
; AVX512F-NEXT:    cmoveq %r13, %rbp
; AVX512F-NEXT:    movq {{[0-9]+}}(%rsp), %r13
; AVX512F-NEXT:    cmovneq %rax, %r13
; AVX512F-NEXT:    movq {{[0-9]+}}(%rsp), %r8
; AVX512F-NEXT:    cmovneq %r12, %r8
; AVX512F-NEXT:    movq {{[0-9]+}}(%rsp), %rax
; AVX512F-NEXT:    cmovneq %rbx, %rax
; AVX512F-NEXT:    movq {{[0-9]+}}(%rsp), %rbx
...
; AVX512VL-NEXT:    cmovneq %r13, %r8
; AVX512VL-NEXT:    movq {{[0-9]+}}(%rsp), %r13
; AVX512VL-NEXT:    cmovneq {{[0-9]+}}(%rsp), %r13
; AVX512VL-NEXT:    movq {{[0-9]+}}(%rsp), %rax
; AVX512VL-NEXT:    cmovneq %r12, %rax
; AVX512VL-NEXT:    testb $-128, %cl
; AVX512VL-NEXT:    cmoveq %r15, %r11
...
; AVX512VL-NEXT:    cmovneq %r13, %rax
; AVX512VL-NEXT:    cmoveq %r13, %rdx
; AVX512VL-NEXT:    testb $64, %cl
; AVX512VL-NEXT:    cmoveq %r11, %r10
...
; AVX512VL-NEXT:    shrdq %cl, %rbx, %r9
; AVX512VL-NEXT:    shrdq %cl, %r14, %r15
; AVX512VL-NEXT:    movq %rdi, %rax
; AVX512VL-NEXT:    shrdq %cl, %r11, %r14
; AVX512VL-NEXT:    # kill: def $cl killed $cl killed $rcx
; AVX512VL-NEXT:    shrdq %cl, %r10, %r11
; AVX512VL-NEXT:    movq %r11, 56(%rdi)
; AVX512VL-NEXT:    movq %r14, 48(%rdi)
; AVX512VL-NEXT:    movq %r15, 40(%rdi)
; AVX512VL-NEXT:    movq %r12, 32(%rdi)
...
; AVX512VBMI-NEXT:    movq {{[0-9]+}}(%rsp), %r8
; AVX512VBMI-NEXT:    cmovneq %r13, %r8
; AVX512VBMI-NEXT:    movq {{[0-9]+}}(%rsp), %r13
; AVX512VBMI-NEXT:    cmovneq {{[0-9]+}}(%rsp), %r13
; AVX512VBMI-NEXT:    movq {{[0-9]+}}(%rsp), %rax
; AVX512VBMI-NEXT:    cmovneq %r12, %rax
; AVX512VBMI-NEXT:    testb $-128, %cl
; AVX512VBMI-NEXT:    cmoveq %r15, %r11
...
; AVX512VBMI-NEXT:    cmovneq %r13, %rax
; AVX512VBMI-NEXT:    cmoveq %r13, %rdx
; AVX512VBMI-NEXT:    testb $64, %cl
; AVX512VBMI-NEXT:    cmoveq %r11, %r10
...
; AVX512VBMI-NEXT:    shrdq %cl, %rbx, %r9
; AVX512VBMI-NEXT:    shrdq %cl, %r14, %r15
; AVX512VBMI-NEXT:    movq %rdi, %rax
; AVX512VBMI-NEXT:    shrdq %cl, %r11, %r14
; AVX512VBMI-NEXT:    # kill: def $cl killed $cl killed $rcx
; AVX512VBMI-NEXT:    shrdq %cl, %r10, %r11
; AVX512VBMI-NEXT:    movq %r11, 56(%rdi)
; AVX512VBMI-NEXT:    movq %r14, 48(%rdi)
; AVX512VBMI-NEXT:    movq %r15, 40(%rdi)
; AVX512VBMI-NEXT:    movq %r12, 32(%rdi)
...
; AVX512F-NEXT:    cmovneq %rbx, %rdx
; AVX512F-NEXT:    cmovneq %r9, %rbx
; AVX512F-NEXT:    cmovneq %r15, %r9
...
; AVX512VL-NEXT:    cmovneq %r13, %rax
; AVX512VL-NEXT:    movq %r13, %r8
; AVX512VL-NEXT:    cmovneq %r12, %r8
; AVX512VL-NEXT:    cmovneq %r10, %r12
; AVX512VL-NEXT:    movq %rbx, %rdx
; AVX512VL-NEXT:    cmovneq %r15, %rdx
; AVX512VL-NEXT:    movq %r15, %r9
; AVX512VL-NEXT:    cmovneq %rsi, %r9
...
; AVX512VBMI-NEXT:    cmovneq %r13, %rax
; AVX512VBMI-NEXT:    movq %r13, %r8
; AVX512VBMI-NEXT:    cmovneq %r12, %r8
; AVX512VBMI-NEXT:    cmovneq %r10, %r12
; AVX512VBMI-NEXT:    movq %rbx, %rdx
; AVX512VBMI-NEXT:    cmovneq %r15, %rdx
; AVX512VBMI-NEXT:    movq %r15, %r9
; AVX512VBMI-NEXT:    cmovneq %rsi, %r9
...
; AVX512VBMI-NEXT:    movq %r9, %r15
; AVX512VBMI-NEXT:    shldq %cl, %r8, %r15
...
; AVX512VBMI-NEXT:    shldq %cl, %rdx, %r12
; AVX512VBMI-NEXT:    movq %rdi, %rax
; AVX512VBMI-NEXT:    movq %r11, %rdx
...
; AVX512VBMI-NEXT:    movq %r12, 40(%rdi)
...
; AVX512VL-NEXT:    # kill: def $cl killed $cl killed $rcx
; AVX512VL-NEXT:    shrdq %cl, %r14, %r15
; AVX512VL-NEXT:    movq %r15, 56(%rdi)
; AVX512VL-NEXT:    movq %r10, 48(%rdi)
; AVX512VL-NEXT:    movq %r9, 40(%rdi)
; AVX512VL-NEXT:    movq %rdx, 32(%rdi)
...
; AVX512VBMI-NEXT:    movq %rdx, %r13
; AVX512VBMI-NEXT:    cmoveq %r10, %r13
...
; AVX512VBMI-NEXT:    # kill: def $cl killed $cl killed $rcx
; AVX512VBMI-NEXT:    shrdq %cl, %r14, %r15
; AVX512VBMI-NEXT:    movq %r15, 56(%rdi)
; AVX512VBMI-NEXT:    movq %r10, 48(%rdi)
; AVX512VBMI-NEXT:    movq %r9, 40(%rdi)
; AVX512VBMI-NEXT:    movq %rdx, 32(%rdi)
...
; SSE-NEXT:    movq %r12, %rbx
; SSE-NEXT:    shldq %cl, %r11, %rbx
; SSE-NEXT:    movq %rdx, %r11
; SSE-NEXT:    shldq %cl, %r12, %r11
; SSE-NEXT:    movq %r14, %r15
; SSE-NEXT:    shldq %cl, %rdx, %r15
...
; AVX2-NEXT:    movq 32(%rdx), %rbx
; AVX2-NEXT:    movq 40(%rdx), %rbp
; AVX2-NEXT:    movq 48(%rdx), %r10
; AVX2-NEXT:    testl $256, %ecx # imm = 0x100
; AVX2-NEXT:    movq 48(%rsi), %r8
; AVX2-NEXT:    cmovneq %r11, %r8
; AVX2-NEXT:    movq 40(%rsi), %r14
...
; SSE-NEXT:    movq 32(%rdx), %rbp
; SSE-NEXT:    movq 40(%rdx), %r8
; SSE-NEXT:    movq 56(%rdx), %rbx
; SSE-NEXT:    testl $256, %ecx # imm = 0x100
; SSE-NEXT:    movq 56(%rsi), %rax
; SSE-NEXT:    cmoveq %r10, %rax
; SSE-NEXT:    movq %rax, {{[-0-9]+}}(%r{{[sb]}}p) # 8-byte Spill
; SSE-NEXT:    movq 40(%rsi), %r15
; SSE-NEXT:    cmoveq %r9, %r15
; SSE-NEXT:    movq 32(%rsi), %r14
; SSE-NEXT:    cmoveq %r11, %r14
; SSE-NEXT:    cmoveq %rbx, %r10
; SSE-NEXT:    cmoveq %r8, %r9
; SSE-NEXT:    cmoveq %rbp, %r11
; SSE-NEXT:    movq 16(%rsi), %r13
; SSE-NEXT:    movq 24(%rdx), %r12
; SSE-NEXT:    cmovneq %rbx, %r12
; SSE-NEXT:    movq 8(%rdx), %rbx
; SSE-NEXT:    cmovneq %r8, %rbx
; SSE-NEXT:    movq (%rdx), %r8
; SSE-NEXT:    cmovneq %rbp, %r8
; SSE-NEXT:    movq 48(%rdx), %rbp
; SSE-NEXT:    movq 48(%rsi), %rsi
; SSE-NEXT:    cmoveq %r13, %rsi
; SSE-NEXT:    cmoveq %rbp, %r13
; SSE-NEXT:    movq 16(%rdx), %rax
; SSE-NEXT:    cmovneq %rbp, %rax
; SSE-NEXT:    testb $-128, %cl
...
; AVX2-NEXT:    movq 32(%rdx), %rbp
; AVX2-NEXT:    movq 40(%rdx), %r9
; AVX2-NEXT:    movq 56(%rdx), %rbx
; AVX2-NEXT:    testl $256, %ecx # imm = 0x100
; AVX2-NEXT:    movq 56(%rsi), %r8
; AVX2-NEXT:    cmoveq %r10, %r8
; AVX2-NEXT:    movq %r8, {{[-0-9]+}}(%r{{[sb]}}p) # 8-byte Spill
; AVX2-NEXT:    movq 40(%rsi), %r15
; AVX2-NEXT:    cmoveq %rax, %r15
; AVX2-NEXT:    movq 32(%rsi), %r14
; AVX2-NEXT:    cmoveq %r11, %r14
; AVX2-NEXT:    cmoveq %rbx, %r10
; AVX2-NEXT:    cmoveq %r9, %rax
; AVX2-NEXT:    cmoveq %rbp, %r11
; AVX2-NEXT:    movq 16(%rsi), %r12
; AVX2-NEXT:    movq 24(%rdx), %r13
; AVX2-NEXT:    cmovneq %rbx, %r13
; AVX2-NEXT:    movq 8(%rdx), %rbx
; AVX2-NEXT:    cmovneq %r9, %rbx
; AVX2-NEXT:    movq (%rdx), %r9
; AVX2-NEXT:    cmovneq %rbp, %r9
; AVX2-NEXT:    movq 48(%rdx), %rbp
; AVX2-NEXT:    movq 48(%rsi), %rsi
; AVX2-NEXT:    cmoveq %r12, %rsi
; AVX2-NEXT:    cmoveq %rbp, %r12
; AVX2-NEXT:    movq 16(%rdx), %r8
...
; AVX2-NEXT:    movq %r15, 48(%rdi)
; AVX2-NEXT:    movq %rdx, 40(%rdi)
; AVX2-NEXT:    movq %r10, 32(%rdi)
; AVX2-NEXT:    movq %r14, 24(%rdi)
...
; SSE-NEXT:    shrdq %cl, %r14, %rdx
; SSE-NEXT:    # kill: def $cl killed $cl killed $rcx
; SSE-NEXT:    shrdq %cl, %rbx, %r14
; SSE-NEXT:    movq %rdi, %rax
; SSE-NEXT:    movq %r14, 56(%rdi)
; SSE-NEXT:    movq %rdx, 48(%rdi)
; SSE-NEXT:    movq %r9, 40(%rdi)
...
; SSE42-NEXT:    cmovneq %r15, %r10
; SSE42-NEXT:    cmovneq %rbx, %r15
; SSE42-NEXT:    cmovneq %r12, %rbx
; SSE42-NEXT:    cmovneq %r9, %r12
...
; AVX2-NEXT:    cmoveq %rbp, %r13
; AVX2-NEXT:    vmovq %xmm3, %rbp
; AVX2-NEXT:    cmovneq %r11, %r15
; AVX2-NEXT:    cmovneq %rbp, %r11
; AVX2-NEXT:    cmoveq %rbp, %r8
...
; SSE2-NEXT:    movq %xmm6, %r13
; SSE2-NEXT:    movq %xmm7, %rbp
; SSE2-NEXT:    cmoveq %r12, %rsi
; SSE2-NEXT:    cmoveq %r11, %r14
; SSE2-NEXT:    cmoveq %rbp, %r12
; SSE2-NEXT:    cmoveq %r13, %r11
; SSE2-NEXT:    cmovneq %r13, %rdx
; SSE2-NEXT:    movq %xmm5, %r13
; SSE2-NEXT:    cmovneq %rbp, %r13
; SSE2-NEXT:    testb $-128, %cl
; SSE2-NEXT:    cmovneq %r13, %rdx
; SSE2-NEXT:    cmoveq %r14, %rsi
; SSE2-NEXT:    cmoveq %r12, %r14
; SSE2-NEXT:    cmoveq %r11, %r12
; SSE2-NEXT:    cmoveq %r13, %r11
; SSE2-NEXT:    cmovneq %r15, %r8
; SSE2-NEXT:    cmoveq %r10, %rax
; SSE2-NEXT:    cmoveq %rbx, %r10
; SSE2-NEXT:    cmoveq %r9, %rbx
; SSE2-NEXT:    cmoveq %r15, %r9
; SSE2-NEXT:    testb $64, %cl
; SSE2-NEXT:    cmoveq %rsi, %rax
; SSE2-NEXT:    cmoveq %r10, %rsi
; SSE2-NEXT:    cmoveq %r14, %r10
; SSE2-NEXT:    cmoveq %rbx, %r14
; SSE2-NEXT:    cmoveq %r12, %rbx
; SSE2-NEXT:    cmoveq %r9, %r12
...
; SSE2-NEXT:    shrdq %cl, %r12, %r9
; SSE2-NEXT:    shrdq %cl, %rbx, %r12
; SSE2-NEXT:    shrdq %cl, %r14, %rbx
; SSE2-NEXT:    shrdq %cl, %r10, %r14
; SSE2-NEXT:    shrdq %cl, %rsi, %r10
; SSE2-NEXT:    # kill: def $cl killed $cl killed $rcx
; SSE2-NEXT:    shrdq %cl, %rax, %rsi
; SSE2-NEXT:    movq %rdi, %rax
; SSE2-NEXT:    movq %rsi, 56(%rdi)
; SSE2-NEXT:    movq %r10, 48(%rdi)
; SSE2-NEXT:    movq %r14, 40(%rdi)
; SSE2-NEXT:    movq %rbx, 32(%rdi)
; SSE2-NEXT:    movq %r12, 24(%rdi)
...
; SSE42-NEXT:    pextrq $1, %xmm6, %r13
; SSE42-NEXT:    movq %xmm4, %rsi
; SSE42-NEXT:    pextrq $1, %xmm7, %rbp
; SSE42-NEXT:    testl $256, %ecx # imm = 0x100
; SSE42-NEXT:    cmoveq %r11, %rax
; SSE42-NEXT:    cmoveq %r9, %r10
; SSE42-NEXT:    cmoveq %rbp, %r11
; SSE42-NEXT:    cmoveq %r13, %r9
; SSE42-NEXT:    cmovneq %rbp, %r14
; SSE42-NEXT:    cmovneq %r13, %r8
; SSE42-NEXT:    movq %xmm6, %r13
; SSE42-NEXT:    movq %xmm7, %rbp
; SSE42-NEXT:    cmoveq %r12, %rdx
; SSE42-NEXT:    cmoveq %rbx, %r15
; SSE42-NEXT:    cmoveq %rbp, %r12
; SSE42-NEXT:    cmoveq %r13, %rbx
; SSE42-NEXT:    cmovneq %r13, %rsi
; SSE42-NEXT:    movq %xmm5, %r13
; SSE42-NEXT:    cmovneq %rbp, %r13
; SSE42-NEXT:    testb $-128, %cl
; SSE42-NEXT:    cmovneq %r13, %rsi
; SSE42-NEXT:    cmoveq %r15, %rdx
; SSE42-NEXT:    cmoveq %r12, %r15
...
; SSE42-NEXT:    cmoveq %r14, %r9
; SSE42-NEXT:    testb $64, %cl
; SSE42-NEXT:    cmoveq %rdx, %rax
; SSE42-NEXT:    cmoveq %r10, %rdx
; SSE42-NEXT:    cmoveq %r15, %r10
; SSE42-NEXT:    cmoveq %r11, %r15
; SSE42-NEXT:    cmoveq %r12, %r11
; SSE42-NEXT:    cmoveq %r9, %r12
; SSE42-NEXT:    cmoveq %rbx, %r9
; SSE42-NEXT:    cmoveq %r8, %rbx
; SSE42-NEXT:    cmovneq %r8, %rsi
; SSE42-NEXT:    shrdq %cl, %rbx, %rsi
; SSE42-NEXT:    shrdq %cl, %r9, %rbx
; SSE42-NEXT:    shrdq %cl, %r12, %r9
; SSE42-NEXT:    shrdq %cl, %r11, %r12
; SSE42-NEXT:    shrdq %cl, %r15, %r11
; SSE42-NEXT:    shrdq %cl, %r10, %r15
; SSE42-NEXT:    shrdq %cl, %rdx, %r10
; SSE42-NEXT:    # kill: def $cl killed $cl killed $rcx
; SSE42-NEXT:    shrdq %cl, %rax, %rdx
; SSE42-NEXT:    movq %rdi, %rax
; SSE42-NEXT:    movq %rdx, 56(%rdi)
; SSE42-NEXT:    movq %r10, 48(%rdi)
; SSE42-NEXT:    movq %r15, 40(%rdi)
...
; AVX2-NEXT:    cmoveq %r13, %r12
; AVX2-NEXT:    cmoveq %r11, %r13
; AVX2-NEXT:    cmoveq %r9, %r11
; AVX2-NEXT:    cmovneq %r9, %rdx
; AVX2-NEXT:    shrdq %cl, %r11, %rdx
; AVX2-NEXT:    shrdq %cl, %r13, %r11
...
; AVX2-NEXT:    shrdq %cl, %r8, %rsi
; AVX2-NEXT:    movq %rsi, 56(%rdi)
; AVX2-NEXT:    movq %r10, 48(%rdi)
; AVX2-NEXT:    movq %r14, 40(%rdi)
; AVX2-NEXT:    movq %rbx, 32(%rdi)
...
; SSE2-NEXT:    movq %xmm4, %r12
; SSE2-NEXT:    movq %r12, %r13
; SSE2-NEXT:    cmovneq %rax, %r13
...
; SSE42-NEXT:    movq %r9, %r14
; SSE42-NEXT:    shldq %cl, %r15, %r14
; SSE42-NEXT:    movq %r10, %r15
; SSE42-NEXT:    shldq %cl, %r9, %r15
...
; SSE42-NEXT:    # kill: def $cl killed $cl killed $rcx
; SSE42-NEXT:    shldq %cl, %rsi, %r11
; SSE42-NEXT:    movq %rdi, %rax
; SSE42-NEXT:    movq %r11, 56(%rdi)
