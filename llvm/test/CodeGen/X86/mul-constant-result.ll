...
; X64-HSW-NEXT:    leal -1(%rdi), %ecx
; X64-HSW-NEXT:    cmpl $31, %ecx
; X64-HSW-NEXT:    ja .LBB0_32
; X64-HSW-NEXT:  # %bb.1:
; X64-HSW-NEXT:    jmpq *.LJTI0_0(,%rcx,8)
; X64-HSW-NEXT:  .LBB0_2:
