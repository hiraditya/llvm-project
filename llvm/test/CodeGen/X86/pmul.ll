...
; SSE41:       # %bb.0: # %entry
; SSE41-NEXT:    movdqa {{.*#+}} xmm1 = [117,117,117,117,117,117,117,117,117,117,117,117,117,117,117,117]
; SSE41-NEXT:    pmullw %xmm0, %xmm1
; SSE41-NEXT:    pmaddubsw {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %xmm0 # [0,117,0,117,0,117,0,117,0,117,0,117,0,117,0,117]
...
; SSE2-LABEL: mul_v8i16c:
; SSE2:       # %bb.0: # %entry
; SSE2-NEXT:    movdqa {{.*#+}} xmm1 = [117,117,117,117,117,117,117,117]
; SSE2-NEXT:    pmullw %xmm0, %xmm1
; SSE2-NEXT:    movdqa %xmm1, %xmm0
; SSE2-NEXT:    retq
;
; SSE41-LABEL: mul_v8i16c:
; SSE41:       # %bb.0: # %entry
; SSE41-NEXT:    pmovsxbw {{.*#+}} xmm1 = [117,117,117,117,117,117,117,117]
; SSE41-NEXT:    pmullw %xmm0, %xmm1
...
; SSE41:       # %bb.0: # %entry
; SSE41-NEXT:    pmovsxbd {{.*#+}} xmm1 = [117,117,117,117]
...
; AVX512F-NEXT:    vpbroadcastb {{.*#+}} ymm1 = [117,117,117,117,117,117,117,117,117,117,117,117,117,117,117,117,117,117,117,117,117,117,117,117,117,117,117,117,117,117,117,117]
; AVX512F-NEXT:    vpmullw %ymm1, %ymm2, %ymm3
...
; AVX512F-NEXT:    vpsllw $8, %ymm0, %ymm0
; AVX512F-NEXT:    vpmaddubsw %ymm3, %ymm2, %ymm2
; AVX512F-NEXT:    vpsllw $8, %ymm2, %ymm2
; AVX512F-NEXT:    vinserti64x4 $1, %ymm2, %zmm0, %zmm0
; AVX512F-NEXT:    vpternlogd {{.*#+}} zmm1 = (zmm1 & m32bcst) | zmm0
...
; AVX512BW-NEXT:    vpternlogd {{.*#+}} zmm1 = (zmm1 & m32bcst) | zmm0
...
; AVX512F-NEXT:    vpmullw %ymm3, %ymm4, %ymm2
...
; AVX512F-NEXT:    vpmaddubsw %ymm1, %ymm0, %ymm0
; AVX512F-NEXT:    vpsllw $8, %ymm0, %ymm0
; AVX512F-NEXT:    vpandn %ymm3, %ymm5, %ymm1
; AVX512F-NEXT:    vpmaddubsw %ymm1, %ymm4, %ymm1
; AVX512F-NEXT:    vpsllw $8, %ymm1, %ymm1
; AVX512F-NEXT:    vinserti64x4 $1, %ymm1, %zmm0, %zmm0
; AVX512F-NEXT:    vpternlogq {{.*#+}} zmm2 = (zmm2 & zmm5) | zmm0
...
; AVX512BW-NEXT:    vpsllw $8, %zmm0, %zmm0
; AVX512BW-NEXT:    vpternlogq {{.*#+}} zmm2 = (zmm2 & zmm3) | zmm0
...
; SSE41-NEXT:    movdqa %xmm0, %xmm4
; SSE41-NEXT:    punpckhdq {{.*#+}} xmm4 = xmm4[2],xmm2[2],xmm4[3],xmm2[3]
...
; SSE41-NEXT:    movdqa %xmm0, %xmm6
; SSE41-NEXT:    punpckhdq {{.*#+}} xmm6 = xmm6[2],xmm4[2],xmm6[3],xmm4[3]
; SSE41-NEXT:    pmovzxdq {{.*#+}} xmm7 = xmm1[0],zero,xmm1[1],zero
; SSE41-NEXT:    movdqa %xmm1, %xmm8
; SSE41-NEXT:    punpckhdq {{.*#+}} xmm8 = xmm8[2],xmm4[2],xmm8[3],xmm4[3]
...
; SSE2-NEXT:    punpckhdq {{.*#+}} xmm11 = xmm11[2],xmm1[2],xmm11[3],xmm1[3]
; SSE2-NEXT:    punpckldq {{.*#+}} xmm12 = xmm12[0],xmm1[0],xmm12[1],xmm1[1]
...
; SSE2-NEXT:    pshufd {{.*#+}} xmm13 = xmm4[2,3,2,3]
; SSE2-NEXT:    pxor %xmm14, %xmm14
; SSE2-NEXT:    pcmpgtd %xmm13, %xmm14
; SSE2-NEXT:    punpckldq {{.*#+}} xmm13 = xmm13[0],xmm14[0],xmm13[1],xmm14[1]
; SSE2-NEXT:    pxor %xmm15, %xmm15
; SSE2-NEXT:    pcmpgtd %xmm4, %xmm15
; SSE2-NEXT:    punpckldq {{.*#+}} xmm4 = xmm4[0],xmm15[0],xmm4[1],xmm15[1]
; SSE2-NEXT:    movdqa %xmm1, %xmm0
; SSE2-NEXT:    punpckldq {{.*#+}} xmm0 = xmm0[0],xmm6[0],xmm0[1],xmm6[1]
; SSE2-NEXT:    pmuludq %xmm4, %xmm0
; SSE2-NEXT:    punpckldq {{.*#+}} xmm15 = xmm15[0],xmm6[0],xmm15[1],xmm6[1]
; SSE2-NEXT:    pmuludq %xmm12, %xmm15
; SSE2-NEXT:    paddq %xmm15, %xmm0
; SSE2-NEXT:    psllq $32, %xmm0
; SSE2-NEXT:    pmuludq %xmm4, %xmm12
; SSE2-NEXT:    paddq %xmm12, %xmm0
; SSE2-NEXT:    punpckhdq {{.*#+}} xmm1 = xmm1[2],xmm6[2],xmm1[3],xmm6[3]
; SSE2-NEXT:    pmuludq %xmm13, %xmm1
; SSE2-NEXT:    punpckldq {{.*#+}} xmm14 = xmm14[0],xmm6[0],xmm14[1],xmm6[1]
; SSE2-NEXT:    pmuludq %xmm11, %xmm14
; SSE2-NEXT:    paddq %xmm14, %xmm1
; SSE2-NEXT:    psllq $32, %xmm1
...
; SSE2-NEXT:    punpckldq {{.*#+}} xmm10 = xmm10[0],xmm6[0],xmm10[1],xmm6[1]
; SSE2-NEXT:    pmuludq %xmm7, %xmm10
; SSE2-NEXT:    paddq %xmm10, %xmm4
