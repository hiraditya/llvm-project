...
; AVX512F-NEXT:    vpermi2ps %zmm2, %zmm0, %zmm1
...
; AVX512-FAST-NEXT:    vxorps %xmm2, %xmm2, %xmm2
; AVX512-FAST-NEXT:    vpmovsxbq {{.*#+}} ymm1 = [8,10,12,14]
; AVX512-FAST-NEXT:    vpermi2ps %ymm2, %ymm0, %ymm1
; AVX512-FAST-NEXT:    vmovaps %ymm1, %ymm0
...
; AVX512F-NEXT:    vpternlogq {{.*#+}} zmm2 = zmm0 ^ (zmm2 & (zmm1 ^ zmm0))
...
; AVX512F:       # %bb.0: # %entry
; AVX512F-NEXT:    vpbroadcastd {{.*#+}} zmm2 = [65535,0,65535,0,65535,0,65535,0,65535,0,65535,0,65535,0,65535,0,65535,0,65535,0,65535,0,65535,0,65535,0,65535,0,65535,0,65535,0]
; AVX512F-NEXT:    vpternlogd {{.*#+}} zmm2 = zmm0 ^ (zmm2 & (zmm1 ^ zmm0))
; AVX512F-NEXT:    vmovdqa64 %zmm2, %zmm0
; AVX512F-NEXT:    ret{{[l|q]}}
entry:
...
; X86-AVX512-NEXT:    vpermi2ps (%eax), %ymm0, %ymm1
...
; X64-AVX512-NEXT:    vpermi2ps (%rdi), %ymm0, %ymm1
...
; X86-AVX512F-NEXT:    vpermi2ps %zmm2, %zmm0, %zmm1
...
; X64-AVX512F-NEXT:    vmovaps (%rdi), %ymm2
; X64-AVX512F-NEXT:    vpmovsxbd {{.*#+}} ymm1 = [23,22,19,3,23,22,6,7]
; X64-AVX512F-NEXT:    vpermi2ps %zmm2, %zmm0, %zmm1
...
; X86-AVX512-NEXT:    vpermi2ps (%eax), %zmm0, %zmm1
...
; X64-AVX512-NEXT:    vpermi2ps (%rdi), %zmm0, %zmm1
...
; X86-AVX512F-NEXT:    vpermi2ps (%eax), %zmm0, %zmm1
...
; X64-AVX512F-NEXT:    vpermi2ps (%rdi), %zmm0, %zmm1
