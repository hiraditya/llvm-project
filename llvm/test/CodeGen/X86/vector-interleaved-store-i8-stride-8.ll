...
; SSE-NEXT:    pshufhw {{.*#+}} xmm6 = xmm5[0,1,2,3,4,5,7,5]
; SSE-NEXT:    pshufhw {{.*#+}} xmm5 = xmm5[0,1,2,3,4,5,6,4]
; SSE-NEXT:    packuswb %xmm6, %xmm5
; SSE-NEXT:    movdqa {{.*#+}} xmm7 = [65535,65535,65535,0,65535,65535,65535,0]
...
; SSE-NEXT:    pshufhw {{.*#+}} xmm9 = xmm6[0,1,2,3,7,5,6,7]
...
; SSE-NEXT:    pshufhw {{.*#+}} xmm9 = xmm4[0,1,2,3,5,7,6,7]
...
; SSE-NEXT:    pshuflw {{.*#+}} xmm9 = xmm3[1,3,2,3,4,5,6,7]
...
; SSE-NEXT:    pshuflw {{.*#+}} xmm9 = xmm2[3,1,2,3,4,5,6,7]
...
; SSE-NEXT:    pshufhw {{.*#+}} xmm5 = xmm1[0,1,2,3,4,5,5,7]
...
; SSE-NEXT:    pshuflw {{.*#+}} xmm4 = xmm0[0,1,3,1,4,5,6,7]
...
; SSE-NEXT:    pshufd {{.*#+}} xmm9 = xmm0[0,0,2,1]
...
; SSE-NEXT:    pshufhw {{.*#+}} xmm12 = xmm9[0,1,2,3,5,5,5,5]
...
; SSE-NEXT:    pshufhw {{.*#+}} xmm13 = xmm0[0,1,2,3,5,5,5,5]
; SSE-NEXT:    pand %xmm14, %xmm13
...
; SSE-NEXT:    pshufhw {{.*#+}} xmm5 = xmm1[0,1,2,3,4,4,6,5]
...
; AVX512-FCP-NEXT:    vpmovsxdq {{.*#+}} ymm4 = [201851904,218694913,235537922,252380931]
; AVX512-FCP-NEXT:    vpshufb %ymm4, %ymm7, %ymm7
; AVX512-FCP-NEXT:    vpblendd {{.*#+}} ymm5 = ymm7[0],ymm5[1],ymm7[2],ymm5[3],ymm7[4],ymm5[5],ymm7[6],ymm5[7]
...
; AVX512DQ-FCP-NEXT:    vpmovsxdq {{.*#+}} ymm4 = [201851904,218694913,235537922,252380931]
; AVX512DQ-FCP-NEXT:    vpshufb %ymm4, %ymm7, %ymm7
; AVX512DQ-FCP-NEXT:    vpblendd {{.*#+}} ymm5 = ymm7[0],ymm5[1],ymm7[2],ymm5[3],ymm7[4],ymm5[5],ymm7[6],ymm5[7]
...
; SSE-NEXT:    pshuflw {{.*#+}} xmm6 = xmm14[0,1,1,3,4,5,6,7]
...
; SSE-NEXT:    pshuflw {{.*#+}} xmm1 = xmm15[0,0,2,1,4,5,6,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm1 = xmm1[0,1,1,3]
...
; SSE-NEXT:    pshuflw {{.*#+}} xmm7 = xmm15[0,2,2,3,4,5,6,7]
...
; SSE-NEXT:    pshufhw {{.*#+}} xmm8 = xmm15[0,1,2,3,4,6,6,7]
...
; SSE-NEXT:    pshufhw {{.*#+}} xmm6 = xmm15[0,1,2,3,4,4,6,5]
...
; SSE-NEXT:    pshuflw {{.*#+}} xmm9 = xmm2[0,0,2,1,4,5,6,7]
...
; SSE-NEXT:    pshufd {{.*#+}} xmm6 = xmm5[0,0,2,1]
...
; SSE-NEXT:    movdqa %xmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; SSE-NEXT:    pshuflw {{.*#+}} xmm4 = xmm14[0,0,2,1,4,5,6,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm4 = xmm4[0,0,2,1]
...
; SSE-NEXT:    pshufhw {{.*#+}} xmm1 = xmm4[0,1,2,3,4,4,6,5]
; SSE-NEXT:    pshufd {{.*#+}} xmm1 = xmm1[0,2,2,3]
; SSE-NEXT:    movdqa %xmm9, %xmm2
; SSE-NEXT:    pandn %xmm1, %xmm2
; SSE-NEXT:    pshufhw {{.*#+}} xmm1 = xmm5[0,1,2,3,4,5,5,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm1 = xmm1[0,2,2,3]
; SSE-NEXT:    pand %xmm9, %xmm1
; SSE-NEXT:    por %xmm1, %xmm2
; SSE-NEXT:    pshufhw {{.*#+}} xmm1 = xmm12[0,1,2,3,4,4,6,5]
; SSE-NEXT:    pshufd {{.*#+}} xmm1 = xmm1[2,1,3,3]
; SSE-NEXT:    movdqa %xmm7, %xmm4
; SSE-NEXT:    pandn %xmm1, %xmm4
...
; SSE-NEXT:    pand %xmm9, %xmm4
; SSE-NEXT:    por %xmm4, %xmm5
; SSE-NEXT:    pshufhw {{.*#+}} xmm4 = xmm8[0,1,2,3,4,4,6,5]
...
; SSE-NEXT:    pshufd {{.*#+}} xmm5 = xmm14[2,2,2,2]
...
; AVX512-NEXT:    vpunpckhbw {{.*#+}} xmm0 = xmm4[8],xmm1[8],xmm4[9],xmm1[9],xmm4[10],xmm1[10],xmm4[11],xmm1[11],xmm4[12],xmm1[12],xmm4[13],xmm1[13],xmm4[14],xmm1[14],xmm4[15],xmm1[15]
...
; AVX512-NEXT:    vpunpckhbw {{.*#+}} xmm2 = xmm6[8],xmm5[8],xmm6[9],xmm5[9],xmm6[10],xmm5[10],xmm6[11],xmm5[11],xmm6[12],xmm5[12],xmm6[13],xmm5[13],xmm6[14],xmm5[14],xmm6[15],xmm5[15]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm7 = xmm2[0,1,2,3,4,5,5,7]
...
; AVX512-NEXT:    vpblendw {{.*#+}} ymm1 = ymm7[0,1,2],ymm1[3],ymm7[4,5,6],ymm1[7],ymm7[8,9,10],ymm1[11],ymm7[12,13,14],ymm1[15]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm7 = xmm0[0,0,2,1,4,5,6,7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm0 = xmm0[0,2,2,3,4,5,6,7]
; AVX512-NEXT:    vinserti128 $1, %xmm0, %ymm7, %ymm0
; AVX512-NEXT:    vpshufd {{.*#+}} ymm0 = ymm0[0,0,2,1,4,4,6,5]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm7 = xmm2[0,1,1,3,4,5,6,7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm2 = xmm2[2,1,3,3,4,5,6,7]
; AVX512-NEXT:    vinserti128 $1, %xmm2, %ymm7, %ymm2
...
; AVX512-NEXT:    vpunpckhbw {{.*#+}} xmm1 = xmm9[8],xmm7[8],xmm9[9],xmm7[9],xmm9[10],xmm7[10],xmm9[11],xmm7[11],xmm9[12],xmm7[12],xmm9[13],xmm7[13],xmm9[14],xmm7[14],xmm9[15],xmm7[15]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm8 = xmm1[0,1,2,3,4,4,6,5]
...
; AVX512-NEXT:    vpshufd {{.*#+}} ymm8 = ymm8[2,1,3,3,6,5,7,7]
...
; AVX512-NEXT:    vpblendw {{.*#+}} ymm0 = ymm0[0],ymm8[1],ymm0[2,3,4],ymm8[5],ymm0[6,7,8],ymm8[9],ymm0[10,11,12],ymm8[13],ymm0[14,15]
...
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm1 = xmm0[0,1,2,3,4,4,6,5]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm8 = xmm0[0,1,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti128 $1, %xmm8, %ymm1, %ymm1
; AVX512-NEXT:    vpunpcklbw {{.*#+}} xmm8 = xmm15[0],xmm14[0],xmm15[1],xmm14[1],xmm15[2],xmm14[2],xmm15[3],xmm14[3],xmm15[4],xmm14[4],xmm15[5],xmm14[5],xmm15[6],xmm14[6],xmm15[7],xmm14[7]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm11 = xmm8[0,1,2,3,4,5,5,7]
...
; AVX512-NEXT:    vinserti64x4 $1, %ymm10, %zmm0, %zmm19
; AVX512-NEXT:    vmovdqa 16(%rdx), %xmm8
; AVX512-NEXT:    vpunpcklbw {{.*#+}} xmm0 = xmm8[0],xmm2[0],xmm8[1],xmm2[1],xmm8[2],xmm2[2],xmm8[3],xmm2[3],xmm8[4],xmm2[4],xmm8[5],xmm2[5],xmm8[6],xmm2[6],xmm8[7],xmm2[7]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm10 = xmm0[0,1,2,3,4,4,6,5]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm11 = xmm0[0,1,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti32x4 $1, %xmm11, %ymm10, %ymm16
...
; AVX512-NEXT:    vpunpcklbw {{.*#+}} xmm10 = xmm1[0],xmm11[0],xmm1[1],xmm11[1],xmm1[2],xmm11[2],xmm1[3],xmm11[3],xmm1[4],xmm11[4],xmm1[5],xmm11[5],xmm1[6],xmm11[6],xmm1[7],xmm11[7]
...
; AVX512-NEXT:    vpunpckhbw {{.*#+}} xmm0 = xmm8[8],xmm2[8],xmm8[9],xmm2[9],xmm8[10],xmm2[10],xmm8[11],xmm2[11],xmm8[12],xmm2[12],xmm8[13],xmm2[13],xmm8[14],xmm2[14],xmm8[15],xmm2[15]
...
; AVX512-NEXT:    vinserti128 $1, %xmm3, %ymm2, %ymm2
; AVX512-NEXT:    vpunpcklbw {{.*#+}} xmm3 = xmm6[0],xmm5[0],xmm6[1],xmm5[1],xmm6[2],xmm5[2],xmm6[3],xmm5[3],xmm6[4],xmm5[4],xmm6[5],xmm5[5],xmm6[6],xmm5[6],xmm6[7],xmm5[7]
...
; AVX512-NEXT:    vpunpcklbw {{.*#+}} xmm2 = xmm9[0],xmm7[0],xmm9[1],xmm7[1],xmm9[2],xmm7[2],xmm9[3],xmm7[3],xmm9[4],xmm7[4],xmm9[5],xmm7[5],xmm9[6],xmm7[6],xmm9[7],xmm7[7]
...
; AVX512-NEXT:    vpblendmd %zmm17, %zmm18, %zmm3 {%k1}
; AVX512-NEXT:    vpblendmd %zmm19, %zmm16, %zmm4 {%k1}
; AVX512-NEXT:    vpblendmd %zmm12, %zmm0, %zmm0 {%k1}
; AVX512-NEXT:    vpblendmd %zmm1, %zmm2, %zmm1 {%k1}
...
; AVX512-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm0 = xmm13[8],xmm1[8],xmm13[9],xmm1[9],xmm13[10],xmm1[10],xmm13[11],xmm1[11],xmm13[12],xmm1[12],xmm13[13],xmm1[13],xmm13[14],xmm1[14],xmm13[15],xmm1[15]
; AVX512-FCP-NEXT:    vmovdqa64 %xmm1, %xmm30
; AVX512-FCP-NEXT:    vinserti128 $1, %xmm0, %ymm0, %ymm0
; AVX512-FCP-NEXT:    vmovdqa (%rsi), %xmm11
; AVX512-FCP-NEXT:    vmovdqa (%rdi), %xmm12
; AVX512-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm1 = xmm12[8],xmm11[8],xmm12[9],xmm11[9],xmm12[10],xmm11[10],xmm12[11],xmm11[11],xmm12[12],xmm11[12],xmm12[13],xmm11[13],xmm12[14],xmm11[14],xmm12[15],xmm11[15]
...
; AVX512-FCP-NEXT:    vpmovsxwq {{.*#+}} xmm10 = [1284,1798]
...
; AVX512-FCP-NEXT:    vmovdqa 16(%rax), %xmm8
; AVX512-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm0 = xmm8[0],xmm9[0],xmm8[1],xmm9[1],xmm8[2],xmm9[2],xmm8[3],xmm9[3],xmm8[4],xmm9[4],xmm8[5],xmm9[5],xmm8[6],xmm9[6],xmm8[7],xmm9[7]
; AVX512-FCP-NEXT:    vinserti128 $1, %xmm0, %ymm0, %ymm0
...
; AVX512-FCP-NEXT:    vmovdqa {{.*#+}} ymm3 = [0,1,2,3,8,9,8,9,8,9,10,11,10,11,10,11,0,1,2,3,12,13,12,13,12,13,10,11,14,15,14,15]
...
; AVX512-FCP-NEXT:    vinserti128 $1, %xmm2, %ymm2, %ymm0
...
; AVX512-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm15 = xmm1[0],xmm3[0],xmm1[1],xmm3[1],xmm1[2],xmm3[2],xmm1[3],xmm3[3],xmm1[4],xmm3[4],xmm1[5],xmm3[5],xmm1[6],xmm3[6],xmm1[7],xmm3[7]
...
; AVX512-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm14 = xmm2[0],zero,zero,zero,xmm2[1],zero,zero,zero
; AVX512-FCP-NEXT:    vpshufb %xmm10, %xmm2, %xmm2
; AVX512-FCP-NEXT:    vmovdqa64 %xmm10, %xmm31
; AVX512-FCP-NEXT:    vinserti128 $1, %xmm2, %ymm14, %ymm2
; AVX512-FCP-NEXT:    vpshufb {{.*#+}} ymm14 = ymm15[u,u,0,1,u,u,u,u,u,u,2,3,u,u,u,u,u,u,20,21,u,u,u,u,u,u,22,23,u,u,u,u]
; AVX512-FCP-NEXT:    vpblendw {{.*#+}} ymm2 = ymm2[0],ymm14[1],ymm2[2,3,4],ymm14[5],ymm2[6,7,8],ymm14[9],ymm2[10,11,12],ymm14[13],ymm2[14,15]
; AVX512-FCP-NEXT:    vinserti64x4 $1, %ymm0, %zmm2, %zmm19
; AVX512-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm0 = xmm8[8],xmm9[8],xmm8[9],xmm9[9],xmm8[10],xmm9[10],xmm8[11],xmm9[11],xmm8[12],xmm9[12],xmm8[13],xmm9[13],xmm8[14],xmm9[14],xmm8[15],xmm9[15]
; AVX512-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm2 = xmm6[8],xmm7[8],xmm6[9],xmm7[9],xmm6[10],xmm7[10],xmm6[11],xmm7[11],xmm6[12],xmm7[12],xmm6[13],xmm7[13],xmm6[14],xmm7[14],xmm6[15],xmm7[15]
; AVX512-FCP-NEXT:    vinserti128 $1, %xmm0, %ymm0, %ymm0
; AVX512-FCP-NEXT:    vinserti128 $1, %xmm2, %ymm2, %ymm2
...
; AVX512-FCP-NEXT:    vpshufb %ymm9, %ymm2, %ymm7
...
; AVX512-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm1 = xmm1[8],xmm3[8],xmm1[9],xmm3[9],xmm1[10],xmm3[10],xmm1[11],xmm3[11],xmm1[12],xmm3[12],xmm1[13],xmm3[13],xmm1[14],xmm3[14],xmm1[15],xmm3[15]
...
; AVX512-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm3 = xmm13[0],xmm3[0],xmm13[1],xmm3[1],xmm13[2],xmm3[2],xmm13[3],xmm3[3],xmm13[4],xmm3[4],xmm13[5],xmm3[5],xmm13[6],xmm3[6],xmm13[7],xmm3[7]
; AVX512-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm4 = xmm12[0],xmm11[0],xmm12[1],xmm11[1],xmm12[2],xmm11[2],xmm12[3],xmm11[3],xmm12[4],xmm11[4],xmm12[5],xmm11[5],xmm12[6],xmm11[6],xmm12[7],xmm11[7]
...
; AVX512-FCP-NEXT:    vpblendmd %zmm23, %zmm17, %zmm4 {%k1}
; AVX512-FCP-NEXT:    vpblendmd %zmm18, %zmm19, %zmm5 {%k1}
; AVX512-FCP-NEXT:    vpblendmd %zmm20, %zmm1, %zmm0 {%k1}
; AVX512-FCP-NEXT:    vpblendmd %zmm2, %zmm3, %zmm1 {%k1}
...
; AVX512BW-NEXT:    vpblendmd %zmm9, %zmm19, %zmm9 {%k1}
; AVX512BW-NEXT:    vpunpcklbw {{.*#+}} xmm14 = xmm3[0],xmm1[0],xmm3[1],xmm1[1],xmm3[2],xmm1[2],xmm3[3],xmm1[3],xmm3[4],xmm1[4],xmm3[5],xmm1[5],xmm3[6],xmm1[6],xmm3[7],xmm1[7]
; AVX512BW-NEXT:    vpunpcklbw {{.*#+}} xmm19 = xmm8[0],xmm6[0],xmm8[1],xmm6[1],xmm8[2],xmm6[2],xmm8[3],xmm6[3],xmm8[4],xmm6[4],xmm8[5],xmm6[5],xmm8[6],xmm6[6],xmm8[7],xmm6[7]
; AVX512BW-NEXT:    vpermt2w %zmm14, %zmm10, %zmm19
; AVX512BW-NEXT:    vpunpcklbw {{.*#+}} xmm14 = xmm13[0],xmm11[0],xmm13[1],xmm11[1],xmm13[2],xmm11[2],xmm13[3],xmm11[3],xmm13[4],xmm11[4],xmm13[5],xmm11[5],xmm13[6],xmm11[6],xmm13[7],xmm11[7]
...
; AVX512BW-NEXT:    vpermt2w %zmm14, %zmm20, %zmm21
; AVX512BW-NEXT:    vpblendmd %zmm19, %zmm21, %zmm14 {%k1}
...
; AVX512BW-NEXT:    vpblendmd %zmm3, %zmm6, %zmm1 {%k1}
...
; AVX512BW-NEXT:    vpunpcklbw {{.*#+}} xmm2 = xmm7[0],xmm5[0],xmm7[1],xmm5[1],xmm7[2],xmm5[2],xmm7[3],xmm5[3],xmm7[4],xmm5[4],xmm7[5],xmm5[5],xmm7[6],xmm5[6],xmm7[7],xmm5[7]
...
; AVX512BW-NEXT:    vpunpcklbw {{.*#+}} xmm3 = xmm17[0],xmm15[0],xmm17[1],xmm15[1],xmm17[2],xmm15[2],xmm17[3],xmm15[3],xmm17[4],xmm15[4],xmm17[5],xmm15[5],xmm17[6],xmm15[6],xmm17[7],xmm15[7]
; AVX512BW-NEXT:    vpermt2w %zmm0, %zmm20, %zmm3
; AVX512BW-NEXT:    vpblendmd %zmm2, %zmm3, %zmm0 {%k1}
...
; AVX512BW-FCP-NEXT:    vpblendmd %zmm9, %zmm19, %zmm9 {%k1}
; AVX512BW-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm14 = xmm3[0],xmm1[0],xmm3[1],xmm1[1],xmm3[2],xmm1[2],xmm3[3],xmm1[3],xmm3[4],xmm1[4],xmm3[5],xmm1[5],xmm3[6],xmm1[6],xmm3[7],xmm1[7]
; AVX512BW-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm19 = xmm8[0],xmm6[0],xmm8[1],xmm6[1],xmm8[2],xmm6[2],xmm8[3],xmm6[3],xmm8[4],xmm6[4],xmm8[5],xmm6[5],xmm8[6],xmm6[6],xmm8[7],xmm6[7]
; AVX512BW-FCP-NEXT:    vpermt2w %zmm14, %zmm10, %zmm19
...
; AVX512BW-FCP-NEXT:    vpermt2w %zmm14, %zmm20, %zmm21
; AVX512BW-FCP-NEXT:    vpblendmd %zmm19, %zmm21, %zmm14 {%k1}
...
; AVX512BW-FCP-NEXT:    vpblendmd %zmm3, %zmm6, %zmm1 {%k1}
...
; AVX512BW-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm2 = xmm7[0],xmm5[0],xmm7[1],xmm5[1],xmm7[2],xmm5[2],xmm7[3],xmm5[3],xmm7[4],xmm5[4],xmm7[5],xmm5[5],xmm7[6],xmm5[6],xmm7[7],xmm5[7]
...
; AVX512BW-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm3 = xmm17[0],xmm15[0],xmm17[1],xmm15[1],xmm17[2],xmm15[2],xmm17[3],xmm15[3],xmm17[4],xmm15[4],xmm17[5],xmm15[5],xmm17[6],xmm15[6],xmm17[7],xmm15[7]
; AVX512BW-FCP-NEXT:    vpermt2w %zmm0, %zmm20, %zmm3
; AVX512BW-FCP-NEXT:    vpblendmd %zmm2, %zmm3, %zmm0 {%k1}
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm0, (%rax)
...
; AVX512DQ-BW-NEXT:    vpblendmd %zmm9, %zmm19, %zmm9 {%k1}
; AVX512DQ-BW-NEXT:    vpunpcklbw {{.*#+}} xmm14 = xmm3[0],xmm1[0],xmm3[1],xmm1[1],xmm3[2],xmm1[2],xmm3[3],xmm1[3],xmm3[4],xmm1[4],xmm3[5],xmm1[5],xmm3[6],xmm1[6],xmm3[7],xmm1[7]
; AVX512DQ-BW-NEXT:    vpunpcklbw {{.*#+}} xmm19 = xmm8[0],xmm6[0],xmm8[1],xmm6[1],xmm8[2],xmm6[2],xmm8[3],xmm6[3],xmm8[4],xmm6[4],xmm8[5],xmm6[5],xmm8[6],xmm6[6],xmm8[7],xmm6[7]
; AVX512DQ-BW-NEXT:    vpermt2w %zmm14, %zmm10, %zmm19
; AVX512DQ-BW-NEXT:    vpunpcklbw {{.*#+}} xmm14 = xmm13[0],xmm11[0],xmm13[1],xmm11[1],xmm13[2],xmm11[2],xmm13[3],xmm11[3],xmm13[4],xmm11[4],xmm13[5],xmm11[5],xmm13[6],xmm11[6],xmm13[7],xmm11[7]
...
; AVX512DQ-BW-NEXT:    vpermt2w %zmm14, %zmm20, %zmm21
; AVX512DQ-BW-NEXT:    vpblendmd %zmm19, %zmm21, %zmm14 {%k1}
...
; AVX512DQ-BW-NEXT:    vpblendmd %zmm3, %zmm6, %zmm1 {%k1}
...
; AVX512DQ-BW-NEXT:    vpunpcklbw {{.*#+}} xmm2 = xmm7[0],xmm5[0],xmm7[1],xmm5[1],xmm7[2],xmm5[2],xmm7[3],xmm5[3],xmm7[4],xmm5[4],xmm7[5],xmm5[5],xmm7[6],xmm5[6],xmm7[7],xmm5[7]
...
; AVX512DQ-BW-NEXT:    vpunpcklbw {{.*#+}} xmm3 = xmm17[0],xmm15[0],xmm17[1],xmm15[1],xmm17[2],xmm15[2],xmm17[3],xmm15[3],xmm17[4],xmm15[4],xmm17[5],xmm15[5],xmm17[6],xmm15[6],xmm17[7],xmm15[7]
; AVX512DQ-BW-NEXT:    vpermt2w %zmm0, %zmm20, %zmm3
; AVX512DQ-BW-NEXT:    vpblendmd %zmm2, %zmm3, %zmm0 {%k1}
...
; AVX512DQ-BW-FCP-NEXT:    vpblendmd %zmm9, %zmm19, %zmm9 {%k1}
; AVX512DQ-BW-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm14 = xmm3[0],xmm1[0],xmm3[1],xmm1[1],xmm3[2],xmm1[2],xmm3[3],xmm1[3],xmm3[4],xmm1[4],xmm3[5],xmm1[5],xmm3[6],xmm1[6],xmm3[7],xmm1[7]
; AVX512DQ-BW-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm19 = xmm8[0],xmm6[0],xmm8[1],xmm6[1],xmm8[2],xmm6[2],xmm8[3],xmm6[3],xmm8[4],xmm6[4],xmm8[5],xmm6[5],xmm8[6],xmm6[6],xmm8[7],xmm6[7]
; AVX512DQ-BW-FCP-NEXT:    vpermt2w %zmm14, %zmm10, %zmm19
...
; AVX512DQ-BW-FCP-NEXT:    vpermt2w %zmm14, %zmm20, %zmm21
; AVX512DQ-BW-FCP-NEXT:    vpblendmd %zmm19, %zmm21, %zmm14 {%k1}
...
; AVX512DQ-BW-FCP-NEXT:    vpblendmd %zmm3, %zmm6, %zmm1 {%k1}
...
; AVX512DQ-BW-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm2 = xmm7[0],xmm5[0],xmm7[1],xmm5[1],xmm7[2],xmm5[2],xmm7[3],xmm5[3],xmm7[4],xmm5[4],xmm7[5],xmm5[5],xmm7[6],xmm5[6],xmm7[7],xmm5[7]
...
; AVX512DQ-BW-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm3 = xmm17[0],xmm15[0],xmm17[1],xmm15[1],xmm17[2],xmm15[2],xmm17[3],xmm15[3],xmm17[4],xmm15[4],xmm17[5],xmm15[5],xmm17[6],xmm15[6],xmm17[7],xmm15[7]
; AVX512DQ-BW-FCP-NEXT:    vpermt2w %zmm0, %zmm20, %zmm3
; AVX512DQ-BW-FCP-NEXT:    vpblendmd %zmm2, %zmm3, %zmm0 {%k1}
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm0, (%rax)
...
; SSE-NEXT:    pshuflw {{.*#+}} xmm7 = xmm10[0,0,2,1,4,5,6,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm7 = xmm7[0,0,2,1]
; SSE-NEXT:    movdqa {{.*#+}} xmm0 = [65535,65535,65535,0,65535,65535,65535,0]
...
; SSE-NEXT:    pshuflw {{.*#+}} xmm12 = xmm11[0,1,1,3,4,5,6,7]
...
; SSE-NEXT:    pshufd {{.*#+}} xmm6 = xmm14[1,3,2,3]
...
; SSE-NEXT:    pand %xmm0, %xmm6
; SSE-NEXT:    por %xmm6, %xmm14
; SSE-NEXT:    pshufhw {{.*#+}} xmm6 = xmm12[0,1,2,3,4,4,6,5]
; SSE-NEXT:    pshufd {{.*#+}} xmm6 = xmm6[2,1,3,3]
; SSE-NEXT:    movdqa %xmm9, %xmm15
; SSE-NEXT:    pandn %xmm6, %xmm15
; SSE-NEXT:    pshufd {{.*#+}} xmm6 = xmm13[2,2,2,2]
; SSE-NEXT:    pshufhw {{.*#+}} xmm6 = xmm6[0,1,2,3,5,5,5,5]
; SSE-NEXT:    pand %xmm9, %xmm6
; SSE-NEXT:    por %xmm6, %xmm15
; SSE-NEXT:    pshufd {{.*#+}} xmm6 = xmm14[1,3,2,3]
...
; SSE-NEXT:    pshufd {{.*#+}} xmm12 = xmm5[0,0,2,1]
; SSE-NEXT:    pand %xmm0, %xmm12
...
; SSE-NEXT:    pshufd {{.*#+}} xmm12 = xmm6[0,0,2,1]
; SSE-NEXT:    pand %xmm0, %xmm12
...
; SSE-NEXT:    pshufd {{.*#+}} xmm7 = xmm11[0,2,2,3]
...
; SSE-NEXT:    pshufhw {{.*#+}} xmm10 = xmm2[0,1,2,3,4,5,5,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm10 = xmm10[0,2,2,3]
...
; SSE-NEXT:    pandn %xmm6, %xmm10
; SSE-NEXT:    punpckhbw {{.*#+}} xmm1 = xmm1[8],xmm3[8],xmm1[9],xmm3[9],xmm1[10],xmm3[10],xmm1[11],xmm3[11],xmm1[12],xmm3[12],xmm1[13],xmm3[13],xmm1[14],xmm3[14],xmm1[15],xmm3[15]
; SSE-NEXT:    pshuflw {{.*#+}} xmm3 = xmm1[0,1,1,3,4,5,6,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm3 = xmm3[0,0,2,1]
; SSE-NEXT:    pand %xmm8, %xmm3
...
; SSE-NEXT:    pand %xmm9, %xmm3
; SSE-NEXT:    por %xmm3, %xmm6
; SSE-NEXT:    pshufd {{.*#+}} xmm3 = xmm5[1,3,2,3]
; SSE-NEXT:    pshufd {{.*#+}} xmm5 = xmm6[0,2,2,3]
; SSE-NEXT:    punpckldq {{.*#+}} xmm5 = xmm5[0],xmm3[0],xmm5[1],xmm3[1]
; SSE-NEXT:    movdqa %xmm5, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; SSE-NEXT:    pshufhw {{.*#+}} xmm3 = xmm4[0,1,2,3,4,4,6,5]
; SSE-NEXT:    pshufd {{.*#+}} xmm3 = xmm3[0,2,2,3]
; SSE-NEXT:    movdqa %xmm8, %xmm5
; SSE-NEXT:    pandn %xmm3, %xmm5
; SSE-NEXT:    pshufhw {{.*#+}} xmm3 = xmm1[0,1,2,3,4,5,5,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm3 = xmm3[0,2,2,3]
; SSE-NEXT:    pand %xmm8, %xmm3
; SSE-NEXT:    por %xmm3, %xmm5
...
; SSE-NEXT:    pand %xmm9, %xmm0
; SSE-NEXT:    por %xmm0, %xmm1
; SSE-NEXT:    pshufd {{.*#+}} xmm0 = xmm4[1,3,2,3]
; SSE-NEXT:    pshufd {{.*#+}} xmm1 = xmm1[0,2,2,3]
; SSE-NEXT:    punpckldq {{.*#+}} xmm1 = xmm1[0],xmm0[0],xmm1[1],xmm0[1]
; SSE-NEXT:    movdqa %xmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
...
; SSE-NEXT:    por %xmm6, %xmm15
; SSE-NEXT:    pshufd {{.*#+}} xmm6 = xmm14[1,3,2,3]
; SSE-NEXT:    pshufd {{.*#+}} xmm8 = xmm15[0,2,2,3]
...
; SSE-NEXT:    pshuflw {{.*#+}} xmm11 = xmm1[2,1,3,3,4,5,6,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm11 = xmm11[0,0,2,1]
...
; SSE-NEXT:    pshufd {{.*#+}} xmm11 = xmm14[1,3,2,3]
; SSE-NEXT:    pshufd {{.*#+}} xmm15 = xmm15[0,2,2,3]
; SSE-NEXT:    punpckldq {{.*#+}} xmm15 = xmm15[0],xmm11[0],xmm15[1],xmm11[1]
; SSE-NEXT:    pshufhw {{.*#+}} xmm11 = xmm6[0,1,2,3,4,4,6,5]
; SSE-NEXT:    pshufd {{.*#+}} xmm11 = xmm11[0,2,2,3]
; SSE-NEXT:    movdqa %xmm7, %xmm14
; SSE-NEXT:    pandn %xmm11, %xmm14
; SSE-NEXT:    pshufhw {{.*#+}} xmm11 = xmm1[0,1,2,3,4,5,5,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm11 = xmm11[0,2,2,3]
; SSE-NEXT:    pand %xmm7, %xmm11
; SSE-NEXT:    por %xmm11, %xmm14
; SSE-NEXT:    pshufhw {{.*#+}} xmm11 = xmm3[0,1,2,3,4,4,6,5]
...
; SSE-NEXT:    pshufd {{.*#+}} xmm11 = xmm7[0,2,2,3]
...
; SSE-NEXT:    punpckldq {{.*#+}} xmm0 = xmm0[0],xmm1[0],xmm0[1],xmm1[1]
; SSE-NEXT:    pshufhw {{.*#+}} xmm1 = xmm10[0,1,2,3,4,4,6,5]
; SSE-NEXT:    pshufd {{.*#+}} xmm1 = xmm1[0,2,2,3]
...
; SSE-NEXT:    movq {{[0-9]+}}(%rsp), %rax
; SSE-NEXT:    movdqa %xmm3, 496(%rax)
; SSE-NEXT:    movdqa %xmm1, 480(%rax)
; SSE-NEXT:    movdqa %xmm0, 464(%rax)
; SSE-NEXT:    movdqa %xmm12, 448(%rax)
; SSE-NEXT:    movdqa %xmm6, 432(%rax)
; SSE-NEXT:    movdqa %xmm11, 416(%rax)
...
; AVX512-NEXT:    vinserti128 $1, %xmm4, %ymm3, %ymm8
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm3 = xmm2[0,1,2,3,4,4,6,5]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm2 = xmm2[0,1,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti32x4 $1, %xmm2, %ymm3, %ymm29
; AVX512-NEXT:    vmovdqa (%r10), %xmm4
...
; AVX512-NEXT:    vpunpckhbw {{.*#+}} xmm2 = xmm2[8],xmm4[8],xmm2[9],xmm4[9],xmm2[10],xmm4[10],xmm2[11],xmm4[11],xmm2[12],xmm4[12],xmm2[13],xmm4[13],xmm2[14],xmm4[14],xmm2[15],xmm4[15]
...
; AVX512-NEXT:    vmovdqa %xmm4, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX512-NEXT:    vmovdqa 48(%r9), %xmm10
; AVX512-NEXT:    vmovdqa (%r8), %xmm2
; AVX512-NEXT:    vmovdqa %xmm2, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX512-NEXT:    vmovdqa 48(%r8), %xmm11
; AVX512-NEXT:    vpunpckhbw {{.*#+}} xmm2 = xmm2[8],xmm4[8],xmm2[9],xmm4[9],xmm2[10],xmm4[10],xmm2[11],xmm4[11],xmm2[12],xmm4[12],xmm2[13],xmm4[13],xmm2[14],xmm4[14],xmm2[15],xmm4[15]
...
; AVX512-NEXT:    vinserti128 $1, %xmm2, %ymm4, %ymm2
; AVX512-NEXT:    vmovdqu %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX512-NEXT:    vpunpcklbw {{.*#+}} xmm2 = xmm5[0],xmm3[0],xmm5[1],xmm3[1],xmm5[2],xmm3[2],xmm5[3],xmm3[3],xmm5[4],xmm3[4],xmm5[5],xmm3[5],xmm5[6],xmm3[6],xmm5[7],xmm3[7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm4 = xmm2[0,0,2,1,4,5,6,7]
...
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm2 = xmm2[0,1,2,3,6,5,7,7]
; AVX512-NEXT:    vinserti128 $1, %xmm2, %ymm13, %ymm9
...
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm13 = xmm0[0,2,2,3,4,5,6,7]
; AVX512-NEXT:    vinserti32x4 $1, %xmm13, %ymm1, %ymm26
...
; AVX512-NEXT:    vinserti32x4 $1, %xmm0, %ymm13, %ymm27
...
; AVX512-NEXT:    vinserti32x4 $1, %xmm5, %ymm3, %ymm31
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm3 = xmm0[0,1,2,3,4,4,6,5]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm0 = xmm0[0,1,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti32x4 $1, %xmm0, %ymm3, %ymm24
; AVX512-NEXT:    vpunpckhbw {{.*#+}} xmm0 = xmm11[8],xmm10[8],xmm11[9],xmm10[9],xmm11[10],xmm10[10],xmm11[11],xmm10[11],xmm11[12],xmm10[12],xmm11[13],xmm10[13],xmm11[14],xmm10[14],xmm11[15],xmm10[15]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm0[0,1,1,3,4,5,6,7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm5 = xmm0[2,1,3,3,4,5,6,7]
; AVX512-NEXT:    vinserti32x4 $1, %xmm5, %ymm3, %ymm21
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm3 = xmm0[0,1,2,3,4,5,5,7]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm0 = xmm0[0,1,2,3,6,5,7,7]
; AVX512-NEXT:    vinserti32x4 $1, %xmm0, %ymm3, %ymm19
; AVX512-NEXT:    vpunpcklbw {{.*#+}} xmm0 = xmm4[0],xmm12[0],xmm4[1],xmm12[1],xmm4[2],xmm12[2],xmm4[3],xmm12[3],xmm4[4],xmm12[4],xmm4[5],xmm12[5],xmm4[6],xmm12[6],xmm4[7],xmm12[7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm0[0,0,2,1,4,5,6,7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm5 = xmm0[0,2,2,3,4,5,6,7]
; AVX512-NEXT:    vinserti32x4 $1, %xmm5, %ymm3, %ymm17
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm3 = xmm0[0,1,2,3,4,4,6,5]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm0 = xmm0[0,1,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti128 $1, %xmm0, %ymm3, %ymm15
...
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm0[0,0,2,1,4,5,6,7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm5 = xmm0[0,2,2,3,4,5,6,7]
; AVX512-NEXT:    vinserti32x4 $1, %xmm5, %ymm3, %ymm22
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm3 = xmm0[0,1,2,3,4,4,6,5]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm0 = xmm0[0,1,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti32x4 $1, %xmm0, %ymm3, %ymm20
; AVX512-NEXT:    vmovdqa 32(%r9), %xmm0
; AVX512-NEXT:    vmovdqa 32(%r8), %xmm3
; AVX512-NEXT:    vpunpcklbw {{.*#+}} xmm5 = xmm3[0],xmm0[0],xmm3[1],xmm0[1],xmm3[2],xmm0[2],xmm3[3],xmm0[3],xmm3[4],xmm0[4],xmm3[5],xmm0[5],xmm3[6],xmm0[6],xmm3[7],xmm0[7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm10 = xmm5[0,1,1,3,4,5,6,7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm11 = xmm5[2,1,3,3,4,5,6,7]
; AVX512-NEXT:    vinserti32x4 $1, %xmm11, %ymm10, %ymm18
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm10 = xmm5[0,1,2,3,4,5,5,7]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm5 = xmm5[0,1,2,3,6,5,7,7]
; AVX512-NEXT:    vinserti32x4 $1, %xmm5, %ymm10, %ymm16
; AVX512-NEXT:    vpunpckhbw {{.*#+}} xmm4 = xmm4[8],xmm12[8],xmm4[9],xmm12[9],xmm4[10],xmm12[10],xmm4[11],xmm12[11],xmm4[12],xmm12[12],xmm4[13],xmm12[13],xmm4[14],xmm12[14],xmm4[15],xmm12[15]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm5 = xmm4[0,0,2,1,4,5,6,7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm10 = xmm4[0,2,2,3,4,5,6,7]
...
; AVX512-NEXT:    vpunpckhbw {{.*#+}} xmm0 = xmm3[8],xmm0[8],xmm3[9],xmm0[9],xmm3[10],xmm0[10],xmm3[11],xmm0[11],xmm3[12],xmm0[12],xmm3[13],xmm0[13],xmm3[14],xmm0[14],xmm3[15],xmm0[15]
...
; AVX512-NEXT:    vmovdqa 16(%rcx), %xmm10
; AVX512-NEXT:    vmovdqa 16(%rdx), %xmm5
; AVX512-NEXT:    vpunpcklbw {{.*#+}} xmm0 = xmm5[0],xmm10[0],xmm5[1],xmm10[1],xmm5[2],xmm10[2],xmm5[3],xmm10[3],xmm5[4],xmm10[4],xmm5[5],xmm10[5],xmm5[6],xmm10[6],xmm5[7],xmm10[7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm1 = xmm0[0,0,2,1,4,5,6,7]
...
; AVX512-NEXT:    vinserti128 $1, %xmm0, %ymm1, %ymm0
; AVX512-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX512-NEXT:    vmovdqa 16(%r10), %xmm14
; AVX512-NEXT:    vmovdqa 16(%rax), %xmm13
; AVX512-NEXT:    vpunpcklbw {{.*#+}} xmm0 = xmm13[0],xmm14[0],xmm13[1],xmm14[1],xmm13[2],xmm14[2],xmm13[3],xmm14[3],xmm13[4],xmm14[4],xmm13[5],xmm14[5],xmm13[6],xmm14[6],xmm13[7],xmm14[7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm1 = xmm0[0,0,2,1,4,5,6,7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm4 = xmm0[0,2,2,3,4,5,6,7]
; AVX512-NEXT:    vinserti32x4 $1, %xmm4, %ymm1, %ymm28
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm1 = xmm0[0,1,2,3,4,4,6,5]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm0 = xmm0[0,1,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti32x4 $1, %xmm0, %ymm1, %ymm30
; AVX512-NEXT:    vmovdqa 16(%r9), %xmm11
; AVX512-NEXT:    vmovdqa 16(%r8), %xmm4
; AVX512-NEXT:    vpunpcklbw {{.*#+}} xmm2 = xmm4[0],xmm11[0],xmm4[1],xmm11[1],xmm4[2],xmm11[2],xmm4[3],xmm11[3],xmm4[4],xmm11[4],xmm4[5],xmm11[5],xmm4[6],xmm11[6],xmm4[7],xmm11[7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm1 = xmm2[0,1,1,3,4,5,6,7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm12 = xmm2[2,1,3,3,4,5,6,7]
; AVX512-NEXT:    vinserti32x4 $1, %xmm12, %ymm1, %ymm25
; AVX512-NEXT:    vmovdqa 48(%rsi), %xmm1
; AVX512-NEXT:    vmovdqa 48(%rdi), %xmm12
; AVX512-NEXT:    vpunpcklbw {{.*#+}} xmm0 = xmm12[0],xmm1[0],xmm12[1],xmm1[1],xmm12[2],xmm1[2],xmm12[3],xmm1[3],xmm12[4],xmm1[4],xmm12[5],xmm1[5],xmm12[6],xmm1[6],xmm12[7],xmm1[7]
; AVX512-NEXT:    vpunpckhbw {{.*#+}} xmm3 = xmm12[8],xmm1[8],xmm12[9],xmm1[9],xmm12[10],xmm1[10],xmm12[11],xmm1[11],xmm12[12],xmm1[12],xmm12[13],xmm1[13],xmm12[14],xmm1[14],xmm12[15],xmm1[15]
; AVX512-NEXT:    vmovdqa (%rsi), %xmm1
; AVX512-NEXT:    vmovdqa (%rdi), %xmm12
; AVX512-NEXT:    vpunpckhbw {{.*#+}} xmm6 = xmm12[8],xmm1[8],xmm12[9],xmm1[9],xmm12[10],xmm1[10],xmm12[11],xmm1[11],xmm12[12],xmm1[12],xmm12[13],xmm1[13],xmm12[14],xmm1[14],xmm12[15],xmm1[15]
; AVX512-NEXT:    vmovdqa64 %xmm1, %xmm23
; AVX512-NEXT:    vpmovzxwq {{.*#+}} zmm1 = xmm6[0],zero,zero,zero,xmm6[1],zero,zero,zero,xmm6[2],zero,zero,zero,xmm6[3],zero,zero,zero,xmm6[4],zero,zero,zero,xmm6[5],zero,zero,zero,xmm6[6],zero,zero,zero,xmm6[7],zero,zero,zero
...
; AVX512-NEXT:    vpshufd {{.*#+}} ymm6 = ymm8[0,1,1,3,4,5,5,7]
; AVX512-NEXT:    vpshufd {{.*#+}} ymm29 = ymm29[2,1,3,3,6,5,7,7]
; AVX512-NEXT:    vinserti64x4 $1, %ymm29, %zmm6, %zmm6
; AVX512-NEXT:    vpbroadcastq {{.*#+}} zmm29 = [65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535]
; AVX512-NEXT:    vpternlogq {{.*#+}} zmm6 = (zmm6 & ~zmm29) | zmm1
; AVX512-NEXT:    vpshufd $96, {{[-0-9]+}}(%r{{[sb]}}p), %ymm1 # 32-byte Folded Reload
; AVX512-NEXT:    # ymm1 = mem[0,0,2,1,4,4,6,5]
; AVX512-NEXT:    vpshufd $232, {{[-0-9]+}}(%r{{[sb]}}p), %ymm8 # 32-byte Folded Reload
; AVX512-NEXT:    # ymm8 = mem[0,2,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti64x4 $1, %ymm8, %zmm1, %zmm1
; AVX512-NEXT:    vpshufd $96, {{[-0-9]+}}(%r{{[sb]}}p), %ymm8 # 32-byte Folded Reload
; AVX512-NEXT:    # ymm8 = mem[0,0,2,1,4,4,6,5]
...
; AVX512-NEXT:    vpord %zmm0, %zmm1, %zmm7 {%k1}
; AVX512-NEXT:    vpshufd {{.*#+}} ymm0 = ymm26[0,1,1,3,4,5,5,7]
; AVX512-NEXT:    vpshufd {{.*#+}} ymm1 = ymm27[2,1,3,3,6,5,7,7]
; AVX512-NEXT:    vinserti64x4 $1, %ymm1, %zmm0, %zmm9
; AVX512-NEXT:    vpmovzxwq {{.*#+}} zmm0 = xmm3[0],zero,zero,zero,xmm3[1],zero,zero,zero,xmm3[2],zero,zero,zero,xmm3[3],zero,zero,zero,xmm3[4],zero,zero,zero,xmm3[5],zero,zero,zero,xmm3[6],zero,zero,zero,xmm3[7],zero,zero,zero
; AVX512-NEXT:    vpternlogq {{.*#+}} zmm9 = (zmm9 & ~zmm29) | zmm0
; AVX512-NEXT:    vpshufd {{.*#+}} ymm0 = ymm31[0,0,2,1,4,4,6,5]
; AVX512-NEXT:    vpshufd {{.*#+}} ymm1 = ymm24[0,2,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti64x4 $1, %ymm1, %zmm0, %zmm0
; AVX512-NEXT:    vpshufd {{.*#+}} ymm1 = ymm21[0,0,2,1,4,4,6,5]
; AVX512-NEXT:    vpshufd {{.*#+}} ymm3 = ymm19[0,2,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti64x4 $1, %ymm3, %zmm1, %zmm1
; AVX512-NEXT:    vpandnq %zmm0, %zmm8, %zmm0
; AVX512-NEXT:    vpandq %zmm8, %zmm1, %zmm1
; AVX512-NEXT:    vpord %zmm0, %zmm1, %zmm9 {%k1}
; AVX512-NEXT:    vpshufd {{.*#+}} ymm0 = ymm17[0,1,1,3,4,5,5,7]
; AVX512-NEXT:    vpshufd {{.*#+}} ymm1 = ymm15[2,1,3,3,6,5,7,7]
; AVX512-NEXT:    vinserti64x4 $1, %ymm1, %zmm0, %zmm21
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm0 = xmm2[0,1,2,3,4,5,5,7]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm1 = xmm2[0,1,2,3,6,5,7,7]
; AVX512-NEXT:    vinserti32x4 $1, %xmm1, %ymm0, %ymm17
; AVX512-NEXT:    vpunpckhbw {{.*#+}} xmm0 = xmm5[8],xmm10[8],xmm5[9],xmm10[9],xmm5[10],xmm10[10],xmm5[11],xmm10[11],xmm5[12],xmm10[12],xmm5[13],xmm10[13],xmm5[14],xmm10[14],xmm5[15],xmm10[15]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm1 = xmm0[0,0,2,1,4,5,6,7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm2 = xmm0[0,2,2,3,4,5,6,7]
; AVX512-NEXT:    vinserti32x4 $1, %xmm2, %ymm1, %ymm19
; AVX512-NEXT:    vmovdqa 32(%rsi), %xmm15
; AVX512-NEXT:    vmovdqa 32(%rdi), %xmm1
; AVX512-NEXT:    vpunpcklbw {{.*#+}} xmm2 = xmm1[0],xmm15[0],xmm1[1],xmm15[1],xmm1[2],xmm15[2],xmm1[3],xmm15[3],xmm1[4],xmm15[4],xmm1[5],xmm15[5],xmm1[6],xmm15[6],xmm1[7],xmm15[7]
...
; AVX512-NEXT:    vpternlogq {{.*#+}} zmm21 = (zmm21 & ~zmm29) | zmm2
; AVX512-NEXT:    vpshufd {{.*#+}} ymm2 = ymm22[0,0,2,1,4,4,6,5]
; AVX512-NEXT:    vpshufd {{.*#+}} ymm3 = ymm20[0,2,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti64x4 $1, %ymm3, %zmm2, %zmm2
; AVX512-NEXT:    vpshufd {{.*#+}} ymm3 = ymm18[0,0,2,1,4,4,6,5]
; AVX512-NEXT:    vpshufd {{.*#+}} ymm5 = ymm16[0,2,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti64x4 $1, %ymm5, %zmm3, %zmm3
; AVX512-NEXT:    vpandnq %zmm2, %zmm8, %zmm2
; AVX512-NEXT:    vpandq %zmm8, %zmm3, %zmm3
; AVX512-NEXT:    vpord %zmm2, %zmm3, %zmm21 {%k1}
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm2 = xmm0[0,1,2,3,4,4,6,5]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm0 = xmm0[0,1,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti32x4 $1, %xmm0, %ymm2, %ymm20
; AVX512-NEXT:    vpunpckhbw {{.*#+}} xmm3 = xmm13[8],xmm14[8],xmm13[9],xmm14[9],xmm13[10],xmm14[10],xmm13[11],xmm14[11],xmm13[12],xmm14[12],xmm13[13],xmm14[13],xmm13[14],xmm14[14],xmm13[15],xmm14[15]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm2 = xmm3[0,0,2,1,4,5,6,7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm5 = xmm3[0,2,2,3,4,5,6,7]
; AVX512-NEXT:    vinserti32x4 $1, %xmm5, %ymm2, %ymm22
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm5 = xmm3[0,1,2,3,4,4,6,5]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm3 = xmm3[0,1,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti128 $1, %xmm3, %ymm5, %ymm5
; AVX512-NEXT:    vpunpckhbw {{.*#+}} xmm4 = xmm4[8],xmm11[8],xmm4[9],xmm11[9],xmm4[10],xmm11[10],xmm4[11],xmm11[11],xmm4[12],xmm11[12],xmm4[13],xmm11[13],xmm4[14],xmm11[14],xmm4[15],xmm11[15]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm4[0,1,1,3,4,5,6,7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm10 = xmm4[2,1,3,3,4,5,6,7]
; AVX512-NEXT:    vinserti128 $1, %xmm10, %ymm3, %ymm3
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm10 = xmm4[0,1,2,3,4,5,5,7]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm4 = xmm4[0,1,2,3,6,5,7,7]
; AVX512-NEXT:    vinserti128 $1, %xmm4, %ymm10, %ymm4
; AVX512-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX512-NEXT:    vpunpcklbw {{[-0-9]+}}(%r{{[sb]}}p), %xmm0, %xmm11 # 16-byte Folded Reload
; AVX512-NEXT:    # xmm11 = xmm0[0],mem[0],xmm0[1],mem[1],xmm0[2],mem[2],xmm0[3],mem[3],xmm0[4],mem[4],xmm0[5],mem[5],xmm0[6],mem[6],xmm0[7],mem[7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm10 = xmm11[0,0,2,1,4,5,6,7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm13 = xmm11[0,2,2,3,4,5,6,7]
; AVX512-NEXT:    vinserti128 $1, %xmm13, %ymm10, %ymm10
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm13 = xmm11[0,1,2,3,4,4,6,5]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm11 = xmm11[0,1,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti128 $1, %xmm11, %ymm13, %ymm14
; AVX512-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX512-NEXT:    vpunpcklbw {{[-0-9]+}}(%r{{[sb]}}p), %xmm0, %xmm11 # 16-byte Folded Reload
; AVX512-NEXT:    # xmm11 = xmm0[0],mem[0],xmm0[1],mem[1],xmm0[2],mem[2],xmm0[3],mem[3],xmm0[4],mem[4],xmm0[5],mem[5],xmm0[6],mem[6],xmm0[7],mem[7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm13 = xmm11[0,0,2,1,4,5,6,7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm0 = xmm11[0,2,2,3,4,5,6,7]
; AVX512-NEXT:    vinserti32x4 $1, %xmm0, %ymm13, %ymm16
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm0 = xmm11[0,1,2,3,4,4,6,5]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm11 = xmm11[0,1,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti32x4 $1, %xmm11, %ymm0, %ymm18
; AVX512-NEXT:    vpunpckhbw {{.*#+}} xmm0 = xmm1[8],xmm15[8],xmm1[9],xmm15[9],xmm1[10],xmm15[10],xmm1[11],xmm15[11],xmm1[12],xmm15[12],xmm1[13],xmm15[13],xmm1[14],xmm15[14],xmm1[15],xmm15[15]
...
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm11 = xmm1[0,1,1,3,4,5,6,7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm13 = xmm1[2,1,3,3,4,5,6,7]
; AVX512-NEXT:    vinserti128 $1, %xmm13, %ymm11, %ymm11
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm13 = xmm1[0,1,2,3,4,5,5,7]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm1 = xmm1[0,1,2,3,6,5,7,7]
; AVX512-NEXT:    vinserti128 $1, %xmm1, %ymm13, %ymm1
; AVX512-NEXT:    vmovdqa 16(%rsi), %xmm13
; AVX512-NEXT:    vmovdqa 16(%rdi), %xmm15
; AVX512-NEXT:    vpunpcklbw {{.*#+}} xmm2 = xmm15[0],xmm13[0],xmm15[1],xmm13[1],xmm15[2],xmm13[2],xmm15[3],xmm13[3],xmm15[4],xmm13[4],xmm15[5],xmm13[5],xmm15[6],xmm13[6],xmm15[7],xmm13[7]
...
; AVX512-NEXT:    vpunpcklbw {{.*#+}} xmm12 = xmm12[0],xmm15[0],xmm12[1],xmm15[1],xmm12[2],xmm15[2],xmm12[3],xmm15[3],xmm12[4],xmm15[4],xmm12[5],xmm15[5],xmm12[6],xmm15[6],xmm12[7],xmm15[7]
...
; AVX512-NEXT:    vinserti64x4 $1, %ymm24, %zmm15, %zmm15
; AVX512-NEXT:    vpmovzxwq {{.*#+}} zmm0 = xmm0[0],zero,zero,zero,xmm0[1],zero,zero,zero,xmm0[2],zero,zero,zero,xmm0[3],zero,zero,zero,xmm0[4],zero,zero,zero,xmm0[5],zero,zero,zero,xmm0[6],zero,zero,zero,xmm0[7],zero,zero,zero
; AVX512-NEXT:    vpternlogq {{.*#+}} zmm15 = (zmm15 & ~zmm29) | zmm0
; AVX512-NEXT:    vpmovzxwq {{.*#+}} zmm0 = xmm2[0],zero,zero,zero,xmm2[1],zero,zero,zero,xmm2[2],zero,zero,zero,xmm2[3],zero,zero,zero,xmm2[4],zero,zero,zero,xmm2[5],zero,zero,zero,xmm2[6],zero,zero,zero,xmm2[7],zero,zero,zero
; AVX512-NEXT:    vpmovzxwq {{.*#+}} zmm2 = xmm13[0],zero,zero,zero,xmm13[1],zero,zero,zero,xmm13[2],zero,zero,zero,xmm13[3],zero,zero,zero,xmm13[4],zero,zero,zero,xmm13[5],zero,zero,zero,xmm13[6],zero,zero,zero,xmm13[7],zero,zero,zero
...
; AVX512-NEXT:    vinserti64x4 $1, %ymm24, %zmm13, %zmm13
...
; AVX512-NEXT:    vpandq %zmm8, %zmm24, %zmm24
; AVX512-NEXT:    vpord %zmm13, %zmm24, %zmm15 {%k1}
; AVX512-NEXT:    vpshufd $212, (%rsp), %ymm13 # 32-byte Folded Reload
; AVX512-NEXT:    # ymm13 = mem[0,1,1,3,4,5,5,7]
; AVX512-NEXT:    vpshufd $246, {{[-0-9]+}}(%r{{[sb]}}p), %ymm24 # 32-byte Folded Reload
; AVX512-NEXT:    # ymm24 = mem[2,1,3,3,6,5,7,7]
; AVX512-NEXT:    vinserti64x4 $1, %ymm24, %zmm13, %zmm13
; AVX512-NEXT:    vpternlogq {{.*#+}} zmm13 = (zmm13 & ~zmm29) | zmm0
; AVX512-NEXT:    vpshufd {{.*#+}} ymm0 = ymm28[0,0,2,1,4,4,6,5]
; AVX512-NEXT:    vpshufd {{.*#+}} ymm24 = ymm30[0,2,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti64x4 $1, %ymm24, %zmm0, %zmm0
; AVX512-NEXT:    vpshufd {{.*#+}} ymm23 = ymm25[0,0,2,1,4,4,6,5]
; AVX512-NEXT:    vpshufd {{.*#+}} ymm17 = ymm17[0,2,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti64x4 $1, %ymm17, %zmm23, %zmm17
; AVX512-NEXT:    vpandnq %zmm0, %zmm8, %zmm0
; AVX512-NEXT:    vpandq %zmm8, %zmm17, %zmm17
; AVX512-NEXT:    vpord %zmm0, %zmm17, %zmm13 {%k1}
; AVX512-NEXT:    vpshufd {{.*#+}} ymm0 = ymm19[0,1,1,3,4,5,5,7]
; AVX512-NEXT:    vpshufd {{.*#+}} ymm17 = ymm20[2,1,3,3,6,5,7,7]
; AVX512-NEXT:    vinserti64x4 $1, %ymm17, %zmm0, %zmm0
; AVX512-NEXT:    vpternlogq {{.*#+}} zmm0 = (zmm0 & ~zmm29) | zmm2
; AVX512-NEXT:    vpshufd {{.*#+}} ymm2 = ymm22[0,0,2,1,4,4,6,5]
...
; AVX512-NEXT:    vpandnq %zmm2, %zmm8, %zmm2
; AVX512-NEXT:    vpandq %zmm8, %zmm3, %zmm3
; AVX512-NEXT:    vpord %zmm2, %zmm3, %zmm0 {%k1}
; AVX512-NEXT:    vpshufd {{.*#+}} ymm2 = ymm10[0,1,1,3,4,5,5,7]
; AVX512-NEXT:    vpshufd {{.*#+}} ymm3 = ymm14[2,1,3,3,6,5,7,7]
; AVX512-NEXT:    vinserti64x4 $1, %ymm3, %zmm2, %zmm2
; AVX512-NEXT:    vpternlogq {{.*#+}} zmm2 = (zmm2 & ~zmm29) | zmm12
; AVX512-NEXT:    vpshufd {{.*#+}} ymm3 = ymm16[0,0,2,1,4,4,6,5]
; AVX512-NEXT:    vpshufd {{.*#+}} ymm4 = ymm18[0,2,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti64x4 $1, %ymm4, %zmm3, %zmm3
; AVX512-NEXT:    vpshufd {{.*#+}} ymm4 = ymm11[0,0,2,1,4,4,6,5]
; AVX512-NEXT:    vpshufd {{.*#+}} ymm1 = ymm1[0,2,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti64x4 $1, %ymm1, %zmm4, %zmm1
; AVX512-NEXT:    vpandnq %zmm3, %zmm8, %zmm3
; AVX512-NEXT:    vpandq %zmm8, %zmm1, %zmm1
; AVX512-NEXT:    vpord %zmm3, %zmm1, %zmm2 {%k1}
; AVX512-NEXT:    movq {{[0-9]+}}(%rsp), %rax
...
; AVX512DQ-NEXT:    vinserti128 $1, %xmm4, %ymm3, %ymm8
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm3 = xmm2[0,1,2,3,4,4,6,5]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm2 = xmm2[0,1,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm2, %ymm3, %ymm29
; AVX512DQ-NEXT:    vmovdqa (%r10), %xmm4
; AVX512DQ-NEXT:    vmovdqa %xmm4, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX512DQ-NEXT:    vmovdqa 48(%r10), %xmm3
; AVX512DQ-NEXT:    vmovdqa (%rax), %xmm2
; AVX512DQ-NEXT:    vmovdqa %xmm2, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX512DQ-NEXT:    vmovdqa 48(%rax), %xmm5
; AVX512DQ-NEXT:    vpunpckhbw {{.*#+}} xmm2 = xmm2[8],xmm4[8],xmm2[9],xmm4[9],xmm2[10],xmm4[10],xmm2[11],xmm4[11],xmm2[12],xmm4[12],xmm2[13],xmm4[13],xmm2[14],xmm4[14],xmm2[15],xmm4[15]
...
; AVX512DQ-NEXT:    vmovdqa %xmm4, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX512DQ-NEXT:    vmovdqa 48(%r9), %xmm10
; AVX512DQ-NEXT:    vmovdqa (%r8), %xmm2
; AVX512DQ-NEXT:    vmovdqa %xmm2, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX512DQ-NEXT:    vmovdqa 48(%r8), %xmm11
; AVX512DQ-NEXT:    vpunpckhbw {{.*#+}} xmm2 = xmm2[8],xmm4[8],xmm2[9],xmm4[9],xmm2[10],xmm4[10],xmm2[11],xmm4[11],xmm2[12],xmm4[12],xmm2[13],xmm4[13],xmm2[14],xmm4[14],xmm2[15],xmm4[15]
...
; AVX512DQ-NEXT:    vinserti128 $1, %xmm2, %ymm4, %ymm2
; AVX512DQ-NEXT:    vmovdqu %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX512DQ-NEXT:    vpunpcklbw {{.*#+}} xmm2 = xmm5[0],xmm3[0],xmm5[1],xmm3[1],xmm5[2],xmm3[2],xmm5[3],xmm3[3],xmm5[4],xmm3[4],xmm5[5],xmm3[5],xmm5[6],xmm3[6],xmm5[7],xmm3[7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm4 = xmm2[0,0,2,1,4,5,6,7]
...
; AVX512DQ-NEXT:    vinserti128 $1, %xmm2, %ymm4, %ymm2
; AVX512DQ-NEXT:    vmovdqu %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX512DQ-NEXT:    vpunpcklbw {{.*#+}} xmm2 = xmm11[0],xmm10[0],xmm11[1],xmm10[1],xmm11[2],xmm10[2],xmm11[3],xmm10[3],xmm11[4],xmm10[4],xmm11[5],xmm10[5],xmm11[6],xmm10[6],xmm11[7],xmm10[7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm4 = xmm2[0,1,1,3,4,5,6,7]
...
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm2 = xmm2[0,1,2,3,6,5,7,7]
; AVX512DQ-NEXT:    vinserti128 $1, %xmm2, %ymm13, %ymm9
...
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm13 = xmm0[0,2,2,3,4,5,6,7]
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm13, %ymm1, %ymm26
...
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm0, %ymm13, %ymm27
...
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm5, %ymm3, %ymm31
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm3 = xmm0[0,1,2,3,4,4,6,5]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm0 = xmm0[0,1,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm0, %ymm3, %ymm24
; AVX512DQ-NEXT:    vpunpckhbw {{.*#+}} xmm0 = xmm11[8],xmm10[8],xmm11[9],xmm10[9],xmm11[10],xmm10[10],xmm11[11],xmm10[11],xmm11[12],xmm10[12],xmm11[13],xmm10[13],xmm11[14],xmm10[14],xmm11[15],xmm10[15]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm0[0,1,1,3,4,5,6,7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm5 = xmm0[2,1,3,3,4,5,6,7]
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm5, %ymm3, %ymm21
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm3 = xmm0[0,1,2,3,4,5,5,7]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm0 = xmm0[0,1,2,3,6,5,7,7]
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm0, %ymm3, %ymm19
; AVX512DQ-NEXT:    vpunpcklbw {{.*#+}} xmm0 = xmm4[0],xmm12[0],xmm4[1],xmm12[1],xmm4[2],xmm12[2],xmm4[3],xmm12[3],xmm4[4],xmm12[4],xmm4[5],xmm12[5],xmm4[6],xmm12[6],xmm4[7],xmm12[7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm0[0,0,2,1,4,5,6,7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm5 = xmm0[0,2,2,3,4,5,6,7]
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm5, %ymm3, %ymm17
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm3 = xmm0[0,1,2,3,4,4,6,5]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm0 = xmm0[0,1,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti128 $1, %xmm0, %ymm3, %ymm15
...
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm0[0,0,2,1,4,5,6,7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm5 = xmm0[0,2,2,3,4,5,6,7]
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm5, %ymm3, %ymm22
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm3 = xmm0[0,1,2,3,4,4,6,5]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm0 = xmm0[0,1,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm0, %ymm3, %ymm20
; AVX512DQ-NEXT:    vmovdqa 32(%r9), %xmm0
; AVX512DQ-NEXT:    vmovdqa 32(%r8), %xmm3
; AVX512DQ-NEXT:    vpunpcklbw {{.*#+}} xmm5 = xmm3[0],xmm0[0],xmm3[1],xmm0[1],xmm3[2],xmm0[2],xmm3[3],xmm0[3],xmm3[4],xmm0[4],xmm3[5],xmm0[5],xmm3[6],xmm0[6],xmm3[7],xmm0[7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm10 = xmm5[0,1,1,3,4,5,6,7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm11 = xmm5[2,1,3,3,4,5,6,7]
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm11, %ymm10, %ymm18
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm10 = xmm5[0,1,2,3,4,5,5,7]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm5 = xmm5[0,1,2,3,6,5,7,7]
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm5, %ymm10, %ymm16
; AVX512DQ-NEXT:    vpunpckhbw {{.*#+}} xmm4 = xmm4[8],xmm12[8],xmm4[9],xmm12[9],xmm4[10],xmm12[10],xmm4[11],xmm12[11],xmm4[12],xmm12[12],xmm4[13],xmm12[13],xmm4[14],xmm12[14],xmm4[15],xmm12[15]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm5 = xmm4[0,0,2,1,4,5,6,7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm10 = xmm4[0,2,2,3,4,5,6,7]
...
; AVX512DQ-NEXT:    vpunpckhbw {{.*#+}} xmm0 = xmm3[8],xmm0[8],xmm3[9],xmm0[9],xmm3[10],xmm0[10],xmm3[11],xmm0[11],xmm3[12],xmm0[12],xmm3[13],xmm0[13],xmm3[14],xmm0[14],xmm3[15],xmm0[15]
...
; AVX512DQ-NEXT:    vmovdqa 16(%rcx), %xmm10
; AVX512DQ-NEXT:    vmovdqa 16(%rdx), %xmm5
; AVX512DQ-NEXT:    vpunpcklbw {{.*#+}} xmm0 = xmm5[0],xmm10[0],xmm5[1],xmm10[1],xmm5[2],xmm10[2],xmm5[3],xmm10[3],xmm5[4],xmm10[4],xmm5[5],xmm10[5],xmm5[6],xmm10[6],xmm5[7],xmm10[7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm1 = xmm0[0,0,2,1,4,5,6,7]
...
; AVX512DQ-NEXT:    vmovdqa 16(%rax), %xmm13
; AVX512DQ-NEXT:    vpunpcklbw {{.*#+}} xmm0 = xmm13[0],xmm14[0],xmm13[1],xmm14[1],xmm13[2],xmm14[2],xmm13[3],xmm14[3],xmm13[4],xmm14[4],xmm13[5],xmm14[5],xmm13[6],xmm14[6],xmm13[7],xmm14[7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm1 = xmm0[0,0,2,1,4,5,6,7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm4 = xmm0[0,2,2,3,4,5,6,7]
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm4, %ymm1, %ymm28
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm1 = xmm0[0,1,2,3,4,4,6,5]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm0 = xmm0[0,1,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm0, %ymm1, %ymm30
; AVX512DQ-NEXT:    vmovdqa 16(%r9), %xmm11
; AVX512DQ-NEXT:    vmovdqa 16(%r8), %xmm4
; AVX512DQ-NEXT:    vpunpcklbw {{.*#+}} xmm2 = xmm4[0],xmm11[0],xmm4[1],xmm11[1],xmm4[2],xmm11[2],xmm4[3],xmm11[3],xmm4[4],xmm11[4],xmm4[5],xmm11[5],xmm4[6],xmm11[6],xmm4[7],xmm11[7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm1 = xmm2[0,1,1,3,4,5,6,7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm12 = xmm2[2,1,3,3,4,5,6,7]
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm12, %ymm1, %ymm25
; AVX512DQ-NEXT:    vmovdqa 48(%rsi), %xmm1
; AVX512DQ-NEXT:    vmovdqa 48(%rdi), %xmm12
; AVX512DQ-NEXT:    vpunpcklbw {{.*#+}} xmm0 = xmm12[0],xmm1[0],xmm12[1],xmm1[1],xmm12[2],xmm1[2],xmm12[3],xmm1[3],xmm12[4],xmm1[4],xmm12[5],xmm1[5],xmm12[6],xmm1[6],xmm12[7],xmm1[7]
; AVX512DQ-NEXT:    vpunpckhbw {{.*#+}} xmm3 = xmm12[8],xmm1[8],xmm12[9],xmm1[9],xmm12[10],xmm1[10],xmm12[11],xmm1[11],xmm12[12],xmm1[12],xmm12[13],xmm1[13],xmm12[14],xmm1[14],xmm12[15],xmm1[15]
; AVX512DQ-NEXT:    vmovdqa (%rsi), %xmm1
; AVX512DQ-NEXT:    vmovdqa (%rdi), %xmm12
; AVX512DQ-NEXT:    vpunpckhbw {{.*#+}} xmm6 = xmm12[8],xmm1[8],xmm12[9],xmm1[9],xmm12[10],xmm1[10],xmm12[11],xmm1[11],xmm12[12],xmm1[12],xmm12[13],xmm1[13],xmm12[14],xmm1[14],xmm12[15],xmm1[15]
; AVX512DQ-NEXT:    vmovdqa64 %xmm1, %xmm23
; AVX512DQ-NEXT:    vpmovzxwq {{.*#+}} zmm1 = xmm6[0],zero,zero,zero,xmm6[1],zero,zero,zero,xmm6[2],zero,zero,zero,xmm6[3],zero,zero,zero,xmm6[4],zero,zero,zero,xmm6[5],zero,zero,zero,xmm6[6],zero,zero,zero,xmm6[7],zero,zero,zero
...
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm6 = ymm8[0,1,1,3,4,5,5,7]
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm29 = ymm29[2,1,3,3,6,5,7,7]
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm29, %zmm6, %zmm6
; AVX512DQ-NEXT:    vpbroadcastq {{.*#+}} zmm29 = [65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535]
; AVX512DQ-NEXT:    vpternlogq {{.*#+}} zmm6 = (zmm6 & ~zmm29) | zmm1
; AVX512DQ-NEXT:    vpshufd $96, {{[-0-9]+}}(%r{{[sb]}}p), %ymm1 # 32-byte Folded Reload
; AVX512DQ-NEXT:    # ymm1 = mem[0,0,2,1,4,4,6,5]
; AVX512DQ-NEXT:    vpshufd $232, {{[-0-9]+}}(%r{{[sb]}}p), %ymm8 # 32-byte Folded Reload
; AVX512DQ-NEXT:    # ymm8 = mem[0,2,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm8, %zmm1, %zmm1
; AVX512DQ-NEXT:    vpshufd $96, {{[-0-9]+}}(%r{{[sb]}}p), %ymm8 # 32-byte Folded Reload
; AVX512DQ-NEXT:    # ymm8 = mem[0,0,2,1,4,4,6,5]
...
; AVX512DQ-NEXT:    vpandnq %zmm1, %zmm8, %zmm1
; AVX512DQ-NEXT:    vpandq %zmm8, %zmm7, %zmm7
; AVX512DQ-NEXT:    movw $-21846, %ax # imm = 0xAAAA
; AVX512DQ-NEXT:    kmovw %eax, %k1
; AVX512DQ-NEXT:    vpord %zmm1, %zmm7, %zmm6 {%k1}
; AVX512DQ-NEXT:    vpshufd $212, {{[-0-9]+}}(%r{{[sb]}}p), %ymm1 # 32-byte Folded Reload
; AVX512DQ-NEXT:    # ymm1 = mem[0,1,1,3,4,5,5,7]
; AVX512DQ-NEXT:    vpshufd $246, {{[-0-9]+}}(%r{{[sb]}}p), %ymm7 # 32-byte Folded Reload
; AVX512DQ-NEXT:    # ymm7 = mem[2,1,3,3,6,5,7,7]
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm7, %zmm1, %zmm7
; AVX512DQ-NEXT:    vpternlogq {{.*#+}} zmm7 = (zmm7 & ~zmm29) | zmm0
; AVX512DQ-NEXT:    vpshufd $96, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Folded Reload
; AVX512DQ-NEXT:    # ymm0 = mem[0,0,2,1,4,4,6,5]
; AVX512DQ-NEXT:    vpshufd $232, {{[-0-9]+}}(%r{{[sb]}}p), %ymm1 # 32-byte Folded Reload
; AVX512DQ-NEXT:    # ymm1 = mem[0,2,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm1, %zmm0, %zmm0
; AVX512DQ-NEXT:    vpshufd $96, {{[-0-9]+}}(%r{{[sb]}}p), %ymm1 # 32-byte Folded Reload
; AVX512DQ-NEXT:    # ymm1 = mem[0,0,2,1,4,4,6,5]
...
; AVX512DQ-NEXT:    vpord %zmm0, %zmm1, %zmm7 {%k1}
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm0 = ymm26[0,1,1,3,4,5,5,7]
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm1 = ymm27[2,1,3,3,6,5,7,7]
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm1, %zmm0, %zmm9
; AVX512DQ-NEXT:    vpmovzxwq {{.*#+}} zmm0 = xmm3[0],zero,zero,zero,xmm3[1],zero,zero,zero,xmm3[2],zero,zero,zero,xmm3[3],zero,zero,zero,xmm3[4],zero,zero,zero,xmm3[5],zero,zero,zero,xmm3[6],zero,zero,zero,xmm3[7],zero,zero,zero
; AVX512DQ-NEXT:    vpternlogq {{.*#+}} zmm9 = (zmm9 & ~zmm29) | zmm0
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm0 = ymm31[0,0,2,1,4,4,6,5]
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm1 = ymm24[0,2,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm1, %zmm0, %zmm0
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm1 = ymm21[0,0,2,1,4,4,6,5]
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm3 = ymm19[0,2,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm3, %zmm1, %zmm1
; AVX512DQ-NEXT:    vpandnq %zmm0, %zmm8, %zmm0
; AVX512DQ-NEXT:    vpandq %zmm8, %zmm1, %zmm1
; AVX512DQ-NEXT:    vpord %zmm0, %zmm1, %zmm9 {%k1}
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm0 = ymm17[0,1,1,3,4,5,5,7]
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm1 = ymm15[2,1,3,3,6,5,7,7]
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm1, %zmm0, %zmm21
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm0 = xmm2[0,1,2,3,4,5,5,7]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm1 = xmm2[0,1,2,3,6,5,7,7]
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm1, %ymm0, %ymm17
; AVX512DQ-NEXT:    vpunpckhbw {{.*#+}} xmm0 = xmm5[8],xmm10[8],xmm5[9],xmm10[9],xmm5[10],xmm10[10],xmm5[11],xmm10[11],xmm5[12],xmm10[12],xmm5[13],xmm10[13],xmm5[14],xmm10[14],xmm5[15],xmm10[15]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm1 = xmm0[0,0,2,1,4,5,6,7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm2 = xmm0[0,2,2,3,4,5,6,7]
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm2, %ymm1, %ymm19
; AVX512DQ-NEXT:    vmovdqa 32(%rsi), %xmm15
; AVX512DQ-NEXT:    vmovdqa 32(%rdi), %xmm1
; AVX512DQ-NEXT:    vpunpcklbw {{.*#+}} xmm2 = xmm1[0],xmm15[0],xmm1[1],xmm15[1],xmm1[2],xmm15[2],xmm1[3],xmm15[3],xmm1[4],xmm15[4],xmm1[5],xmm15[5],xmm1[6],xmm15[6],xmm1[7],xmm15[7]
; AVX512DQ-NEXT:    vpmovzxwq {{.*#+}} zmm2 = xmm2[0],zero,zero,zero,xmm2[1],zero,zero,zero,xmm2[2],zero,zero,zero,xmm2[3],zero,zero,zero,xmm2[4],zero,zero,zero,xmm2[5],zero,zero,zero,xmm2[6],zero,zero,zero,xmm2[7],zero,zero,zero
; AVX512DQ-NEXT:    vpternlogq {{.*#+}} zmm21 = (zmm21 & ~zmm29) | zmm2
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm2 = ymm22[0,0,2,1,4,4,6,5]
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm3 = ymm20[0,2,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm3, %zmm2, %zmm2
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm3 = ymm18[0,0,2,1,4,4,6,5]
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm5 = ymm16[0,2,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm5, %zmm3, %zmm3
; AVX512DQ-NEXT:    vpandnq %zmm2, %zmm8, %zmm2
; AVX512DQ-NEXT:    vpandq %zmm8, %zmm3, %zmm3
; AVX512DQ-NEXT:    vpord %zmm2, %zmm3, %zmm21 {%k1}
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm2 = xmm0[0,1,2,3,4,4,6,5]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm0 = xmm0[0,1,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm0, %ymm2, %ymm20
; AVX512DQ-NEXT:    vpunpckhbw {{.*#+}} xmm3 = xmm13[8],xmm14[8],xmm13[9],xmm14[9],xmm13[10],xmm14[10],xmm13[11],xmm14[11],xmm13[12],xmm14[12],xmm13[13],xmm14[13],xmm13[14],xmm14[14],xmm13[15],xmm14[15]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm2 = xmm3[0,0,2,1,4,5,6,7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm5 = xmm3[0,2,2,3,4,5,6,7]
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm5, %ymm2, %ymm22
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm5 = xmm3[0,1,2,3,4,4,6,5]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm3 = xmm3[0,1,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti128 $1, %xmm3, %ymm5, %ymm5
; AVX512DQ-NEXT:    vpunpckhbw {{.*#+}} xmm4 = xmm4[8],xmm11[8],xmm4[9],xmm11[9],xmm4[10],xmm11[10],xmm4[11],xmm11[11],xmm4[12],xmm11[12],xmm4[13],xmm11[13],xmm4[14],xmm11[14],xmm4[15],xmm11[15]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm4[0,1,1,3,4,5,6,7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm10 = xmm4[2,1,3,3,4,5,6,7]
; AVX512DQ-NEXT:    vinserti128 $1, %xmm10, %ymm3, %ymm3
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm10 = xmm4[0,1,2,3,4,5,5,7]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm4 = xmm4[0,1,2,3,6,5,7,7]
; AVX512DQ-NEXT:    vinserti128 $1, %xmm4, %ymm10, %ymm4
; AVX512DQ-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX512DQ-NEXT:    vpunpcklbw {{[-0-9]+}}(%r{{[sb]}}p), %xmm0, %xmm11 # 16-byte Folded Reload
; AVX512DQ-NEXT:    # xmm11 = xmm0[0],mem[0],xmm0[1],mem[1],xmm0[2],mem[2],xmm0[3],mem[3],xmm0[4],mem[4],xmm0[5],mem[5],xmm0[6],mem[6],xmm0[7],mem[7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm10 = xmm11[0,0,2,1,4,5,6,7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm13 = xmm11[0,2,2,3,4,5,6,7]
; AVX512DQ-NEXT:    vinserti128 $1, %xmm13, %ymm10, %ymm10
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm13 = xmm11[0,1,2,3,4,4,6,5]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm11 = xmm11[0,1,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti128 $1, %xmm11, %ymm13, %ymm14
; AVX512DQ-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX512DQ-NEXT:    vpunpcklbw {{[-0-9]+}}(%r{{[sb]}}p), %xmm0, %xmm11 # 16-byte Folded Reload
; AVX512DQ-NEXT:    # xmm11 = xmm0[0],mem[0],xmm0[1],mem[1],xmm0[2],mem[2],xmm0[3],mem[3],xmm0[4],mem[4],xmm0[5],mem[5],xmm0[6],mem[6],xmm0[7],mem[7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm13 = xmm11[0,0,2,1,4,5,6,7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm0 = xmm11[0,2,2,3,4,5,6,7]
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm0, %ymm13, %ymm16
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm0 = xmm11[0,1,2,3,4,4,6,5]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm11 = xmm11[0,1,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm11, %ymm0, %ymm18
; AVX512DQ-NEXT:    vpunpckhbw {{.*#+}} xmm0 = xmm1[8],xmm15[8],xmm1[9],xmm15[9],xmm1[10],xmm15[10],xmm1[11],xmm15[11],xmm1[12],xmm15[12],xmm1[13],xmm15[13],xmm1[14],xmm15[14],xmm1[15],xmm15[15]
...
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm11 = xmm1[0,1,1,3,4,5,6,7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm13 = xmm1[2,1,3,3,4,5,6,7]
; AVX512DQ-NEXT:    vinserti128 $1, %xmm13, %ymm11, %ymm11
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm13 = xmm1[0,1,2,3,4,5,5,7]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm1 = xmm1[0,1,2,3,6,5,7,7]
; AVX512DQ-NEXT:    vinserti128 $1, %xmm1, %ymm13, %ymm1
; AVX512DQ-NEXT:    vmovdqa 16(%rsi), %xmm13
; AVX512DQ-NEXT:    vmovdqa 16(%rdi), %xmm15
; AVX512DQ-NEXT:    vpunpcklbw {{.*#+}} xmm2 = xmm15[0],xmm13[0],xmm15[1],xmm13[1],xmm15[2],xmm13[2],xmm15[3],xmm13[3],xmm15[4],xmm13[4],xmm15[5],xmm13[5],xmm15[6],xmm13[6],xmm15[7],xmm13[7]
...
; AVX512DQ-NEXT:    vpunpcklbw {{.*#+}} xmm12 = xmm12[0],xmm15[0],xmm12[1],xmm15[1],xmm12[2],xmm15[2],xmm12[3],xmm15[3],xmm12[4],xmm15[4],xmm12[5],xmm15[5],xmm12[6],xmm15[6],xmm12[7],xmm15[7]
...
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm24, %zmm15, %zmm15
; AVX512DQ-NEXT:    vpmovzxwq {{.*#+}} zmm0 = xmm0[0],zero,zero,zero,xmm0[1],zero,zero,zero,xmm0[2],zero,zero,zero,xmm0[3],zero,zero,zero,xmm0[4],zero,zero,zero,xmm0[5],zero,zero,zero,xmm0[6],zero,zero,zero,xmm0[7],zero,zero,zero
; AVX512DQ-NEXT:    vpternlogq {{.*#+}} zmm15 = (zmm15 & ~zmm29) | zmm0
; AVX512DQ-NEXT:    vpmovzxwq {{.*#+}} zmm0 = xmm2[0],zero,zero,zero,xmm2[1],zero,zero,zero,xmm2[2],zero,zero,zero,xmm2[3],zero,zero,zero,xmm2[4],zero,zero,zero,xmm2[5],zero,zero,zero,xmm2[6],zero,zero,zero,xmm2[7],zero,zero,zero
; AVX512DQ-NEXT:    vpmovzxwq {{.*#+}} zmm2 = xmm13[0],zero,zero,zero,xmm13[1],zero,zero,zero,xmm13[2],zero,zero,zero,xmm13[3],zero,zero,zero,xmm13[4],zero,zero,zero,xmm13[5],zero,zero,zero,xmm13[6],zero,zero,zero,xmm13[7],zero,zero,zero
...
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm24, %zmm13, %zmm13
...
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm26, %zmm24, %zmm24
; AVX512DQ-NEXT:    vpandnq %zmm13, %zmm8, %zmm13
; AVX512DQ-NEXT:    vpandq %zmm8, %zmm24, %zmm24
; AVX512DQ-NEXT:    vpord %zmm13, %zmm24, %zmm15 {%k1}
; AVX512DQ-NEXT:    vpshufd $212, (%rsp), %ymm13 # 32-byte Folded Reload
; AVX512DQ-NEXT:    # ymm13 = mem[0,1,1,3,4,5,5,7]
; AVX512DQ-NEXT:    vpshufd $246, {{[-0-9]+}}(%r{{[sb]}}p), %ymm24 # 32-byte Folded Reload
; AVX512DQ-NEXT:    # ymm24 = mem[2,1,3,3,6,5,7,7]
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm24, %zmm13, %zmm13
; AVX512DQ-NEXT:    vpternlogq {{.*#+}} zmm13 = (zmm13 & ~zmm29) | zmm0
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm0 = ymm28[0,0,2,1,4,4,6,5]
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm24 = ymm30[0,2,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm24, %zmm0, %zmm0
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm23 = ymm25[0,0,2,1,4,4,6,5]
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm17 = ymm17[0,2,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm17, %zmm23, %zmm17
; AVX512DQ-NEXT:    vpandnq %zmm0, %zmm8, %zmm0
; AVX512DQ-NEXT:    vpandq %zmm8, %zmm17, %zmm17
; AVX512DQ-NEXT:    vpord %zmm0, %zmm17, %zmm13 {%k1}
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm0 = ymm19[0,1,1,3,4,5,5,7]
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm17 = ymm20[2,1,3,3,6,5,7,7]
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm17, %zmm0, %zmm0
; AVX512DQ-NEXT:    vpternlogq {{.*#+}} zmm0 = (zmm0 & ~zmm29) | zmm2
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm2 = ymm22[0,0,2,1,4,4,6,5]
...
; AVX512DQ-NEXT:    vpandnq %zmm2, %zmm8, %zmm2
; AVX512DQ-NEXT:    vpandq %zmm8, %zmm3, %zmm3
; AVX512DQ-NEXT:    vpord %zmm2, %zmm3, %zmm0 {%k1}
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm2 = ymm10[0,1,1,3,4,5,5,7]
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm3 = ymm14[2,1,3,3,6,5,7,7]
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm3, %zmm2, %zmm2
; AVX512DQ-NEXT:    vpternlogq {{.*#+}} zmm2 = (zmm2 & ~zmm29) | zmm12
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm3 = ymm16[0,0,2,1,4,4,6,5]
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm4 = ymm18[0,2,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm4, %zmm3, %zmm3
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm4 = ymm11[0,0,2,1,4,4,6,5]
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm1 = ymm1[0,2,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm1, %zmm4, %zmm1
; AVX512DQ-NEXT:    vpandnq %zmm3, %zmm8, %zmm3
; AVX512DQ-NEXT:    vpandq %zmm8, %zmm1, %zmm1
; AVX512DQ-NEXT:    vpord %zmm3, %zmm1, %zmm2 {%k1}
; AVX512DQ-NEXT:    movq {{[0-9]+}}(%rsp), %rax
; AVX512DQ-NEXT:    vmovdqa64 %zmm2, (%rax)
; AVX512DQ-NEXT:    vmovdqa64 %zmm0, 192(%rax)
; AVX512DQ-NEXT:    vmovdqa64 %zmm13, 128(%rax)
; AVX512DQ-NEXT:    vmovdqa64 %zmm15, 320(%rax)
...
; AVX512BW-NEXT:    vmovdqa 32(%r10), %xmm15
; AVX512BW-NEXT:    vmovdqa 48(%r10), %xmm14
; AVX512BW-NEXT:    vmovdqa (%rax), %xmm2
; AVX512BW-NEXT:    vmovdqa64 32(%rax), %xmm16
; AVX512BW-NEXT:    vmovdqa64 48(%rax), %xmm17
...
; AVX512BW-NEXT:    vmovdqa64 32(%r9), %xmm18
...
; AVX512BW-NEXT:    vpmovsxbw {{.*#+}} zmm6 = [0,1,0,32,4,5,1,33,2,1,2,34,4,5,3,35,0,1,4,36,4,5,5,37,0,1,6,38,6,5,7,39]
; AVX512BW-NEXT:    vpermt2w %zmm4, %zmm6, %zmm0
; AVX512BW-NEXT:    vmovdqa (%rcx), %xmm4
; AVX512BW-NEXT:    vmovdqa64 48(%rcx), %xmm22
; AVX512BW-NEXT:    vmovdqa (%rdx), %xmm7
; AVX512BW-NEXT:    vmovdqa64 48(%rdx), %xmm23
; AVX512BW-NEXT:    vpunpckhbw {{.*#+}} xmm12 = xmm7[8],xmm4[8],xmm7[9],xmm4[9],xmm7[10],xmm4[10],xmm7[11],xmm4[11],xmm7[12],xmm4[12],xmm7[13],xmm4[13],xmm7[14],xmm4[14],xmm7[15],xmm4[15]
...
; AVX512BW-NEXT:    vpunpckhbw {{.*#+}} xmm9 = xmm10[8],xmm8[8],xmm10[9],xmm8[9],xmm10[10],xmm8[10],xmm10[11],xmm8[11],xmm10[12],xmm8[12],xmm10[13],xmm8[13],xmm10[14],xmm8[14],xmm10[15],xmm8[15]
; AVX512BW-NEXT:    vpmovsxbw {{.*#+}} zmm11 = [0,32,0,0,1,33,0,0,2,34,0,0,3,35,0,0,4,36,0,0,5,37,0,0,6,38,0,0,7,39,0,0]
; AVX512BW-NEXT:    vpermt2w %zmm12, %zmm11, %zmm9
; AVX512BW-NEXT:    vpunpcklbw {{.*#+}} xmm13 = xmm17[0],xmm14[0],xmm17[1],xmm14[1],xmm17[2],xmm14[2],xmm17[3],xmm14[3],xmm17[4],xmm14[4],xmm17[5],xmm14[5],xmm17[6],xmm14[6],xmm17[7],xmm14[7]
; AVX512BW-NEXT:    vpunpcklbw {{.*#+}} xmm12 = xmm21[0],xmm19[0],xmm21[1],xmm19[1],xmm21[2],xmm19[2],xmm21[3],xmm19[3],xmm21[4],xmm19[4],xmm21[5],xmm19[5],xmm21[6],xmm19[6],xmm21[7],xmm19[7]
; AVX512BW-NEXT:    vpermt2w %zmm13, %zmm6, %zmm12
...
; AVX512BW-NEXT:    vpunpcklbw {{.*#+}} xmm13 = xmm25[0],xmm24[0],xmm25[1],xmm24[1],xmm25[2],xmm24[2],xmm25[3],xmm24[3],xmm25[4],xmm24[4],xmm25[5],xmm24[5],xmm25[6],xmm24[6],xmm25[7],xmm24[7]
; AVX512BW-NEXT:    vpermt2w %zmm26, %zmm11, %zmm13
...
; AVX512BW-NEXT:    vpermt2w %zmm17, %zmm6, %zmm14
; AVX512BW-NEXT:    vmovdqa64 32(%rdi), %xmm29
; AVX512BW-NEXT:    vpunpckhbw {{.*#+}} xmm19 = xmm23[8],xmm22[8],xmm23[9],xmm22[9],xmm23[10],xmm22[10],xmm23[11],xmm22[11],xmm23[12],xmm22[12],xmm23[13],xmm22[13],xmm23[14],xmm22[14],xmm23[15],xmm22[15]
; AVX512BW-NEXT:    vpunpckhbw {{.*#+}} xmm17 = xmm25[8],xmm24[8],xmm25[9],xmm24[9],xmm25[10],xmm24[10],xmm25[11],xmm24[11],xmm25[12],xmm24[12],xmm25[13],xmm24[13],xmm25[14],xmm24[14],xmm25[15],xmm24[15]
; AVX512BW-NEXT:    vpermt2w %zmm19, %zmm11, %zmm17
; AVX512BW-NEXT:    vpunpcklbw {{.*#+}} xmm21 = xmm16[0],xmm15[0],xmm16[1],xmm15[1],xmm16[2],xmm15[2],xmm16[3],xmm15[3],xmm16[4],xmm15[4],xmm16[5],xmm15[5],xmm16[6],xmm15[6],xmm16[7],xmm15[7]
; AVX512BW-NEXT:    vpunpcklbw {{.*#+}} xmm19 = xmm20[0],xmm18[0],xmm20[1],xmm18[1],xmm20[2],xmm18[2],xmm20[3],xmm18[3],xmm20[4],xmm18[4],xmm20[5],xmm18[5],xmm20[6],xmm18[6],xmm20[7],xmm18[7]
; AVX512BW-NEXT:    vpermt2w %zmm21, %zmm6, %zmm19
...
; AVX512BW-NEXT:    vpunpcklbw {{.*#+}} xmm21 = xmm29[0],xmm28[0],xmm29[1],xmm28[1],xmm29[2],xmm28[2],xmm29[3],xmm28[3],xmm29[4],xmm28[4],xmm29[5],xmm28[5],xmm29[6],xmm28[6],xmm29[7],xmm28[7]
; AVX512BW-NEXT:    vpermt2w %zmm22, %zmm11, %zmm21
...
; AVX512BW-NEXT:    vmovdqa64 16(%rax), %xmm18
; AVX512BW-NEXT:    vpermt2w %zmm16, %zmm6, %zmm15
; AVX512BW-NEXT:    vmovdqa64 16(%r9), %xmm16
; AVX512BW-NEXT:    vpunpckhbw {{.*#+}} xmm20 = xmm27[8],xmm26[8],xmm27[9],xmm26[9],xmm27[10],xmm26[10],xmm27[11],xmm26[11],xmm27[12],xmm26[12],xmm27[13],xmm26[13],xmm27[14],xmm26[14],xmm27[15],xmm26[15]
; AVX512BW-NEXT:    vmovdqa64 16(%r8), %xmm23
; AVX512BW-NEXT:    vpunpckhbw {{.*#+}} xmm24 = xmm29[8],xmm28[8],xmm29[9],xmm28[9],xmm29[10],xmm28[10],xmm29[11],xmm28[11],xmm29[12],xmm28[12],xmm29[13],xmm28[13],xmm29[14],xmm28[14],xmm29[15],xmm28[15]
; AVX512BW-NEXT:    vpermt2w %zmm20, %zmm11, %zmm24
; AVX512BW-NEXT:    vpunpcklbw {{.*#+}} xmm20 = xmm18[0],xmm22[0],xmm18[1],xmm22[1],xmm18[2],xmm22[2],xmm18[3],xmm22[3],xmm18[4],xmm22[4],xmm18[5],xmm22[5],xmm18[6],xmm22[6],xmm18[7],xmm22[7]
; AVX512BW-NEXT:    vpunpcklbw {{.*#+}} xmm25 = xmm23[0],xmm16[0],xmm23[1],xmm16[1],xmm23[2],xmm16[2],xmm23[3],xmm16[3],xmm23[4],xmm16[4],xmm23[5],xmm16[5],xmm23[6],xmm16[6],xmm23[7],xmm16[7]
; AVX512BW-NEXT:    vpermt2w %zmm20, %zmm6, %zmm25
; AVX512BW-NEXT:    vpunpckhbw {{.*#+}} xmm18 = xmm18[8],xmm22[8],xmm18[9],xmm22[9],xmm18[10],xmm22[10],xmm18[11],xmm22[11],xmm18[12],xmm22[12],xmm18[13],xmm22[13],xmm18[14],xmm22[14],xmm18[15],xmm22[15]
; AVX512BW-NEXT:    vpunpckhbw {{.*#+}} xmm16 = xmm23[8],xmm16[8],xmm23[9],xmm16[9],xmm23[10],xmm16[10],xmm23[11],xmm16[11],xmm23[12],xmm16[12],xmm23[13],xmm16[13],xmm23[14],xmm16[14],xmm23[15],xmm16[15]
; AVX512BW-NEXT:    vmovdqa64 16(%rcx), %xmm20
; AVX512BW-NEXT:    vpermt2w %zmm18, %zmm6, %zmm16
...
; AVX512BW-NEXT:    vmovdqa 16(%rsi), %xmm2
...
; AVX512BW-NEXT:    vpermt2w %zmm1, %zmm6, %zmm3
; AVX512BW-NEXT:    vpunpcklbw {{.*#+}} xmm1 = xmm18[0],xmm20[0],xmm18[1],xmm20[1],xmm18[2],xmm20[2],xmm18[3],xmm20[3],xmm18[4],xmm20[4],xmm18[5],xmm20[5],xmm18[6],xmm20[6],xmm18[7],xmm20[7]
...
; AVX512BW-NEXT:    vpermt2w %zmm1, %zmm11, %zmm6
; AVX512BW-NEXT:    vpunpckhbw {{.*#+}} xmm1 = xmm18[8],xmm20[8],xmm18[9],xmm20[9],xmm18[10],xmm20[10],xmm18[11],xmm20[11],xmm18[12],xmm20[12],xmm18[13],xmm20[13],xmm18[14],xmm20[14],xmm18[15],xmm20[15]
...
; AVX512BW-NEXT:    vpermt2w %zmm1, %zmm11, %zmm4
; AVX512BW-NEXT:    movw $-21846, %ax # imm = 0xAAAA
; AVX512BW-NEXT:    kmovd %eax, %k1
; AVX512BW-NEXT:    vpblendmd %zmm0, %zmm9, %zmm0 {%k1}
; AVX512BW-NEXT:    vpblendmd %zmm12, %zmm13, %zmm1 {%k1}
; AVX512BW-NEXT:    vpblendmd %zmm14, %zmm17, %zmm5 {%k1}
; AVX512BW-NEXT:    vpblendmd %zmm19, %zmm21, %zmm7 {%k1}
; AVX512BW-NEXT:    vpblendmd %zmm15, %zmm24, %zmm8 {%k1}
; AVX512BW-NEXT:    vpblendmd %zmm25, %zmm6, %zmm6 {%k1}
; AVX512BW-NEXT:    vpblendmd %zmm16, %zmm2, %zmm2 {%k1}
; AVX512BW-NEXT:    vpblendmd %zmm3, %zmm4, %zmm3 {%k1}
; AVX512BW-NEXT:    movq {{[0-9]+}}(%rsp), %rax
...
; AVX512BW-FCP-NEXT:    vmovdqa64 48(%r8), %xmm29
...
; AVX512BW-FCP-NEXT:    vpmovsxbw {{.*#+}} zmm13 = [0,1,0,32,4,5,1,33,2,1,2,42,4,5,3,43,0,1,4,36,4,5,5,37,0,1,6,46,6,5,7,47]
; AVX512BW-FCP-NEXT:    vpermt2w %zmm14, %zmm13, %zmm11
; AVX512BW-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm14 = xmm17[0],xmm16[0],xmm17[1],xmm16[1],xmm17[2],xmm16[2],xmm17[3],xmm16[3],xmm17[4],xmm16[4],xmm17[5],xmm16[5],xmm17[6],xmm16[6],xmm17[7],xmm16[7]
; AVX512BW-FCP-NEXT:    vinserti128 $1, %xmm14, %ymm14, %ymm15
; AVX512BW-FCP-NEXT:    vpshufb %ymm5, %ymm15, %ymm15
; AVX512BW-FCP-NEXT:    vpshufb %xmm6, %xmm14, %xmm25
; AVX512BW-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm14 = xmm14[0],zero,zero,zero,xmm14[1],zero,zero,zero
; AVX512BW-FCP-NEXT:    vinserti32x4 $1, %xmm25, %ymm14, %ymm14
; AVX512BW-FCP-NEXT:    vinserti64x4 $1, %ymm15, %zmm14, %zmm14
; AVX512BW-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm15 = xmm23[0],xmm19[0],xmm23[1],xmm19[1],xmm23[2],xmm19[2],xmm23[3],xmm19[3],xmm23[4],xmm19[4],xmm23[5],xmm19[5],xmm23[6],xmm19[6],xmm23[7],xmm19[7]
; AVX512BW-FCP-NEXT:    vinserti128 $1, %xmm15, %ymm15, %ymm15
; AVX512BW-FCP-NEXT:    vpermt2w %zmm15, %zmm9, %zmm14
...
; AVX512BW-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm15 = xmm29[0],xmm28[0],xmm29[1],xmm28[1],xmm29[2],xmm28[2],xmm29[3],xmm28[3],xmm29[4],xmm28[4],xmm29[5],xmm28[5],xmm29[6],xmm28[6],xmm29[7],xmm28[7]
; AVX512BW-FCP-NEXT:    vpermt2w %zmm25, %zmm13, %zmm15
...
; AVX512BW-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm17 = xmm23[8],xmm19[8],xmm23[9],xmm19[9],xmm23[10],xmm19[10],xmm23[11],xmm19[11],xmm23[12],xmm19[12],xmm23[13],xmm19[13],xmm23[14],xmm19[14],xmm23[15],xmm19[15]
...
; AVX512BW-FCP-NEXT:    vinserti32x4 $1, %xmm17, %ymm17, %ymm19
; AVX512BW-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm17 = xmm29[8],xmm28[8],xmm29[9],xmm28[9],xmm29[10],xmm28[10],xmm29[11],xmm28[11],xmm29[12],xmm28[12],xmm29[13],xmm28[13],xmm29[14],xmm28[14],xmm29[15],xmm28[15]
; AVX512BW-FCP-NEXT:    vpermt2w %zmm19, %zmm13, %zmm17
; AVX512BW-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm19 = xmm20[0],xmm18[0],xmm20[1],xmm18[1],xmm20[2],xmm18[2],xmm20[3],xmm18[3],xmm20[4],xmm18[4],xmm20[5],xmm18[5],xmm20[6],xmm18[6],xmm20[7],xmm18[7]
; AVX512BW-FCP-NEXT:    vinserti32x4 $1, %xmm19, %ymm19, %ymm23
; AVX512BW-FCP-NEXT:    vpshufb %ymm5, %ymm23, %ymm23
; AVX512BW-FCP-NEXT:    vpshufb %xmm6, %xmm19, %xmm24
; AVX512BW-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm19 = xmm19[0],zero,zero,zero,xmm19[1],zero,zero,zero
; AVX512BW-FCP-NEXT:    vinserti32x4 $1, %xmm24, %ymm19, %ymm19
; AVX512BW-FCP-NEXT:    vinserti64x4 $1, %ymm23, %zmm19, %zmm19
...
; AVX512BW-FCP-NEXT:    vpermt2w %zmm23, %zmm9, %zmm19
; AVX512BW-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm23 = xmm30[0],xmm25[0],xmm30[1],xmm25[1],xmm30[2],xmm25[2],xmm30[3],xmm25[3],xmm30[4],xmm25[4],xmm30[5],xmm25[5],xmm30[6],xmm25[6],xmm30[7],xmm25[7]
...
; AVX512BW-FCP-NEXT:    vpermt2w %zmm24, %zmm13, %zmm23
; AVX512BW-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm18 = xmm20[8],xmm18[8],xmm20[9],xmm18[9],xmm20[10],xmm18[10],xmm20[11],xmm18[11],xmm20[12],xmm18[12],xmm20[13],xmm18[13],xmm20[14],xmm18[14],xmm20[15],xmm18[15]
; AVX512BW-FCP-NEXT:    vpshufb %xmm6, %xmm18, %xmm20
; AVX512BW-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm24 = xmm18[0],zero,zero,zero,xmm18[1],zero,zero,zero
; AVX512BW-FCP-NEXT:    vinserti32x4 $1, %xmm20, %ymm24, %ymm20
; AVX512BW-FCP-NEXT:    vinserti32x4 $1, %xmm18, %ymm18, %ymm18
; AVX512BW-FCP-NEXT:    vpshufb %ymm5, %ymm18, %ymm18
...
; AVX512BW-FCP-NEXT:    vpermt2w %zmm20, %zmm9, %zmm18
; AVX512BW-FCP-NEXT:    vmovdqa64 16(%rcx), %xmm26
; AVX512BW-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm20 = xmm30[8],xmm25[8],xmm30[9],xmm25[9],xmm30[10],xmm25[10],xmm30[11],xmm25[11],xmm30[12],xmm25[12],xmm30[13],xmm25[13],xmm30[14],xmm25[14],xmm30[15],xmm25[15]
...
; AVX512BW-FCP-NEXT:    vpermt2w %zmm21, %zmm13, %zmm20
...
; AVX512BW-FCP-NEXT:    vpermt2w %zmm3, %zmm13, %zmm9
...
; AVX512BW-FCP-NEXT:    vinserti128 $1, %xmm3, %ymm3, %ymm3
; AVX512BW-FCP-NEXT:    vpermt2w %zmm3, %zmm13, %zmm2
...
; AVX512BW-FCP-NEXT:    vinserti128 $1, %xmm3, %ymm3, %ymm3
; AVX512BW-FCP-NEXT:    vpermt2w %zmm3, %zmm13, %zmm4
; AVX512BW-FCP-NEXT:    movw $-21846, %ax # imm = 0xAAAA
; AVX512BW-FCP-NEXT:    kmovd %eax, %k1
; AVX512BW-FCP-NEXT:    vpblendmd %zmm11, %zmm0, %zmm0 {%k1}
; AVX512BW-FCP-NEXT:    vpblendmd %zmm15, %zmm14, %zmm3 {%k1}
; AVX512BW-FCP-NEXT:    vpblendmd %zmm17, %zmm16, %zmm5 {%k1}
; AVX512BW-FCP-NEXT:    vpblendmd %zmm23, %zmm19, %zmm6 {%k1}
; AVX512BW-FCP-NEXT:    vpblendmd %zmm20, %zmm18, %zmm7 {%k1}
; AVX512BW-FCP-NEXT:    vpblendmd %zmm9, %zmm21, %zmm8 {%k1}
; AVX512BW-FCP-NEXT:    vpblendmd %zmm2, %zmm22, %zmm2 {%k1}
; AVX512BW-FCP-NEXT:    vpblendmd %zmm4, %zmm1, %zmm1 {%k1}
; AVX512BW-FCP-NEXT:    movq {{[0-9]+}}(%rsp), %rax
...
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm5, 448(%rax)
...
; AVX512DQ-BW-NEXT:    vmovdqa 32(%r10), %xmm15
; AVX512DQ-BW-NEXT:    vmovdqa 48(%r10), %xmm14
; AVX512DQ-BW-NEXT:    vmovdqa (%rax), %xmm2
; AVX512DQ-BW-NEXT:    vmovdqa64 32(%rax), %xmm16
; AVX512DQ-BW-NEXT:    vmovdqa64 48(%rax), %xmm17
...
; AVX512DQ-BW-NEXT:    vmovdqa64 32(%r9), %xmm18
...
; AVX512DQ-BW-NEXT:    vpmovsxbw {{.*#+}} zmm6 = [0,1,0,32,4,5,1,33,2,1,2,34,4,5,3,35,0,1,4,36,4,5,5,37,0,1,6,38,6,5,7,39]
; AVX512DQ-BW-NEXT:    vpermt2w %zmm4, %zmm6, %zmm0
; AVX512DQ-BW-NEXT:    vmovdqa (%rcx), %xmm4
; AVX512DQ-BW-NEXT:    vmovdqa64 48(%rcx), %xmm22
; AVX512DQ-BW-NEXT:    vmovdqa (%rdx), %xmm7
; AVX512DQ-BW-NEXT:    vmovdqa64 48(%rdx), %xmm23
; AVX512DQ-BW-NEXT:    vpunpckhbw {{.*#+}} xmm12 = xmm7[8],xmm4[8],xmm7[9],xmm4[9],xmm7[10],xmm4[10],xmm7[11],xmm4[11],xmm7[12],xmm4[12],xmm7[13],xmm4[13],xmm7[14],xmm4[14],xmm7[15],xmm4[15]
...
; AVX512DQ-BW-NEXT:    vpunpckhbw {{.*#+}} xmm9 = xmm10[8],xmm8[8],xmm10[9],xmm8[9],xmm10[10],xmm8[10],xmm10[11],xmm8[11],xmm10[12],xmm8[12],xmm10[13],xmm8[13],xmm10[14],xmm8[14],xmm10[15],xmm8[15]
; AVX512DQ-BW-NEXT:    vpmovsxbw {{.*#+}} zmm11 = [0,32,0,0,1,33,0,0,2,34,0,0,3,35,0,0,4,36,0,0,5,37,0,0,6,38,0,0,7,39,0,0]
; AVX512DQ-BW-NEXT:    vpermt2w %zmm12, %zmm11, %zmm9
; AVX512DQ-BW-NEXT:    vpunpcklbw {{.*#+}} xmm13 = xmm17[0],xmm14[0],xmm17[1],xmm14[1],xmm17[2],xmm14[2],xmm17[3],xmm14[3],xmm17[4],xmm14[4],xmm17[5],xmm14[5],xmm17[6],xmm14[6],xmm17[7],xmm14[7]
; AVX512DQ-BW-NEXT:    vpunpcklbw {{.*#+}} xmm12 = xmm21[0],xmm19[0],xmm21[1],xmm19[1],xmm21[2],xmm19[2],xmm21[3],xmm19[3],xmm21[4],xmm19[4],xmm21[5],xmm19[5],xmm21[6],xmm19[6],xmm21[7],xmm19[7]
; AVX512DQ-BW-NEXT:    vpermt2w %zmm13, %zmm6, %zmm12
...
; AVX512DQ-BW-NEXT:    vpunpcklbw {{.*#+}} xmm13 = xmm25[0],xmm24[0],xmm25[1],xmm24[1],xmm25[2],xmm24[2],xmm25[3],xmm24[3],xmm25[4],xmm24[4],xmm25[5],xmm24[5],xmm25[6],xmm24[6],xmm25[7],xmm24[7]
; AVX512DQ-BW-NEXT:    vpermt2w %zmm26, %zmm11, %zmm13
...
; AVX512DQ-BW-NEXT:    vpermt2w %zmm17, %zmm6, %zmm14
; AVX512DQ-BW-NEXT:    vmovdqa64 32(%rdi), %xmm29
; AVX512DQ-BW-NEXT:    vpunpckhbw {{.*#+}} xmm19 = xmm23[8],xmm22[8],xmm23[9],xmm22[9],xmm23[10],xmm22[10],xmm23[11],xmm22[11],xmm23[12],xmm22[12],xmm23[13],xmm22[13],xmm23[14],xmm22[14],xmm23[15],xmm22[15]
; AVX512DQ-BW-NEXT:    vpunpckhbw {{.*#+}} xmm17 = xmm25[8],xmm24[8],xmm25[9],xmm24[9],xmm25[10],xmm24[10],xmm25[11],xmm24[11],xmm25[12],xmm24[12],xmm25[13],xmm24[13],xmm25[14],xmm24[14],xmm25[15],xmm24[15]
; AVX512DQ-BW-NEXT:    vpermt2w %zmm19, %zmm11, %zmm17
; AVX512DQ-BW-NEXT:    vpunpcklbw {{.*#+}} xmm21 = xmm16[0],xmm15[0],xmm16[1],xmm15[1],xmm16[2],xmm15[2],xmm16[3],xmm15[3],xmm16[4],xmm15[4],xmm16[5],xmm15[5],xmm16[6],xmm15[6],xmm16[7],xmm15[7]
; AVX512DQ-BW-NEXT:    vpunpcklbw {{.*#+}} xmm19 = xmm20[0],xmm18[0],xmm20[1],xmm18[1],xmm20[2],xmm18[2],xmm20[3],xmm18[3],xmm20[4],xmm18[4],xmm20[5],xmm18[5],xmm20[6],xmm18[6],xmm20[7],xmm18[7]
; AVX512DQ-BW-NEXT:    vpermt2w %zmm21, %zmm6, %zmm19
...
; AVX512DQ-BW-NEXT:    vpunpcklbw {{.*#+}} xmm21 = xmm29[0],xmm28[0],xmm29[1],xmm28[1],xmm29[2],xmm28[2],xmm29[3],xmm28[3],xmm29[4],xmm28[4],xmm29[5],xmm28[5],xmm29[6],xmm28[6],xmm29[7],xmm28[7]
; AVX512DQ-BW-NEXT:    vpermt2w %zmm22, %zmm11, %zmm21
...
; AVX512DQ-BW-NEXT:    vmovdqa64 16(%rax), %xmm18
; AVX512DQ-BW-NEXT:    vpermt2w %zmm16, %zmm6, %zmm15
; AVX512DQ-BW-NEXT:    vmovdqa64 16(%r9), %xmm16
; AVX512DQ-BW-NEXT:    vpunpckhbw {{.*#+}} xmm20 = xmm27[8],xmm26[8],xmm27[9],xmm26[9],xmm27[10],xmm26[10],xmm27[11],xmm26[11],xmm27[12],xmm26[12],xmm27[13],xmm26[13],xmm27[14],xmm26[14],xmm27[15],xmm26[15]
; AVX512DQ-BW-NEXT:    vmovdqa64 16(%r8), %xmm23
; AVX512DQ-BW-NEXT:    vpunpckhbw {{.*#+}} xmm24 = xmm29[8],xmm28[8],xmm29[9],xmm28[9],xmm29[10],xmm28[10],xmm29[11],xmm28[11],xmm29[12],xmm28[12],xmm29[13],xmm28[13],xmm29[14],xmm28[14],xmm29[15],xmm28[15]
; AVX512DQ-BW-NEXT:    vpermt2w %zmm20, %zmm11, %zmm24
; AVX512DQ-BW-NEXT:    vpunpcklbw {{.*#+}} xmm20 = xmm18[0],xmm22[0],xmm18[1],xmm22[1],xmm18[2],xmm22[2],xmm18[3],xmm22[3],xmm18[4],xmm22[4],xmm18[5],xmm22[5],xmm18[6],xmm22[6],xmm18[7],xmm22[7]
; AVX512DQ-BW-NEXT:    vpunpcklbw {{.*#+}} xmm25 = xmm23[0],xmm16[0],xmm23[1],xmm16[1],xmm23[2],xmm16[2],xmm23[3],xmm16[3],xmm23[4],xmm16[4],xmm23[5],xmm16[5],xmm23[6],xmm16[6],xmm23[7],xmm16[7]
; AVX512DQ-BW-NEXT:    vpermt2w %zmm20, %zmm6, %zmm25
; AVX512DQ-BW-NEXT:    vpunpckhbw {{.*#+}} xmm18 = xmm18[8],xmm22[8],xmm18[9],xmm22[9],xmm18[10],xmm22[10],xmm18[11],xmm22[11],xmm18[12],xmm22[12],xmm18[13],xmm22[13],xmm18[14],xmm22[14],xmm18[15],xmm22[15]
; AVX512DQ-BW-NEXT:    vpunpckhbw {{.*#+}} xmm16 = xmm23[8],xmm16[8],xmm23[9],xmm16[9],xmm23[10],xmm16[10],xmm23[11],xmm16[11],xmm23[12],xmm16[12],xmm23[13],xmm16[13],xmm23[14],xmm16[14],xmm23[15],xmm16[15]
; AVX512DQ-BW-NEXT:    vmovdqa64 16(%rcx), %xmm20
; AVX512DQ-BW-NEXT:    vpermt2w %zmm18, %zmm6, %zmm16
...
; AVX512DQ-BW-NEXT:    vmovdqa 16(%rsi), %xmm2
...
; AVX512DQ-BW-NEXT:    vpermt2w %zmm1, %zmm6, %zmm3
; AVX512DQ-BW-NEXT:    vpunpcklbw {{.*#+}} xmm1 = xmm18[0],xmm20[0],xmm18[1],xmm20[1],xmm18[2],xmm20[2],xmm18[3],xmm20[3],xmm18[4],xmm20[4],xmm18[5],xmm20[5],xmm18[6],xmm20[6],xmm18[7],xmm20[7]
...
; AVX512DQ-BW-NEXT:    vpermt2w %zmm1, %zmm11, %zmm6
; AVX512DQ-BW-NEXT:    vpunpckhbw {{.*#+}} xmm1 = xmm18[8],xmm20[8],xmm18[9],xmm20[9],xmm18[10],xmm20[10],xmm18[11],xmm20[11],xmm18[12],xmm20[12],xmm18[13],xmm20[13],xmm18[14],xmm20[14],xmm18[15],xmm20[15]
...
; AVX512DQ-BW-NEXT:    vpermt2w %zmm1, %zmm11, %zmm4
; AVX512DQ-BW-NEXT:    movw $-21846, %ax # imm = 0xAAAA
; AVX512DQ-BW-NEXT:    kmovd %eax, %k1
; AVX512DQ-BW-NEXT:    vpblendmd %zmm0, %zmm9, %zmm0 {%k1}
; AVX512DQ-BW-NEXT:    vpblendmd %zmm12, %zmm13, %zmm1 {%k1}
; AVX512DQ-BW-NEXT:    vpblendmd %zmm14, %zmm17, %zmm5 {%k1}
; AVX512DQ-BW-NEXT:    vpblendmd %zmm19, %zmm21, %zmm7 {%k1}
; AVX512DQ-BW-NEXT:    vpblendmd %zmm15, %zmm24, %zmm8 {%k1}
; AVX512DQ-BW-NEXT:    vpblendmd %zmm25, %zmm6, %zmm6 {%k1}
; AVX512DQ-BW-NEXT:    vpblendmd %zmm16, %zmm2, %zmm2 {%k1}
; AVX512DQ-BW-NEXT:    vpblendmd %zmm3, %zmm4, %zmm3 {%k1}
; AVX512DQ-BW-NEXT:    movq {{[0-9]+}}(%rsp), %rax
...
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm5, 448(%rax)
...
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 48(%r8), %xmm29
...
; AVX512DQ-BW-FCP-NEXT:    vpmovsxbw {{.*#+}} zmm13 = [0,1,0,32,4,5,1,33,2,1,2,42,4,5,3,43,0,1,4,36,4,5,5,37,0,1,6,46,6,5,7,47]
; AVX512DQ-BW-FCP-NEXT:    vpermt2w %zmm14, %zmm13, %zmm11
; AVX512DQ-BW-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm14 = xmm17[0],xmm16[0],xmm17[1],xmm16[1],xmm17[2],xmm16[2],xmm17[3],xmm16[3],xmm17[4],xmm16[4],xmm17[5],xmm16[5],xmm17[6],xmm16[6],xmm17[7],xmm16[7]
; AVX512DQ-BW-FCP-NEXT:    vinserti128 $1, %xmm14, %ymm14, %ymm15
; AVX512DQ-BW-FCP-NEXT:    vpshufb %ymm5, %ymm15, %ymm15
; AVX512DQ-BW-FCP-NEXT:    vpshufb %xmm6, %xmm14, %xmm25
; AVX512DQ-BW-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm14 = xmm14[0],zero,zero,zero,xmm14[1],zero,zero,zero
; AVX512DQ-BW-FCP-NEXT:    vinserti32x4 $1, %xmm25, %ymm14, %ymm14
; AVX512DQ-BW-FCP-NEXT:    vinserti64x4 $1, %ymm15, %zmm14, %zmm14
; AVX512DQ-BW-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm15 = xmm23[0],xmm19[0],xmm23[1],xmm19[1],xmm23[2],xmm19[2],xmm23[3],xmm19[3],xmm23[4],xmm19[4],xmm23[5],xmm19[5],xmm23[6],xmm19[6],xmm23[7],xmm19[7]
; AVX512DQ-BW-FCP-NEXT:    vinserti128 $1, %xmm15, %ymm15, %ymm15
; AVX512DQ-BW-FCP-NEXT:    vpermt2w %zmm15, %zmm9, %zmm14
...
; AVX512DQ-BW-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm15 = xmm29[0],xmm28[0],xmm29[1],xmm28[1],xmm29[2],xmm28[2],xmm29[3],xmm28[3],xmm29[4],xmm28[4],xmm29[5],xmm28[5],xmm29[6],xmm28[6],xmm29[7],xmm28[7]
; AVX512DQ-BW-FCP-NEXT:    vpermt2w %zmm25, %zmm13, %zmm15
...
; AVX512DQ-BW-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm17 = xmm23[8],xmm19[8],xmm23[9],xmm19[9],xmm23[10],xmm19[10],xmm23[11],xmm19[11],xmm23[12],xmm19[12],xmm23[13],xmm19[13],xmm23[14],xmm19[14],xmm23[15],xmm19[15]
...
; AVX512DQ-BW-FCP-NEXT:    vinserti32x4 $1, %xmm17, %ymm17, %ymm19
; AVX512DQ-BW-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm17 = xmm29[8],xmm28[8],xmm29[9],xmm28[9],xmm29[10],xmm28[10],xmm29[11],xmm28[11],xmm29[12],xmm28[12],xmm29[13],xmm28[13],xmm29[14],xmm28[14],xmm29[15],xmm28[15]
; AVX512DQ-BW-FCP-NEXT:    vpermt2w %zmm19, %zmm13, %zmm17
; AVX512DQ-BW-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm19 = xmm20[0],xmm18[0],xmm20[1],xmm18[1],xmm20[2],xmm18[2],xmm20[3],xmm18[3],xmm20[4],xmm18[4],xmm20[5],xmm18[5],xmm20[6],xmm18[6],xmm20[7],xmm18[7]
; AVX512DQ-BW-FCP-NEXT:    vinserti32x4 $1, %xmm19, %ymm19, %ymm23
; AVX512DQ-BW-FCP-NEXT:    vpshufb %ymm5, %ymm23, %ymm23
; AVX512DQ-BW-FCP-NEXT:    vpshufb %xmm6, %xmm19, %xmm24
; AVX512DQ-BW-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm19 = xmm19[0],zero,zero,zero,xmm19[1],zero,zero,zero
; AVX512DQ-BW-FCP-NEXT:    vinserti32x4 $1, %xmm24, %ymm19, %ymm19
; AVX512DQ-BW-FCP-NEXT:    vinserti64x4 $1, %ymm23, %zmm19, %zmm19
...
; AVX512DQ-BW-FCP-NEXT:    vpermt2w %zmm23, %zmm9, %zmm19
; AVX512DQ-BW-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm23 = xmm30[0],xmm25[0],xmm30[1],xmm25[1],xmm30[2],xmm25[2],xmm30[3],xmm25[3],xmm30[4],xmm25[4],xmm30[5],xmm25[5],xmm30[6],xmm25[6],xmm30[7],xmm25[7]
...
; AVX512DQ-BW-FCP-NEXT:    vpermt2w %zmm24, %zmm13, %zmm23
; AVX512DQ-BW-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm18 = xmm20[8],xmm18[8],xmm20[9],xmm18[9],xmm20[10],xmm18[10],xmm20[11],xmm18[11],xmm20[12],xmm18[12],xmm20[13],xmm18[13],xmm20[14],xmm18[14],xmm20[15],xmm18[15]
; AVX512DQ-BW-FCP-NEXT:    vpshufb %xmm6, %xmm18, %xmm20
; AVX512DQ-BW-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm24 = xmm18[0],zero,zero,zero,xmm18[1],zero,zero,zero
; AVX512DQ-BW-FCP-NEXT:    vinserti32x4 $1, %xmm20, %ymm24, %ymm20
; AVX512DQ-BW-FCP-NEXT:    vinserti32x4 $1, %xmm18, %ymm18, %ymm18
; AVX512DQ-BW-FCP-NEXT:    vpshufb %ymm5, %ymm18, %ymm18
...
; AVX512DQ-BW-FCP-NEXT:    vpermt2w %zmm20, %zmm9, %zmm18
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 16(%rcx), %xmm26
; AVX512DQ-BW-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm20 = xmm30[8],xmm25[8],xmm30[9],xmm25[9],xmm30[10],xmm25[10],xmm30[11],xmm25[11],xmm30[12],xmm25[12],xmm30[13],xmm25[13],xmm30[14],xmm25[14],xmm30[15],xmm25[15]
...
; AVX512DQ-BW-FCP-NEXT:    vpermt2w %zmm21, %zmm13, %zmm20
...
; AVX512DQ-BW-FCP-NEXT:    vpermt2w %zmm3, %zmm13, %zmm9
...
; AVX512DQ-BW-FCP-NEXT:    vinserti128 $1, %xmm3, %ymm3, %ymm3
; AVX512DQ-BW-FCP-NEXT:    vpermt2w %zmm3, %zmm13, %zmm2
...
; AVX512DQ-BW-FCP-NEXT:    vinserti128 $1, %xmm3, %ymm3, %ymm3
; AVX512DQ-BW-FCP-NEXT:    vpermt2w %zmm3, %zmm13, %zmm4
; AVX512DQ-BW-FCP-NEXT:    movw $-21846, %ax # imm = 0xAAAA
; AVX512DQ-BW-FCP-NEXT:    kmovd %eax, %k1
; AVX512DQ-BW-FCP-NEXT:    vpblendmd %zmm11, %zmm0, %zmm0 {%k1}
; AVX512DQ-BW-FCP-NEXT:    vpblendmd %zmm15, %zmm14, %zmm3 {%k1}
; AVX512DQ-BW-FCP-NEXT:    vpblendmd %zmm17, %zmm16, %zmm5 {%k1}
; AVX512DQ-BW-FCP-NEXT:    vpblendmd %zmm23, %zmm19, %zmm6 {%k1}
; AVX512DQ-BW-FCP-NEXT:    vpblendmd %zmm20, %zmm18, %zmm7 {%k1}
; AVX512DQ-BW-FCP-NEXT:    vpblendmd %zmm9, %zmm21, %zmm8 {%k1}
; AVX512DQ-BW-FCP-NEXT:    vpblendmd %zmm2, %zmm22, %zmm2 {%k1}
; AVX512DQ-BW-FCP-NEXT:    vpblendmd %zmm4, %zmm1, %zmm1 {%k1}
; AVX512DQ-BW-FCP-NEXT:    movq {{[0-9]+}}(%rsp), %rax
...
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm5, 448(%rax)
