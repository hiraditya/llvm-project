...
; CHECK-SSE41-NEXT:    movdqa {{.*#+}} xmm0 = [171798691,171798691,171798691,171798691]
...
; CHECK-SSE41-NEXT:    pslld $30, %xmm1
...
; CHECK-SSE2-NEXT:    movdqa {{.*#+}} xmm2 = [1030792151,1030792151,3264175145,3264175145]
...
; CHECK-SSE41:       # %bb.0:
; CHECK-SSE41-NEXT:    movdqa {{.*#+}} xmm1 = [3264175145,1030792151,1030792151,3264175145]
; CHECK-SSE41-NEXT:    pmulld %xmm0, %xmm1
; CHECK-SSE41-NEXT:    movdqa {{.*#+}} xmm0 = [171798691,1,1,171798691]
; CHECK-SSE41-NEXT:    pminud %xmm1, %xmm0
; CHECK-SSE41-NEXT:    pcmpeqd %xmm1, %xmm0
; CHECK-SSE41-NEXT:    psrld $31, %xmm0
; CHECK-SSE41-NEXT:    retq
...
; CHECK-SSE2:       # %bb.0:
; CHECK-SSE2-NEXT:    movdqa {{.*#+}} xmm1 = [4252017623,3264175145,4252017623,3264175145]
; CHECK-SSE2-NEXT:    pmuludq %xmm0, %xmm1
; CHECK-SSE2-NEXT:    pshufd {{.*#+}} xmm1 = xmm1[0,2,2,3]
; CHECK-SSE2-NEXT:    pshufd {{.*#+}} xmm0 = xmm0[1,1,3,3]
; CHECK-SSE2-NEXT:    movdqa {{.*#+}} xmm2 = [3264175145,3264175145,3264175145,3264175145]
; CHECK-SSE2-NEXT:    pmuludq %xmm0, %xmm2
; CHECK-SSE2-NEXT:    pshufd {{.*#+}} xmm0 = xmm2[0,2,2,3]
; CHECK-SSE2-NEXT:    punpckldq {{.*#+}} xmm1 = xmm1[0],xmm0[0],xmm1[1],xmm0[1]
...
; CHECK-SSE41:       # %bb.0:
; CHECK-SSE41-NEXT:    movdqa {{.*#+}} xmm1 = [4252017623,3264175145,4252017623,3264175145]
; CHECK-SSE41-NEXT:    pmulld %xmm0, %xmm1
; CHECK-SSE41-NEXT:    movdqa %xmm1, %xmm2
; CHECK-SSE41-NEXT:    psrld $2, %xmm2
; CHECK-SSE41-NEXT:    pslld $30, %xmm1
; CHECK-SSE41-NEXT:    por %xmm1, %xmm2
; CHECK-SSE41-NEXT:    movdqa {{.*#+}} xmm0 = [1,42949672,1,42949672]
; CHECK-SSE41-NEXT:    pminud %xmm2, %xmm0
; CHECK-SSE41-NEXT:    pcmpeqd %xmm2, %xmm0
; CHECK-SSE41-NEXT:    psrld $31, %xmm0
; CHECK-SSE41-NEXT:    retq
...
; CHECK-SSE41-NEXT:    pmovsxbd {{.*#+}} xmm2 = [25,25,25,25]
; CHECK-SSE41-NEXT:    pmulld %xmm1, %xmm2
...
; CHECK-SSE41-NEXT:    pmovsxbd {{.*#+}} xmm2 = [100,100,100,100]
; CHECK-SSE41-NEXT:    pmulld %xmm1, %xmm2
; CHECK-SSE41-NEXT:    psubd %xmm2, %xmm0
; CHECK-SSE41-NEXT:    pxor %xmm1, %xmm1
; CHECK-SSE41-NEXT:    pcmpeqd %xmm0, %xmm1
...
; CHECK-SSE2:       # %bb.0:
; CHECK-SSE2-NEXT:    movdqa {{.*#+}} xmm1 = [15,15,15,15]
...
; CHECK-SSE41:       # %bb.0:
; CHECK-SSE41-NEXT:    pmovsxbd {{.*#+}} xmm1 = [15,15,15,15]
...
; CHECK-SSE:       # %bb.0:
; CHECK-SSE-NEXT:    movdqa {{.*#+}} xmm1 = [2147483647,2147483647,2147483647,2147483647]
