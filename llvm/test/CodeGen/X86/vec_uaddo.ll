...
; SSE41-NEXT:    movdqa %xmm10, 16(%rdi)
...
; SSE-NEXT:    pshufd {{.*#+}} xmm0 = xmm1[1,3,3,3]
; SSE-NEXT:    pand %xmm0, %xmm2
; SSE-NEXT:    pshufd {{.*#+}} xmm0 = xmm3[1,3,3,3]
