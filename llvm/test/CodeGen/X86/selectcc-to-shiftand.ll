...
; ANY-NEXT:    movdqa {{.*#+}} xmm1 = [128,128,128,128,128,128,128,128,128,128,128,128,128,128,128,128]
; ANY-NEXT:    pand %xmm0, %xmm1
; ANY-NEXT:    movdqa %xmm1, %xmm0
; ANY-NEXT:    retq
...
; ANY:       # %bb.0:
; ANY-NEXT:    psllw $7, %xmm0
; ANY-NEXT:    movdqa {{.*#+}} xmm1 = [128,128,128,128,128,128,128,128]
; ANY-NEXT:    pand %xmm0, %xmm1
; ANY-NEXT:    movdqa %xmm1, %xmm0
; ANY-NEXT:    retq
...
; ANY-NEXT:    movdqa {{.*#+}} xmm1 = [64,64,64,64]
; ANY-NEXT:    pand %xmm0, %xmm1
; ANY-NEXT:    movdqa %xmm1, %xmm0
; ANY-NEXT:    retq
...
; ANY-NEXT:    movdqa {{.*#+}} xmm1 = [65536,65536]
; ANY-NEXT:    pand %xmm0, %xmm1
; ANY-NEXT:    movdqa %xmm1, %xmm0
; ANY-NEXT:    retq
