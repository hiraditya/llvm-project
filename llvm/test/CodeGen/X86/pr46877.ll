...
; CHECK-LABEL: tester:
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    vmovaps %xmm3, %xmm14
; CHECK-NEXT:    vmovaps %xmm1, %xmm12
...
; CHECK-NEXT:    vmulss %xmm4, %xmm8, %xmm6
...
; CHECK-NEXT:    vmovaps %xmm3, %xmm5
; CHECK-NEXT:    vmulss %xmm1, %xmm6, %xmm1
; CHECK-NEXT:    vmovss {{.*#+}} xmm15 = mem[0],zero,zero,zero
; CHECK-NEXT:    vmulss %xmm0, %xmm15, %xmm3
; CHECK-NEXT:    vmovss %xmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 4-byte Spill
; CHECK-NEXT:    vmulss %xmm3, %xmm11, %xmm6
...
; CHECK-NEXT:    vfnmadd213ss {{.*#+}} xmm4 = -(xmm7 * xmm4) + xmm0
; CHECK-NEXT:    vmulss %xmm2, %xmm4, %xmm2
; CHECK-NEXT:    vmulss %xmm1, %xmm2, %xmm1
...
; CHECK-NEXT:    vmulss %xmm12, %xmm9, %xmm4
; CHECK-NEXT:    vfnmadd132ss {{.*#+}} xmm4 = -(xmm4 * mem) + xmm0
; CHECK-NEXT:    vmovss {{.*#+}} xmm2 = mem[0],zero,zero,zero
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm2, %xmm6
; CHECK-NEXT:    vfnmadd132ss {{.*#+}} xmm6 = -(xmm6 * mem) + xmm0
; CHECK-NEXT:    vmulss %xmm4, %xmm6, %xmm4
; CHECK-NEXT:    vmulss %xmm1, %xmm4, %xmm1
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm1, %xmm1
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm1, %xmm1
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm1, %xmm1
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm5, %xmm4
; CHECK-NEXT:    vfnmadd132ss {{.*#+}} xmm4 = -(xmm4 * mem) + xmm0
; CHECK-NEXT:    vmulss %xmm1, %xmm4, %xmm1
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm1, %xmm1
; CHECK-NEXT:    vmovss {{.*#+}} xmm4 = mem[0],zero,zero,zero
...
; CHECK-NEXT:    vfnmadd213ss {{.*#+}} xmm6 = -(xmm13 * xmm6) + xmm0
; CHECK-NEXT:    vmulss %xmm1, %xmm6, %xmm1
; CHECK-NEXT:    vmulss %xmm0, %xmm10, %xmm15
...
; CHECK-NEXT:    vmovss {{.*#+}} xmm8 = mem[0],zero,zero,zero
; CHECK-NEXT:    vfnmadd213ss {{.*#+}} xmm10 = -(xmm8 * xmm10) + xmm0
; CHECK-NEXT:    vmulss %xmm6, %xmm10, %xmm6
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm1, %xmm1
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm1, %xmm1
; CHECK-NEXT:    vmulss %xmm1, %xmm6, %xmm10
; CHECK-NEXT:    vmovss {{.*#+}} xmm3 = mem[0],zero,zero,zero
; CHECK-NEXT:    vfnmadd213ss {{.*#+}} xmm3 = -(xmm8 * xmm3) + xmm0
; CHECK-NEXT:    vmovss {{.*#+}} xmm5 = mem[0],zero,zero,zero
; CHECK-NEXT:    vmulss %xmm5, %xmm15, %xmm2
; CHECK-NEXT:    vfnmadd132ss {{.*#+}} xmm2 = -(xmm2 * mem) + xmm0
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm0, %xmm6
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm6, %xmm1
; CHECK-NEXT:    vfnmadd132ss {{.*#+}} xmm1 = -(xmm1 * mem) + xmm0
; CHECK-NEXT:    vmulss %xmm3, %xmm2, %xmm2
; CHECK-NEXT:    vmulss %xmm5, %xmm9, %xmm3
...
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm15, %xmm9
...
; CHECK-NEXT:    vmovss {{.*#+}} xmm5 = mem[0],zero,zero,zero
; CHECK-NEXT:    vfnmadd213ss {{.*#+}} xmm1 = -(xmm5 * xmm1) + xmm0
...
; CHECK-NEXT:    vmovss {{[-0-9]+}}(%r{{[sb]}}p), %xmm8 # 4-byte Reload
; CHECK-NEXT:    # xmm8 = mem[0],zero,zero,zero
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm8, %xmm3
; CHECK-NEXT:    vfnmadd213ss {{.*#+}} xmm3 = -(xmm10 * xmm3) + xmm0
; CHECK-NEXT:    vmulss %xmm3, %xmm2, %xmm2
; CHECK-NEXT:    vmovss {{.*#+}} xmm3 = mem[0],zero,zero,zero
; CHECK-NEXT:    vfnmadd132ss {{.*#+}} xmm3 = -(xmm3 * mem) + xmm0
...
; CHECK-NEXT:    vmovss {{.*#+}} xmm2 = mem[0],zero,zero,zero
; CHECK-NEXT:    vfnmadd213ss {{.*#+}} xmm2 = -(xmm14 * xmm2) + xmm0
; CHECK-NEXT:    vmulss %xmm1, %xmm2, %xmm9
; CHECK-NEXT:    vmulss %xmm0, %xmm4, %xmm1
...
; CHECK-NEXT:    vfnmadd132ss {{.*#+}} xmm2 = -(xmm2 * mem) + xmm0
; CHECK-NEXT:    vmulss %xmm1, %xmm2, %xmm1
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm9, %xmm2
; CHECK-NEXT:    vmulss %xmm2, %xmm1, %xmm9
; CHECK-NEXT:    vfnmadd213ss {{.*#+}} xmm7 = -(xmm4 * xmm7) + xmm0
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm15, %xmm1
; CHECK-NEXT:    vfnmadd213ss {{.*#+}} xmm1 = -(xmm14 * xmm1) + xmm0
; CHECK-NEXT:    vmovss {{.*#+}} xmm2 = mem[0],zero,zero,zero
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm2, %xmm2
; CHECK-NEXT:    vfnmadd132ss {{.*#+}} xmm2 = -(xmm2 * mem) + xmm0
; CHECK-NEXT:    vmulss %xmm7, %xmm1, %xmm1
; CHECK-NEXT:    vmulss %xmm1, %xmm2, %xmm1
; CHECK-NEXT:    vfnmadd213ss {{.*#+}} xmm11 = -(xmm13 * xmm11) + xmm0
; CHECK-NEXT:    vmulss %xmm1, %xmm11, %xmm2
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm0, %xmm1
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm1, %xmm4
; CHECK-NEXT:    vfnmadd132ss {{.*#+}} xmm4 = -(xmm4 * mem) + xmm0
; CHECK-NEXT:    vmovss {{.*#+}} xmm1 = mem[0],zero,zero,zero
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm1, %xmm3
; CHECK-NEXT:    vmulss %xmm1, %xmm12, %xmm7
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm15, %xmm1
; CHECK-NEXT:    vmulss %xmm15, %xmm14, %xmm6
...
; CHECK-NEXT:    vmulss %xmm0, %xmm10, %xmm10
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm10, %xmm10
; CHECK-NEXT:    vmovss {{.*#+}} xmm8 = mem[0],zero,zero,zero
; CHECK-NEXT:    vfnmadd213ss {{.*#+}} xmm10 = -(xmm8 * xmm10) + xmm0
; CHECK-NEXT:    vfnmadd213ss {{.*#+}} xmm12 = -(xmm8 * xmm12) + xmm0
; CHECK-NEXT:    vfmsub213ss {{.*#+}} xmm1 = (xmm14 * xmm1) - xmm0
; CHECK-NEXT:    vfnmadd132ss {{.*#+}} xmm5 = -(xmm5 * mem) + xmm0
; CHECK-NEXT:    vmulss %xmm2, %xmm5, %xmm0
; CHECK-NEXT:    vmulss %xmm0, %xmm6, %xmm0
; CHECK-NEXT:    vmulss %xmm0, %xmm11, %xmm0
; CHECK-NEXT:    vmulss %xmm0, %xmm3, %xmm0
; CHECK-NEXT:    vmulss {{[0-9]+}}(%rsp), %xmm9, %xmm2
; CHECK-NEXT:    vmulss %xmm2, %xmm0, %xmm0
; CHECK-NEXT:    vmulss %xmm4, %xmm7, %xmm2
; CHECK-NEXT:    vmulss %xmm2, %xmm10, %xmm2
; CHECK-NEXT:    vmulss %xmm2, %xmm12, %xmm2
