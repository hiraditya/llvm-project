...
; SSE41-NEXT:    pshufd {{.*#+}} xmm3 = xmm1[3,3,3,3]
; SSE41-NEXT:    pmovsxbd %xmm3, %xmm3
...
; SSE41-NEXT:    paddb %xmm4, %xmm9
; SSE41-NEXT:    pxor %xmm0, %xmm0
; SSE41-NEXT:    pcmpgtb %xmm6, %xmm0
; SSE41-NEXT:    pxor %xmm4, %xmm4
; SSE41-NEXT:    pcmpgtb %xmm2, %xmm4
; SSE41-NEXT:    paddb %xmm4, %xmm0
; SSE41-NEXT:    paddb %xmm9, %xmm0
; SSE41-NEXT:    pxor %xmm2, %xmm2
; SSE41-NEXT:    pcmpgtb %xmm5, %xmm2
; SSE41-NEXT:    pxor %xmm4, %xmm4
; SSE41-NEXT:    pcmpgtb %xmm1, %xmm4
; SSE41-NEXT:    paddb %xmm4, %xmm2
; SSE41-NEXT:    pxor %xmm1, %xmm1
; SSE41-NEXT:    pcmpgtb %xmm7, %xmm1
; SSE41-NEXT:    pxor %xmm4, %xmm4
; SSE41-NEXT:    pcmpgtb %xmm3, %xmm4
