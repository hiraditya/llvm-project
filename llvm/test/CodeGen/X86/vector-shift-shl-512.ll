...
; AVX512DQ:       # %bb.0:
; AVX512DQ-NEXT:    vextracti64x4 $1, %zmm0, %ymm2
; AVX512DQ-NEXT:    vbroadcasti128 {{.*#+}} ymm1 = [1,2,4,8,16,32,64,128,128,64,32,16,8,4,2,1,1,2,4,8,16,32,64,128,128,64,32,16,8,4,2,1]
; AVX512DQ-NEXT:    # ymm1 = mem[0,1,0,1]
; AVX512DQ-NEXT:    vpmullw %ymm1, %ymm2, %ymm3
; AVX512DQ-NEXT:    vpmullw %ymm1, %ymm0, %ymm1
...
; AVX512DQ-NEXT:    vpmaddubsw %ymm3, %ymm2, %ymm2
; AVX512DQ-NEXT:    vpsllw $8, %ymm2, %ymm2
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm2, %zmm0, %zmm0
; AVX512DQ-NEXT:    vpternlogd {{.*#+}} zmm1 = (zmm1 & m32bcst) | zmm0
