...
; CHECK-NEXT:    movdqa {{.*#+}} xmm3 = [726,726,726,726]
; CHECK-NEXT:    paddd %xmm0, %xmm3
; CHECK-NEXT:    movdqa %xmm2, v2
; CHECK-NEXT:    movdqa %xmm3, v3
...
; CHECK-NEXT:    movdqa {{.*#+}} xmm3 = [33,33,55,55]
; CHECK-NEXT:    pmuludq %xmm0, %xmm3
; CHECK-NEXT:    pshufd {{.*#+}} xmm0 = xmm3[0,2,2,3]
; CHECK-NEXT:    punpckldq {{.*#+}} xmm2 = xmm2[0],xmm0[0],xmm2[1],xmm0[1]
; CHECK-NEXT:    movdqa {{.*#+}} xmm0 = [242,726,1452,2420]
; CHECK-NEXT:    paddd %xmm2, %xmm0
; CHECK-NEXT:    movdqa {{.*#+}} xmm3 = [726,1452,2420,3630]
; CHECK-NEXT:    paddd %xmm2, %xmm3
