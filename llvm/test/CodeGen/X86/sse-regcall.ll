...
; WIN32-NEXT:    movaps %xmm2, %xmm0
; WIN32-NEXT:    addps %xmm6, %xmm0
; WIN32-NEXT:    mulps %xmm6, %xmm2
; WIN32-NEXT:    subps %xmm2, %xmm0
; WIN32-NEXT:    movups 24(%ebp), %xmm1
; WIN32-NEXT:    addps %xmm0, %xmm1
; WIN32-NEXT:    movaps %xmm3, %xmm0
; WIN32-NEXT:    addps %xmm7, %xmm0
; WIN32-NEXT:    mulps %xmm7, %xmm3
; WIN32-NEXT:    subps %xmm3, %xmm0
; WIN32-NEXT:    movups 40(%ebp), %xmm2
; WIN32-NEXT:    addps %xmm0, %xmm2
; WIN32-NEXT:    movaps %xmm5, %xmm0
; WIN32-NEXT:    movaps (%esp), %xmm3 # 16-byte Reload
; WIN32-NEXT:    addps %xmm3, %xmm0
; WIN32-NEXT:    mulps %xmm3, %xmm5
; WIN32-NEXT:    subps %xmm5, %xmm0
; WIN32-NEXT:    movups 56(%ebp), %xmm3
; WIN32-NEXT:    addps %xmm0, %xmm3
...
; WIN32-NEXT:    subl %edi, %edx
; WIN32-NEXT:    leal (%esi,%ebp), %eax
; WIN32-NEXT:    movl %eax, (%esp) # 4-byte Spill
; WIN32-NEXT:    subl %ebp, %esi
; WIN32-NEXT:    movl {{[0-9]+}}(%esp), %ebp
; WIN32-NEXT:    movl {{[0-9]+}}(%esp), %eax
; WIN32-NEXT:    leal (%eax,%ebp), %edi
; WIN32-NEXT:    subl %ebp, %eax
; WIN32-NEXT:    imull %ebx, %eax
; WIN32-NEXT:    movl {{[0-9]+}}(%esp), %ebx
; WIN32-NEXT:    movl {{[0-9]+}}(%esp), %ecx
; WIN32-NEXT:    leal (%ecx,%ebx), %ebp
; WIN32-NEXT:    subl %ebx, %ecx
; WIN32-NEXT:    imull %edx, %ecx
; WIN32-NEXT:    addl %eax, %ecx
; WIN32-NEXT:    movl {{[0-9]+}}(%esp), %edx
; WIN32-NEXT:    movl {{[0-9]+}}(%esp), %ebx
; WIN32-NEXT:    leal (%ebx,%edx), %eax
; WIN32-NEXT:    subl %edx, %ebx
; WIN32-NEXT:    imull %esi, %ebx
; WIN32-NEXT:    addl %ecx, %ebx
; WIN32-NEXT:    imull {{[-0-9]+}}(%e{{[sb]}}p), %edi # 4-byte Folded Reload
; WIN32-NEXT:    imull {{[-0-9]+}}(%e{{[sb]}}p), %ebp # 4-byte Folded Reload
; WIN32-NEXT:    addl %edi, %ebp
; WIN32-NEXT:    imull (%esp), %eax # 4-byte Folded Reload
...
; LINUXOSX-NEXT:    # kill: def $ecx killed $ecx def $rcx
; LINUXOSX-NEXT:    # kill: def $esi killed $esi def $rsi
; LINUXOSX-NEXT:    # kill: def $r15d killed $r15d def $r15
...
; LINUXOSX-NEXT:    # kill: def $eax killed $eax def $rax
; LINUXOSX-NEXT:    leal (%rax,%rcx), %r10d
; LINUXOSX-NEXT:    # kill: def $eax killed $eax killed $rax
; LINUXOSX-NEXT:    subl %ecx, %eax
; LINUXOSX-NEXT:    leal (%rdx,%rdi), %ecx
...
; LINUXOSX-NEXT:    leal (%r15,%r11), %eax
; LINUXOSX-NEXT:    movl %r15d, %r8d
; LINUXOSX-NEXT:    subl %r11d, %r8d
; LINUXOSX-NEXT:    imull %esi, %r8d
; LINUXOSX-NEXT:    addl %r12d, %r8d
; LINUXOSX-NEXT:    imull %r10d, %edi
; LINUXOSX-NEXT:    imull %ecx, %r9d
; LINUXOSX-NEXT:    addl %edi, %r9d
; LINUXOSX-NEXT:    imull %edx, %eax
...
; WIN32-NEXT:    movups 120(%ebp), %xmm0
; WIN32-NEXT:    addps %xmm7, %xmm0
; WIN32-NEXT:    movups 248(%ebp), %xmm7
; WIN32-NEXT:    addps %xmm0, %xmm7
; WIN32-NEXT:    movaps %xmm7, (%esp) # 16-byte Spill
; WIN32-NEXT:    movups 104(%ebp), %xmm0
; WIN32-NEXT:    addps %xmm6, %xmm0
; WIN32-NEXT:    movups 232(%ebp), %xmm7
; WIN32-NEXT:    addps %xmm0, %xmm7
; WIN32-NEXT:    movups 88(%ebp), %xmm0
; WIN32-NEXT:    addps %xmm5, %xmm0
; WIN32-NEXT:    movups 216(%ebp), %xmm6
; WIN32-NEXT:    addps %xmm0, %xmm6
; WIN32-NEXT:    movups 72(%ebp), %xmm0
; WIN32-NEXT:    addps %xmm4, %xmm0
; WIN32-NEXT:    movups 200(%ebp), %xmm5
; WIN32-NEXT:    addps %xmm0, %xmm5
; WIN32-NEXT:    movups 56(%ebp), %xmm0
; WIN32-NEXT:    addps %xmm3, %xmm0
; WIN32-NEXT:    movups 184(%ebp), %xmm4
; WIN32-NEXT:    addps %xmm0, %xmm4
; WIN32-NEXT:    movups 40(%ebp), %xmm0
; WIN32-NEXT:    addps %xmm2, %xmm0
; WIN32-NEXT:    movups 168(%ebp), %xmm3
; WIN32-NEXT:    addps %xmm0, %xmm3
; WIN32-NEXT:    movups 24(%ebp), %xmm0
; WIN32-NEXT:    addps %xmm1, %xmm0
; WIN32-NEXT:    movups 152(%ebp), %xmm2
; WIN32-NEXT:    addps %xmm0, %xmm2
; WIN32-NEXT:    movups 8(%ebp), %xmm1
; WIN32-NEXT:    addps {{[-0-9]+}}(%e{{[sb]}}p), %xmm1 # 16-byte Folded Reload
; WIN32-NEXT:    movups 136(%ebp), %xmm0
; WIN32-NEXT:    addps %xmm1, %xmm0
...
; WIN32-NEXT:    movaps %xmm7, %xmm6
; WIN32-NEXT:    movaps (%esp), %xmm7 # 16-byte Reload
; WIN32-NEXT:    movl %ebp, %esp
; WIN32-NEXT:    popl %ebp
; WIN32-NEXT:    retl
;
...
; WIN64-NEXT:    addps %xmm0, %xmm8
; WIN64-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm9
; WIN64-NEXT:    addps %xmm1, %xmm9
; WIN64-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm10
; WIN64-NEXT:    addps %xmm2, %xmm10
; WIN64-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm11
; WIN64-NEXT:    addps %xmm3, %xmm11
; WIN64-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm12
; WIN64-NEXT:    addps %xmm4, %xmm12
; WIN64-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm13
; WIN64-NEXT:    addps %xmm5, %xmm13
; WIN64-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm14
; WIN64-NEXT:    addps %xmm6, %xmm14
; WIN64-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm15
; WIN64-NEXT:    addps %xmm7, %xmm15
; WIN64-NEXT:    movaps %xmm8, %xmm0
; WIN64-NEXT:    movaps %xmm9, %xmm1
; WIN64-NEXT:    movaps %xmm10, %xmm2
; WIN64-NEXT:    movaps %xmm11, %xmm3
; WIN64-NEXT:    movaps %xmm12, %xmm4
; WIN64-NEXT:    movaps %xmm13, %xmm5
; WIN64-NEXT:    movaps %xmm14, %xmm6
; WIN64-NEXT:    movaps %xmm15, %xmm7
; WIN64-NEXT:    popq %rax
; WIN64-NEXT:    retq
;
...
; LINUXOSX-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm8
; LINUXOSX-NEXT:    addps %xmm0, %xmm8
; LINUXOSX-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm9
; LINUXOSX-NEXT:    addps %xmm1, %xmm9
; LINUXOSX-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm10
; LINUXOSX-NEXT:    addps %xmm2, %xmm10
; LINUXOSX-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm11
; LINUXOSX-NEXT:    addps %xmm3, %xmm11
; LINUXOSX-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm12
; LINUXOSX-NEXT:    addps %xmm4, %xmm12
; LINUXOSX-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm13
; LINUXOSX-NEXT:    addps %xmm5, %xmm13
; LINUXOSX-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm14
; LINUXOSX-NEXT:    addps %xmm6, %xmm14
; LINUXOSX-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm15
; LINUXOSX-NEXT:    addps %xmm7, %xmm15
; LINUXOSX-NEXT:    movaps %xmm8, %xmm0
; LINUXOSX-NEXT:    movaps %xmm9, %xmm1
; LINUXOSX-NEXT:    movaps %xmm10, %xmm2
; LINUXOSX-NEXT:    movaps %xmm11, %xmm3
; LINUXOSX-NEXT:    movaps %xmm12, %xmm4
; LINUXOSX-NEXT:    movaps %xmm13, %xmm5
; LINUXOSX-NEXT:    movaps %xmm14, %xmm6
; LINUXOSX-NEXT:    movaps %xmm15, %xmm7
; LINUXOSX-NEXT:    retq
