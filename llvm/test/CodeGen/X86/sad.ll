...
; SSE2-NEXT:    psadbw %xmm3, %xmm4
; SSE2-NEXT:    paddd %xmm4, %xmm1
; SSE2-NEXT:    movdqa a+1040(%rax), %xmm3
; SSE2-NEXT:    movdqa b+1040(%rax), %xmm4
; SSE2-NEXT:    psadbw %xmm3, %xmm4
...
; SSE2-NEXT:    movdqu 16(%rdi), %xmm4
; SSE2-NEXT:    psadbw %xmm4, %xmm1
; SSE2-NEXT:    movdqu 32(%rdi), %xmm4
