...
; FMA:       # %bb.0:
; FMA-NEXT:    vfmadd213ss {{.*#+}} xmm1 = (xmm0 * xmm1) + xmm2
...
; FMA:       # %bb.0:
; FMA-NEXT:    vfmadd213ps {{.*#+}} xmm1 = (xmm0 * xmm1) + xmm2
; FMA-NEXT:    vmovaps %xmm1, %xmm0
; FMA-NEXT:    retq
;
...
; FMA:       # %bb.0:
; FMA-NEXT:    vfmadd213sd {{.*#+}} xmm1 = (xmm0 * xmm1) + xmm2
; FMA-NEXT:    vmovapd %xmm1, %xmm0
; FMA-NEXT:    retq
;
...
; AVX512:       # %bb.0:
; AVX512-NEXT:    vfmadd213sd {{.*#+}} xmm1 = (xmm0 * xmm1) + xmm2
...
; FMA:       # %bb.0:
; FMA-NEXT:    vfmadd213pd {{.*#+}} xmm1 = (xmm0 * xmm1) + xmm2
; FMA-NEXT:    vmovapd %xmm1, %xmm0
; FMA-NEXT:    retq
;
...
; FMA:       # %bb.0:
; FMA-NEXT:    vfmadd213pd {{.*#+}} ymm1 = (ymm0 * ymm1) + ymm2
; FMA-NEXT:    vmovapd %ymm1, %ymm0
; FMA-NEXT:    retq
;
...
; FMA:       # %bb.0:
; FMA-NEXT:    vfmsub213ss {{.*#+}} xmm1 = (xmm0 * xmm1) - xmm2
; FMA-NEXT:    vmovaps %xmm1, %xmm0
; FMA-NEXT:    retq
;
...
; AVX512:       # %bb.0:
; AVX512-NEXT:    vfmsub213ss {{.*#+}} xmm1 = (xmm0 * xmm1) - xmm2
; AVX512-NEXT:    vmovaps %xmm1, %xmm0
; AVX512-NEXT:    retq
  %x = fmul contract float %a0, %a1
...
; FMA:       # %bb.0:
; FMA-NEXT:    vfmsub213ps {{.*#+}} xmm1 = (xmm0 * xmm1) - xmm2
; FMA-NEXT:    vmovaps %xmm1, %xmm0
; FMA-NEXT:    retq
;
...
; AVX512:       # %bb.0:
; AVX512-NEXT:    vfmsub213ps {{.*#+}} xmm1 = (xmm0 * xmm1) - xmm2
; AVX512-NEXT:    vmovaps %xmm1, %xmm0
; AVX512-NEXT:    retq
  %x = fmul contract <4 x float> %a0, %a1
...
; FMA:       # %bb.0:
; FMA-NEXT:    vfmsub213ps {{.*#+}} ymm1 = (ymm0 * ymm1) - ymm2
; FMA-NEXT:    vmovaps %ymm1, %ymm0
; FMA-NEXT:    retq
;
...
; AVX512:       # %bb.0:
; AVX512-NEXT:    vfmsub213ps {{.*#+}} ymm1 = (ymm0 * ymm1) - ymm2
; AVX512-NEXT:    vmovaps %ymm1, %ymm0
; AVX512-NEXT:    retq
  %x = fmul contract <8 x float> %a0, %a1
...
; FMA:       # %bb.0:
; FMA-NEXT:    vfmsub213sd {{.*#+}} xmm1 = (xmm0 * xmm1) - xmm2
; FMA-NEXT:    vmovapd %xmm1, %xmm0
; FMA-NEXT:    retq
;
...
; AVX512:       # %bb.0:
; AVX512-NEXT:    vfmsub213sd {{.*#+}} xmm1 = (xmm0 * xmm1) - xmm2
; AVX512-NEXT:    vmovapd %xmm1, %xmm0
; AVX512-NEXT:    retq
  %x = fmul contract double %a0, %a1
...
; FMA:       # %bb.0:
; FMA-NEXT:    vfmsub213pd {{.*#+}} xmm1 = (xmm0 * xmm1) - xmm2
; FMA-NEXT:    vmovapd %xmm1, %xmm0
; FMA-NEXT:    retq
;
...
; AVX512:       # %bb.0:
; AVX512-NEXT:    vfmsub213pd {{.*#+}} xmm1 = (xmm0 * xmm1) - xmm2
; AVX512-NEXT:    vmovapd %xmm1, %xmm0
; AVX512-NEXT:    retq
  %x = fmul contract <2 x double> %a0, %a1
...
; FMA:       # %bb.0:
; FMA-NEXT:    vfmsub213pd {{.*#+}} ymm1 = (ymm0 * ymm1) - ymm2
; FMA-NEXT:    vmovapd %ymm1, %ymm0
; FMA-NEXT:    retq
;
...
; AVX512:       # %bb.0:
; AVX512-NEXT:    vfmsub213pd {{.*#+}} ymm1 = (ymm0 * ymm1) - ymm2
; AVX512-NEXT:    vmovapd %ymm1, %ymm0
; AVX512-NEXT:    retq
  %x = fmul contract <4 x double> %a0, %a1
...
; FMA:       # %bb.0:
; FMA-NEXT:    vfnmadd213ss {{.*#+}} xmm1 = -(xmm0 * xmm1) + xmm2
; FMA-NEXT:    vmovaps %xmm1, %xmm0
; FMA-NEXT:    retq
;
...
; AVX512:       # %bb.0:
; AVX512-NEXT:    vfnmadd213ss {{.*#+}} xmm1 = -(xmm0 * xmm1) + xmm2
; AVX512-NEXT:    vmovaps %xmm1, %xmm0
; AVX512-NEXT:    retq
  %x = fmul contract float %a0, %a1
...
; FMA:       # %bb.0:
; FMA-NEXT:    vfnmadd213ps {{.*#+}} xmm1 = -(xmm0 * xmm1) + xmm2
; FMA-NEXT:    vmovaps %xmm1, %xmm0
; FMA-NEXT:    retq
;
...
; AVX512:       # %bb.0:
; AVX512-NEXT:    vfnmadd213ps {{.*#+}} xmm1 = -(xmm0 * xmm1) + xmm2
; AVX512-NEXT:    vmovaps %xmm1, %xmm0
; AVX512-NEXT:    retq
  %x = fmul contract <4 x float> %a0, %a1
...
; FMA:       # %bb.0:
; FMA-NEXT:    vfnmadd213ps {{.*#+}} ymm1 = -(ymm0 * ymm1) + ymm2
; FMA-NEXT:    vmovaps %ymm1, %ymm0
; FMA-NEXT:    retq
;
...
; AVX512:       # %bb.0:
; AVX512-NEXT:    vfnmadd213ps {{.*#+}} ymm1 = -(ymm0 * ymm1) + ymm2
; AVX512-NEXT:    vmovaps %ymm1, %ymm0
; AVX512-NEXT:    retq
  %x = fmul contract <8 x float> %a0, %a1
...
; FMA:       # %bb.0:
; FMA-NEXT:    vfnmadd213sd {{.*#+}} xmm1 = -(xmm0 * xmm1) + xmm2
; FMA-NEXT:    vmovapd %xmm1, %xmm0
; FMA-NEXT:    retq
;
...
; AVX512:       # %bb.0:
; AVX512-NEXT:    vfnmadd213sd {{.*#+}} xmm1 = -(xmm0 * xmm1) + xmm2
; AVX512-NEXT:    vmovapd %xmm1, %xmm0
; AVX512-NEXT:    retq
  %x = fmul contract double %a0, %a1
...
; FMA:       # %bb.0:
; FMA-NEXT:    vfnmadd213pd {{.*#+}} xmm1 = -(xmm0 * xmm1) + xmm2
; FMA-NEXT:    vmovapd %xmm1, %xmm0
; FMA-NEXT:    retq
;
...
; AVX512:       # %bb.0:
; AVX512-NEXT:    vfnmadd213pd {{.*#+}} xmm1 = -(xmm0 * xmm1) + xmm2
; AVX512-NEXT:    vmovapd %xmm1, %xmm0
; AVX512-NEXT:    retq
  %x = fmul contract <2 x double> %a0, %a1
...
; FMA:       # %bb.0:
; FMA-NEXT:    vfnmadd213pd {{.*#+}} ymm1 = -(ymm0 * ymm1) + ymm2
; FMA-NEXT:    vmovapd %ymm1, %ymm0
; FMA-NEXT:    retq
;
...
; AVX512:       # %bb.0:
; AVX512-NEXT:    vfnmadd213pd {{.*#+}} ymm1 = -(ymm0 * ymm1) + ymm2
; AVX512-NEXT:    vmovapd %ymm1, %ymm0
; AVX512-NEXT:    retq
  %x = fmul contract <4 x double> %a0, %a1
...
; FMA:       # %bb.0:
; FMA-NEXT:    vfnmsub213ss {{.*#+}} xmm1 = -(xmm0 * xmm1) - xmm2
; FMA-NEXT:    vmovaps %xmm1, %xmm0
; FMA-NEXT:    retq
;
...
; AVX512:       # %bb.0:
; AVX512-NEXT:    vfnmsub213ss {{.*#+}} xmm1 = -(xmm0 * xmm1) - xmm2
; AVX512-NEXT:    vmovaps %xmm1, %xmm0
; AVX512-NEXT:    retq
  %x = fmul contract float %a0, %a1
...
; FMA:       # %bb.0:
; FMA-NEXT:    vfnmsub213ps {{.*#+}} xmm1 = -(xmm0 * xmm1) - xmm2
; FMA-NEXT:    vmovaps %xmm1, %xmm0
; FMA-NEXT:    retq
;
...
; AVX512:       # %bb.0:
; AVX512-NEXT:    vfnmsub213ps {{.*#+}} xmm1 = -(xmm0 * xmm1) - xmm2
; AVX512-NEXT:    vmovaps %xmm1, %xmm0
; AVX512-NEXT:    retq
  %x = fmul contract <4 x float> %a0, %a1
...
; FMA:       # %bb.0:
; FMA-NEXT:    vfnmsub213ps {{.*#+}} ymm1 = -(ymm0 * ymm1) - ymm2
; FMA-NEXT:    vmovaps %ymm1, %ymm0
; FMA-NEXT:    retq
;
...
; AVX512:       # %bb.0:
; AVX512-NEXT:    vfnmsub213ps {{.*#+}} ymm1 = -(ymm0 * ymm1) - ymm2
; AVX512-NEXT:    vmovaps %ymm1, %ymm0
; AVX512-NEXT:    retq
  %x = fmul contract <8 x float> %a0, %a1
...
; FMA:       # %bb.0:
; FMA-NEXT:    vfnmsub213sd {{.*#+}} xmm1 = -(xmm0 * xmm1) - xmm2
; FMA-NEXT:    vmovapd %xmm1, %xmm0
; FMA-NEXT:    retq
;
...
; AVX512:       # %bb.0:
; AVX512-NEXT:    vfnmsub213sd {{.*#+}} xmm1 = -(xmm0 * xmm1) - xmm2
; AVX512-NEXT:    vmovapd %xmm1, %xmm0
; AVX512-NEXT:    retq
  %x = fmul contract double %a0, %a1
...
; FMA:       # %bb.0:
; FMA-NEXT:    vfnmsub213pd {{.*#+}} xmm1 = -(xmm0 * xmm1) - xmm2
; FMA-NEXT:    vmovapd %xmm1, %xmm0
; FMA-NEXT:    retq
;
...
; AVX512:       # %bb.0:
; AVX512-NEXT:    vfnmsub213pd {{.*#+}} xmm1 = -(xmm0 * xmm1) - xmm2
; AVX512-NEXT:    vmovapd %xmm1, %xmm0
; AVX512-NEXT:    retq
  %x = fmul contract <2 x double> %a0, %a1
...
; FMA:       # %bb.0:
; FMA-NEXT:    vfnmsub213pd {{.*#+}} ymm1 = -(ymm0 * ymm1) - ymm2
; FMA-NEXT:    vmovapd %ymm1, %ymm0
; FMA-NEXT:    retq
;
...
; AVX512:       # %bb.0:
; AVX512-NEXT:    vfnmsub213pd {{.*#+}} ymm1 = -(ymm0 * ymm1) - ymm2
; AVX512-NEXT:    vmovapd %ymm1, %ymm0
; AVX512-NEXT:    retq
  %x = fmul contract <4 x double> %a0, %a1
...
; FMA:       # %bb.0:
; FMA-NEXT:    vmovaps (%rdi), %xmm2
; FMA-NEXT:    vfmadd132ps {{.*#+}} xmm2 = (xmm2 * xmm0) + xmm1
; FMA-NEXT:    vmovaps %xmm2, %xmm0
; FMA-NEXT:    retq
;
...
; AVX512-NEXT:    vfmadd132ps {{.*#+}} xmm2 = (xmm2 * xmm0) + xmm1
...
; FMA:       # %bb.0:
; FMA-NEXT:    vmovapd (%rdi), %xmm2
; FMA-NEXT:    vfmsub132pd {{.*#+}} xmm2 = (xmm2 * xmm0) - xmm1
...
; AVX512-NEXT:    vfmsub132pd {{.*#+}} xmm2 = (xmm2 * xmm0) - xmm1
...
; FMA:       # %bb.0:
; FMA-NEXT:    vfmadd213ps {{.*#+}} xmm1 = (xmm0 * xmm1) + xmm1
; FMA-NEXT:    vmovaps %xmm1, %xmm0
; FMA-NEXT:    retq
;
...
; FMA:       # %bb.0:
; FMA-NEXT:    vfmsub213ps {{.*#+}} xmm1 = (xmm0 * xmm1) - xmm1
; FMA-NEXT:    vmovaps %xmm1, %xmm0
; FMA-NEXT:    retq
;
...
; AVX512:       # %bb.0:
; AVX512-NEXT:    vfmsub213ps {{.*#+}} xmm1 = (xmm0 * xmm1) - xmm1
; AVX512-NEXT:    vmovaps %xmm1, %xmm0
; AVX512-NEXT:    retq
  %a = fadd contract ninf<4 x float> %x, <float -1.0, float -1.0, float -1.0, float -1.0>
  %m = fmul contract ninf<4 x float> %a, %y
...
; FMA:       # %bb.0:
; FMA-NEXT:    vfnmadd213ps {{.*#+}} xmm1 = -(xmm0 * xmm1) + xmm1
; FMA-NEXT:    vmovaps %xmm1, %xmm0
; FMA-NEXT:    retq
;
...
; AVX512:       # %bb.0:
; AVX512-NEXT:    vfnmadd213ps {{.*#+}} xmm1 = -(xmm0 * xmm1) + xmm1
; AVX512-NEXT:    vmovaps %xmm1, %xmm0
; AVX512-NEXT:    retq
  %s = fsub contract ninf<4 x float> <float 1.0, float 1.0, float 1.0, float 1.0>, %x
...
; FMA:       # %bb.0:
; FMA-NEXT:    vfnmsub213ps {{.*#+}} xmm1 = -(xmm0 * xmm1) - xmm1
; FMA-NEXT:    vmovaps %xmm1, %xmm0
; FMA-NEXT:    retq
;
...
; AVX512:       # %bb.0:
; AVX512-NEXT:    vfnmsub213ps {{.*#+}} xmm1 = -(xmm0 * xmm1) - xmm1
; AVX512-NEXT:    vmovaps %xmm1, %xmm0
; AVX512-NEXT:    retq
  %s = fsub contract ninf<4 x float> <float -1.0, float -1.0, float -1.0, float -1.0>, %x
  %m = fmul contract ninf<4 x float> %y, %s
...
; FMA-NEXT:    vfmadd231ss {{.*#+}} xmm1 = (xmm0 * xmm2) + xmm1
; FMA-NEXT:    vmovaps %xmm1, %xmm0
; FMA-NEXT:    retq
;
...
; AVX512-NEXT:    vfmadd231ss {{.*#+}} xmm1 = (xmm0 * xmm2) + xmm1
; AVX512-NEXT:    vmovaps %xmm1, %xmm0
; AVX512-NEXT:    retq
...
; FMA-NEXT:    vfmsub231ss {{.*#+}} xmm1 = (xmm0 * xmm2) - xmm1
; FMA-NEXT:    vmovaps %xmm1, %xmm0
; FMA-NEXT:    retq
;
...
; FMA-NEXT:    vfmadd231ps {{.*#+}} xmm1 = (xmm0 * xmm2) + xmm1
; FMA-NEXT:    vmovaps %xmm1, %xmm0
; FMA-NEXT:    retq
;
...
; AVX512-NEXT:    vfmadd231ps {{.*#+}} xmm1 = (xmm0 * xmm2) + xmm1
; AVX512-NEXT:    vmovaps %xmm1, %xmm0
; AVX512-NEXT:    retq
...
; FMA-NEXT:    vfmsub231ps {{.*#+}} xmm1 = (xmm0 * xmm2) - xmm1
; FMA-NEXT:    vmovaps %xmm1, %xmm0
; FMA-NEXT:    retq
;
...
; FMA-NEXT:    vfmadd231ps {{.*#+}} ymm1 = (ymm0 * ymm2) + ymm1
; FMA-NEXT:    vmovaps %ymm1, %ymm0
; FMA-NEXT:    retq
;
...
; AVX512-NEXT:    vfmadd231ps {{.*#+}} ymm1 = (ymm0 * ymm2) + ymm1
; AVX512-NEXT:    vmovaps %ymm1, %ymm0
; AVX512-NEXT:    retq
...
; FMA-NEXT:    vfmsub231ps {{.*#+}} ymm1 = (ymm0 * ymm2) - ymm1
; FMA-NEXT:    vmovaps %ymm1, %ymm0
; FMA-NEXT:    retq
;
...
; FMA-NEXT:    vfmadd231sd {{.*#+}} xmm1 = (xmm0 * xmm2) + xmm1
; FMA-NEXT:    vmovapd %xmm1, %xmm0
; FMA-NEXT:    retq
;
...
; AVX512-NEXT:    vfmadd231sd {{.*#+}} xmm1 = (xmm0 * xmm2) + xmm1
; AVX512-NEXT:    vmovapd %xmm1, %xmm0
; AVX512-NEXT:    retq
...
; FMA-NEXT:    vfmsub231sd {{.*#+}} xmm1 = (xmm0 * xmm2) - xmm1
; FMA-NEXT:    vmovapd %xmm1, %xmm0
; FMA-NEXT:    retq
;
...
; AVX512-NEXT:    vfmsub231sd {{.*#+}} xmm1 = (xmm0 * xmm2) - xmm1
; AVX512-NEXT:    vmovapd %xmm1, %xmm0
; AVX512-NEXT:    retq
...
; FMA-NEXT:    vfmadd231pd {{.*#+}} xmm1 = (xmm0 * xmm2) + xmm1
; FMA-NEXT:    vmovapd %xmm1, %xmm0
; FMA-NEXT:    retq
;
...
; AVX512-NEXT:    vfmadd231pd {{.*#+}} xmm1 = (xmm0 * xmm2) + xmm1
; AVX512-NEXT:    vmovapd %xmm1, %xmm0
; AVX512-NEXT:    retq
...
; FMA-NEXT:    vfmsub231pd {{.*#+}} xmm1 = (xmm0 * xmm2) - xmm1
; FMA-NEXT:    vmovapd %xmm1, %xmm0
; FMA-NEXT:    retq
;
...
; AVX512-NEXT:    vfmsub231pd {{.*#+}} xmm1 = (xmm0 * xmm2) - xmm1
; AVX512-NEXT:    vmovapd %xmm1, %xmm0
; AVX512-NEXT:    retq
...
; FMA-NEXT:    vfmadd231pd {{.*#+}} ymm1 = (ymm0 * ymm2) + ymm1
; FMA-NEXT:    vmovapd %ymm1, %ymm0
; FMA-NEXT:    retq
;
...
; AVX512-NEXT:    vfmadd231pd {{.*#+}} ymm1 = (ymm0 * ymm2) + ymm1
; AVX512-NEXT:    vmovapd %ymm1, %ymm0
; AVX512-NEXT:    retq
...
; FMA-NEXT:    vfmsub231pd {{.*#+}} ymm1 = (ymm0 * ymm2) - ymm1
; FMA-NEXT:    vmovapd %ymm1, %ymm0
; FMA-NEXT:    retq
;
...
; AVX512-NEXT:    vfmsub231pd {{.*#+}} ymm1 = (ymm0 * ymm2) - ymm1
; AVX512-NEXT:    vmovapd %ymm1, %ymm0
; AVX512-NEXT:    retq
...
; FMA:       # %bb.0:
; FMA-NEXT:    vmovaps {{.*#+}} xmm2 = [4.0E+0,6.0E+0,6.0E+0,4.0E+0]
; FMA-NEXT:    vfmadd213ps {{.*#+}} xmm2 = (xmm0 * xmm2) + xmm1
; FMA-NEXT:    vmovaps %xmm2, %xmm0
; FMA-NEXT:    retq
;
...
; AVX512:       # %bb.0:
; AVX512-NEXT:    vmovaps {{.*#+}} xmm2 = [4.0E+0,6.0E+0,6.0E+0,4.0E+0]
; AVX512-NEXT:    vfmadd213ps {{.*#+}} xmm2 = (xmm0 * xmm2) + xmm1
; AVX512-NEXT:    vmovaps %xmm2, %xmm0
; AVX512-NEXT:    retq
  %m0 = fmul contract reassoc <4 x float> %x,  <float 1.0, float 2.0, float 3.0, float 4.0>
...
; FMA-NEXT:    vfnmsub231sd {{.*#+}} xmm2 = -(xmm0 * xmm1) - xmm2
; FMA-NEXT:    vmovapd %xmm2, %xmm0
; FMA-NEXT:    retq
;
...
; AVX512-NEXT:    vfnmsub231sd {{.*#+}} xmm2 = -(xmm0 * xmm1) - xmm2
; AVX512-NEXT:    vmovapd %xmm2, %xmm0
; AVX512-NEXT:    retq
...
; FMA-NEXT:    vfnmsub231ps {{.*#+}} xmm2 = -(xmm0 * xmm1) - xmm2
; FMA-NEXT:    vmovaps %xmm2, %xmm0
; FMA-NEXT:    retq
;
...
; AVX512-NEXT:    vfnmsub231ps {{.*#+}} xmm2 = -(xmm0 * xmm1) - xmm2
; AVX512-NEXT:    vmovaps %xmm2, %xmm0
; AVX512-NEXT:    retq
...
; FMA:       # %bb.0:
; FMA-NEXT:    vxorpd %xmm2, %xmm2, %xmm2
; FMA-NEXT:    vfnmsub231pd {{.*#+}} ymm2 = -(ymm0 * ymm1) - ymm2
; FMA-NEXT:    vmovapd %ymm2, %ymm0
; FMA-NEXT:    retq
;
...
; AVX512:       # %bb.0:
; AVX512-NEXT:    vxorpd %xmm2, %xmm2, %xmm2
; AVX512-NEXT:    vfnmsub231pd {{.*#+}} ymm2 = -(ymm0 * ymm1) - ymm2
; AVX512-NEXT:    vmovapd %ymm2, %ymm0
; AVX512-NEXT:    retq
...
; FMA:       # %bb.0:
; FMA-NEXT:    vfmadd213sd {{.*#+}} xmm3 = (xmm2 * xmm3) + xmm4
; FMA-NEXT:    vfmadd231sd {{.*#+}} xmm3 = (xmm0 * xmm1) + xmm3
; FMA-NEXT:    vmovapd %xmm3, %xmm0
; FMA-NEXT:    retq
;
...
; AVX512:       # %bb.0:
; AVX512-NEXT:    vfmadd213sd {{.*#+}} xmm3 = (xmm2 * xmm3) + xmm4
; AVX512-NEXT:    vfmadd231sd {{.*#+}} xmm3 = (xmm0 * xmm1) + xmm3
...
; FMA:       # %bb.0:
; FMA-NEXT:    vfmadd213ss {{.*#+}} xmm3 = (xmm2 * xmm3) + xmm4
; FMA-NEXT:    vfmadd231ss {{.*#+}} xmm3 = (xmm0 * xmm1) + xmm3
; FMA-NEXT:    vmovaps %xmm3, %xmm0
; FMA-NEXT:    retq
;
...
; AVX512:       # %bb.0:
; AVX512-NEXT:    vfmadd213ss {{.*#+}} xmm3 = (xmm2 * xmm3) + xmm4
; AVX512-NEXT:    vfmadd231ss {{.*#+}} xmm3 = (xmm0 * xmm1) + xmm3
...
; FMA-NEXT:    vfmadd231ss {{.*#+}} xmm2 = (xmm0 * xmm1) + xmm2
...
; FMA-NEXT:    vfmadd231pd {{.*#+}} xmm2 = (xmm0 * xmm1) + xmm2
; FMA-NEXT:    vfmadd231pd {{.*#+}} xmm2 = (xmm6 * xmm7) + xmm2
; FMA-NEXT:    vfmadd231pd {{.*#+}} xmm2 = (xmm4 * xmm5) + xmm2
; FMA-NEXT:    vmovapd %xmm2, %xmm0
; FMA-NEXT:    retq
;
...
; AVX512-NEXT:    vfmadd231pd {{.*#+}} xmm2 = (xmm0 * xmm1) + xmm2
; AVX512-NEXT:    vfmadd231pd {{.*#+}} xmm2 = (xmm6 * xmm7) + xmm2
; AVX512-NEXT:    vfmadd231pd {{.*#+}} xmm2 = (xmm4 * xmm5) + xmm2
; AVX512-NEXT:    vmovapd %xmm2, %xmm0
; AVX512-NEXT:    retq
...
; FMA-NEXT:    vfmadd213ss {{.*#+}} xmm3 = (xmm2 * xmm3) + xmm0
; FMA-NEXT:    vaddss %xmm3, %xmm4, %xmm0
; FMA-NEXT:    retq
;
...
; AVX512-NEXT:    vfmadd213ss {{.*#+}} xmm3 = (xmm2 * xmm3) + xmm0
; AVX512-NEXT:    vaddss %xmm3, %xmm4, %xmm0
; AVX512-NEXT:    retq
...
; FMA-NEXT:    vfmadd213ss {{.*#+}} xmm1 = (xmm0 * xmm1) + xmm2
; FMA-NEXT:    vaddss %xmm1, %xmm4, %xmm0
; FMA-NEXT:    retq
;
...
; AVX512-NEXT:    vfmadd213ss {{.*#+}} xmm1 = (xmm0 * xmm1) + xmm2
; AVX512-NEXT:    vaddss %xmm1, %xmm4, %xmm0
; AVX512-NEXT:    retq
  %m1 = fmul contract fast float %a, %b
  %m2 = fmul contract fast float %c, %d
