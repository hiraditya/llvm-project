...
; CHECK-NEXT:    vmovss {{.*#+}} xmm1 = [2.5E+0,0.0E+0,0.0E+0,0.0E+0]
...
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    vmovapd {{.*#+}} xmm0 = [1.5E+0,5.0E-1]
; CHECK-NEXT:    vmovapd {{.*#+}} xmm1 = [3.5E+0,2.5E+0]
...
; CHECK-NEXT:    vfmadd213ss {{.*#+}} xmm1 = (xmm2 * xmm1) + mem
; CHECK-NEXT:    vmovss {{.*#+}} xmm2 = [1.5E+0,0.0E+0,0.0E+0,0.0E+0]
; CHECK-NEXT:    vmovss {{.*#+}} xmm3 = [4.5E+0,0.0E+0,0.0E+0,0.0E+0]
; CHECK-NEXT:    vfmadd213ss {{.*#+}} xmm2 = (xmm3 * xmm2) + mem
; CHECK-NEXT:    vinsertps {{.*#+}} xmm1 = xmm1[0],xmm2[0],xmm1[2,3]
...
; CHECK-NEXT:    vmovapd {{.*#+}} xmm1 = [2.5E+0,1.5E+0]
; CHECK-NEXT:    vmovapd {{.*#+}} xmm2 = [5.5E+0,4.5E+0]
; CHECK-NEXT:    vfmadd213pd {{.*#+}} xmm1 = (xmm2 * xmm1) + mem
...
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    vmovapd {{.*#+}} ymm0 = [3.5E+0,2.5E+0,1.5E+0,5.0E-1]
; CHECK-NEXT:    vmovapd {{.*#+}} ymm1 = [7.5E+0,6.5E+0,5.5E+0,4.5E+0]
...
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    vmovaps {{.*#+}} xmm0 = [3.5E+0,2.5E+0,1.5E+0,5.0E-1]
; CHECK-NEXT:    vmovaps {{.*#+}} xmm1 = [7.5E+0,6.5E+0,5.5E+0,4.5E+0]
...
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    vmovaps {{.*#+}} ymm0 = [3.5E+0,2.5E+0,1.5E+0,5.0E-1,7.5E+0,6.5E+0,5.5E+0,4.5E+0]
; CHECK-NEXT:    vmovaps {{.*#+}} ymm1 = [7.5E+0,6.5E+0,5.5E+0,4.5E+0,1.15E+1,1.05E+1,9.5E+0,8.5E+0]
