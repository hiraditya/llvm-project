...
; SSE2-NEXT:    pshufd {{.*#+}} xmm8 = xmm2[0,0,0,0]
...
; SSSE3-NEXT:    pshufd {{.*#+}} xmm8 = xmm2[0,0,0,0]
...
; SSE41-NEXT:    pmuludq %xmm9, %xmm8
; SSE41-NEXT:    pblendw {{.*#+}} xmm8 = xmm7[0,1],xmm8[2,3],xmm7[4,5],xmm8[6,7]
...
; SSE2-NEXT:    pshufd {{.*#+}} xmm1 = xmm8[1,3,2,3]
; SSE2-NEXT:    pshufd {{.*#+}} xmm3 = xmm3[1,1,3,3]
; SSE2-NEXT:    pmuludq %xmm7, %xmm3
; SSE2-NEXT:    pshufd {{.*#+}} xmm7 = xmm3[1,3,2,3]
...
; SSE2-NEXT:    punpckldq {{.*#+}} xmm4 = xmm4[0],xmm2[0],xmm4[1],xmm2[1]
; SSE2-NEXT:    pshufd {{.*#+}} xmm2 = xmm8[0,2,2,3]
...
; SSSE3-NEXT:    pmuludq %xmm3, %xmm8
; SSSE3-NEXT:    pshufd {{.*#+}} xmm1 = xmm8[1,3,2,3]
; SSSE3-NEXT:    pshufd {{.*#+}} xmm3 = xmm3[1,1,3,3]
; SSSE3-NEXT:    pmuludq %xmm7, %xmm3
; SSSE3-NEXT:    pshufd {{.*#+}} xmm7 = xmm3[1,3,2,3]
; SSSE3-NEXT:    punpckldq {{.*#+}} xmm1 = xmm1[0],xmm7[0],xmm1[1],xmm7[1]
; SSSE3-NEXT:    pcmpeqd %xmm5, %xmm1
; SSSE3-NEXT:    pxor %xmm6, %xmm1
; SSSE3-NEXT:    pshufd {{.*#+}} xmm4 = xmm4[0,2,2,3]
; SSSE3-NEXT:    pshufd {{.*#+}} xmm2 = xmm2[0,2,2,3]
; SSSE3-NEXT:    punpckldq {{.*#+}} xmm4 = xmm4[0],xmm2[0],xmm4[1],xmm2[1]
; SSSE3-NEXT:    pshufd {{.*#+}} xmm2 = xmm8[0,2,2,3]
...
; SSE41-NEXT:    pshufd {{.*#+}} xmm5 = xmm5[1,1,3,3]
; SSE41-NEXT:    pblendw {{.*#+}} xmm0 = xmm5[0,1],xmm0[2,3],xmm5[4,5],xmm0[6,7]
...
; SSE2-NEXT:    pshufd {{.*#+}} xmm1 = xmm11[1,3,2,3]
...
; SSE2-NEXT:    pmuludq %xmm6, %xmm12
; SSE2-NEXT:    pshufd {{.*#+}} xmm2 = xmm12[1,3,2,3]
; SSE2-NEXT:    pshufd {{.*#+}} xmm6 = xmm6[1,1,3,3]
; SSE2-NEXT:    pmuludq %xmm13, %xmm6
; SSE2-NEXT:    pshufd {{.*#+}} xmm13 = xmm6[1,3,2,3]
...
; SSE2-NEXT:    pmuludq %xmm7, %xmm14
; SSE2-NEXT:    pshufd {{.*#+}} xmm3 = xmm14[1,3,2,3]
; SSE2-NEXT:    pshufd {{.*#+}} xmm7 = xmm7[1,1,3,3]
; SSE2-NEXT:    pmuludq %xmm13, %xmm7
; SSE2-NEXT:    pshufd {{.*#+}} xmm13 = xmm7[1,3,2,3]
; SSE2-NEXT:    punpckldq {{.*#+}} xmm3 = xmm3[0],xmm13[0],xmm3[1],xmm13[1]
...
; SSSE3-NEXT:    pshufd {{.*#+}} xmm1 = xmm11[1,3,2,3]
; SSSE3-NEXT:    pshufd {{.*#+}} xmm5 = xmm5[1,1,3,3]
; SSSE3-NEXT:    pmuludq %xmm12, %xmm5
; SSSE3-NEXT:    pshufd {{.*#+}} xmm12 = xmm5[1,3,2,3]
...
; SSSE3-NEXT:    pmuludq %xmm6, %xmm12
; SSSE3-NEXT:    pshufd {{.*#+}} xmm2 = xmm12[1,3,2,3]
; SSSE3-NEXT:    pshufd {{.*#+}} xmm6 = xmm6[1,1,3,3]
; SSSE3-NEXT:    pmuludq %xmm13, %xmm6
; SSSE3-NEXT:    pshufd {{.*#+}} xmm13 = xmm6[1,3,2,3]
...
; SSSE3-NEXT:    pmuludq %xmm7, %xmm14
; SSSE3-NEXT:    pshufd {{.*#+}} xmm3 = xmm14[1,3,2,3]
; SSSE3-NEXT:    pshufd {{.*#+}} xmm7 = xmm7[1,1,3,3]
; SSSE3-NEXT:    pmuludq %xmm13, %xmm7
; SSSE3-NEXT:    pshufd {{.*#+}} xmm13 = xmm7[1,3,2,3]
; SSSE3-NEXT:    punpckldq {{.*#+}} xmm3 = xmm3[0],xmm13[0],xmm3[1],xmm13[1]
...
; SSE41-NEXT:    pmuludq %xmm9, %xmm0
; SSE41-NEXT:    movdqa %xmm8, %xmm9
; SSE41-NEXT:    pmuludq %xmm4, %xmm9
; SSE41-NEXT:    pshufd {{.*#+}} xmm9 = xmm9[1,1,3,3]
; SSE41-NEXT:    pblendw {{.*#+}} xmm0 = xmm9[0,1],xmm0[2,3],xmm9[4,5],xmm0[6,7]
...
; SSE41-NEXT:    pmuludq %xmm10, %xmm9
; SSE41-NEXT:    movdqa %xmm1, %xmm10
; SSE41-NEXT:    pmuludq %xmm5, %xmm10
; SSE41-NEXT:    pshufd {{.*#+}} xmm10 = xmm10[1,1,3,3]
; SSE41-NEXT:    pblendw {{.*#+}} xmm9 = xmm10[0,1],xmm9[2,3],xmm10[4,5],xmm9[6,7]
...
; SSE41-NEXT:    pmuludq %xmm11, %xmm10
; SSE41-NEXT:    movdqa %xmm2, %xmm11
; SSE41-NEXT:    pmuludq %xmm6, %xmm11
; SSE41-NEXT:    pshufd {{.*#+}} xmm11 = xmm11[1,1,3,3]
; SSE41-NEXT:    pblendw {{.*#+}} xmm10 = xmm11[0,1],xmm10[2,3],xmm11[4,5],xmm10[6,7]
...
; SSE41-NEXT:    pmuludq %xmm14, %xmm11
; SSE41-NEXT:    movdqa %xmm3, %xmm14
; SSE41-NEXT:    pmuludq %xmm7, %xmm14
; SSE41-NEXT:    pshufd {{.*#+}} xmm14 = xmm14[1,1,3,3]
; SSE41-NEXT:    pblendw {{.*#+}} xmm11 = xmm14[0,1],xmm11[2,3],xmm14[4,5],xmm11[6,7]
; SSE41-NEXT:    pcmpeqd %xmm12, %xmm11
; SSE41-NEXT:    pxor %xmm13, %xmm11
; SSE41-NEXT:    pmulld %xmm4, %xmm8
...
; SSE41-NEXT:    pshufd {{.*#+}} xmm1 = xmm5[1,1,1,1]
...
; SSE41-NEXT:    pshufd {{.*#+}} xmm2 = xmm5[2,3,2,3]
...
; SSE41-NEXT:    pshufd {{.*#+}} xmm3 = xmm5[3,3,3,3]
...
; SSSE3-NEXT:    punpckhbw {{.*#+}} xmm5 = xmm5[8],xmm4[8],xmm5[9],xmm4[9],xmm5[10],xmm4[10],xmm5[11],xmm4[11],xmm5[12],xmm4[12],xmm5[13],xmm4[13],xmm5[14],xmm4[14],xmm5[15],xmm4[15]
...
; SSSE3-NEXT:    pmullw %xmm0, %xmm2
; SSSE3-NEXT:    movdqa %xmm2, %xmm0
; SSSE3-NEXT:    pand %xmm6, %xmm0
; SSSE3-NEXT:    packuswb %xmm7, %xmm0
; SSSE3-NEXT:    movdqa %xmm3, %xmm7
; SSSE3-NEXT:    punpckhbw {{.*#+}} xmm7 = xmm7[8],xmm4[8],xmm7[9],xmm4[9],xmm7[10],xmm4[10],xmm7[11],xmm4[11],xmm7[12],xmm4[12],xmm7[13],xmm4[13],xmm7[14],xmm4[14],xmm7[15],xmm4[15]
; SSSE3-NEXT:    movdqa %xmm1, %xmm8
...
; SSE41-NEXT:    punpckhbw {{.*#+}} xmm6 = xmm6[8],xmm5[8],xmm6[9],xmm5[9],xmm6[10],xmm5[10],xmm6[11],xmm5[11],xmm6[12],xmm5[12],xmm6[13],xmm5[13],xmm6[14],xmm5[14],xmm6[15],xmm5[15]
...
; SSE41-NEXT:    pshufd {{.*#+}} xmm7 = xmm2[1,1,1,1]
...
; SSE41-NEXT:    pshufd {{.*#+}} xmm8 = xmm2[2,3,2,3]
...
; SSE41-NEXT:    pshufd {{.*#+}} xmm9 = xmm2[3,3,3,3]
...
; SSE2-NEXT:    pcmpeqb %xmm9, %xmm7
; SSE2-NEXT:    pcmpeqb %xmm9, %xmm6
; SSE2-NEXT:    pcmpeqb %xmm9, %xmm5
; SSE2-NEXT:    pcmpeqb %xmm9, %xmm4
...
; SSE2-NEXT:    movdqa %xmm10, 224(%rdi)
; SSE2-NEXT:    punpckhwd {{.*#+}} xmm4 = xmm4[4,4,5,5,6,6,7,7]
; SSE2-NEXT:    pslld $31, %xmm4
; SSE2-NEXT:    psrad $31, %xmm4
...
; SSSE3-NEXT:    pmullw %xmm2, %xmm6
; SSSE3-NEXT:    movdqa %xmm6, %xmm8
; SSSE3-NEXT:    pand %xmm12, %xmm8
; SSSE3-NEXT:    packuswb %xmm14, %xmm8
; SSSE3-NEXT:    movdqa %xmm7, %xmm2
; SSSE3-NEXT:    punpckhbw {{.*#+}} xmm2 = xmm2[8],xmm9[8],xmm2[9],xmm9[9],xmm2[10],xmm9[10],xmm2[11],xmm9[11],xmm2[12],xmm9[12],xmm2[13],xmm9[13],xmm2[14],xmm9[14],xmm2[15],xmm9[15]
; SSSE3-NEXT:    movdqa %xmm3, %xmm14
...
; SSSE3-NEXT:    psrlw $8, %xmm5
; SSSE3-NEXT:    packuswb %xmm11, %xmm5
; SSSE3-NEXT:    psrlw $8, %xmm10
; SSSE3-NEXT:    psrlw $8, %xmm4
; SSSE3-NEXT:    packuswb %xmm10, %xmm4
; SSSE3-NEXT:    pcmpeqb %xmm9, %xmm7
; SSSE3-NEXT:    pcmpeqb %xmm9, %xmm6
; SSSE3-NEXT:    pcmpeqb %xmm9, %xmm5
; SSSE3-NEXT:    pcmpeqb %xmm9, %xmm4
...
; SSSE3-NEXT:    punpcklwd {{.*#+}} xmm6 = xmm6[0,0,1,1,2,2,3,3]
; SSSE3-NEXT:    movdqa %xmm6, 128(%rdi)
; SSSE3-NEXT:    movdqa %xmm5, %xmm1
...
; SSSE3-NEXT:    punpcklwd {{.*#+}} xmm10 = xmm10[0,0,1,1,2,2,3,3]
; SSSE3-NEXT:    pslld $31, %xmm10
; SSSE3-NEXT:    psrad $31, %xmm10
; SSSE3-NEXT:    movdqa %xmm10, 224(%rdi)
; SSSE3-NEXT:    punpckhwd {{.*#+}} xmm4 = xmm4[4,4,5,5,6,6,7,7]
; SSSE3-NEXT:    pslld $31, %xmm4
; SSSE3-NEXT:    psrad $31, %xmm4
...
; SSSE3-NEXT:    pslld $31, %xmm7
; SSSE3-NEXT:    psrad $31, %xmm7
; SSSE3-NEXT:    movdqa %xmm7, 160(%rdi)
; SSSE3-NEXT:    punpckhwd {{.*#+}} xmm4 = xmm4[4,4,5,5,6,6,7,7]
; SSSE3-NEXT:    pslld $31, %xmm4
; SSSE3-NEXT:    psrad $31, %xmm4
...
; SSE41-NEXT:    pmovzxbw {{.*#+}} xmm8 = xmm4[0],zero,xmm4[1],zero,xmm4[2],zero,xmm4[3],zero,xmm4[4],zero,xmm4[5],zero,xmm4[6],zero,xmm4[7],zero
; SSE41-NEXT:    movdqa %xmm4, %xmm10
; SSE41-NEXT:    punpckhbw {{.*#+}} xmm10 = xmm10[8],xmm9[8],xmm10[9],xmm9[9],xmm10[10],xmm9[10],xmm10[11],xmm9[11],xmm10[12],xmm9[12],xmm10[13],xmm9[13],xmm10[14],xmm9[14],xmm10[15],xmm9[15]
; SSE41-NEXT:    pmovzxbw {{.*#+}} xmm4 = xmm0[0],zero,xmm0[1],zero,xmm0[2],zero,xmm0[3],zero,xmm0[4],zero,xmm0[5],zero,xmm0[6],zero,xmm0[7],zero
...
; SSE41-NEXT:    pmullw %xmm0, %xmm10
; SSE41-NEXT:    pmovzxbw {{.*#+}} xmm12 = [255,255,255,255,255,255,255,255]
...
; SSE41-NEXT:    punpckhbw {{.*#+}} xmm11 = xmm11[8],xmm9[8],xmm11[9],xmm9[9],xmm11[10],xmm9[10],xmm11[11],xmm9[11],xmm11[12],xmm9[12],xmm11[13],xmm9[13],xmm11[14],xmm9[14],xmm11[15],xmm9[15]
...
; SSE41-NEXT:    punpckhbw {{.*#+}} xmm13 = xmm13[8],xmm9[8],xmm13[9],xmm9[9],xmm13[10],xmm9[10],xmm13[11],xmm9[11],xmm13[12],xmm9[12],xmm13[13],xmm9[13],xmm13[14],xmm9[14],xmm13[15],xmm9[15]
...
; SSE41-NEXT:    pmullw %xmm2, %xmm13
; SSE41-NEXT:    movdqa %xmm13, %xmm2
; SSE41-NEXT:    pand %xmm12, %xmm2
...
; SSE41-NEXT:    pmovzxbw {{.*#+}} xmm14 = xmm3[0],zero,xmm3[1],zero,xmm3[2],zero,xmm3[3],zero,xmm3[4],zero,xmm3[5],zero,xmm3[6],zero,xmm3[7],zero
...
; SSE41-NEXT:    movdqa %xmm7, %xmm15
; SSE41-NEXT:    pand %xmm12, %xmm15
; SSE41-NEXT:    pmullw %xmm14, %xmm2
; SSE41-NEXT:    movdqa %xmm2, %xmm3
; SSE41-NEXT:    pand %xmm12, %xmm3
; SSE41-NEXT:    packuswb %xmm15, %xmm3
; SSE41-NEXT:    psrlw $8, %xmm7
; SSE41-NEXT:    psrlw $8, %xmm2
; SSE41-NEXT:    packuswb %xmm7, %xmm2
; SSE41-NEXT:    psrlw $8, %xmm13
; SSE41-NEXT:    psrlw $8, %xmm1
; SSE41-NEXT:    packuswb %xmm13, %xmm1
...
; SSE41-NEXT:    pslld $31, %xmm2
; SSE41-NEXT:    psrad $31, %xmm2
; SSE41-NEXT:    movdqa %xmm2, 208(%rdi)
...
; SSE41-NEXT:    pslld $31, %xmm2
; SSE41-NEXT:    psrad $31, %xmm2
; SSE41-NEXT:    movdqa %xmm2, 176(%rdi)
; SSE41-NEXT:    pshufd {{.*#+}} xmm1 = xmm1[1,1,1,1]
; SSE41-NEXT:    pmovzxbd {{.*#+}} xmm1 = xmm1[0],zero,zero,zero,xmm1[1],zero,zero,zero,xmm1[2],zero,zero,zero,xmm1[3],zero,zero,zero
; SSE41-NEXT:    pslld $31, %xmm1
; SSE41-NEXT:    psrad $31, %xmm1
; SSE41-NEXT:    movdqa %xmm1, 144(%rdi)
...
; SSSE3-NEXT:    pshufd {{.*#+}} xmm4 = xmm3[0,2,2,3]
; SSSE3-NEXT:    pshufd {{.*#+}} xmm5 = xmm1[0,2,2,3]
; SSSE3-NEXT:    punpckldq {{.*#+}} xmm4 = xmm4[0],xmm5[0],xmm4[1],xmm5[1]
; SSSE3-NEXT:    psrld $24, %xmm4
...
; SSE41-NEXT:    pblendw {{.*#+}} xmm3 = xmm0[0,1],xmm3[2,3],xmm0[4,5],xmm3[6,7]
...
; SSE2-NEXT:    mulq %rcx
; SSE2-NEXT:    seto %dil
; SSE2-NEXT:    orb %r9b, %dil
; SSE2-NEXT:    orb %bpl, %dil
; SSE2-NEXT:    addq %rax, %r8
; SSE2-NEXT:    movq %rcx, %rax
; SSE2-NEXT:    mulq %r14
; SSE2-NEXT:    addq %rdx, %r8
; SSE2-NEXT:    setb %cl
; SSE2-NEXT:    orb %dil, %cl
...
; SSE2-NEXT:    movq %r8, 24(%rbx)
; SSE2-NEXT:    movq %r10, 8(%rbx)
; SSE2-NEXT:    popq %rbx
; SSE2-NEXT:    popq %r12
; SSE2-NEXT:    popq %r14
; SSE2-NEXT:    popq %r15
...
; SSSE3-NEXT:    mulq %rcx
; SSSE3-NEXT:    seto %dil
; SSSE3-NEXT:    orb %r9b, %dil
; SSSE3-NEXT:    orb %bpl, %dil
; SSSE3-NEXT:    addq %rax, %r8
; SSSE3-NEXT:    movq %rcx, %rax
; SSSE3-NEXT:    mulq %r14
; SSSE3-NEXT:    addq %rdx, %r8
; SSSE3-NEXT:    setb %cl
; SSSE3-NEXT:    orb %dil, %cl
...
; SSSE3-NEXT:    movq %r8, 24(%rbx)
; SSSE3-NEXT:    movq %r10, 8(%rbx)
; SSSE3-NEXT:    popq %rbx
; SSSE3-NEXT:    popq %r12
; SSSE3-NEXT:    popq %r14
; SSSE3-NEXT:    popq %r15
...
; SSE41-NEXT:    mulq %rcx
; SSE41-NEXT:    seto %dil
; SSE41-NEXT:    orb %r9b, %dil
; SSE41-NEXT:    orb %bpl, %dil
; SSE41-NEXT:    addq %rax, %r8
; SSE41-NEXT:    movq %rcx, %rax
; SSE41-NEXT:    mulq %r14
; SSE41-NEXT:    addq %rdx, %r8
; SSE41-NEXT:    setb %cl
; SSE41-NEXT:    orb %dil, %cl
...
; SSE41-NEXT:    movq %r8, 24(%rbx)
; SSE41-NEXT:    movq %r10, 8(%rbx)
; SSE41-NEXT:    popq %rbx
; SSE41-NEXT:    popq %r12
; SSE41-NEXT:    popq %r14
; SSE41-NEXT:    popq %r15
...
; AVX-NEXT:    mulq %rcx
; AVX-NEXT:    seto %dil
; AVX-NEXT:    orb %r9b, %dil
; AVX-NEXT:    orb %bpl, %dil
...
; AVX512F-NEXT:    setb %dl
; AVX512F-NEXT:    orb %r9b, %dl
...
; AVX512F-NEXT:    vpcmpeqd %xmm0, %xmm0, %xmm0
; AVX512F-NEXT:    vmovdqa32 %xmm0, %xmm0 {%k1} {z}
; AVX512F-NEXT:    movq %rcx, 16(%rbx)
; AVX512F-NEXT:    movq %rax, (%rbx)
; AVX512F-NEXT:    movq %r10, 24(%rbx)
; AVX512F-NEXT:    movq %rsi, 8(%rbx)
...
; AVX512BW-NEXT:    leaq (%r11,%rax), %r10
; AVX512BW-NEXT:    movq %rcx, %rax
; AVX512BW-NEXT:    mulq %r14
; AVX512BW-NEXT:    movq %rax, %rcx
; AVX512BW-NEXT:    addq %rdx, %r10
...
; AVX512BW-NEXT:    setb %dl
; AVX512BW-NEXT:    orb %r9b, %dl
; AVX512BW-NEXT:    andl $1, %edx
; AVX512BW-NEXT:    kmovw %edx, %k1
; AVX512BW-NEXT:    kshiftlw $1, %k0, %k0
; AVX512BW-NEXT:    korw %k0, %k1, %k1
; AVX512BW-NEXT:    vpcmpeqd %xmm0, %xmm0, %xmm0
; AVX512BW-NEXT:    vmovdqa32 %xmm0, %xmm0 {%k1} {z}
; AVX512BW-NEXT:    movq %rcx, 16(%rbx)
; AVX512BW-NEXT:    movq %rax, (%rbx)
; AVX512BW-NEXT:    movq %r10, 24(%rbx)
; AVX512BW-NEXT:    movq %rsi, 8(%rbx)
