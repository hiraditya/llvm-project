...
; SSE4-NEXT:    pmaxsd %xmm2, %xmm3
; SSE4-NEXT:    pshufd {{.*#+}} xmm0 = xmm3[2,3,2,3]
; SSE4-NEXT:    pmaxsd %xmm3, %xmm0
; SSE4-NEXT:    pshufd {{.*#+}} xmm1 = xmm0[1,1,1,1]
; SSE4-NEXT:    pmaxsd %xmm0, %xmm1
; SSE4-NEXT:    movd %xmm1, %eax
; SSE4-NEXT:    retq
...
; SSE4:       # %bb.0:
; SSE4-NEXT:    movdqa {{.*#+}} xmm1 = [32767,32767,32767,32767,32767,32767,32767,32767]
...
; SSE4-NEXT:    movdqa {{.*#+}} xmm0 = [32767,32767,32767,32767,32767,32767,32767,32767]
...
; SSE4:       # %bb.0:
; SSE4-NEXT:    movdqa {{.*#+}} xmm1 = [127,127,127,127,127,127,127,127,127,127,127,127,127,127,127,127]
; SSE4-NEXT:    pxor %xmm0, %xmm1
; SSE4-NEXT:    movdqa %xmm1, %xmm0
; SSE4-NEXT:    psrlw $8, %xmm0
...
; SSE4-NEXT:    pmaxsb %xmm0, %xmm1
; SSE4-NEXT:    movdqa {{.*#+}} xmm0 = [127,127,127,127,127,127,127,127,127,127,127,127,127,127,127,127]
; SSE4-NEXT:    pxor %xmm1, %xmm0
; SSE4-NEXT:    movdqa %xmm0, %xmm1
; SSE4-NEXT:    psrlw $8, %xmm1
