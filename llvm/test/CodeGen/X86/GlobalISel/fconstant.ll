...
; CHECK64_LARGE-NEXT:    movss {{.*#+}} xmm1 = mem[0],zero,zero,zero
; CHECK64_LARGE-NEXT:    addss %xmm0, %xmm1
; CHECK64_LARGE-NEXT:    movss %xmm1, (%rdi)
...
; CHECK32-NEXT:    movss {{.*#+}} xmm1 = mem[0],zero,zero,zero
; CHECK32-NEXT:    addss %xmm0, %xmm1
; CHECK32-NEXT:    movss %xmm1, (%eax)
; CHECK32-NEXT:    retl
entry:
