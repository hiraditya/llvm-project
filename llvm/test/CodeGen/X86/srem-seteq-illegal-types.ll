...
; SSE2-NEXT:    movdqa {{.*#+}} xmm0 = [3,8589934589]
; SSE2-NEXT:    pcmpeqd %xmm1, %xmm0
; SSE2-NEXT:    movd {{.*#+}} xmm1 = [3,0,0,0]
...
; SSE41-NEXT:    pmovsxbd {{.*#+}} xmm0 = [4294967295,1,4294967295,1]
...
; SSE41-NEXT:    pmovsxbd {{.*#+}} xmm0 = [3,0,4294967293,1]
