...
; DEFAULT-NEXT:    movdqa {{.*#+}} xmm1 = [1,1,1,1,u,u,u,u]
; DEFAULT-NEXT:    por %xmm0, %xmm1
; DEFAULT-NEXT:    pshuflw {{.*#+}} xmm0 = xmm1[2,2,2,2,4,5,6,7]
; DEFAULT-NEXT:    paddw %xmm1, %xmm0
; DEFAULT-NEXT:    movdqa %xmm0, %xmm1
; DEFAULT-NEXT:    psrld $16, %xmm1
; DEFAULT-NEXT:    paddw %xmm0, %xmm1
; DEFAULT-NEXT:    movd %xmm1, %eax
; DEFAULT-NEXT:    cwtl
; DEFAULT-NEXT:    retq
;
; TOPOLOGICAL-LABEL: PR134602:
; TOPOLOGICAL:       # %bb.0:
; TOPOLOGICAL-NEXT:    # kill: def $edi killed $edi def $rdi
; TOPOLOGICAL-NEXT:    orl $1, %edi
; TOPOLOGICAL-NEXT:    leal 3(%rdi), %eax
; TOPOLOGICAL-NEXT:    cwtl
