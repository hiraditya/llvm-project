...
; X64-NEXT:    movdqa {{.*#+}} xmm1 = [7,7,7,7,7,7,7,7,7,7,7,7,7,7,7,7]
; X64-NEXT:    pand %xmm0, %xmm1
; X64-NEXT:    movdqa {{.*#+}} xmm0 = [4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4]
...
; X64-NEXT:    movd {{.*#+}} xmm0 = [2048,8192,0,0,0,0,0,0]
...
; X64-NEXT:    pxor %xmm0, %xmm0
; X64-NEXT:    punpcklbw {{.*#+}} xmm1 = xmm1[0],xmm0[0],xmm1[1],xmm0[1],xmm1[2],xmm0[2],xmm1[3],xmm0[3],xmm1[4],xmm0[4],xmm1[5],xmm0[5],xmm1[6],xmm0[6],xmm1[7],xmm0[7]
; X64-NEXT:    movd {{.*#+}} xmm2 = [1024,4096,0,0,0,0,0,0]
...
; X64-NEXT:    pxor %xmm0, %xmm0
; X64-NEXT:    punpcklbw {{.*#+}} xmm1 = xmm1[0],xmm0[0],xmm1[1],xmm0[1],xmm1[2],xmm0[2],xmm1[3],xmm0[3],xmm1[4],xmm0[4],xmm1[5],xmm0[5],xmm1[6],xmm0[6],xmm1[7],xmm0[7]
; X64-NEXT:    movd {{.*#+}} xmm2 = [16384,4096,0,0,0,0,0,0]
; X64-NEXT:    pmullw %xmm1, %xmm2
; X64-NEXT:    movdqa {{.*#+}} xmm1 = [32768,32768,32768,32768,32768,32768,32768,32768]
; X64-NEXT:    pand %xmm2, %xmm1
; X64-NEXT:    pcmpgtw %xmm2, %xmm0
