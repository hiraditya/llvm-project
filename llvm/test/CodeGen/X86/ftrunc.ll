...
; SSE2-NEXT:    movdqa {{.*#+}} xmm1 = [1258291200,1258291200,1258291200,1258291200]
...
; SSE2-NEXT:    pand %xmm2, %xmm0
; SSE2-NEXT:    movdqa {{.*#+}} xmm1 = [4841369599423283200,4841369599423283200]
; SSE2-NEXT:    por %xmm0, %xmm1
