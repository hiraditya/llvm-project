...
; SSE2-NEXT:    shufps {{.*#+}} xmm9 = xmm9[1,3],xmm6[1,3]
; SSE2-NEXT:    andps %xmm9, %xmm10
; SSE2-NEXT:    shufps {{.*#+}} xmm4 = xmm4[1,3],xmm7[1,3]
; SSE2-NEXT:    orps %xmm10, %xmm4
; SSE2-NEXT:    movsd {{.*#+}} xmm5 = [4294967295,4294967295,0,0]
; SSE2-NEXT:    xorps %xmm4, %xmm5
; SSE2-NEXT:    xorps %xmm4, %xmm4
; SSE2-NEXT:    pcmpgtd %xmm5, %xmm4
; SSE2-NEXT:    pshufd {{.*#+}} xmm6 = xmm5[2,2,3,3]
