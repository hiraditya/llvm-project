...
; WIN32-NEXT:    leal (%edi,%esi), %eax
; WIN32-NEXT:    movl %eax, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; WIN32-NEXT:    subl %esi, %edi
; WIN32-NEXT:    leal (%ebp,%ebx), %eax
; WIN32-NEXT:    movl %eax, (%esp) # 4-byte Spill
; WIN32-NEXT:    subl %ebx, %ebp
; WIN32-NEXT:    movl {{[0-9]+}}(%esp), %ebx
; WIN32-NEXT:    movl {{[0-9]+}}(%esp), %edx
; WIN32-NEXT:    leal (%edx,%ebx), %esi
; WIN32-NEXT:    subl %ebx, %edx
; WIN32-NEXT:    imull %ecx, %edx
; WIN32-NEXT:    movl {{[0-9]+}}(%esp), %eax
; WIN32-NEXT:    movl {{[0-9]+}}(%esp), %ecx
; WIN32-NEXT:    leal (%ecx,%eax), %ebx
...
; WIN32-NEXT:    imull {{[-0-9]+}}(%e{{[sb]}}p), %ebx # 4-byte Folded Reload
; WIN32-NEXT:    addl %esi, %ebx
; WIN32-NEXT:    imull (%esp), %ecx # 4-byte Folded Reload
