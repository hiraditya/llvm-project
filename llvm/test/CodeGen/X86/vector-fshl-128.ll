...
; SSE2-NEXT:    shufps {{.*#+}} xmm3 = xmm3[0,1],xmm1[2,3]
...
; X86-SSE2-NEXT:    shufps {{.*#+}} xmm3 = xmm3[0,1],xmm1[2,3]
...
; X86-SSE2-NEXT:    orps %xmm1, %xmm3
; X86-SSE2-NEXT:    movaps %xmm3, %xmm0
; X86-SSE2-NEXT:    retl
...
; SSE2-NEXT:    movdqa %xmm2, %xmm5
; SSE2-NEXT:    pandn %xmm4, %xmm5
; SSE2-NEXT:    pshuflw {{.*#+}} xmm0 = xmm5[2,3,3,3,4,5,6,7]
; SSE2-NEXT:    psrld $1, %xmm1
; SSE2-NEXT:    movdqa %xmm1, %xmm6
; SSE2-NEXT:    psrld %xmm0, %xmm6
; SSE2-NEXT:    pshuflw {{.*#+}} xmm7 = xmm5[0,1,1,1,4,5,6,7]
; SSE2-NEXT:    movdqa %xmm1, %xmm0
; SSE2-NEXT:    psrld %xmm7, %xmm0
...
; SSE2-NEXT:    movdqa {{.*#+}} xmm1 = [1065353216,1065353216,1065353216,1065353216]
...
; SSE41:       # %bb.0:
; SSE41-NEXT:    pmovsxbd {{.*#+}} xmm4 = [31,31,31,31]
; SSE41-NEXT:    movdqa %xmm2, %xmm5
; SSE41-NEXT:    pandn %xmm4, %xmm5
; SSE41-NEXT:    pshuflw {{.*#+}} xmm3 = xmm5[2,3,3,3,4,5,6,7]
; SSE41-NEXT:    psrld $1, %xmm1
; SSE41-NEXT:    movdqa %xmm1, %xmm6
; SSE41-NEXT:    psrld %xmm3, %xmm6
; SSE41-NEXT:    pshufd {{.*#+}} xmm7 = xmm5[2,3,2,3]
; SSE41-NEXT:    pshuflw {{.*#+}} xmm8 = xmm7[2,3,3,3,4,5,6,7]
; SSE41-NEXT:    movdqa %xmm1, %xmm3
; SSE41-NEXT:    psrld %xmm8, %xmm3
; SSE41-NEXT:    pblendw {{.*#+}} xmm3 = xmm6[0,1,2,3],xmm3[4,5,6,7]
; SSE41-NEXT:    pshuflw {{.*#+}} xmm5 = xmm5[0,1,1,1,4,5,6,7]
; SSE41-NEXT:    movdqa %xmm1, %xmm6
; SSE41-NEXT:    psrld %xmm5, %xmm6
; SSE41-NEXT:    pshuflw {{.*#+}} xmm5 = xmm7[0,1,1,1,4,5,6,7]
; SSE41-NEXT:    psrld %xmm5, %xmm1
; SSE41-NEXT:    pblendw {{.*#+}} xmm1 = xmm6[0,1,2,3],xmm1[4,5,6,7]
; SSE41-NEXT:    pblendw {{.*#+}} xmm3 = xmm1[0,1],xmm3[2,3],xmm1[4,5],xmm3[6,7]
; SSE41-NEXT:    pand %xmm4, %xmm2
; SSE41-NEXT:    pslld $23, %xmm2
; SSE41-NEXT:    movdqa {{.*#+}} xmm1 = [1065353216,1065353216,1065353216,1065353216]
...
; X86-SSE2-NEXT:    shufps {{.*#+}} xmm0 = xmm0[0,3],xmm1[0,3]
; X86-SSE2-NEXT:    pand %xmm4, %xmm2
...
; SSE41-NEXT:    pmovzxwd {{.*#+}} xmm5 = xmm4[0],zero,xmm4[1],zero,xmm4[2],zero,xmm4[3],zero
; SSE41-NEXT:    punpckhwd {{.*#+}} xmm4 = xmm4[4],xmm2[4],xmm4[5],xmm2[5],xmm4[6],xmm2[6],xmm4[7],xmm2[7]
...
; X86-SSE2-NEXT:    movdqa %xmm1, %xmm6
; X86-SSE2-NEXT:    punpckhwd {{.*#+}} xmm6 = xmm6[4],xmm0[4],xmm6[5],xmm0[5],xmm6[6],xmm0[6],xmm6[7],xmm0[7]
...
; X86-SSE2-NEXT:    cvttps2dq %xmm2, %xmm7
; X86-SSE2-NEXT:    pshufd {{.*#+}} xmm0 = xmm6[1,1,3,3]
; X86-SSE2-NEXT:    pmuludq %xmm7, %xmm6
; X86-SSE2-NEXT:    pshufd {{.*#+}} xmm2 = xmm6[0,2,2,3]
; X86-SSE2-NEXT:    pshufd {{.*#+}} xmm6 = xmm7[1,1,3,3]
; X86-SSE2-NEXT:    pmuludq %xmm0, %xmm6
; X86-SSE2-NEXT:    pshufd {{.*#+}} xmm0 = xmm6[0,2,2,3]
; X86-SSE2-NEXT:    punpckldq {{.*#+}} xmm2 = xmm2[0],xmm0[0],xmm2[1],xmm0[1]
; X86-SSE2-NEXT:    psrad $16, %xmm2
; X86-SSE2-NEXT:    punpcklwd {{.*#+}} xmm1 = xmm1[0],xmm4[0],xmm1[1],xmm4[1],xmm1[2],xmm4[2],xmm1[3],xmm4[3]
; X86-SSE2-NEXT:    pxor %xmm0, %xmm0
; X86-SSE2-NEXT:    punpcklwd {{.*#+}} xmm3 = xmm3[0],xmm0[0],xmm3[1],xmm0[1],xmm3[2],xmm0[2],xmm3[3],xmm0[3]
...
; SSE41-NEXT:    pmovzxbd {{.*#+}} xmm2 = xmm4[0],zero,zero,zero,xmm4[1],zero,zero,zero,xmm4[2],zero,zero,zero,xmm4[3],zero,zero,zero
; SSE41-NEXT:    pmovzxbw {{.*#+}} xmm5 = xmm4[0],zero,xmm4[1],zero,xmm4[2],zero,xmm4[3],zero,xmm4[4],zero,xmm4[5],zero,xmm4[6],zero,xmm4[7],zero
; SSE41-NEXT:    punpckhbw {{.*#+}} xmm4 = xmm4[8],xmm3[8],xmm4[9],xmm3[9],xmm4[10],xmm3[10],xmm4[11],xmm3[11],xmm4[12],xmm3[12],xmm4[13],xmm3[13],xmm4[14],xmm3[14],xmm4[15],xmm3[15]
...
; X86-SSE2-NEXT:    punpckhwd {{.*#+}} xmm6 = xmm6[4],xmm2[4],xmm6[5],xmm2[5],xmm6[6],xmm2[6],xmm6[7],xmm2[7]
...
; X86-SSE2-NEXT:    packssdw %xmm6, %xmm4
; X86-SSE2-NEXT:    movdqa %xmm1, %xmm6
; X86-SSE2-NEXT:    punpckhbw {{.*#+}} xmm6 = xmm6[8],xmm0[8],xmm6[9],xmm0[9],xmm6[10],xmm0[10],xmm6[11],xmm0[11],xmm6[12],xmm0[12],xmm6[13],xmm0[13],xmm6[14],xmm0[14],xmm6[15],xmm0[15]
; X86-SSE2-NEXT:    pmullw %xmm6, %xmm4
...
; X86-SSE2-NEXT:    pslld $23, %xmm3
; X86-SSE2-NEXT:    paddd %xmm5, %xmm3
; X86-SSE2-NEXT:    cvttps2dq %xmm3, %xmm2
...
; SSE2-NEXT:    movd {{.*#+}} xmm4 = [31,0,0,0]
; SSE2-NEXT:    pand %xmm2, %xmm4
; SSE2-NEXT:    psllq %xmm4, %xmm3
; SSE2-NEXT:    punpckldq {{.*#+}} xmm1 = xmm1[0],xmm0[0],xmm1[1],xmm0[1]
; SSE2-NEXT:    psllq %xmm4, %xmm1
...
; X86-SSE2-NEXT:    movd {{.*#+}} xmm4 = [31,0,0,0]
; X86-SSE2-NEXT:    pand %xmm2, %xmm4
; X86-SSE2-NEXT:    psllq %xmm4, %xmm3
...
; X86-SSE2-NEXT:    movd {{.*#+}} xmm4 = [7,0,0,0]
; X86-SSE2-NEXT:    pand %xmm2, %xmm4
; X86-SSE2-NEXT:    psllw %xmm4, %xmm3
; X86-SSE2-NEXT:    psrlw $8, %xmm3
; X86-SSE2-NEXT:    punpcklbw {{.*#+}} xmm1 = xmm1[0],xmm0[0],xmm1[1],xmm0[1],xmm1[2],xmm0[2],xmm1[3],xmm0[3],xmm1[4],xmm0[4],xmm1[5],xmm0[5],xmm1[6],xmm0[6],xmm1[7],xmm0[7]
; X86-SSE2-NEXT:    psllw %xmm4, %xmm1
...
; X86-SSE2-NEXT:    movd {{.*#+}} xmm0 = [31,0,0,0]
...
; X86-SSE2-NEXT:    shufps {{.*#+}} xmm2 = xmm2[0,1],xmm1[2,3]
; X86-SSE2-NEXT:    movdqa %xmm0, %xmm1
...
; SSE2-NEXT:    movdqa {{.*#+}} xmm3 = [32,32,128,128]
...
; SSE41-NEXT:    pmovzxbd {{.*#+}} xmm1 = [16,32,64,128]
; SSE41-NEXT:    pmulld %xmm0, %xmm1
; SSE41-NEXT:    por %xmm1, %xmm2
; SSE41-NEXT:    movdqa %xmm2, %xmm0
; SSE41-NEXT:    retq
...
; X86-SSE2-NEXT:    movdqa {{.*#+}} xmm3 = [32,32,128,128]
...
; SSE2-NEXT:    psrlw $1, %xmm1
; SSE2-NEXT:    movdqa {{.*#+}} xmm0 = [2,4,8,16,32,64,128,256]
...
; SSE41-NEXT:    psrlw $1, %xmm1
; SSE41-NEXT:    movdqa {{.*#+}} xmm0 = [2,4,8,16,32,64,128,256]
...
; X86-SSE2-NEXT:    psrlw $1, %xmm1
; X86-SSE2-NEXT:    movdqa {{.*#+}} xmm0 = [2,4,8,16,32,64,128,256]
; X86-SSE2-NEXT:    pmulhuw %xmm1, %xmm0
...
; SSE2-NEXT:    movdqa {{.*#+}} xmm3 = [1,128,64,32,16,8,4,2]
; SSE2-NEXT:    pmullw %xmm2, %xmm3
; SSE2-NEXT:    psrlw $8, %xmm3
; SSE2-NEXT:    punpcklbw {{.*#+}} xmm1 = xmm1[0],xmm0[0],xmm1[1],xmm0[1],xmm1[2],xmm0[2],xmm1[3],xmm0[3],xmm1[4],xmm0[4],xmm1[5],xmm0[5],xmm1[6],xmm0[6],xmm1[7],xmm0[7]
; SSE2-NEXT:    movdqa {{.*#+}} xmm0 = [1,2,4,8,16,32,64,128]
...
; SSE41-NEXT:    pmovzxbw {{.*#+}} xmm3 = [1,128,64,32,16,8,4,2]
; SSE41-NEXT:    pmullw %xmm2, %xmm3
; SSE41-NEXT:    psrlw $8, %xmm3
; SSE41-NEXT:    punpcklbw {{.*#+}} xmm1 = xmm1[0],xmm0[0],xmm1[1],xmm0[1],xmm1[2],xmm0[2],xmm1[3],xmm0[3],xmm1[4],xmm0[4],xmm1[5],xmm0[5],xmm1[6],xmm0[6],xmm1[7],xmm0[7]
; SSE41-NEXT:    pmovzxbw {{.*#+}} xmm0 = [1,2,4,8,16,32,64,128]
...
; AVX512VBMI2-NEXT:    vpsllvw %zmm0, %zmm2, %zmm0
; AVX512VBMI2-NEXT:    vpsrlw $8, %ymm0, %ymm0
; AVX512VBMI2-NEXT:    vpmovwb %zmm0, %ymm0
; AVX512VBMI2-NEXT:    # kill: def $xmm0 killed $xmm0 killed $ymm0
; AVX512VBMI2-NEXT:    vzeroupper
...
; X86-SSE2-NEXT:    movdqa {{.*#+}} xmm3 = [1,128,64,32,16,8,4,2]
; X86-SSE2-NEXT:    pmullw %xmm2, %xmm3
; X86-SSE2-NEXT:    psrlw $8, %xmm3
; X86-SSE2-NEXT:    punpcklbw {{.*#+}} xmm1 = xmm1[0],xmm0[0],xmm1[1],xmm0[1],xmm1[2],xmm0[2],xmm1[3],xmm0[3],xmm1[4],xmm0[4],xmm1[5],xmm0[5],xmm1[6],xmm0[6],xmm1[7],xmm0[7]
; X86-SSE2-NEXT:    movdqa {{.*#+}} xmm0 = [1,2,4,8,16,32,64,128]
...
; AVX512F-NEXT:    vpternlogd {{.*#+}} zmm0 = zmm1 ^ (m32bcst & (zmm0 ^ zmm1))
...
; AVX512VL-NEXT:    vpternlogd {{.*#+}} xmm0 = xmm1 ^ (m32bcst & (xmm0 ^ xmm1))
; AVX512VL-NEXT:    retq
;
...
; AVX512BW-NEXT:    vpternlogd {{.*#+}} zmm0 = zmm1 ^ (m32bcst & (zmm0 ^ zmm1))
...
; AVX512VBMI2-NEXT:    vpternlogd {{.*#+}} zmm0 = zmm1 ^ (m32bcst & (zmm0 ^ zmm1))
; AVX512VBMI2-NEXT:    # kill: def $xmm0 killed $xmm0 killed $zmm0
; AVX512VBMI2-NEXT:    vzeroupper
; AVX512VBMI2-NEXT:    retq
;
...
; AVX512VLBW-NEXT:    vpternlogd {{.*#+}} xmm0 = xmm1 ^ (m32bcst & (xmm0 ^ xmm1))
; AVX512VLBW-NEXT:    retq
;
...
; AVX512VLVBMI2-NEXT:    vpternlogd {{.*#+}} xmm0 = xmm1 ^ (m32bcst & (xmm0 ^ xmm1))
; AVX512VLVBMI2-NEXT:    retq
;
...
; X86-SSE2-NEXT:    movdqa {{.*#+}} xmm1 = [240,240,240,240,240,240,240,240,240,240,240,240,240,240,240,240]
