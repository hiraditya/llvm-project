...
; AVX512-NEXT:    vmovdqa64 %zmm2, 192(%rdx)
...
; AVX512-FCP-NEXT:    vmovdqa64 %zmm2, 192(%rdx)
...
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm2, 192(%rdx)
...
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm2, 192(%rdx)
...
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm2, 192(%rdx)
...
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm2, 192(%rdx)
...
; AVX512-FCP-NEXT:    vmovdqa64 %zmm6, 448(%rdx)
...
; AVX512DQ-NEXT:    vpermt2q %zmm7, %zmm8, %zmm6
...
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm6, 448(%rdx)
...
; AVX512BW-NEXT:    vpermt2q %zmm7, %zmm8, %zmm6
...
; AVX512-NEXT:    vmovdqa64 %zmm9, 960(%rdx)
...
; AVX512-FCP-NEXT:    vmovdqa64 %zmm9, 960(%rdx)
...
; AVX512DQ-NEXT:    vmovdqa64 %zmm9, 960(%rdx)
...
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm9, 960(%rdx)
...
; AVX512BW-NEXT:    vmovdqa64 %zmm9, 960(%rdx)
...
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm9, 960(%rdx)
...
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm9, 960(%rdx)
...
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm9, 960(%rdx)
