...
; SSE2:       # %bb.0:
; SSE2-NEXT:    movq {{.*#+}} xmm2 = [268435456,134217728,0,0]
; SSE2-NEXT:    pmuludq %xmm0, %xmm2
; SSE2-NEXT:    pshufd {{.*#+}} xmm1 = xmm2[1,3,2,3]
; SSE2-NEXT:    pshufd {{.*#+}} xmm0 = xmm0[1,1,3,3]
; SSE2-NEXT:    movdqa {{.*#+}} xmm3 = [134217728,134217728,u,u]
...
; SSE41:       # %bb.0:
; SSE41-NEXT:    pshufd {{.*#+}} xmm1 = xmm0[1,1,3,3]
; SSE41-NEXT:    movdqa {{.*#+}} xmm2 = [134217728,134217728,u,u]
; SSE41-NEXT:    pmuludq %xmm1, %xmm2
; SSE41-NEXT:    movq {{.*#+}} xmm1 = [268435456,134217728,0,0]
