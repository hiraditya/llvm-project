...
; SSSE3-NEXT:    movq %r9, 16(%rax)
; SSSE3-NEXT:    movq %rdi, (%rax)
; SSSE3-NEXT:    movq %rdx, 24(%rax)
...
; SSE41-NEXT:    movq %r9, 16(%rax)
; SSE41-NEXT:    movq %rdi, (%rax)
; SSE41-NEXT:    movq %rdx, 24(%rax)
