...
; X86-BMI-NEXT:    mulxl %eax, %ebx, %ebx
; X86-BMI-NEXT:    movl %esi, %edx
; X86-BMI-NEXT:    mulxl %eax, %eax, %ebp
; X86-BMI-NEXT:    addl %eax, %ebx
; X86-BMI-NEXT:    adcl $0, %ebp
; X86-BMI-NEXT:    movl %ecx, %edx
; X86-BMI-NEXT:    mulxl %edi, %ecx, %eax
; X86-BMI-NEXT:    addl %ecx, %ebx
; X86-BMI-NEXT:    adcl %ebp, %eax
; X86-BMI-NEXT:    setb %cl
; X86-BMI-NEXT:    movzbl %cl, %ecx
; X86-BMI-NEXT:    movl %esi, %edx
; X86-BMI-NEXT:    mulxl %edi, %esi, %edx
; X86-BMI-NEXT:    addl %esi, %eax
; X86-BMI-NEXT:    adcl %edx, %ecx
; X86-BMI-NEXT:    movl %ecx, %edx
...
; X86-NOBMI-NEXT:    movl 4(%eax,%esi,8), %edi
...
; X86-NOBMI-NEXT:    addl %eax, %edi
; X86-NOBMI-NEXT:    adcl %edx, %ecx
; X86-NOBMI-NEXT:    setb (%esp) # 1-byte Folded Spill
; X86-NOBMI-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %eax # 4-byte Reload
; X86-NOBMI-NEXT:    mull %ebp
; X86-NOBMI-NEXT:    addl %eax, %ecx
; X86-NOBMI-NEXT:    movzbl (%esp), %eax # 1-byte Folded Reload
; X86-NOBMI-NEXT:    adcl %edx, %eax
...
; X86-BMI-NEXT:    movl 4(%eax,%ebx,8), %edi
; X86-BMI-NEXT:    movl %ecx, %edx
; X86-BMI-NEXT:    movl {{[0-9]+}}(%esp), %eax
; X86-BMI-NEXT:    mulxl %eax, %edx, %esi
; X86-BMI-NEXT:    movl %edx, (%esp) # 4-byte Spill
; X86-BMI-NEXT:    movl %edi, %edx
; X86-BMI-NEXT:    mulxl %eax, %edx, %eax
; X86-BMI-NEXT:    addl %edx, %esi
; X86-BMI-NEXT:    adcl $0, %eax
; X86-BMI-NEXT:    movl %ecx, %edx
; X86-BMI-NEXT:    mulxl {{[0-9]+}}(%esp), %edx, %ecx
; X86-BMI-NEXT:    addl %edx, %esi
; X86-BMI-NEXT:    adcl %eax, %ecx
; X86-BMI-NEXT:    movl %edi, %edx
; X86-BMI-NEXT:    mulxl {{[0-9]+}}(%esp), %eax, %edi
; X86-BMI-NEXT:    setb %dl
; X86-BMI-NEXT:    addl %eax, %ecx
; X86-BMI-NEXT:    movzbl %dl, %eax
; X86-BMI-NEXT:    adcl %edi, %eax
; X86-BMI-NEXT:    movl %ebp, %edi
; X86-BMI-NEXT:    movl (%esp), %ebp # 4-byte Reload
...
; X86-BMI-NEXT:    movl %ebp, (%edx,%ebx,8)
; X86-BMI-NEXT:    movl %edi, %ebp
; X86-BMI-NEXT:    movl %esi, 4(%edx,%ebx,8)
; X86-BMI-NEXT:    addl $1, %ebx
; X86-BMI-NEXT:    adcl $0, %ebp
; X86-BMI-NEXT:    movl %ebx, %edx
; X86-BMI-NEXT:    xorl {{[0-9]+}}(%esp), %edx
; X86-BMI-NEXT:    movl %ebp, %esi
; X86-BMI-NEXT:    xorl {{[0-9]+}}(%esp), %esi
