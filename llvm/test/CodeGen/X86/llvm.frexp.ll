...
; X64-NEXT:    andl $31744, %edx # imm = 0x7C00
...
; X64-NEXT:    cmovael %esi, %edx
; X64-NEXT:    shrl $10, %edx
; X64-NEXT:    leal -12(%rdx), %eax
; X64-NEXT:    cmpl $1024, %esi # imm = 0x400
; X64-NEXT:    cmovael %edx, %eax
; X64-NEXT:    leal -14(%rax), %edx
; X64-NEXT:    andl $-31745, %edi # imm = 0x83FF
; X64-NEXT:    addl $14336, %edi # imm = 0x3800
; X64-NEXT:    leal -31744(%rsi), %eax
; X64-NEXT:    movzwl %ax, %esi
; X64-NEXT:    xorl %eax, %eax
; X64-NEXT:    cmpl $33792, %esi # imm = 0x8400
; X64-NEXT:    cmoval %edx, %eax
; X64-NEXT:    cmovbel %ecx, %edi
