...
; X86-BMI-NEXT:    testl %eax, %eax
; X86-BMI-NEXT:    movl $0, %edx
; X86-BMI-NEXT:    cmovgl %eax, %edx
; X86-BMI-NEXT:    movl {{[0-9]+}}(%esp), %eax
...
; X86-BMI-NEXT:    cmovgl %ecx, %esi
; X86-BMI-NEXT:    movl {{[0-9]+}}(%esp), %ecx
; X86-BMI-NEXT:    cmovsl %edx, %ecx
; X86-BMI-NEXT:    movl {{[0-9]+}}(%esp), %edi
; X86-BMI-NEXT:    cmovsl %edx, %edi
; X86-BMI-NEXT:    movl {{[0-9]+}}(%esp), %ebx
; X86-BMI-NEXT:    cmovsl %edx, %ebx
; X86-BMI-NEXT:    movl %esi, 12(%eax)
