...
; SSE2-NEXT:    shufps {{.*#+}} xmm7 = xmm7[0,2],xmm11[0,2]
...
; SSE2-NEXT:    movdqa {{.*#+}} xmm10 = [2147483903,2147483903,2147483903,2147483903]
...
; SSE4:       # %bb.0:
; SSE4-NEXT:    pxor %xmm3, %xmm3
; SSE4-NEXT:    pmovsxbw {{.*#+}} xmm2 = [65535,0,65535,0,65535,0,65535,0]
...
; SSE4:       # %bb.0:
; SSE4-NEXT:    pxor %xmm3, %xmm3
; SSE4-NEXT:    pmovzxbd {{.*#+}} xmm2 = [255,255,255,255]
; SSE4-NEXT:    pminud %xmm0, %xmm2
; SSE4-NEXT:    packusdw %xmm2, %xmm2
; SSE4-NEXT:    packuswb %xmm2, %xmm2
; SSE4-NEXT:    pcmpeqd %xmm1, %xmm3
; SSE4-NEXT:    movmskps %xmm3, %eax
; SSE4-NEXT:    xorl $15, %eax
; SSE4-NEXT:    testb $1, %al
