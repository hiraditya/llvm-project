...
; SSE41-NEXT:    pshuflw {{.*#+}} xmm1 = xmm2[2,3,3,3,4,5,6,7]
; SSE41-NEXT:    movdqa %xmm0, %xmm3
; SSE41-NEXT:    psrld %xmm1, %xmm3
...
; SSE41:       # %bb.0:
; SSE41-NEXT:    pmovsxbd {{.*#+}} xmm2 = [0,2,3,4]
; SSE41-NEXT:    paddd %xmm1, %xmm2
; SSE41-NEXT:    pshuflw {{.*#+}} xmm1 = xmm2[2,3,3,3,4,5,6,7]
; SSE41-NEXT:    movdqa %xmm0, %xmm3
; SSE41-NEXT:    psrld %xmm1, %xmm3
...
; SSE41-NEXT:    movdqa {{.*#+}} xmm2 = [25645,61681,8195,9363,512,32769,32897,2]
; SSE41-NEXT:    pmulhuw %xmm1, %xmm2
; SSE41-NEXT:    psubw %xmm2, %xmm0
; SSE41-NEXT:    movd {{.*#+}} xmm1 = [32768,0,0,0]
...
; SSE41-NEXT:    pblendw {{.*#+}} xmm0 = xmm0[0,1,2],xmm1[3,4],xmm0[5,6],xmm1[7]
; SSE41-NEXT:    retq
;
...
; SSE2-NEXT:    por %xmm2, %xmm1
; SSE2-NEXT:    movdqa {{.*#+}} xmm2 = [16393,59919,58255,32787,55189,8197,52429,32789]
; SSE2-NEXT:    pmulhuw %xmm1, %xmm2
; SSE2-NEXT:    movdqa {{.*#+}} xmm0 = [8,2048,2048,2,2048,8,2048,2]
...
; SSE41-NEXT:    movdqa {{.*#+}} xmm2 = [16393,59919,58255,32787,55189,8197,52429,32789]
; SSE41-NEXT:    pmulhuw %xmm1, %xmm2
; SSE41-NEXT:    movdqa {{.*#+}} xmm0 = [8,2048,2048,2,2048,8,2048,2]
...
; SSE-NEXT:    psrlw $1, %xmm0
; SSE-NEXT:    paddw %xmm1, %xmm0
; SSE-NEXT:    movdqa {{.*#+}} xmm1 = [16384,4096,4096,4096,4096,2048,2048,1024]
; SSE-NEXT:    pmulhuw %xmm0, %xmm1
; SSE-NEXT:    movdqa %xmm1, %xmm0
; SSE-NEXT:    retq
;
...
; SSE41-NEXT:    pmovzxbq {{.*#+}} xmm3 = [171,0]
...
; SSE2-NEXT:    movdqa {{.*#+}} xmm4 = [u,32768,0,0,0,0,0,32768]
; SSE2-NEXT:    pmulhuw %xmm0, %xmm4
; SSE2-NEXT:    paddw %xmm3, %xmm4
; SSE2-NEXT:    movdqa {{.*#+}} xmm0 = [u,u,0,4,0,4,16,0,4,0,0,4,0,0,0,16]
; SSE2-NEXT:    pmulhuw %xmm4, %xmm0
; SSE2-NEXT:    movdqa {{.*#+}} xmm4 = [0,0,0,0,0,0,65535,0]
...
; SSE41-NEXT:    movdqa {{.*#+}} xmm3 = [u,32768,0,0,0,0,0,32768]
...
; SSE41-NEXT:    pblendw {{.*#+}} xmm1 = xmm1[0,1,2,3,4,5],xmm3[6],xmm1[7]
...
; SSE2-NEXT:    movdqa {{.*#+}} xmm2 = [613566757,613566757,613566757,613566757]
