...
; X86-SSE-NEXT:    pmovzxdq {{.*#+}} xmm0 = xmm4[0],zero,xmm4[1],zero
; X86-SSE-NEXT:    punpckhdq {{.*#+}} xmm4 = xmm4[2],xmm1[2],xmm4[3],xmm1[3]
; X86-SSE-NEXT:    psadbw %xmm1, %xmm4
; X86-SSE-NEXT:    psadbw %xmm1, %xmm0
; X86-SSE-NEXT:    packuswb %xmm4, %xmm0
; X86-SSE-NEXT:    retl
...
; X86-SSE-NEXT:    movdqa {{.*#+}} xmm4 = [0,1,1,2,1,2,2,3,1,2,2,3,2,3,3,4]
; X86-SSE-NEXT:    movdqa %xmm4, %xmm1
