...
; SSE2-NEXT:    movaps {{.*#+}} xmm2 = [15,255,4095,65535]
...
; SSE41-NEXT:    movaps {{.*#+}} xmm2 = [15,255,4095,65535]
...
; SSE2:       # %bb.0:
; SSE2-NEXT:    movdqa {{.*#+}} xmm2 = [15,255,4095,65535]
...
; SSE2-NEXT:    punpckhqdq {{.*#+}} xmm2 = xmm2[1],xmm4[1]
; SSE2-NEXT:    shufps {{.*#+}} xmm0 = xmm0[0,3],xmm2[0,3]
; SSE2-NEXT:    retq
;
; SSE41-LABEL: combine_vec_ashr_positive:
; SSE41:       # %bb.0:
; SSE41-NEXT:    pmovzxwd {{.*#+}} xmm2 = [15,255,4095,65535]
; SSE41-NEXT:    pand %xmm0, %xmm2
; SSE41-NEXT:    pshuflw {{.*#+}} xmm0 = xmm1[2,3,3,3,4,5,6,7]
; SSE41-NEXT:    movdqa %xmm2, %xmm3
; SSE41-NEXT:    psrld %xmm0, %xmm3
; SSE41-NEXT:    pshufd {{.*#+}} xmm4 = xmm1[2,3,2,3]
; SSE41-NEXT:    pshuflw {{.*#+}} xmm5 = xmm4[2,3,3,3,4,5,6,7]
; SSE41-NEXT:    movdqa %xmm2, %xmm0
; SSE41-NEXT:    psrld %xmm5, %xmm0
; SSE41-NEXT:    pblendw {{.*#+}} xmm0 = xmm3[0,1,2,3],xmm0[4,5,6,7]
...
; SSE41:       # %bb.0:
; SSE41-NEXT:    movdqa %xmm0, %xmm2
; SSE41-NEXT:    pmovsxbw {{.*#+}} xmm3 = [15,15,15,15,15,15,15,15]
