...
; CHECK-LABEL: sll8_nosplat:
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    movdqa {{.*#+}} xmm2 = [2,4,8,64,4,4,4,4]
; CHECK-NEXT:    pmullw %xmm0, %xmm2
; CHECK-NEXT:    movdqa {{.*#+}} xmm1 = [512,128,32,2,16,2,2,2]
...
; CHECK-LABEL: shl9:
; CHECK:       # %bb.0:
; CHECK-NEXT:    psllw $3, %xmm0
; CHECK-NEXT:    movdqa {{.*#+}} xmm1 = [248,248,248,248,248,248,248,248,248,248,248,248,248,248,248,248]
...
; CHECK-NEXT:    movdqa {{.*#+}} xmm1 = [31,31,31,31,31,31,31,31,31,31,31,31,31,31,31,31]
; CHECK-NEXT:    pand %xmm0, %xmm1
; CHECK-NEXT:    movdqa %xmm1, %xmm0
; CHECK-NEXT:    ret{{[l|q]}}
...
; CHECK-NEXT:    movdqa {{.*#+}} xmm1 = [31,31,31,31,31,31,31,31,31,31,31,31,31,31,31,31]
; CHECK-NEXT:    pand %xmm0, %xmm1
; CHECK-NEXT:    movdqa {{.*#+}} xmm0 = [16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16]
