...
; SSE41:       # %bb.0:
; SSE41-NEXT:    pshufd {{.*#+}} xmm1 = xmm0[1,1,3,3]
; SSE41-NEXT:    pmovsxbd {{.*#+}} xmm2 = [32,32,32,32]
; SSE41-NEXT:    pmuludq %xmm1, %xmm2
; SSE41-NEXT:    pmovsxbd {{.*#+}} xmm1 = [16,32,0,0]
