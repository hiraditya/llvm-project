...
; X64-SSE2-NEXT:    pshufd {{.*#+}} xmm5 = xmm2[0,0,2,2]
...
; X64-SSE2-NEXT:    pshufd {{.*#+}} xmm1 = xmm6[1,1,3,3]
...
; X64-SSE2-NEXT:    pshufd {{.*#+}} xmm0 = xmm3[1,1,3,3]
...
; X64-SSE2-NEXT:    pcmpeqd %xmm2, %xmm3
...
; X86-SSE42-NEXT:    movdqa {{.*#+}} xmm0 = [32768,32768,32768,32768,32768,32768,32768,32768]
...
; X64-SSE42-NEXT:    movdqa {{.*#+}} xmm0 = [32768,32768,32768,32768,32768,32768,32768,32768]
...
; X86-SSE42-NEXT:    movdqa {{.*#+}} xmm0 = [128,128,128,128,128,128,128,128,128,128,128,128,128,128,128,128]
; X86-SSE42-NEXT:    pxor %xmm1, %xmm0
; X86-SSE42-NEXT:    movdqa %xmm0, %xmm1
...
; X64-SSE42-NEXT:    movdqa {{.*#+}} xmm0 = [128,128,128,128,128,128,128,128,128,128,128,128,128,128,128,128]
; X64-SSE42-NEXT:    pxor %xmm1, %xmm0
; X64-SSE42-NEXT:    movdqa %xmm0, %xmm1
