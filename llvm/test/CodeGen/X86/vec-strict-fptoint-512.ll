...
; AVX512VL-32-NEXT:    movl {{[0-9]+}}(%esp), %edi
; AVX512VL-32-NEXT:    xorl %ebx, %edi
; AVX512VL-32-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %eax # 4-byte Reload
; AVX512VL-32-NEXT:    shll $31, %eax
; AVX512VL-32-NEXT:    movl {{[0-9]+}}(%esp), %ebx
; AVX512VL-32-NEXT:    xorl %eax, %ebx
; AVX512VL-32-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %eax # 4-byte Reload
; AVX512VL-32-NEXT:    shll $31, %eax
...
; AVX512VL-32-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %eax # 4-byte Reload
; AVX512VL-32-NEXT:    shll $31, %eax
; AVX512VL-32-NEXT:    movl {{[0-9]+}}(%esp), %edx
; AVX512VL-32-NEXT:    xorl %eax, %edx
; AVX512VL-32-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %eax # 4-byte Reload
; AVX512VL-32-NEXT:    shll $31, %eax
; AVX512VL-32-NEXT:    movl {{[0-9]+}}(%esp), %ecx
; AVX512VL-32-NEXT:    xorl %eax, %ecx
; AVX512VL-32-NEXT:    vmovd {{.*#+}} xmm0 = mem[0],zero,zero,zero
; AVX512VL-32-NEXT:    vpinsrd $1, {{[-0-9]+}}(%e{{[sb]}}p), %xmm0, %xmm0 # 4-byte Folded Reload
; AVX512VL-32-NEXT:    vpinsrd $2, (%esp), %xmm0, %xmm0
; AVX512VL-32-NEXT:    vpinsrd $3, {{[-0-9]+}}(%e{{[sb]}}p), %xmm0, %xmm0 # 4-byte Folded Reload
; AVX512VL-32-NEXT:    vmovd {{.*#+}} xmm1 = mem[0],zero,zero,zero
; AVX512VL-32-NEXT:    vpinsrd $1, %edi, %xmm1, %xmm1
; AVX512VL-32-NEXT:    vpinsrd $2, {{[0-9]+}}(%esp), %xmm1, %xmm1
; AVX512VL-32-NEXT:    vpinsrd $3, {{[-0-9]+}}(%e{{[sb]}}p), %xmm1, %xmm1 # 4-byte Folded Reload
; AVX512VL-32-NEXT:    vmovd {{.*#+}} xmm2 = mem[0],zero,zero,zero
; AVX512VL-32-NEXT:    vpinsrd $1, %esi, %xmm2, %xmm2
; AVX512VL-32-NEXT:    vpinsrd $2, {{[0-9]+}}(%esp), %xmm2, %xmm2
