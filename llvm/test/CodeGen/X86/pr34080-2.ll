...
; CHECK-NEXT:    leal 257(%ebx,%eax), %eax
...
; CHECK-NEXT:    imull $3600000, 20(%esi), %eax # imm = 0x36EE80
; CHECK-NEXT:    imull $60000, 24(%esi), %ecx # imm = 0xEA60
