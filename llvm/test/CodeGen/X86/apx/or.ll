...
; NDD-NEXT:    orb %dil, %al # encoding: [0x40,0x08,0xf8]
; NDD-NEXT:    retq # encoding: [0xc3]
;
; IMMONLY-LABEL: or8rm:
; IMMONLY:       # %bb.0: # %entry
; IMMONLY-NEXT:    movzbl (%rsi), %eax # encoding: [0x0f,0xb6,0x06]
; IMMONLY-NEXT:    orb %dil, %al # encoding: [0x40,0x08,0xf8]
...
; NF-NEXT:    orb %dil, %al # encoding: [0x40,0x08,0xf8]
; NF-NEXT:    retq # encoding: [0xc3]
entry:
    %t = load i8, ptr %b
    %or = or i8 %a, %t
...
; NDD-NEXT:    orw %di, %ax # encoding: [0x66,0x09,0xf8]
; NDD-NEXT:    retq # encoding: [0xc3]
;
; IMMONLY-LABEL: or16rm:
; IMMONLY:       # %bb.0: # %entry
; IMMONLY-NEXT:    movzwl (%rsi), %eax # encoding: [0x0f,0xb7,0x06]
; IMMONLY-NEXT:    orw %di, %ax # encoding: [0x66,0x09,0xf8]
; IMMONLY-NEXT:    retq # encoding: [0xc3]
;
; MEM-LABEL: or16rm:
; MEM:       # %bb.0: # %entry
...
; NF-NEXT:    orw %di, %ax # encoding: [0x66,0x09,0xf8]
; NF-NEXT:    retq # encoding: [0xc3]
entry:
    %t = load i16, ptr %b
    %or = or i16 %a, %t
...
; NDD-NEXT:    orq %rdi, %rax # encoding: [0x48,0x09,0xf8]
; NDD-NEXT:    retq # encoding: [0xc3]
;
; IMMONLY-LABEL: or64rm:
; IMMONLY:       # %bb.0: # %entry
; IMMONLY-NEXT:    movq (%rsi), %rax # encoding: [0x48,0x8b,0x06]
; IMMONLY-NEXT:    orq %rdi, %rax # encoding: [0x48,0x09,0xf8]
; IMMONLY-NEXT:    retq # encoding: [0xc3]
;
; MEM-LABEL: or64rm:
; MEM:       # %bb.0: # %entry
...
; NF-NEXT:    orq %rdi, %rax # encoding: [0x48,0x09,0xf8]
; NF-NEXT:    retq # encoding: [0xc3]
entry:
    %t = load i64, ptr %b
    %or = or i64 %a, %t
...
; NDD-NEXT:    orb %sil, %al # encoding: [0x40,0x08,0xf0]
; NDD-NEXT:    retq # encoding: [0xc3]
;
; IMMONLY-LABEL: or8mr:
; IMMONLY:       # %bb.0: # %entry
; IMMONLY-NEXT:    movzbl (%rdi), %eax # encoding: [0x0f,0xb6,0x07]
; IMMONLY-NEXT:    orb %sil, %al # encoding: [0x40,0x08,0xf0]
; IMMONLY-NEXT:    retq # encoding: [0xc3]
;
; MEM-LABEL: or8mr:
; MEM:       # %bb.0: # %entry
...
; NF-NEXT:    orb %sil, %al # encoding: [0x40,0x08,0xf0]
; NF-NEXT:    retq # encoding: [0xc3]
entry:
  %t= load i8, ptr %a
  %or = or i8 %t, %b
...
; NDD-NEXT:    orw %si, %ax # encoding: [0x66,0x09,0xf0]
; NDD-NEXT:    retq # encoding: [0xc3]
;
; IMMONLY-LABEL: or16mr:
; IMMONLY:       # %bb.0: # %entry
; IMMONLY-NEXT:    movzwl (%rdi), %eax # encoding: [0x0f,0xb7,0x07]
; IMMONLY-NEXT:    orw %si, %ax # encoding: [0x66,0x09,0xf0]
; IMMONLY-NEXT:    retq # encoding: [0xc3]
;
; MEM-LABEL: or16mr:
; MEM:       # %bb.0: # %entry
...
; NF-NEXT:    orw %si, %ax # encoding: [0x66,0x09,0xf0]
; NF-NEXT:    retq # encoding: [0xc3]
entry:
  %t= load i16, ptr %a
  %or = or i16 %t, %b
...
; NDD-NEXT:    orl %esi, %eax # encoding: [0x09,0xf0]
; NDD-NEXT:    retq # encoding: [0xc3]
;
; IMMONLY-LABEL: or32mr:
; IMMONLY:       # %bb.0: # %entry
; IMMONLY-NEXT:    movl (%rdi), %eax # encoding: [0x8b,0x07]
; IMMONLY-NEXT:    orl %esi, %eax # encoding: [0x09,0xf0]
; IMMONLY-NEXT:    retq # encoding: [0xc3]
;
; MEM-LABEL: or32mr:
; MEM:       # %bb.0: # %entry
...
; NF-NEXT:    orl %esi, %eax # encoding: [0x09,0xf0]
; NF-NEXT:    retq # encoding: [0xc3]
entry:
  %t= load i32, ptr %a
  %or = or i32 %t, %b
...
; NDD-NEXT:    orq %rsi, %rax # encoding: [0x48,0x09,0xf0]
; NDD-NEXT:    retq # encoding: [0xc3]
;
; IMMONLY-LABEL: or64mr:
; IMMONLY:       # %bb.0: # %entry
; IMMONLY-NEXT:    movq (%rdi), %rax # encoding: [0x48,0x8b,0x07]
; IMMONLY-NEXT:    orq %rsi, %rax # encoding: [0x48,0x09,0xf0]
; IMMONLY-NEXT:    retq # encoding: [0xc3]
;
; MEM-LABEL: or64mr:
; MEM:       # %bb.0: # %entry
...
; NF-NEXT:    orq %rsi, %rax # encoding: [0x48,0x09,0xf0]
; NF-NEXT:    retq # encoding: [0xc3]
entry:
  %t= load i64, ptr %a
  %or = or i64 %t, %b
...
; NDD-NEXT:    orl %esi, %ecx # encoding: [0x09,0xf1]
; NDD-NEXT:    sete %al # encoding: [0x0f,0x94,0xc0]
...
; IMMONLY-NEXT:    orl %esi, %ecx # encoding: [0x09,0xf1]
; IMMONLY-NEXT:    sete %al # encoding: [0x0f,0x94,0xc0]
...
; NF-NEXT:    orl %esi, %ecx # encoding: [0x09,0xf1]
; NF-NEXT:    sete %al # encoding: [0x0f,0x94,0xc0]
...
; NDD-NEXT:    orq %rsi, %rcx # encoding: [0x48,0x09,0xf1]
; NDD-NEXT:    sete %al # encoding: [0x0f,0x94,0xc0]
...
; IMMONLY-NEXT:    orq %rsi, %rcx # encoding: [0x48,0x09,0xf1]
; IMMONLY-NEXT:    sete %al # encoding: [0x0f,0x94,0xc0]
...
; NF-NEXT:    orq %rsi, %rcx # encoding: [0x48,0x09,0xf1]
; NF-NEXT:    sete %al # encoding: [0x0f,0x94,0xc0]
