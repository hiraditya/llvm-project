...
; NDD-NEXT:    adcb %dil, %al # encoding: [0x40,0x10,0xf8]
...
; NDD-NEXT:    adcw %di, %ax # encoding: [0x66,0x11,0xf8]
; NDD-NEXT:    retq # encoding: [0xc3]
;
; MEM-LABEL: adc16rm:
; MEM:       # %bb.0:
...
; NDD-NEXT:    adcl %edi, %eax # encoding: [0x11,0xf8]
; NDD-NEXT:    retq # encoding: [0xc3]
;
; MEM-LABEL: adc32rm:
; MEM:       # %bb.0:
...
; NDD-NEXT:    adcq %rdi, %rax # encoding: [0x48,0x11,0xf8]
; NDD-NEXT:    retq # encoding: [0xc3]
;
; MEM-LABEL: adc64rm:
; MEM:       # %bb.0:
