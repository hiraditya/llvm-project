...
; NDD-NEXT:    xorb %dil, %al # encoding: [0x40,0x30,0xf8]
; NDD-NEXT:    retq # encoding: [0xc3]
;
; IMMONLY-LABEL: xor8rm:
; IMMONLY:       # %bb.0: # %entry
; IMMONLY-NEXT:    movzbl (%rsi), %eax # encoding: [0x0f,0xb6,0x06]
; IMMONLY-NEXT:    xorb %dil, %al # encoding: [0x40,0x30,0xf8]
...
; NF-NEXT:    xorb %dil, %al # encoding: [0x40,0x30,0xf8]
; NF-NEXT:    retq # encoding: [0xc3]
entry:
    %t = load i8, ptr %b
    %xor = xor i8 %a, %t
...
; NDD-NEXT:    xorw %di, %ax # encoding: [0x66,0x31,0xf8]
; NDD-NEXT:    retq # encoding: [0xc3]
;
; IMMONLY-LABEL: xor16rm:
; IMMONLY:       # %bb.0: # %entry
; IMMONLY-NEXT:    movzwl (%rsi), %eax # encoding: [0x0f,0xb7,0x06]
; IMMONLY-NEXT:    xorw %di, %ax # encoding: [0x66,0x31,0xf8]
; IMMONLY-NEXT:    retq # encoding: [0xc3]
;
; MEM-LABEL: xor16rm:
; MEM:       # %bb.0: # %entry
...
; NF-NEXT:    xorw %di, %ax # encoding: [0x66,0x31,0xf8]
; NF-NEXT:    retq # encoding: [0xc3]
entry:
    %t = load i16, ptr %b
    %xor = xor i16 %a, %t
...
; NDD-NEXT:    xorl %edi, %eax # encoding: [0x31,0xf8]
; NDD-NEXT:    retq # encoding: [0xc3]
;
; IMMONLY-LABEL: xor32rm:
; IMMONLY:       # %bb.0: # %entry
; IMMONLY-NEXT:    movl (%rsi), %eax # encoding: [0x8b,0x06]
; IMMONLY-NEXT:    xorl %edi, %eax # encoding: [0x31,0xf8]
; IMMONLY-NEXT:    retq # encoding: [0xc3]
;
; MEM-LABEL: xor32rm:
; MEM:       # %bb.0: # %entry
...
; NF-NEXT:    xorl %edi, %eax # encoding: [0x31,0xf8]
; NF-NEXT:    retq # encoding: [0xc3]
entry:
    %t = load i32, ptr %b
    %xor = xor i32 %a, %t
...
; NDD-NEXT:    xorq %rdi, %rax # encoding: [0x48,0x31,0xf8]
; NDD-NEXT:    retq # encoding: [0xc3]
;
; IMMONLY-LABEL: xor64rm:
; IMMONLY:       # %bb.0: # %entry
; IMMONLY-NEXT:    movq (%rsi), %rax # encoding: [0x48,0x8b,0x06]
; IMMONLY-NEXT:    xorq %rdi, %rax # encoding: [0x48,0x31,0xf8]
; IMMONLY-NEXT:    retq # encoding: [0xc3]
;
; MEM-LABEL: xor64rm:
; MEM:       # %bb.0: # %entry
...
; NF-NEXT:    xorq %rdi, %rax # encoding: [0x48,0x31,0xf8]
; NF-NEXT:    retq # encoding: [0xc3]
entry:
    %t = load i64, ptr %b
    %xor = xor i64 %a, %t
...
; NDD-NEXT:    xorb %sil, %al # encoding: [0x40,0x30,0xf0]
; NDD-NEXT:    retq # encoding: [0xc3]
;
; IMMONLY-LABEL: xor8mr:
; IMMONLY:       # %bb.0: # %entry
; IMMONLY-NEXT:    movzbl (%rdi), %eax # encoding: [0x0f,0xb6,0x07]
; IMMONLY-NEXT:    xorb %sil, %al # encoding: [0x40,0x30,0xf0]
; IMMONLY-NEXT:    retq # encoding: [0xc3]
;
; MEM-LABEL: xor8mr:
; MEM:       # %bb.0: # %entry
...
; NF-NEXT:    xorb %sil, %al # encoding: [0x40,0x30,0xf0]
; NF-NEXT:    retq # encoding: [0xc3]
entry:
  %t= load i8, ptr %a
  %xor = xor i8 %t, %b
...
; NDD-NEXT:    xorw %si, %ax # encoding: [0x66,0x31,0xf0]
; NDD-NEXT:    retq # encoding: [0xc3]
;
; IMMONLY-LABEL: xor16mr:
; IMMONLY:       # %bb.0: # %entry
; IMMONLY-NEXT:    movzwl (%rdi), %eax # encoding: [0x0f,0xb7,0x07]
; IMMONLY-NEXT:    xorw %si, %ax # encoding: [0x66,0x31,0xf0]
; IMMONLY-NEXT:    retq # encoding: [0xc3]
;
; MEM-LABEL: xor16mr:
; MEM:       # %bb.0: # %entry
...
; NF-NEXT:    xorw %si, %ax # encoding: [0x66,0x31,0xf0]
; NF-NEXT:    retq # encoding: [0xc3]
entry:
  %t= load i16, ptr %a
  %xor = xor i16 %t, %b
...
; NDD-NEXT:    xorl %esi, %eax # encoding: [0x31,0xf0]
; NDD-NEXT:    retq # encoding: [0xc3]
;
; IMMONLY-LABEL: xor32mr:
; IMMONLY:       # %bb.0: # %entry
; IMMONLY-NEXT:    movl (%rdi), %eax # encoding: [0x8b,0x07]
; IMMONLY-NEXT:    xorl %esi, %eax # encoding: [0x31,0xf0]
; IMMONLY-NEXT:    retq # encoding: [0xc3]
;
; MEM-LABEL: xor32mr:
; MEM:       # %bb.0: # %entry
...
; NF-NEXT:    xorl %esi, %eax # encoding: [0x31,0xf0]
; NF-NEXT:    retq # encoding: [0xc3]
entry:
  %t= load i32, ptr %a
  %xor = xor i32 %t, %b
...
; NDD-NEXT:    xorq %rsi, %rax # encoding: [0x48,0x31,0xf0]
; NDD-NEXT:    retq # encoding: [0xc3]
;
; IMMONLY-LABEL: xor64mr:
; IMMONLY:       # %bb.0: # %entry
; IMMONLY-NEXT:    movq (%rdi), %rax # encoding: [0x48,0x8b,0x07]
; IMMONLY-NEXT:    xorq %rsi, %rax # encoding: [0x48,0x31,0xf0]
; IMMONLY-NEXT:    retq # encoding: [0xc3]
;
; MEM-LABEL: xor64mr:
; MEM:       # %bb.0: # %entry
...
; NF-NEXT:    xorq %rsi, %rax # encoding: [0x48,0x31,0xf0]
; NF-NEXT:    retq # encoding: [0xc3]
entry:
  %t= load i64, ptr %a
  %xor = xor i64 %t, %b
...
; NDD-NEXT:    xorl %esi, %ecx # encoding: [0x31,0xf1]
; NDD-NEXT:    sete %al # encoding: [0x0f,0x94,0xc0]
...
; IMMONLY-NEXT:    xorl %esi, %ecx # encoding: [0x31,0xf1]
; IMMONLY-NEXT:    sete %al # encoding: [0x0f,0x94,0xc0]
...
; NF-NEXT:    xorl %esi, %ecx # encoding: [0x31,0xf1]
; NF-NEXT:    sete %al # encoding: [0x0f,0x94,0xc0]
...
; NDD-NEXT:    xorq %rsi, %rcx # encoding: [0x48,0x31,0xf1]
; NDD-NEXT:    sete %al # encoding: [0x0f,0x94,0xc0]
...
; IMMONLY-NEXT:    xorq %rsi, %rcx # encoding: [0x48,0x31,0xf1]
; IMMONLY-NEXT:    sete %al # encoding: [0x0f,0x94,0xc0]
...
; NF-NEXT:    xorq %rsi, %rcx # encoding: [0x48,0x31,0xf1]
; NF-NEXT:    sete %al # encoding: [0x0f,0x94,0xc0]
