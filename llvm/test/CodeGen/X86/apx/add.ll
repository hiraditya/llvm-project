...
; NDD-NEXT:    addb %dil, %al # encoding: [0x40,0x00,0xf8]
; NDD-NEXT:    retq # encoding: [0xc3]
;
; IMMONLY-LABEL: add8rm:
; IMMONLY:       # %bb.0: # %entry
; IMMONLY-NEXT:    movzbl (%rsi), %eax # encoding: [0x0f,0xb6,0x06]
; IMMONLY-NEXT:    addb %dil, %al # encoding: [0x40,0x00,0xf8]
...
; NF-NEXT:    addb %dil, %al # encoding: [0x40,0x00,0xf8]
; NF-NEXT:    retq # encoding: [0xc3]
entry:
    %b = load i8, ptr %ptr
    %add = add i8 %a, %b
...
; NDD-NEXT:    addw %di, %ax # encoding: [0x66,0x01,0xf8]
; NDD-NEXT:    retq # encoding: [0xc3]
;
; IMMONLY-LABEL: add16rm:
; IMMONLY:       # %bb.0: # %entry
; IMMONLY-NEXT:    movzwl (%rsi), %eax # encoding: [0x0f,0xb7,0x06]
; IMMONLY-NEXT:    addw %di, %ax # encoding: [0x66,0x01,0xf8]
; IMMONLY-NEXT:    retq # encoding: [0xc3]
;
; MEM-LABEL: add16rm:
; MEM:       # %bb.0: # %entry
...
; NF-NEXT:    addw %di, %ax # encoding: [0x66,0x01,0xf8]
; NF-NEXT:    retq # encoding: [0xc3]
entry:
    %b = load i16, ptr %ptr
    %add = add i16 %a, %b
...
; NDD-NEXT:    addl %edi, %eax # encoding: [0x01,0xf8]
; NDD-NEXT:    retq # encoding: [0xc3]
;
; IMMONLY-LABEL: add32rm:
; IMMONLY:       # %bb.0: # %entry
; IMMONLY-NEXT:    movl (%rsi), %eax # encoding: [0x8b,0x06]
; IMMONLY-NEXT:    addl %edi, %eax # encoding: [0x01,0xf8]
; IMMONLY-NEXT:    retq # encoding: [0xc3]
;
; MEM-LABEL: add32rm:
; MEM:       # %bb.0: # %entry
...
; NF-NEXT:    addl %edi, %eax # encoding: [0x01,0xf8]
; NF-NEXT:    retq # encoding: [0xc3]
entry:
    %b = load i32, ptr %ptr
    %add = add i32 %a, %b
...
; NDD-NEXT:    addq %rdi, %rax # encoding: [0x48,0x01,0xf8]
; NDD-NEXT:    retq # encoding: [0xc3]
;
; IMMONLY-LABEL: add64rm:
; IMMONLY:       # %bb.0: # %entry
; IMMONLY-NEXT:    movq (%rsi), %rax # encoding: [0x48,0x8b,0x06]
; IMMONLY-NEXT:    addq %rdi, %rax # encoding: [0x48,0x01,0xf8]
; IMMONLY-NEXT:    retq # encoding: [0xc3]
;
; MEM-LABEL: add64rm:
; MEM:       # %bb.0: # %entry
...
; NF-NEXT:    addq %rdi, %rax # encoding: [0x48,0x01,0xf8]
; NF-NEXT:    retq # encoding: [0xc3]
entry:
    %b = load i64, ptr %ptr
    %add = add i64 %a, %b
...
; NDD-NEXT:    addb %sil, %al # encoding: [0x40,0x00,0xf0]
; NDD-NEXT:    retq # encoding: [0xc3]
;
; IMMONLY-LABEL: add8mr:
; IMMONLY:       # %bb.0: # %entry
; IMMONLY-NEXT:    movzbl (%rdi), %eax # encoding: [0x0f,0xb6,0x07]
; IMMONLY-NEXT:    addb %sil, %al # encoding: [0x40,0x00,0xf0]
; IMMONLY-NEXT:    retq # encoding: [0xc3]
;
; MEM-LABEL: add8mr:
; MEM:       # %bb.0: # %entry
...
; NF-NEXT:    addb %sil, %al # encoding: [0x40,0x00,0xf0]
; NF-NEXT:    retq # encoding: [0xc3]
entry:
  %t= load i8, ptr %a
  %add = add nsw i8 %t, %b
...
; NDD-NEXT:    addw %si, %ax # encoding: [0x66,0x01,0xf0]
; NDD-NEXT:    retq # encoding: [0xc3]
;
; IMMONLY-LABEL: add16mr:
; IMMONLY:       # %bb.0: # %entry
; IMMONLY-NEXT:    movzwl (%rdi), %eax # encoding: [0x0f,0xb7,0x07]
; IMMONLY-NEXT:    addw %si, %ax # encoding: [0x66,0x01,0xf0]
; IMMONLY-NEXT:    retq # encoding: [0xc3]
;
; MEM-LABEL: add16mr:
; MEM:       # %bb.0: # %entry
...
; NF-NEXT:    addw %si, %ax # encoding: [0x66,0x01,0xf0]
; NF-NEXT:    retq # encoding: [0xc3]
entry:
  %t= load i16, ptr %a
  %add = add nsw i16 %t, %b
...
; NDD-NEXT:    addl %esi, %eax # encoding: [0x01,0xf0]
; NDD-NEXT:    retq # encoding: [0xc3]
;
; IMMONLY-LABEL: add32mr:
; IMMONLY:       # %bb.0: # %entry
; IMMONLY-NEXT:    movl (%rdi), %eax # encoding: [0x8b,0x07]
; IMMONLY-NEXT:    addl %esi, %eax # encoding: [0x01,0xf0]
; IMMONLY-NEXT:    retq # encoding: [0xc3]
;
; MEM-LABEL: add32mr:
; MEM:       # %bb.0: # %entry
...
; NF-NEXT:    addl %esi, %eax # encoding: [0x01,0xf0]
; NF-NEXT:    retq # encoding: [0xc3]
entry:
  %t= load i32, ptr %a
  %add = add nsw i32 %t, %b
...
; NDD-NEXT:    addq %rsi, %rax # encoding: [0x48,0x01,0xf0]
; NDD-NEXT:    retq # encoding: [0xc3]
;
; IMMONLY-LABEL: add64mr:
; IMMONLY:       # %bb.0: # %entry
; IMMONLY-NEXT:    movq (%rdi), %rax # encoding: [0x48,0x8b,0x07]
; IMMONLY-NEXT:    addq %rsi, %rax # encoding: [0x48,0x01,0xf0]
; IMMONLY-NEXT:    retq # encoding: [0xc3]
;
; MEM-LABEL: add64mr:
; MEM:       # %bb.0: # %entry
...
; NF-NEXT:    addq %rsi, %rax # encoding: [0x48,0x01,0xf0]
; NF-NEXT:    retq # encoding: [0xc3]
entry:
  %t= load i64, ptr %a
  %add = add nsw i64 %t, %b
