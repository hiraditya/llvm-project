...
; SSE-NEXT:    movdqa {{.*#+}} xmm0 = [64,64,64,64,64,64,64,64,64,64,64,64,64,64,64,64]
...
; SSE4-NEXT:    movdqa %xmm3, %xmm2
; SSE4-NEXT:    pxor %xmm7, %xmm2
; SSE4-NEXT:    movdqa %xmm2, %xmm5
; SSE4-NEXT:    psrad $1, %xmm5
; SSE4-NEXT:    psrlq $1, %xmm2
; SSE4-NEXT:    pblendw {{.*#+}} xmm5 = xmm2[0,1],xmm5[2,3],xmm2[4,5],xmm5[6,7]
; SSE4-NEXT:    pand %xmm7, %xmm3
; SSE4-NEXT:    paddq %xmm3, %xmm5
; SSE4-NEXT:    movdqa %xmm4, %xmm2
