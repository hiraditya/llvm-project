...
; SSE2-SSSE3-NEXT:    pandn %xmm3, %xmm1
...
; SSE2-SSSE3-NEXT:    pandn {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %xmm5
...
; SSE2-SSSE3-NEXT:    shufps {{.*#+}} xmm1 = xmm1[0,2],xmm5[0,2]
...
; AVX512BWVL-NEXT:    vpblendmq %ymm0, %ymm1, %ymm0 {%k1}
...
; SKX-NEXT:    vpblendmq %ymm0, %ymm1, %ymm0 {%k1}
...
; SSE2-SSSE3-NEXT:    movdqa {{.*#+}} xmm0 = [2147483647,2147483647,2147483647,2147483647]
...
; SSE2-SSSE3-NEXT:    packssdw %xmm5, %xmm5
...
; SSE2-SSSE3-NEXT:    movdqa %xmm2, %xmm9
; SSE2-SSSE3-NEXT:    pcmpgtd %xmm7, %xmm9
...
; SSE2-SSSE3-NEXT:    shufps {{.*#+}} xmm2 = xmm2[0,2],xmm8[0,2]
...
; SSE41:       # %bb.0:
; SSE41-NEXT:    pmovsxbw {{.*#+}} xmm1 = [65535,0,65535,0,65535,0,65535,0]
...
; SSSE3-NEXT:    punpcklqdq {{.*#+}} xmm1 = xmm1[0],xmm7[0]
; SSSE3-NEXT:    retq
;
...
; SSE2-SSSE3-NEXT:    packuswb %xmm9, %xmm5
...
; SSE2-SSSE3-NEXT:    por %xmm0, %xmm2
; SSE2-SSSE3-NEXT:    packuswb %xmm8, %xmm2
...
; SSE2-SSSE3-NEXT:    movdqa 112(%rdi), %xmm5
...
; SSE2-SSSE3-NEXT:    movdqa {{.*#+}} xmm3 = [2147483903,2147483903,2147483903,2147483903]
; SSE2-SSSE3-NEXT:    movdqa %xmm3, %xmm13
...
; SSE2-SSSE3-NEXT:    pandn %xmm2, %xmm13
; SSE2-SSSE3-NEXT:    por %xmm0, %xmm13
; SSE2-SSSE3-NEXT:    movdqa %xmm10, %xmm0
; SSE2-SSSE3-NEXT:    pxor %xmm4, %xmm0
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm11 = xmm0[0,0,2,2]
; SSE2-SSSE3-NEXT:    movdqa %xmm3, %xmm12
; SSE2-SSSE3-NEXT:    pcmpgtd %xmm11, %xmm12
; SSE2-SSSE3-NEXT:    pshufd {{.*#+}} xmm0 = xmm0[1,1,3,3]
; SSE2-SSSE3-NEXT:    pcmpeqd %xmm4, %xmm0
; SSE2-SSSE3-NEXT:    pand %xmm0, %xmm12
; SSE2-SSSE3-NEXT:    pand %xmm12, %xmm10
; SSE2-SSSE3-NEXT:    movdqa %xmm12, %xmm0
; SSE2-SSSE3-NEXT:    pandn %xmm2, %xmm0
; SSE2-SSSE3-NEXT:    por %xmm10, %xmm0
; SSE2-SSSE3-NEXT:    packuswb %xmm13, %xmm0
...
; SSE2-SSSE3-NEXT:    pandn %xmm2, %xmm12
...
; SSE2-SSSE3-NEXT:    packuswb %xmm12, %xmm11
...
; SSE2-SSSE3-NEXT:    packuswb %xmm10, %xmm7
; SSE2-SSSE3-NEXT:    movdqa %xmm5, %xmm6
; SSE2-SSSE3-NEXT:    pxor %xmm4, %xmm6
...
; SSE2-SSSE3-NEXT:    pandn %xmm2, %xmm3
; SSE2-SSSE3-NEXT:    por %xmm1, %xmm3
; SSE2-SSSE3-NEXT:    packuswb %xmm9, %xmm3
...
; SSE2-SSSE3-NEXT:    pandn %xmm2, %xmm1
; SSE2-SSSE3-NEXT:    por %xmm0, %xmm1
; SSE2-SSSE3-NEXT:    packuswb %xmm6, %xmm1
; SSE2-SSSE3-NEXT:    packuswb %xmm1, %xmm1
; SSE2-SSSE3-NEXT:    movdqa %xmm1, %xmm0
; SSE2-SSSE3-NEXT:    retq
;
...
; SSE2-SSSE3-NEXT:    pandn %xmm2, %xmm3
; SSE2-SSSE3-NEXT:    por %xmm1, %xmm3
; SSE2-SSSE3-NEXT:    packuswb %xmm7, %xmm3
; SSE2-SSSE3-NEXT:    packuswb %xmm3, %xmm0
; SSE2-SSSE3-NEXT:    retq
;
...
; SSE2-SSSE3-NEXT:    pcmpgtd %xmm8, %xmm9
; SSE2-SSSE3-NEXT:    pand %xmm9, %xmm0
; SSE2-SSSE3-NEXT:    pandn %xmm3, %xmm9
; SSE2-SSSE3-NEXT:    por %xmm0, %xmm9
; SSE2-SSSE3-NEXT:    movdqa %xmm7, %xmm0
...
; SSE2-SSSE3-NEXT:    pxor %xmm6, %xmm4
; SSE2-SSSE3-NEXT:    pcmpgtd %xmm4, %xmm5
; SSE2-SSSE3-NEXT:    pand %xmm5, %xmm2
