...
; CHECK-NOBMI-NEXT:    andl $-4081, %eax # imm = 0xF00F
...
; CHECK-BMI-NEXT:    andl $-4081, %eax # imm = 0xF00F
...
; CHECK-NOBMI-NEXT:    andl $-16776961, %eax # imm = 0xFF0000FF
; CHECK-NOBMI-NEXT:    orl %edi, %eax
; CHECK-NOBMI-NEXT:    retq
;
...
; CHECK-BMI-NEXT:    andl $-16776961, %eax # imm = 0xFF0000FF
; CHECK-BMI-NEXT:    orl %edi, %eax
; CHECK-BMI-NEXT:    retq
