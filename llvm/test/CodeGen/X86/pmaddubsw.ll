...
; SSE-NEXT:    pmaddwd %xmm5, %xmm4
; SSE-NEXT:    pshufb {{.*#+}} xmm0 = xmm0[0],zero,xmm0[2],zero,xmm0[4],zero,xmm0[6],zero,xmm0[u,u,u,u,u,u,u,u]
...
; SSE:       # %bb.0:
; SSE-NEXT:    movdqa (%rdi), %xmm1
; SSE-NEXT:    pmaddubsw (%rsi), %xmm1
; SSE-NEXT:    movdqa {{.*#+}} xmm0 = [0,0,65535,0,0,65535,0,65535]
