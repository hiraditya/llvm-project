...
; CHECK-NEXT:    addl $8, %esi
; CHECK-NEXT:    .p2align 4
; CHECK-NEXT:  LBB0_2: ## %bb
; CHECK-NEXT:    ## =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    movl (%edx), %edi
; CHECK-NEXT:    movzbl -8(%esi), %ebx
; CHECK-NEXT:    movb %bl, (%edi,%ecx)
; CHECK-NEXT:    movzbl -7(%esi), %ebx
; CHECK-NEXT:    movb %bl, 7(%edi,%ecx)
; CHECK-NEXT:    movzbl -6(%esi), %ebx
; CHECK-NEXT:    movb %bl, 5(%edi,%ecx)
; CHECK-NEXT:    movzbl -5(%esi), %ebx
; CHECK-NEXT:    movb %bl, 3(%edi,%ecx)
; CHECK-NEXT:    movzbl -4(%esi), %ebx
; CHECK-NEXT:    movb %bl, 2(%edi,%ecx)
; CHECK-NEXT:    movzbl -3(%esi), %ebx
; CHECK-NEXT:    movb %bl, 1(%edi,%ecx)
; CHECK-NEXT:    movzbl -2(%esi), %ebx
; CHECK-NEXT:    movb %bl, 2(%edi,%ecx)
; CHECK-NEXT:    movzbl -1(%esi), %ebx
; CHECK-NEXT:    movb %bl, 4(%edi,%ecx)
; CHECK-NEXT:    movzbl (%esi), %ebx
; CHECK-NEXT:    movb %bl, 6(%edi,%ecx)
; CHECK-NEXT:    addl $4, %edx
; CHECK-NEXT:    addl $9, %esi
; CHECK-NEXT:    decl %eax
