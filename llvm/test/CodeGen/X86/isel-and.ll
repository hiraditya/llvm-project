...
; SDAG-X86-NEXT:    andl %ecx, %eax
; SDAG-X86-NEXT:    movl {{[0-9]+}}(%esp), %edx
; SDAG-X86-NEXT:    andl %esi, %edx
...
; FASTISEL-X86-NEXT:    andl %edx, %eax
; FASTISEL-X86-NEXT:    movl {{[0-9]+}}(%esp), %edx
; FASTISEL-X86-NEXT:    andl %ecx, %edx
; FASTISEL-X86-NEXT:    retl
;
