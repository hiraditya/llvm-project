...
; CHECK:       # %bb.0:
; CHECK-NEXT:    leaq 2(%rdi), %rcx
; CHECK-NEXT:    leaq 2147483647(%rdi), %rax
...
; CHECK-NEXT:    cmpq $41, %rsi
; CHECK-NEXT:    movl $2147483649, %eax # imm = 0x80000001
; CHECK-NEXT:    movabsq $42000000000, %rcx # imm = 0x9C7652400
; CHECK-NEXT:    cmoveq %rcx, %rax
; CHECK-NEXT:    addq %rdi, %rax
; CHECK-NEXT:    retq
  %b = icmp ne i64 %x, 41
...
; CHECK-NEXT:    leaq 60(%rsi,%rcx), %rax
; CHECK-NEXT:    leaq 66(%rsi,%rcx), %rcx
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    leaq 60(%rsi), %rcx
; CHECK-NEXT:    leaq 66(%rsi), %rax
; CHECK-NEXT:    testb $1, %dil
