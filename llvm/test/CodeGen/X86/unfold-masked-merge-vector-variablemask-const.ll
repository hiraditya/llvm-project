...
; CHECK-SSE1-NEXT:    andps %xmm0, %xmm2
; CHECK-SSE1-NEXT:    orps %xmm2, %xmm1
...
; CHECK-SSE2:       # %bb.0:
; CHECK-SSE2-NEXT:    movdqa (%rdi), %xmm1
; CHECK-SSE2-NEXT:    pcmpeqd %xmm0, %xmm0
; CHECK-SSE2-NEXT:    pandn (%rdx), %xmm1
; CHECK-SSE2-NEXT:    pxor %xmm1, %xmm0
; CHECK-SSE2-NEXT:    retq
;
...
; CHECK-SSE2-NEXT:    andps %xmm1, %xmm0
...
; CHECK-SSE1-NEXT:    movaps {{.*#+}} xmm1 = [NaN,NaN,NaN,NaN]
; CHECK-SSE1-NEXT:    xorps %xmm0, %xmm1
; CHECK-SSE1-NEXT:    movaps (%rdx), %xmm2
; CHECK-SSE1-NEXT:    andps %xmm0, %xmm2
; CHECK-SSE1-NEXT:    orps %xmm1, %xmm2
...
; CHECK-SSE2-NEXT:    movdqa (%rsi), %xmm0
