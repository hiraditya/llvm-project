...
; NHM:       # %bb.0:
; NHM-NEXT:    rsqrtss %xmm0, %xmm2
; NHM-NEXT:    movaps {{.*#+}} xmm1 = [NaN,NaN,NaN,NaN]
; NHM-NEXT:    andps %xmm0, %xmm1
; NHM-NEXT:    mulss %xmm2, %xmm0
; NHM-NEXT:    movss {{.*#+}} xmm3 = [-5.0E-1,0.0E+0,0.0E+0,0.0E+0]
; NHM-NEXT:    mulss %xmm0, %xmm3
; NHM-NEXT:    mulss %xmm2, %xmm0
; NHM-NEXT:    movss {{.*#+}} xmm2 = [-3.0E+0,0.0E+0,0.0E+0,0.0E+0]
; NHM-NEXT:    addss %xmm0, %xmm2
; NHM-NEXT:    mulss %xmm3, %xmm2
; NHM-NEXT:    cmpltss {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %xmm1
; NHM-NEXT:    andnps %xmm2, %xmm1
...
; NHM-NEXT:    movaps {{.*#+}} xmm2 = [NaN,NaN,NaN,NaN]
; NHM-NEXT:    andps %xmm0, %xmm2
...
; X86-64-NEXT:    movaps {{.*#+}} xmm2 = [NaN,NaN,NaN,NaN]
; X86-64-NEXT:    andps %xmm0, %xmm2
; X86-64-NEXT:    movaps %xmm0, %xmm3
; X86-64-NEXT:    mulps %xmm1, %xmm3
; X86-64-NEXT:    movaps {{.*#+}} xmm4 = [-5.0E-1,-5.0E-1,-5.0E-1,-5.0E-1]
; X86-64-NEXT:    mulps %xmm3, %xmm4
; X86-64-NEXT:    mulps %xmm1, %xmm3
; X86-64-NEXT:    movaps {{.*#+}} xmm0 = [-3.0E+0,-3.0E+0,-3.0E+0,-3.0E+0]
; X86-64-NEXT:    addps %xmm3, %xmm0
; X86-64-NEXT:    mulps %xmm4, %xmm0
; X86-64-NEXT:    movaps {{.*#+}} xmm1 = [1.17549435E-38,1.17549435E-38,1.17549435E-38,1.17549435E-38]
; X86-64-NEXT:    cmpleps %xmm2, %xmm1
; X86-64-NEXT:    andps %xmm1, %xmm0
; X86-64-NEXT:    retq
...
; NHM-NEXT:    movaps %xmm2, %xmm8
; NHM-NEXT:    mulps %xmm4, %xmm8
; NHM-NEXT:    mulps %xmm7, %xmm2
; NHM-NEXT:    addps %xmm3, %xmm2
; NHM-NEXT:    mulps %xmm8, %xmm2
...
; X86-64-NEXT:    rsqrtps %xmm0, %xmm3
; X86-64-NEXT:    mulps %xmm3, %xmm0
; X86-64-NEXT:    movaps {{.*#+}} xmm4 = [-5.0E-1,-5.0E-1,-5.0E-1,-5.0E-1]
; X86-64-NEXT:    movaps %xmm0, %xmm5
; X86-64-NEXT:    mulps %xmm4, %xmm5
; X86-64-NEXT:    mulps %xmm3, %xmm0
; X86-64-NEXT:    movaps {{.*#+}} xmm3 = [-3.0E+0,-3.0E+0,-3.0E+0,-3.0E+0]
; X86-64-NEXT:    addps %xmm3, %xmm0
; X86-64-NEXT:    mulps %xmm5, %xmm0
; X86-64-NEXT:    movaps {{.*#+}} xmm5 = [NaN,NaN,NaN,NaN]
; X86-64-NEXT:    andps %xmm5, %xmm2
; X86-64-NEXT:    movaps {{.*#+}} xmm6 = [1.17549435E-38,1.17549435E-38,1.17549435E-38,1.17549435E-38]
; X86-64-NEXT:    movaps %xmm6, %xmm7
; X86-64-NEXT:    cmpleps %xmm2, %xmm7
; X86-64-NEXT:    andps %xmm7, %xmm0
; X86-64-NEXT:    rsqrtps %xmm1, %xmm7
; X86-64-NEXT:    movaps %xmm1, %xmm2
; X86-64-NEXT:    mulps %xmm7, %xmm2
; X86-64-NEXT:    movaps %xmm2, %xmm8
; X86-64-NEXT:    mulps %xmm4, %xmm8
; X86-64-NEXT:    mulps %xmm7, %xmm2
; X86-64-NEXT:    addps %xmm3, %xmm2
; X86-64-NEXT:    mulps %xmm8, %xmm2
; X86-64-NEXT:    andps %xmm5, %xmm1
; X86-64-NEXT:    cmpleps %xmm1, %xmm6
; X86-64-NEXT:    andps %xmm6, %xmm2
...
; NHM:       # %bb.0:
; NHM-NEXT:    rsqrtps %xmm0, %xmm1
; NHM-NEXT:    xorps %xmm2, %xmm2
; NHM-NEXT:    cmpneqps %xmm0, %xmm2
; NHM-NEXT:    movaps %xmm0, %xmm3
; NHM-NEXT:    mulps %xmm1, %xmm3
; NHM-NEXT:    movaps {{.*#+}} xmm4 = [-5.0E-1,-5.0E-1,-5.0E-1,-5.0E-1]
; NHM-NEXT:    mulps %xmm3, %xmm4
...
; X86-64-NEXT:    cmpneqps %xmm0, %xmm2
; X86-64-NEXT:    movaps %xmm0, %xmm3
; X86-64-NEXT:    mulps %xmm1, %xmm3
; X86-64-NEXT:    movaps {{.*#+}} xmm4 = [-5.0E-1,-5.0E-1,-5.0E-1,-5.0E-1]
; X86-64-NEXT:    mulps %xmm3, %xmm4
...
; NHM-NEXT:    movaps {{.*#+}} xmm4 = [-5.0E-1,-5.0E-1,-5.0E-1,-5.0E-1]
; NHM-NEXT:    movaps %xmm2, %xmm5
; NHM-NEXT:    mulps %xmm4, %xmm5
; NHM-NEXT:    mulps %xmm3, %xmm2
; NHM-NEXT:    movaps {{.*#+}} xmm6 = [-3.0E+0,-3.0E+0,-3.0E+0,-3.0E+0]
; NHM-NEXT:    addps %xmm6, %xmm2
; NHM-NEXT:    mulps %xmm5, %xmm2
; NHM-NEXT:    xorps %xmm5, %xmm5
; NHM-NEXT:    cmpneqps %xmm5, %xmm0
; NHM-NEXT:    andps %xmm0, %xmm2
; NHM-NEXT:    rsqrtps %xmm1, %xmm0
; NHM-NEXT:    movaps %xmm1, %xmm3
; NHM-NEXT:    mulps %xmm0, %xmm3
; NHM-NEXT:    movaps %xmm3, %xmm7
; NHM-NEXT:    mulps %xmm4, %xmm7
; NHM-NEXT:    mulps %xmm0, %xmm3
; NHM-NEXT:    addps %xmm6, %xmm3
; NHM-NEXT:    mulps %xmm7, %xmm3
; NHM-NEXT:    cmpneqps %xmm5, %xmm1
; NHM-NEXT:    andps %xmm1, %xmm3
; NHM-NEXT:    movaps %xmm2, %xmm0
; NHM-NEXT:    movaps %xmm3, %xmm1
; NHM-NEXT:    retq
;
; SNB-LABEL: v8f32_daz:
; SNB:       # %bb.0:
