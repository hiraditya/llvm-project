...
; SSE42-NEXT:    pblendw {{.*#+}} xmm2 = xmm2[0],xmm3[1,2],xmm2[3],xmm3[4,5,6,7]
; SSE42-NEXT:    pshufd {{.*#+}} xmm1 = xmm1[0,0,0,0]
; SSE42-NEXT:    pshufb {{.*#+}} xmm0 = xmm0[0,1,8,9,u,u,2,3,10,11,u,u,4,5,12,13]
; SSE42-NEXT:    pblendw {{.*#+}} xmm1 = xmm0[0,1],xmm1[2],xmm0[3,4],xmm1[5],xmm0[6,7]
...
; SSE2-NEXT:    movdqa {{.*#+}} xmm2 = [65535,65535,0,65535,65535,0,65535,65535]
...
; SSE2-NEXT:    pandn %xmm1, %xmm4
; SSE2-NEXT:    por %xmm3, %xmm4
; SSE2-NEXT:    pshufd {{.*#+}} xmm3 = xmm4[0,2,1,3]
...
; SSE2-NEXT:    pshufd {{.*#+}} xmm7 = xmm0[0,1,2,1]
; SSE2-NEXT:    pshufhw {{.*#+}} xmm7 = xmm7[0,1,2,3,4,5,6,5]
; SSE2-NEXT:    shufps {{.*#+}} xmm7 = xmm7[3,0],xmm4[2,0]
; SSE2-NEXT:    shufps {{.*#+}} xmm3 = xmm3[0,1],xmm7[2,0]
; SSE2-NEXT:    movdqa %xmm2, %xmm4
; SSE2-NEXT:    pandn %xmm1, %xmm4
; SSE2-NEXT:    pand %xmm2, %xmm5
; SSE2-NEXT:    por %xmm5, %xmm4
; SSE2-NEXT:    pshuflw {{.*#+}} xmm4 = xmm4[2,1,2,3,4,5,6,7]
; SSE2-NEXT:    pshufhw {{.*#+}} xmm4 = xmm4[0,1,2,3,4,5,4,7]
...
; SSE2-NEXT:    pshufd {{.*#+}} xmm1 = xmm6[3,1,2,0]
...
; SSE42-NEXT:    pblendw {{.*#+}} xmm3 = xmm4[0,1,2,3,4,5],xmm3[6,7]
; SSE42-NEXT:    movdqa %xmm0, %xmm4
; SSE42-NEXT:    pblendw {{.*#+}} xmm4 = xmm4[0,1],xmm1[2],xmm4[3,4],xmm1[5],xmm4[6,7]
; SSE42-NEXT:    pblendw {{.*#+}} xmm4 = xmm2[0],xmm4[1,2],xmm2[3],xmm4[4,5],xmm2[6],xmm4[7]
...
; SSE2-NEXT:    pshuflw {{.*#+}} xmm3 = xmm5[0,3,2,3,4,5,6,7]
; SSE2-NEXT:    pshufhw {{.*#+}} xmm3 = xmm3[0,1,2,3,6,5,6,7]
...
; SSE42-NEXT:    pblendw {{.*#+}} xmm4 = xmm4[0,1],xmm1[2],xmm4[3,4],xmm1[5],xmm4[6,7]
; SSE42-NEXT:    pblendw {{.*#+}} xmm4 = xmm4[0],xmm0[1],xmm4[2,3],xmm0[4],xmm4[5,6],xmm0[7]
...
; SSE2-NEXT:    pshufd {{.*#+}} xmm4 = xmm4[0,1,2,1]
; SSE2-NEXT:    pshuflw {{.*#+}} xmm4 = xmm4[0,1,2,2,4,5,6,7]
; SSE2-NEXT:    pshufhw {{.*#+}} xmm4 = xmm4[0,1,2,3,7,5,4,5]
; SSE2-NEXT:    pand %xmm5, %xmm4
; SSE2-NEXT:    por %xmm4, %xmm0
...
; SSE2-NEXT:    por %xmm4, %xmm5
; SSE2-NEXT:    movdqa {{.*#+}} xmm4 = [0,65535,65535,0,65535,65535,0,65535]
; SSE2-NEXT:    pand %xmm4, %xmm5
...
; SSE2-NEXT:    movups 80(%rdi), %xmm2
; SSE2-NEXT:    movdqu (%rdi), %xmm5
; SSE2-NEXT:    movdqu 16(%rdi), %xmm1
; SSE2-NEXT:    movups 32(%rdi), %xmm7
; SSE2-NEXT:    movdqu 48(%rdi), %xmm3
; SSE2-NEXT:    movaps %xmm7, %xmm4
; SSE2-NEXT:    pshufd {{.*#+}} xmm8 = xmm1[1,1,1,1]
; SSE2-NEXT:    pshufd {{.*#+}} xmm6 = xmm5[2,3,2,3]
; SSE2-NEXT:    punpckldq {{.*#+}} xmm6 = xmm6[0],xmm8[0],xmm6[1],xmm8[1]
; SSE2-NEXT:    shufps {{.*#+}} xmm6 = xmm6[0,1],xmm7[0,3]
; SSE2-NEXT:    shufps {{.*#+}} xmm7 = xmm7[1,0],xmm1[2,0]
; SSE2-NEXT:    movdqa %xmm5, %xmm8
; SSE2-NEXT:    shufps {{.*#+}} xmm5 = xmm5[0,3],xmm7[2,0]
; SSE2-NEXT:    movaps %xmm2, %xmm7
; SSE2-NEXT:    pshufd {{.*#+}} xmm9 = xmm0[1,1,1,1]
; SSE2-NEXT:    pshufd {{.*#+}} xmm10 = xmm3[2,3,2,3]
; SSE2-NEXT:    punpckldq {{.*#+}} xmm10 = xmm10[0],xmm9[0],xmm10[1],xmm9[1]
; SSE2-NEXT:    shufps {{.*#+}} xmm10 = xmm10[0,1],xmm2[0,3]
; SSE2-NEXT:    shufps {{.*#+}} xmm2 = xmm2[1,0],xmm0[2,0]
; SSE2-NEXT:    movdqa %xmm3, %xmm9
; SSE2-NEXT:    shufps {{.*#+}} xmm3 = xmm3[0,3],xmm2[2,0]
; SSE2-NEXT:    shufps {{.*#+}} xmm7 = xmm7[2,1],xmm0[3,3]
; SSE2-NEXT:    shufps {{.*#+}} xmm9 = xmm9[1,0],xmm0[0,0]
; SSE2-NEXT:    shufps {{.*#+}} xmm9 = xmm9[0,2],xmm7[2,0]
; SSE2-NEXT:    shufps {{.*#+}} xmm4 = xmm4[2,1],xmm1[3,3]
; SSE2-NEXT:    shufps {{.*#+}} xmm8 = xmm8[1,0],xmm1[0,0]
; SSE2-NEXT:    shufps {{.*#+}} xmm8 = xmm8[0,2],xmm4[2,0]
; SSE2-NEXT:    movups %xmm3, 16(%rsi)
; SSE2-NEXT:    movups %xmm5, (%rsi)
; SSE2-NEXT:    movups %xmm9, 16(%rdx)
; SSE2-NEXT:    movups %xmm8, (%rdx)
; SSE2-NEXT:    movups %xmm10, 16(%rcx)
...
; SSE2-NEXT:    pshufd {{.*#+}} xmm2 = xmm0[1,1,0,1]
; SSE2-NEXT:    movsd {{.*#+}} xmm0 = [0,4294967295,0,0]
...
; SSE42-NEXT:    pblendw {{.*#+}} xmm0 = xmm2[0,1],xmm0[2,3],xmm2[4,5,6,7]
