...
; CHECK-NOBMI-NEXT:    andl $-3856, %eax # imm = 0xF0F0
...
; CHECK-BMI-NEXT:    andl $-3856, %eax # imm = 0xF0F0
...
; CHECK-NOBMI-NEXT:    andl $-252645136, %eax # imm = 0xF0F0F0F0
; CHECK-NOBMI-NEXT:    orl %edi, %eax
; CHECK-NOBMI-NEXT:    retq
;
...
; CHECK-BMI-NEXT:    andl $-252645136, %eax # imm = 0xF0F0F0F0
; CHECK-BMI-NEXT:    orl %edi, %eax
; CHECK-BMI-NEXT:    retq
