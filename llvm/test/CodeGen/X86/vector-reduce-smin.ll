...
; SSE4-NEXT:    pminsd %xmm2, %xmm3
; SSE4-NEXT:    pshufd {{.*#+}} xmm0 = xmm3[2,3,2,3]
; SSE4-NEXT:    pminsd %xmm3, %xmm0
; SSE4-NEXT:    pshufd {{.*#+}} xmm1 = xmm0[1,1,1,1]
; SSE4-NEXT:    pminsd %xmm0, %xmm1
; SSE4-NEXT:    movd %xmm1, %eax
; SSE4-NEXT:    retq
...
; SSE4:       # %bb.0:
; SSE4-NEXT:    movdqa {{.*#+}} xmm1 = [32768,32768,32768,32768,32768,32768,32768,32768]
...
; SSE4-NEXT:    movdqa {{.*#+}} xmm0 = [32768,32768,32768,32768,32768,32768,32768,32768]
...
; SSE4:       # %bb.0:
; SSE4-NEXT:    movdqa {{.*#+}} xmm1 = [128,128,128,128,128,128,128,128,128,128,128,128,128,128,128,128]
; SSE4-NEXT:    pxor %xmm0, %xmm1
; SSE4-NEXT:    movdqa %xmm1, %xmm0
; SSE4-NEXT:    psrlw $8, %xmm0
...
; SSE4-NEXT:    pminsb %xmm0, %xmm1
; SSE4-NEXT:    movdqa {{.*#+}} xmm0 = [128,128,128,128,128,128,128,128,128,128,128,128,128,128,128,128]
; SSE4-NEXT:    pxor %xmm1, %xmm0
; SSE4-NEXT:    movdqa %xmm0, %xmm1
; SSE4-NEXT:    psrlw $8, %xmm1
