...
; X86-NO-BMI2-NO-SHLD-NEXT:    cmovel %esi, %ebx
...
; X86-NO-BMI2-HAVE-SHLD-NEXT:    leal (,%ecx,8), %ecx
...
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    leal (,%ecx,8), %ecx
...
; X64-NO-BMI2-HAVE-SHLD-NEXT:    leal (,%rsi,8), %ecx
...
; X64-NO-BMI2-NO-SHLD-NEXT:    shrq %cl, %rdi
; X64-NO-BMI2-NO-SHLD-NEXT:    notb %cl
; X64-NO-BMI2-NO-SHLD-NEXT:    leaq (%rsi,%rsi), %r8
; X64-NO-BMI2-NO-SHLD-NEXT:    shlq %cl, %r8
; X64-NO-BMI2-NO-SHLD-NEXT:    orq %r8, %rdi
; X64-NO-BMI2-NO-SHLD-NEXT:    movl %eax, %ecx
; X64-NO-BMI2-NO-SHLD-NEXT:    shrq %cl, %rsi
; X64-NO-BMI2-NO-SHLD-NEXT:    testb $64, %al
; X64-NO-BMI2-NO-SHLD-NEXT:    cmoveq %rdi, %rsi
...
; X64-HAVE-BMI2-NO-SHLD-NEXT:    movq %xmm1, %rcx
; X64-HAVE-BMI2-NO-SHLD-NEXT:    movq %xmm0, %rsi
; X64-HAVE-BMI2-NO-SHLD-NEXT:    shrxq %rax, %rsi, %rsi
; X64-HAVE-BMI2-NO-SHLD-NEXT:    movl %eax, %edi
; X64-HAVE-BMI2-NO-SHLD-NEXT:    notb %dil
; X64-HAVE-BMI2-NO-SHLD-NEXT:    leaq (%rcx,%rcx), %r8
; X64-HAVE-BMI2-NO-SHLD-NEXT:    shlxq %rdi, %r8, %rdi
; X64-HAVE-BMI2-NO-SHLD-NEXT:    orq %rdi, %rsi
; X64-HAVE-BMI2-NO-SHLD-NEXT:    shrxq %rax, %rcx, %rcx
; X64-HAVE-BMI2-NO-SHLD-NEXT:    testb $64, %al
; X64-HAVE-BMI2-NO-SHLD-NEXT:    cmoveq %rsi, %rcx
