...
; X86-SSE2-NEXT:    movq {{.*#+}} xmm2 = [1,2,4,8,16,32,64,128,0,0,0,0,0,0,0,0]
; X86-SSE2-NEXT:    pand %xmm0, %xmm2
; X86-SSE2-NEXT:    pxor %xmm1, %xmm1
; X86-SSE2-NEXT:    pcmpeqb %xmm2, %xmm1
; X86-SSE2-NEXT:    movq {{.*#+}} xmm0 = [17,17,17,17,17,17,17,17,0,0,0,0,0,0,0,0]
...
; X64-SSE2-NEXT:    movdqa {{.*#+}} xmm0 = [17,17,17,17,17,17,17,17,u,u,u,u,u,u,u,u]
...
; X86-SSE42-NEXT:    pshuflw {{.*#+}} xmm0 = xmm0[0,0,0,0,4,5,6,7]
; X86-SSE42-NEXT:    movq {{.*#+}} xmm1 = [1,2,4,8,16,32,64,128,0,0,0,0,0,0,0,0]
...
; X86-SSE42-NEXT:    movdqa {{.*#+}} xmm0 = [15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15]
; X86-SSE42-NEXT:    pand %xmm2, %xmm0
...
; X64-SSE42-NEXT:    movq {{.*#+}} xmm1 = [1,2,4,8,16,32,64,128,0,0,0,0,0,0,0,0]
...
; X64-SSE42-NEXT:    movdqa {{.*#+}} xmm0 = [15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15]
; X64-SSE42-NEXT:    pand %xmm2, %xmm0
; X64-SSE42-NEXT:    retq
;
...
; X86-AVX512-NEXT:    vpblendmb %xmm1, %xmm0, %xmm0 {%k1}
...
; X64-AVX512-NEXT:    vpblendmb %xmm1, %xmm0, %xmm0 {%k1}
