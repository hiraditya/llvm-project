...
; SSE2-NEXT:    pshufd {{.*#+}} xmm4 = xmm2[0,0,0,0]
...
; SSE41-NEXT:    pblendw {{.*#+}} xmm5 = xmm4[0,1],xmm5[2,3],xmm4[4,5],xmm5[6,7]
; SSE41-NEXT:    pmulld %xmm1, %xmm0
...
; SSE41-NEXT:    pblendw {{.*#+}} xmm4 = xmm5[0,1],xmm4[2,3],xmm5[4,5],xmm4[6,7]
...
; SSE2-NEXT:    pshufd {{.*#+}} xmm10 = xmm5[1,3,2,3]
; SSE2-NEXT:    punpckldq {{.*#+}} xmm11 = xmm11[0],xmm10[0],xmm11[1],xmm10[1]
; SSE2-NEXT:    psubd %xmm9, %xmm11
; SSE2-NEXT:    pshufd {{.*#+}} xmm1 = xmm1[0,2,2,3]
...
; SSE2-NEXT:    pshufd {{.*#+}} xmm9 = xmm6[1,3,2,3]
...
; SSSE3-NEXT:    pshufd {{.*#+}} xmm10 = xmm5[1,3,2,3]
; SSSE3-NEXT:    punpckldq {{.*#+}} xmm11 = xmm11[0],xmm10[0],xmm11[1],xmm10[1]
; SSSE3-NEXT:    psubd %xmm9, %xmm11
; SSSE3-NEXT:    pshufd {{.*#+}} xmm1 = xmm1[0,2,2,3]
...
; SSSE3-NEXT:    pmuludq %xmm9, %xmm6
; SSSE3-NEXT:    pshufd {{.*#+}} xmm9 = xmm6[1,3,2,3]
; SSSE3-NEXT:    punpckldq {{.*#+}} xmm10 = xmm10[0],xmm9[0],xmm10[1],xmm9[1]
; SSSE3-NEXT:    psubd %xmm5, %xmm10
; SSSE3-NEXT:    pshufd {{.*#+}} xmm2 = xmm2[0,2,2,3]
...
; SSE41-NEXT:    pmuldq %xmm9, %xmm8
; SSE41-NEXT:    movdqa %xmm0, %xmm9
; SSE41-NEXT:    pmuldq %xmm4, %xmm9
; SSE41-NEXT:    pshufd {{.*#+}} xmm9 = xmm9[1,1,3,3]
; SSE41-NEXT:    pblendw {{.*#+}} xmm8 = xmm9[0,1],xmm8[2,3],xmm9[4,5],xmm8[6,7]
...
; SSE41-NEXT:    pmuldq %xmm8, %xmm5
; SSE41-NEXT:    movdqa %xmm2, %xmm8
; SSE41-NEXT:    pmuldq %xmm6, %xmm8
; SSE41-NEXT:    pshufd {{.*#+}} xmm8 = xmm8[1,1,3,3]
; SSE41-NEXT:    pblendw {{.*#+}} xmm5 = xmm8[0,1],xmm5[2,3],xmm8[4,5],xmm5[6,7]
...
; SSE41-NEXT:    pmuldq %xmm7, %xmm6
; SSE41-NEXT:    pshufd {{.*#+}} xmm6 = xmm6[1,1,3,3]
; SSE41-NEXT:    pblendw {{.*#+}} xmm5 = xmm6[0,1],xmm5[2,3],xmm6[4,5],xmm5[6,7]
...
; SSE41-NEXT:    pmulhw %xmm4, %xmm3
; SSE41-NEXT:    movdqa %xmm3, %xmm5
; SSE41-NEXT:    psrlw $8, %xmm5
; SSE41-NEXT:    pxor %xmm4, %xmm4
; SSE41-NEXT:    punpcklbw {{.*#+}} xmm4 = xmm4[0],xmm1[0],xmm4[1],xmm1[1],xmm4[2],xmm1[2],xmm4[3],xmm1[3],xmm4[4],xmm1[4],xmm4[5],xmm1[5],xmm4[6],xmm1[6],xmm4[7],xmm1[7]
...
; SSSE3-NEXT:    pxor %xmm4, %xmm4
; SSSE3-NEXT:    punpckhbw {{.*#+}} xmm4 = xmm4[8],xmm1[8],xmm4[9],xmm1[9],xmm4[10],xmm1[10],xmm4[11],xmm1[11],xmm4[12],xmm1[12],xmm4[13],xmm1[13],xmm4[14],xmm1[14],xmm4[15],xmm1[15]
; SSSE3-NEXT:    pmulhw %xmm4, %xmm7
...
; SSSE3-NEXT:    movdqa {{.*#+}} xmm6 = [255,255,255,255,255,255,255,255]
; SSSE3-NEXT:    pand %xmm6, %xmm7
; SSSE3-NEXT:    pand %xmm6, %xmm4
; SSSE3-NEXT:    packuswb %xmm7, %xmm4
; SSSE3-NEXT:    pxor %xmm3, %xmm3
; SSSE3-NEXT:    pcmpgtb %xmm4, %xmm3
; SSSE3-NEXT:    pcmpeqb %xmm3, %xmm1
; SSSE3-NEXT:    pcmpeqd %xmm7, %xmm7
; SSSE3-NEXT:    pxor %xmm7, %xmm1
; SSSE3-NEXT:    pxor %xmm8, %xmm8
; SSSE3-NEXT:    punpckhbw {{.*#+}} xmm8 = xmm8[8],xmm2[8],xmm8[9],xmm2[9],xmm8[10],xmm2[10],xmm8[11],xmm2[11],xmm8[12],xmm2[12],xmm8[13],xmm2[13],xmm8[14],xmm2[14],xmm8[15],xmm2[15]
; SSSE3-NEXT:    pxor %xmm3, %xmm3
...
; SSE41-NEXT:    punpckhbw {{.*#+}} xmm7 = xmm7[8],xmm3[8],xmm7[9],xmm3[9],xmm7[10],xmm3[10],xmm7[11],xmm3[11],xmm7[12],xmm3[12],xmm7[13],xmm3[13],xmm7[14],xmm3[14],xmm7[15],xmm3[15]
; SSE41-NEXT:    pxor %xmm4, %xmm4
...
; SSE41-NEXT:    pxor %xmm3, %xmm3
; SSE41-NEXT:    pcmpgtb %xmm4, %xmm3
; SSE41-NEXT:    pcmpeqb %xmm3, %xmm1
; SSE41-NEXT:    pcmpeqd %xmm7, %xmm7
; SSE41-NEXT:    pxor %xmm7, %xmm1
; SSE41-NEXT:    pxor %xmm8, %xmm8
; SSE41-NEXT:    punpckhbw {{.*#+}} xmm8 = xmm8[8],xmm2[8],xmm8[9],xmm2[9],xmm8[10],xmm2[10],xmm8[11],xmm2[11],xmm8[12],xmm2[12],xmm8[13],xmm2[13],xmm8[14],xmm2[14],xmm8[15],xmm2[15]
; SSE41-NEXT:    pxor %xmm3, %xmm3
...
; SSE2-NEXT:    pxor %xmm8, %xmm8
; SSE2-NEXT:    punpckhbw {{.*#+}} xmm8 = xmm8[8],xmm3[8],xmm8[9],xmm3[9],xmm8[10],xmm3[10],xmm8[11],xmm3[11],xmm8[12],xmm3[12],xmm8[13],xmm3[13],xmm8[14],xmm3[14],xmm8[15],xmm3[15]
...
; SSE2-NEXT:    pxor %xmm10, %xmm10
; SSE2-NEXT:    punpckhbw {{.*#+}} xmm10 = xmm10[8],xmm5[8],xmm10[9],xmm5[9],xmm10[10],xmm5[10],xmm10[11],xmm5[11],xmm10[12],xmm5[12],xmm10[13],xmm5[13],xmm10[14],xmm5[14],xmm10[15],xmm5[15]
; SSE2-NEXT:    pxor %xmm6, %xmm6
...
; SSSE3-NEXT:    pxor %xmm8, %xmm8
; SSSE3-NEXT:    punpckhbw {{.*#+}} xmm8 = xmm8[8],xmm3[8],xmm8[9],xmm3[9],xmm8[10],xmm3[10],xmm8[11],xmm3[11],xmm8[12],xmm3[12],xmm8[13],xmm3[13],xmm8[14],xmm3[14],xmm8[15],xmm3[15]
...
; SSSE3-NEXT:    packuswb %xmm11, %xmm2
; SSSE3-NEXT:    pand %xmm9, %xmm10
; SSSE3-NEXT:    pand %xmm9, %xmm7
; SSSE3-NEXT:    packuswb %xmm10, %xmm7
; SSSE3-NEXT:    pxor %xmm6, %xmm6
; SSSE3-NEXT:    pcmpgtb %xmm7, %xmm6
; SSSE3-NEXT:    pcmpeqb %xmm6, %xmm2
; SSSE3-NEXT:    pxor %xmm10, %xmm10
; SSSE3-NEXT:    punpckhbw {{.*#+}} xmm10 = xmm10[8],xmm5[8],xmm10[9],xmm5[9],xmm10[10],xmm5[10],xmm10[11],xmm5[11],xmm10[12],xmm5[12],xmm10[13],xmm5[13],xmm10[14],xmm5[14],xmm10[15],xmm5[15]
; SSSE3-NEXT:    pxor %xmm6, %xmm6
...
; SSSE3-NEXT:    pxor %xmm5, %xmm5
; SSSE3-NEXT:    pcmpgtb %xmm6, %xmm5
; SSSE3-NEXT:    pcmpeqb %xmm5, %xmm1
; SSSE3-NEXT:    pxor %xmm10, %xmm10
; SSSE3-NEXT:    punpckhbw {{.*#+}} xmm10 = xmm10[8],xmm4[8],xmm10[9],xmm4[9],xmm10[10],xmm4[10],xmm10[11],xmm4[11],xmm10[12],xmm4[12],xmm10[13],xmm4[13],xmm10[14],xmm4[14],xmm10[15],xmm4[15]
; SSSE3-NEXT:    pxor %xmm5, %xmm5
...
; SSSE3-NEXT:    pslld $31, %xmm7
; SSSE3-NEXT:    psrad $31, %xmm7
; SSSE3-NEXT:    movdqa %xmm7, 144(%rdi)
; SSSE3-NEXT:    movdqa %xmm2, %xmm3
; SSSE3-NEXT:    punpcklwd {{.*#+}} xmm2 = xmm2[0,0,1,1,2,2,3,3]
; SSSE3-NEXT:    pslld $31, %xmm2
; SSSE3-NEXT:    psrad $31, %xmm2
...
; SSE41-NEXT:    punpckhbw {{.*#+}} xmm10 = xmm10[8],xmm7[8],xmm10[9],xmm7[9],xmm10[10],xmm7[10],xmm10[11],xmm7[11],xmm10[12],xmm7[12],xmm10[13],xmm7[13],xmm10[14],xmm7[14],xmm10[15],xmm7[15]
; SSE41-NEXT:    pxor %xmm8, %xmm8
; SSE41-NEXT:    punpckhbw {{.*#+}} xmm8 = xmm8[8],xmm3[8],xmm8[9],xmm3[9],xmm8[10],xmm3[10],xmm8[11],xmm3[11],xmm8[12],xmm3[12],xmm8[13],xmm3[13],xmm8[14],xmm3[14],xmm8[15],xmm3[15]
; SSE41-NEXT:    pmulhw %xmm8, %xmm10
; SSE41-NEXT:    movdqa %xmm10, %xmm9
; SSE41-NEXT:    psrlw $8, %xmm9
; SSE41-NEXT:    pxor %xmm8, %xmm8
...
; SSE41-NEXT:    packuswb %xmm9, %xmm3
; SSE41-NEXT:    pmovzxbw {{.*#+}} xmm9 = [255,255,255,255,255,255,255,255]
; SSE41-NEXT:    pand %xmm9, %xmm10
; SSE41-NEXT:    pand %xmm9, %xmm8
; SSE41-NEXT:    packuswb %xmm10, %xmm8
; SSE41-NEXT:    pxor %xmm7, %xmm7
; SSE41-NEXT:    pcmpgtb %xmm8, %xmm7
; SSE41-NEXT:    pcmpeqb %xmm7, %xmm3
; SSE41-NEXT:    pxor %xmm10, %xmm10
; SSE41-NEXT:    punpckhbw {{.*#+}} xmm10 = xmm10[8],xmm6[8],xmm10[9],xmm6[9],xmm10[10],xmm6[10],xmm10[11],xmm6[11],xmm10[12],xmm6[12],xmm10[13],xmm6[13],xmm10[14],xmm6[14],xmm10[15],xmm6[15]
; SSE41-NEXT:    pxor %xmm7, %xmm7
...
; SSE41-NEXT:    psrlw $8, %xmm11
; SSE41-NEXT:    pmulhw %xmm6, %xmm7
; SSE41-NEXT:    movdqa %xmm7, %xmm2
; SSE41-NEXT:    psrlw $8, %xmm2
; SSE41-NEXT:    packuswb %xmm11, %xmm2
; SSE41-NEXT:    pand %xmm9, %xmm10
; SSE41-NEXT:    pand %xmm9, %xmm7
; SSE41-NEXT:    packuswb %xmm10, %xmm7
; SSE41-NEXT:    pxor %xmm6, %xmm6
; SSE41-NEXT:    pcmpgtb %xmm7, %xmm6
; SSE41-NEXT:    pcmpeqb %xmm6, %xmm2
; SSE41-NEXT:    pxor %xmm10, %xmm10
; SSE41-NEXT:    punpckhbw {{.*#+}} xmm10 = xmm10[8],xmm5[8],xmm10[9],xmm5[9],xmm10[10],xmm5[10],xmm10[11],xmm5[11],xmm10[12],xmm5[12],xmm10[13],xmm5[13],xmm10[14],xmm5[14],xmm10[15],xmm5[15]
; SSE41-NEXT:    pxor %xmm6, %xmm6
...
; SSE41-NEXT:    pmulhw %xmm6, %xmm10
; SSE41-NEXT:    pxor %xmm6, %xmm6
; SSE41-NEXT:    punpcklbw {{.*#+}} xmm6 = xmm6[0],xmm5[0],xmm6[1],xmm5[1],xmm6[2],xmm5[2],xmm6[3],xmm5[3],xmm6[4],xmm5[4],xmm6[5],xmm5[5],xmm6[6],xmm5[6],xmm6[7],xmm5[7]
; SSE41-NEXT:    pxor %xmm5, %xmm5
...
; SSE41-NEXT:    psrlw $8, %xmm1
; SSE41-NEXT:    packuswb %xmm11, %xmm1
; SSE41-NEXT:    pand %xmm9, %xmm10
; SSE41-NEXT:    pand %xmm9, %xmm6
; SSE41-NEXT:    packuswb %xmm10, %xmm6
; SSE41-NEXT:    pxor %xmm5, %xmm5
; SSE41-NEXT:    pcmpgtb %xmm6, %xmm5
; SSE41-NEXT:    pcmpeqb %xmm5, %xmm1
; SSE41-NEXT:    pxor %xmm10, %xmm10
; SSE41-NEXT:    punpckhbw {{.*#+}} xmm10 = xmm10[8],xmm4[8],xmm10[9],xmm4[9],xmm10[10],xmm4[10],xmm10[11],xmm4[11],xmm10[12],xmm4[12],xmm10[13],xmm4[13],xmm10[14],xmm4[14],xmm10[15],xmm4[15]
; SSE41-NEXT:    pxor %xmm5, %xmm5
...
; SSE41-NEXT:    pmulhw %xmm5, %xmm10
; SSE41-NEXT:    pxor %xmm5, %xmm5
; SSE41-NEXT:    punpcklbw {{.*#+}} xmm5 = xmm5[0],xmm4[0],xmm5[1],xmm4[1],xmm5[2],xmm4[2],xmm5[3],xmm4[3],xmm5[4],xmm4[4],xmm5[5],xmm4[5],xmm5[6],xmm4[6],xmm5[7],xmm4[7]
; SSE41-NEXT:    pxor %xmm4, %xmm4
...
; SSE41-NEXT:    psrlw $8, %xmm0
; SSE41-NEXT:    packuswb %xmm11, %xmm0
; SSE41-NEXT:    pand %xmm9, %xmm10
; SSE41-NEXT:    pand %xmm9, %xmm5
; SSE41-NEXT:    packuswb %xmm10, %xmm5
; SSE41-NEXT:    pxor %xmm4, %xmm4
; SSE41-NEXT:    pcmpgtb %xmm5, %xmm4
...
; SSE2-NEXT:    imulq %rsi, %rdx
; SSE2-NEXT:    movq $-1, %rsi
; SSE2-NEXT:    movl $0, %r9d
; SSE2-NEXT:    cmovoq %rsi, %r9
; SSE2-NEXT:    movq %rdx, %xmm1
; SSE2-NEXT:    imulq %rcx, %rax
; SSE2-NEXT:    movq %rax, %xmm0
; SSE2-NEXT:    punpcklqdq {{.*#+}} xmm1 = xmm1[0],xmm0[0]
; SSE2-NEXT:    movq %r9, %xmm0
; SSE2-NEXT:    cmovoq %rsi, %r8
...
; AVX512F-NEXT:    imulq %rsi, %rdx
; AVX512F-NEXT:    seto %sil
...
; AVX512BW-NEXT:    imulq %rsi, %rdx
; AVX512BW-NEXT:    seto %sil
...
; SSSE3-NEXT:    pslld $8, %xmm3
; SSSE3-NEXT:    psrad $8, %xmm3
...
; SSE2-NEXT:    adcq %rdx, %r11
; SSE2-NEXT:    movq %r11, %r8
; SSE2-NEXT:    sarq $63, %r8
; SSE2-NEXT:    movq %r12, %r14
; SSE2-NEXT:    sarq $63, %r14
; SSE2-NEXT:    imulq %r10, %r14
; SSE2-NEXT:    movq %r10, %rax
; SSE2-NEXT:    mulq %r12
...
; SSE2-NEXT:    addq %r14, %r11
; SSE2-NEXT:    adcq %r8, %r10
; SSE2-NEXT:    movq %rbx, %rax
; SSE2-NEXT:    imulq %r12
; SSE2-NEXT:    addq %rax, %r11
; SSE2-NEXT:    adcq %rdx, %r10
; SSE2-NEXT:    movq %rdi, 24(%r15)
; SSE2-NEXT:    sarq $63, %rdi
; SSE2-NEXT:    xorq %rdi, %r10
; SSE2-NEXT:    xorq %rdi, %r11
...
; SSSE3-NEXT:    adcq %rdx, %r11
; SSSE3-NEXT:    movq %r11, %r8
; SSSE3-NEXT:    sarq $63, %r8
; SSSE3-NEXT:    movq %r12, %r14
; SSSE3-NEXT:    sarq $63, %r14
; SSSE3-NEXT:    imulq %r10, %r14
; SSSE3-NEXT:    movq %r10, %rax
; SSSE3-NEXT:    mulq %r12
; SSSE3-NEXT:    addq %rax, %rdi
; SSSE3-NEXT:    adcq %rdx, %r14
; SSSE3-NEXT:    movq %r14, %r10
; SSSE3-NEXT:    sarq $63, %r10
; SSSE3-NEXT:    addq %r14, %r11
; SSSE3-NEXT:    adcq %r8, %r10
; SSSE3-NEXT:    movq %rbx, %rax
; SSSE3-NEXT:    imulq %r12
; SSSE3-NEXT:    addq %rax, %r11
; SSSE3-NEXT:    adcq %rdx, %r10
; SSSE3-NEXT:    movq %rdi, 24(%r15)
; SSSE3-NEXT:    sarq $63, %rdi
; SSSE3-NEXT:    xorq %rdi, %r10
; SSSE3-NEXT:    xorq %rdi, %r11
; SSSE3-NEXT:    xorl %eax, %eax
; SSSE3-NEXT:    orq %r11, %r10
; SSSE3-NEXT:    setne %al
; SSSE3-NEXT:    negl %eax
...
; SSE41-NEXT:    adcq %rdx, %rbp
; SSE41-NEXT:    movq %rbp, %r8
; SSE41-NEXT:    sarq $63, %r8
; SSE41-NEXT:    movq %r9, %r14
; SSE41-NEXT:    sarq $63, %r14
; SSE41-NEXT:    imulq %rdi, %r14
; SSE41-NEXT:    movq %rdi, %rax
; SSE41-NEXT:    mulq %r9
; SSE41-NEXT:    addq %rax, %rsi
; SSE41-NEXT:    adcq %rdx, %r14
; SSE41-NEXT:    movq %r14, %rdi
; SSE41-NEXT:    sarq $63, %rdi
; SSE41-NEXT:    addq %r14, %rbp
; SSE41-NEXT:    adcq %r8, %rdi
; SSE41-NEXT:    movq %r11, %rax
; SSE41-NEXT:    imulq %r9
; SSE41-NEXT:    addq %rax, %rbp
; SSE41-NEXT:    adcq %rdx, %rdi
; SSE41-NEXT:    movq %rsi, 8(%r15)
; SSE41-NEXT:    sarq $63, %rsi
; SSE41-NEXT:    xorq %rsi, %rdi
; SSE41-NEXT:    xorq %rsi, %rbp
; SSE41-NEXT:    xorl %r9d, %r9d
; SSE41-NEXT:    orq %rbp, %rdi
; SSE41-NEXT:    setne %r9b
; SSE41-NEXT:    movq %rbx, %r11
; SSE41-NEXT:    sarq $63, %r11
; SSE41-NEXT:    imulq %r13, %r11
...
; SSE41-NEXT:    adcq %rdx, %r11
; SSE41-NEXT:    movq %r11, %r8
; SSE41-NEXT:    sarq $63, %r8
; SSE41-NEXT:    movq %r12, %r14
; SSE41-NEXT:    sarq $63, %r14
; SSE41-NEXT:    imulq %r10, %r14
; SSE41-NEXT:    movq %r10, %rax
; SSE41-NEXT:    mulq %r12
; SSE41-NEXT:    addq %rax, %rdi
; SSE41-NEXT:    adcq %rdx, %r14
; SSE41-NEXT:    movq %r14, %r10
; SSE41-NEXT:    sarq $63, %r10
; SSE41-NEXT:    addq %r14, %r11
; SSE41-NEXT:    adcq %r8, %r10
; SSE41-NEXT:    movq %rbx, %rax
; SSE41-NEXT:    imulq %r12
; SSE41-NEXT:    addq %rax, %r11
; SSE41-NEXT:    adcq %rdx, %r10
; SSE41-NEXT:    movq %rdi, 24(%r15)
; SSE41-NEXT:    sarq $63, %rdi
; SSE41-NEXT:    xorq %rdi, %r10
; SSE41-NEXT:    xorq %rdi, %r11
; SSE41-NEXT:    xorl %eax, %eax
; SSE41-NEXT:    orq %r11, %r10
; SSE41-NEXT:    setne %al
; SSE41-NEXT:    negl %eax
; SSE41-NEXT:    negl %r9d
...
; AVX-NEXT:    adcq %rdx, %rbp
; AVX-NEXT:    movq %rbp, %r8
; AVX-NEXT:    sarq $63, %r8
...
; AVX-NEXT:    adcq %rdx, %r11
; AVX-NEXT:    movq %r11, %r8
; AVX-NEXT:    sarq $63, %r8
; AVX-NEXT:    movq %r12, %r14
; AVX-NEXT:    sarq $63, %r14
; AVX-NEXT:    imulq %r10, %r14
; AVX-NEXT:    movq %r10, %rax
; AVX-NEXT:    mulq %r12
...
; AVX-NEXT:    addq %r14, %r11
; AVX-NEXT:    adcq %r8, %r10
; AVX-NEXT:    movq %rbx, %rax
; AVX-NEXT:    imulq %r12
; AVX-NEXT:    addq %rax, %r11
; AVX-NEXT:    adcq %rdx, %r10
; AVX-NEXT:    movq %rdi, 24(%r15)
; AVX-NEXT:    sarq $63, %rdi
; AVX-NEXT:    xorq %rdi, %r10
; AVX-NEXT:    xorq %rdi, %r11
...
; AVX512F-NEXT:    addq %r11, %r8
; AVX512F-NEXT:    adcq %rdx, %rbx
; AVX512F-NEXT:    movq %rbx, %r11
...
; AVX512F-NEXT:    addq %rax, %r8
; AVX512F-NEXT:    adcq %rdx, %r14
; AVX512F-NEXT:    movq %r14, %rdi
; AVX512F-NEXT:    sarq $63, %rdi
; AVX512F-NEXT:    addq %r14, %rbx
; AVX512F-NEXT:    adcq %r11, %rdi
; AVX512F-NEXT:    movq %rsi, %rax
; AVX512F-NEXT:    imulq %r9
; AVX512F-NEXT:    addq %rax, %rbx
; AVX512F-NEXT:    adcq %rdx, %rdi
; AVX512F-NEXT:    movq %r8, 8(%r15)
; AVX512F-NEXT:    sarq $63, %r8
; AVX512F-NEXT:    xorq %r8, %rdi
; AVX512F-NEXT:    xorq %r8, %rbx
; AVX512F-NEXT:    orq %rbx, %rdi
; AVX512F-NEXT:    setne %al
; AVX512F-NEXT:    andl $1, %eax
...
; AVX512BW-NEXT:    addq %r11, %r8
; AVX512BW-NEXT:    adcq %rdx, %rbx
; AVX512BW-NEXT:    movq %rbx, %r11
