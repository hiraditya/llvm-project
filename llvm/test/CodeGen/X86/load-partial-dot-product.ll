...
; SSSE3-NEXT:    shufps {{.*#+}} xmm2 = xmm2[0,0],xmm0[3,0]
...
; SSSE3-NEXT:    movss {{.*#+}} xmm2 = mem[0],zero,zero,zero
; SSSE3-NEXT:    movss {{.*#+}} xmm0 = mem[0],zero,zero,zero
; SSSE3-NEXT:    mulss %xmm2, %xmm0
; SSSE3-NEXT:    movshdup {{.*#+}} xmm2 = xmm1[1,1,3,3]
; SSSE3-NEXT:    addss %xmm2, %xmm1
; SSSE3-NEXT:    addss %xmm1, %xmm0
; SSSE3-NEXT:    retq
;
...
; SSE2-NEXT:    mulps %xmm0, %xmm2
; SSE2-NEXT:    movss {{.*#+}} xmm0 = mem[0],zero,zero,zero
; SSE2-NEXT:    mulss %xmm1, %xmm0
; SSE2-NEXT:    addss %xmm2, %xmm0
; SSE2-NEXT:    shufps {{.*#+}} xmm2 = xmm2[1,1,1,1]
; SSE2-NEXT:    addss %xmm2, %xmm0
; SSE2-NEXT:    retq
;
...
; SSSE3-NEXT:    mulps %xmm0, %xmm2
; SSSE3-NEXT:    movss {{.*#+}} xmm0 = mem[0],zero,zero,zero
; SSSE3-NEXT:    mulss %xmm1, %xmm0
