...
; CHECK-NEXT:    je LBB0_53
; CHECK-NEXT:    .p2align 4
; CHECK-NEXT:  LBB0_19: ## %while.cond197.backedge
; CHECK-NEXT:    ## in Loop: Header=BB0_12 Depth=1
; CHECK-NEXT:    decl %ebp
; CHECK-NEXT:    testl %ebp, %ebp
; CHECK-NEXT:    movl %ebx, %r15d
; CHECK-NEXT:    jle LBB0_20
; CHECK-NEXT:  LBB0_12: ## %while.body200
...
; CHECK-NEXT:    jmpq *%rax
; CHECK-NEXT:  LBB0_24: ## %sw.bb474
; CHECK-NEXT:    ## in Loop: Header=BB0_12 Depth=1
; CHECK-NEXT:    testb %r12b, %r12b
; CHECK-NEXT:    ## implicit-def: $r14
; CHECK-NEXT:    jne LBB0_32
; CHECK-NEXT:  ## %bb.25: ## %do.body479.preheader
; CHECK-NEXT:    ## in Loop: Header=BB0_12 Depth=1
; CHECK-NEXT:    testb %r12b, %r12b
; CHECK-NEXT:    ## implicit-def: $r14
; CHECK-NEXT:    jne LBB0_32
; CHECK-NEXT:  ## %bb.26: ## %land.rhs485.preheader
; CHECK-NEXT:    ## in Loop: Header=BB0_12 Depth=1
; CHECK-NEXT:    ## implicit-def: $rax
; CHECK-NEXT:    jmp LBB0_27
; CHECK-NEXT:    .p2align 4
; CHECK-NEXT:  LBB0_30: ## %do.body479.backedge
; CHECK-NEXT:    ## in Loop: Header=BB0_27 Depth=2
; CHECK-NEXT:    leaq 1(%r14), %rax
; CHECK-NEXT:    testb %r12b, %r12b
; CHECK-NEXT:    je LBB0_31
; CHECK-NEXT:  LBB0_27: ## %land.rhs485
; CHECK-NEXT:    ## Parent Loop BB0_12 Depth=1
; CHECK-NEXT:    ## => This Inner Loop Header: Depth=2
; CHECK-NEXT:    testb %sil, %sil
; CHECK-NEXT:    jne LBB0_53
; CHECK-NEXT:  ## %bb.28: ## %cond.true.i.i2780
; CHECK-NEXT:    ## in Loop: Header=BB0_27 Depth=2
; CHECK-NEXT:    movq %rax, %r14
; CHECK-NEXT:    testb %al, %al
; CHECK-NEXT:    jne LBB0_30
; CHECK-NEXT:  ## %bb.29: ## %lor.rhs500
; CHECK-NEXT:    ## in Loop: Header=BB0_27 Depth=2
...
; CHECK-NEXT:    ja LBB0_19
; CHECK-NEXT:  ## %bb.14: ## %while.body200
; CHECK-NEXT:    ## in Loop: Header=BB0_12 Depth=1
; CHECK-NEXT:    movslq (%rdx,%rax,4), %rax
; CHECK-NEXT:    addq %rdx, %rax
; CHECK-NEXT:    jmpq *%rax
; CHECK-NEXT:  LBB0_17: ## %while.cond201.preheader
; CHECK-NEXT:    ## in Loop: Header=BB0_12 Depth=1
...
; CHECK-NEXT:  ## %bb.44: ## in Loop: Header=BB0_12 Depth=1
; CHECK-NEXT:    movq $0, {{[-0-9]+}}(%r{{[sb]}}p) ## 8-byte Folded Spill
...
; CHECK-NEXT:    jmp LBB0_19
; CHECK-NEXT:  LBB0_18: ## %sw.bb243
; CHECK-NEXT:    ## in Loop: Header=BB0_12 Depth=1
; CHECK-NEXT:    movl $2, %ebx
; CHECK-NEXT:    jmp LBB0_19
; CHECK-NEXT:  LBB0_31: ## %if.end517.loopexitsplit
; CHECK-NEXT:    ## in Loop: Header=BB0_12 Depth=1
; CHECK-NEXT:    incq %r14
...
; CHECK-NEXT:    .p2align 4
; CHECK-NEXT:  LBB0_23: ## %for.cond357
; CHECK-NEXT:    ## =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    jmp LBB0_23
; CHECK-NEXT:  LBB0_20: ## %while.end1465
; CHECK-NEXT:    leal 1(%rbx), %eax
; CHECK-NEXT:    cmpl $16, %eax
; CHECK-NEXT:    ja LBB0_48
; CHECK-NEXT:  ## %bb.21: ## %while.end1465
; CHECK-NEXT:    movl $83969, %ecx ## imm = 0x14801
...
; CHECK-NEXT:  LBB0_15: ## %while.cond635.preheader
; CHECK-NEXT:    testb %al, %al
; CHECK-NEXT:    je LBB0_39
; CHECK-NEXT:    .p2align 4
; CHECK-NEXT:  LBB0_16: ## %for.body643.us
; CHECK-NEXT:    ## =>This Inner Loop Header: Depth=1
