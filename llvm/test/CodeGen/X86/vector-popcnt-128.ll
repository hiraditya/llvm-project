...
; SSSE3-NEXT:    paddb %xmm3, %xmm4
; SSSE3-NEXT:    pxor %xmm0, %xmm0
; SSSE3-NEXT:    psadbw %xmm4, %xmm0
; SSSE3-NEXT:    retq
;
...
; SSSE3-NEXT:    movdqa {{.*#+}} xmm4 = [0,1,1,2,1,2,2,3,1,2,2,3,2,3,3,4]
...
; SSE3-NEXT:    movdqa {{.*#+}} xmm2 = [2147483648,2147483648,2147483648,2147483648]
; SSE3-NEXT:    pxor %xmm1, %xmm2
; SSE3-NEXT:    movdqa %xmm2, %xmm1
; SSE3-NEXT:    pxor %xmm0, %xmm1
; SSE3-NEXT:    pcmpgtd %xmm2, %xmm1
...
; SSE3-NEXT:    movdqa {{.*#+}} xmm3 = [2147483648,2147483648,2147483648,2147483648]
; SSE3-NEXT:    pxor %xmm1, %xmm3
; SSE3-NEXT:    movdqa %xmm3, %xmm1
; SSE3-NEXT:    pxor %xmm0, %xmm1
; SSE3-NEXT:    pcmpgtd %xmm3, %xmm1
...
; SSE3-NEXT:    movdqa {{.*#+}} xmm2 = [32768,32768,32768,32768,32768,32768,32768,32768]
; SSE3-NEXT:    pxor %xmm1, %xmm2
; SSE3-NEXT:    movdqa %xmm2, %xmm1
; SSE3-NEXT:    pxor %xmm0, %xmm1
; SSE3-NEXT:    pcmpgtw %xmm2, %xmm1
; SSE3-NEXT:    movdqa %xmm1, %xmm0
; SSE3-NEXT:    retq
;
