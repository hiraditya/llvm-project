...
; CHECK-NEXT:    cvttps2dq %xmm3, %xmm5
; CHECK-NEXT:    movaps %xmm3, %xmm6
; CHECK-NEXT:    cmpltps %xmm4, %xmm6
; CHECK-NEXT:    movaps {{.*#+}} xmm7 = [13,14,15,16]
; CHECK-NEXT:    movaps %xmm6, %xmm3
; CHECK-NEXT:    orps %xmm7, %xmm3
; CHECK-NEXT:    cvtdq2ps %xmm5, %xmm5
; CHECK-NEXT:    andps %xmm7, %xmm5
; CHECK-NEXT:    andps %xmm3, %xmm5
; CHECK-NEXT:    andnps %xmm6, %xmm3
; CHECK-NEXT:    cvttps2dq %xmm2, %xmm6
; CHECK-NEXT:    movaps %xmm2, %xmm7
; CHECK-NEXT:    cmpltps %xmm4, %xmm7
; CHECK-NEXT:    movaps {{.*#+}} xmm2 = [9,10,11,12]
; CHECK-NEXT:    movaps %xmm7, %xmm8
; CHECK-NEXT:    orps %xmm2, %xmm8
; CHECK-NEXT:    cvtdq2ps %xmm6, %xmm6
; CHECK-NEXT:    andps %xmm2, %xmm6
; CHECK-NEXT:    andps %xmm8, %xmm6
; CHECK-NEXT:    movaps %xmm8, %xmm2
; CHECK-NEXT:    andnps %xmm7, %xmm2
; CHECK-NEXT:    cvttps2dq %xmm1, %xmm7
; CHECK-NEXT:    movaps %xmm1, %xmm8
; CHECK-NEXT:    cmpltps %xmm4, %xmm8
; CHECK-NEXT:    movaps {{.*#+}} xmm1 = [5,6,7,8]
; CHECK-NEXT:    movaps %xmm8, %xmm9
; CHECK-NEXT:    orps %xmm1, %xmm9
; CHECK-NEXT:    cvtdq2ps %xmm7, %xmm7
; CHECK-NEXT:    andps %xmm1, %xmm7
; CHECK-NEXT:    andps %xmm9, %xmm7
; CHECK-NEXT:    movaps %xmm9, %xmm1
; CHECK-NEXT:    andnps %xmm8, %xmm1
; CHECK-NEXT:    cvttps2dq %xmm0, %xmm8
; CHECK-NEXT:    movaps %xmm0, %xmm9
; CHECK-NEXT:    cmpltps %xmm4, %xmm9
; CHECK-NEXT:    movaps {{.*#+}} xmm0 = [1,2,3,4]
; CHECK-NEXT:    movaps %xmm9, %xmm4
; CHECK-NEXT:    orps %xmm0, %xmm4
; CHECK-NEXT:    cvtdq2ps %xmm8, %xmm8
; CHECK-NEXT:    andps %xmm0, %xmm8
; CHECK-NEXT:    andps %xmm4, %xmm8
; CHECK-NEXT:    movaps %xmm4, %xmm0
; CHECK-NEXT:    andnps %xmm9, %xmm0
; CHECK-NEXT:    movaps {{.*#+}} xmm4 = [1,1,1,1]
