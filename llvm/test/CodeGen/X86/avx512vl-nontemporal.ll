...
; CHECK-NEXT:    movl (%rdx), %ecx ## encoding: [0x8b,0x0a]
...
; CHECK-NEXT:    movl (%rdx), %esi ## encoding: [0x8b,0x32]
; CHECK-NEXT:    addl %ecx, %esi ## encoding: [0x01,0xce]
; CHECK-NEXT:    vmovntpd %ymm0, (%rdi) ## EVEX TO VEX Compression encoding: [0xc5,0xfd,0x2b,0x07]
; CHECK-NEXT:    movl (%rdx), %eax ## encoding: [0x8b,0x02]
; CHECK-NEXT:    addl %esi, %eax ## encoding: [0x01,0xf0]
