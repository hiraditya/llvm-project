...
; GNUX32-NEXT:    movzbl {{[0-9]+}}(%esp), %r9d
; GNUX32-NEXT:    addq %rdi, %rsi
; GNUX32-NEXT:    addq %rdx, %rcx
; GNUX32-NEXT:    addq %rsi, %rcx
; GNUX32-NEXT:    leaq (%rax,%rbx), %rdx
; GNUX32-NEXT:    leaq (%r8,%r9), %rax
