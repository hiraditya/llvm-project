...
; CHECK-NEXT:    movzbl -2(%ecx,%ebx,4), %edx
; CHECK-NEXT:    movb %dl, (%eax,%ebx)
; CHECK-NEXT:    movzbl (%ecx,%ebx,4), %edx
; CHECK-NEXT:    movb %dl, (%esi,%ebx)
; CHECK-NEXT:    incl %ebx
...
; CHECK-NEXT:    movl %edx, (%esp) ## 4-byte Spill
; CHECK-NEXT:    leal (%ecx,%eax), %ebp
; CHECK-NEXT:    movl {{[0-9]+}}(%esp), %eax
; CHECK-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %ecx ## 4-byte Reload
; CHECK-NEXT:    leal (%eax,%ecx), %edi
; CHECK-NEXT:    .p2align 4
