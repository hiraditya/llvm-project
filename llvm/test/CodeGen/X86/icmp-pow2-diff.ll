...
; AVX2-NEXT:    retq
;
; SSE41-LABEL: andnot_eq_v4i32_todo_no_splat:
; SSE41:       # %bb.0:
; SSE41-NEXT:    pcmpeqd %xmm2, %xmm2
; SSE41-NEXT:    pcmpeqd %xmm0, %xmm2
; SSE41-NEXT:    pmovsxwd {{.*#+}} xmm1 = [4294967287,4294967279,4294967291,4294967167]
; SSE41-NEXT:    pcmpeqd %xmm0, %xmm1
; SSE41-NEXT:    por %xmm2, %xmm1
; SSE41-NEXT:    movdqa %xmm1, %xmm0
; SSE41-NEXT:    retq
;
; SSE2-LABEL: andnot_eq_v4i32_todo_no_splat:
; SSE2:       # %bb.0:
; SSE2-NEXT:    pcmpeqd %xmm2, %xmm2
; SSE2-NEXT:    pcmpeqd %xmm0, %xmm2
; SSE2-NEXT:    movdqa {{.*#+}} xmm1 = [4294967287,4294967279,4294967291,4294967167]
...
; SSE-NEXT:    movdqa {{.*#+}} xmm1 = [49151,65279,65503,57343,49151,65279,65503,57343]
...
; CHECK-NEXT:    leal 1073741825(%rdi), %eax
; CHECK-NEXT:    testl $-1073741825, %eax # imm = 0xBFFFFFFF
; CHECK-NEXT:    setne %al
; CHECK-NEXT:    retq
...
; CHECK-NEXT:    testl $49151, %eax # imm = 0xBFFF
; CHECK-NEXT:    setne %al
; CHECK-NEXT:    retq
...
; SSE41:       # %bb.0:
; SSE41-NEXT:    pmovsxbw {{.*#+}} xmm2 = [65533,65533,65533,65533,65533,65533,65533,65533]
; SSE41-NEXT:    pcmpeqw %xmm0, %xmm2
; SSE41-NEXT:    pcmpeqd %xmm1, %xmm1
; SSE41-NEXT:    movdqa {{.*#+}} xmm3 = [16381,16381,16381,16381,16381,16381,16381,16381]
...
; SSE2:       # %bb.0:
; SSE2-NEXT:    movdqa {{.*#+}} xmm2 = [65533,65533,65533,65533,65533,65533,65533,65533]
; SSE2-NEXT:    pcmpeqw %xmm0, %xmm2
; SSE2-NEXT:    pcmpeqd %xmm1, %xmm1
; SSE2-NEXT:    movdqa {{.*#+}} xmm3 = [16381,16381,16381,16381,16381,16381,16381,16381]
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    leaq 256(%rdi), %rax
; CHECK-NEXT:    testq $-1025, %rax # imm = 0xFBFF
; CHECK-NEXT:    setne %al
; CHECK-NEXT:    retq
