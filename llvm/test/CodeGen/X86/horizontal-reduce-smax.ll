...
; X86-SSE2-NEXT:    pshufd {{.*#+}} xmm3 = xmm4[0,0,2,2]
; X86-SSE2-NEXT:    pshufd {{.*#+}} xmm2 = xmm2[1,1,3,3]
...
; X64-SSE2-NEXT:    pshufd {{.*#+}} xmm0 = xmm6[1,1,3,3]
...
; X86-SSE42-NEXT:    movdqa {{.*#+}} xmm0 = [32767,32767,32767,32767,32767,32767,32767,32767]
...
; X64-SSE42-NEXT:    movdqa {{.*#+}} xmm0 = [32767,32767,32767,32767,32767,32767,32767,32767]
...
; X86-SSE42-NEXT:    movdqa {{.*#+}} xmm0 = [127,127,127,127,127,127,127,127,127,127,127,127,127,127,127,127]
; X86-SSE42-NEXT:    pxor %xmm1, %xmm0
; X86-SSE42-NEXT:    movdqa %xmm0, %xmm1
...
; X64-SSE42-NEXT:    movdqa {{.*#+}} xmm0 = [127,127,127,127,127,127,127,127,127,127,127,127,127,127,127,127]
; X64-SSE42-NEXT:    pxor %xmm1, %xmm0
; X64-SSE42-NEXT:    movdqa %xmm0, %xmm1
