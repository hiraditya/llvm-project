...
; AVX512F-NEXT:    vpternlogq {{.*#+}} ymm2 = ymm2 ^ (ymm3 & (ymm2 ^ ymm0))
...
; AVX512DQ-NEXT:    vpternlogq {{.*#+}} ymm2 = ymm2 ^ (ymm3 & (ymm2 ^ ymm0))
...
; SSE42-NEXT:    pshufd {{.*#+}} xmm1 = xmm0[0,0,0,0]
; SSE42-NEXT:    movdqa 48(%rdi), %xmm2
; SSE42-NEXT:    pblendw {{.*#+}} xmm2 = xmm1[0],xmm2[1,2,3,4,5],xmm1[6],xmm2[7]
; SSE42-NEXT:    pshufd {{.*#+}} xmm1 = xmm0[0,0,1,1]
; SSE42-NEXT:    pshufd {{.*#+}} xmm0 = xmm0[0,1,0,1]
; SSE42-NEXT:    movdqa (%rsi), %xmm3
; SSE42-NEXT:    paddb %xmm2, %xmm3
...
; SSE42-NEXT:    pshufd {{.*#+}} xmm1 = xmm0[0,0,0,0]
; SSE42-NEXT:    movdqa 48(%rdi), %xmm2
; SSE42-NEXT:    pblendw {{.*#+}} xmm2 = xmm1[0,1],xmm2[2,3,4,5],xmm1[6,7]
; SSE42-NEXT:    pshufd {{.*#+}} xmm1 = xmm0[0,0,1,1]
; SSE42-NEXT:    pshufd {{.*#+}} xmm0 = xmm0[0,1,0,1]
; SSE42-NEXT:    movdqa (%rsi), %xmm3
; SSE42-NEXT:    paddb %xmm2, %xmm3
