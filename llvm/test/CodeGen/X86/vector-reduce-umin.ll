...
; SSE4-NEXT:    pminud %xmm2, %xmm3
; SSE4-NEXT:    pshufd {{.*#+}} xmm0 = xmm3[2,3,2,3]
; SSE4-NEXT:    pminud %xmm3, %xmm0
; SSE4-NEXT:    pshufd {{.*#+}} xmm1 = xmm0[1,1,1,1]
; SSE4-NEXT:    pminud %xmm0, %xmm1
; SSE4-NEXT:    movd %xmm1, %eax
; SSE4-NEXT:    retq
...
; SSE4-NEXT:    pminuw %xmm2, %xmm3
; SSE4-NEXT:    phminposuw %xmm3, %xmm0
; SSE4-NEXT:    movd %xmm0, %eax
; SSE4-NEXT:    # kill: def $ax killed $ax killed $eax
; SSE4-NEXT:    retq
;
...
; SSE4-NEXT:    pminub %xmm2, %xmm3
; SSE4-NEXT:    movdqa %xmm3, %xmm0
; SSE4-NEXT:    psrlw $8, %xmm0
; SSE4-NEXT:    pminub %xmm3, %xmm0
; SSE4-NEXT:    phminposuw %xmm0, %xmm0
; SSE4-NEXT:    movd %xmm0, %eax
; SSE4-NEXT:    # kill: def $al killed $al killed $eax
; SSE4-NEXT:    retq
