...
; SSE-NEXT:    pshuflw {{.*#+}} xmm3 = xmm4[2,1,2,3,4,5,6,7]
...
; SSE-NEXT:    pshufhw {{.*#+}} xmm14 = xmm3[0,1,2,3,6,5,4,7]
...
; SSE-NEXT:    pshufd {{.*#+}} xmm7 = xmm11[3,1,2,0]
...
; SSE-NEXT:    pshuflw {{.*#+}} xmm4 = xmm15[2,1,0,3,4,5,6,7]
; SSE-NEXT:    pshufhw {{.*#+}} xmm4 = xmm4[0,1,2,3,6,5,4,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm4 = xmm4[0,3,2,1]
; SSE-NEXT:    pshuflw {{.*#+}} xmm4 = xmm4[1,2,3,0,4,5,6,7]
; SSE-NEXT:    pshufhw {{.*#+}} xmm4 = xmm4[0,1,2,3,5,6,7,4]
; SSE-NEXT:    pshufhw {{.*#+}} xmm11 = xmm13[0,1,2,3,4,7,6,7]
...
; SSE-NEXT:    pshuflw {{.*#+}} xmm5 = xmm10[0,3,2,3,4,5,6,7]
...
; AVX512-NEXT:    vpmovsxdq {{.*#+}} xmm4 = [18446744073709551615,16777215]
; AVX512-NEXT:    vpternlogq {{.*#+}} xmm4 = xmm1 ^ (xmm4 & (xmm0 ^ xmm1))
...
; AVX512-FCP-NEXT:    vpmovsxdq {{.*#+}} xmm4 = [18446744073709551615,16777215]
; AVX512-FCP-NEXT:    vpternlogq {{.*#+}} xmm4 = xmm1 ^ (xmm4 & (xmm0 ^ xmm1))
...
; AVX512DQ-NEXT:    vpmovsxdq {{.*#+}} xmm4 = [18446744073709551615,16777215]
; AVX512DQ-NEXT:    vpternlogq {{.*#+}} xmm4 = xmm1 ^ (xmm4 & (xmm0 ^ xmm1))
...
; AVX512DQ-FCP-NEXT:    vpmovsxdq {{.*#+}} xmm4 = [18446744073709551615,16777215]
; AVX512DQ-FCP-NEXT:    vpternlogq {{.*#+}} xmm4 = xmm1 ^ (xmm4 & (xmm0 ^ xmm1))
...
; SSE-NEXT:    pshufhw {{.*#+}} xmm0 = xmm0[0,1,2,3,6,5,4,7]
; SSE-NEXT:    pshuflw {{.*#+}} xmm4 = xmm14[0,3,2,3,4,5,6,7]
...
; SSE-NEXT:    pshufd {{.*#+}} xmm12 = xmm12[3,1,2,0]
; SSE-NEXT:    pshuflw {{.*#+}} xmm12 = xmm12[2,1,2,3,4,5,6,7]
...
; SSE-NEXT:    pshuflw {{.*#+}} xmm2 = xmm2[1,2,3,0,4,5,6,7]
; SSE-NEXT:    pshufhw {{.*#+}} xmm11 = xmm2[0,1,2,3,5,6,7,4]
; SSE-NEXT:    pshufhw {{.*#+}} xmm0 = xmm0[0,1,2,3,4,7,6,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm0 = xmm0[0,2,2,3]
; SSE-NEXT:    pshuflw {{.*#+}} xmm0 = xmm0[1,2,3,3,4,5,6,7]
; SSE-NEXT:    packuswb %xmm0, %xmm11
...
; SSE-NEXT:    pshufhw {{.*#+}} xmm8 = xmm3[0,1,2,3,6,5,4,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm0 = xmm0[2,1,2,3]
; SSE-NEXT:    pshuflw {{.*#+}} xmm0 = xmm0[2,1,2,3,4,5,6,7]
...
; SSE-NEXT:    pshufd {{.*#+}} xmm6 = xmm13[3,1,2,0]
...
; SSE-NEXT:    pshuflw {{.*#+}} xmm1 = xmm6[2,1,0,3,4,5,6,7]
; SSE-NEXT:    pshufhw {{.*#+}} xmm1 = xmm1[0,1,2,3,6,5,4,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm1 = xmm1[0,3,2,1]
; SSE-NEXT:    pshuflw {{.*#+}} xmm1 = xmm1[1,2,3,0,4,5,6,7]
; SSE-NEXT:    pshufhw {{.*#+}} xmm13 = xmm1[0,1,2,3,5,6,7,4]
...
; SSE-NEXT:    pandn %xmm12, %xmm4
; SSE-NEXT:    por %xmm0, %xmm4
; SSE-NEXT:    pshuflw {{.*#+}} xmm0 = xmm4[2,1,0,3,4,5,6,7]
; SSE-NEXT:    pshufhw {{.*#+}} xmm0 = xmm0[0,1,2,3,6,5,4,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm0 = xmm0[0,3,2,1]
; SSE-NEXT:    pshuflw {{.*#+}} xmm0 = xmm0[1,2,3,0,4,5,6,7]
; SSE-NEXT:    pshufhw {{.*#+}} xmm4 = xmm0[0,1,2,3,5,6,7,4]
...
; SSE-NEXT:    pshuflw {{.*#+}} xmm5 = xmm14[0,3,2,3,4,5,6,7]
; SSE-NEXT:    pshufhw {{.*#+}} xmm5 = xmm5[0,1,2,3,6,5,6,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm5 = xmm5[0,1,2,0]
; SSE-NEXT:    pshuflw {{.*#+}} xmm5 = xmm5[2,2,2,2,4,5,6,7]
; SSE-NEXT:    pshufhw {{.*#+}} xmm5 = xmm5[0,1,2,3,5,6,7,4]
...
; SSE-NEXT:    pshufhw {{.*#+}} xmm12 = xmm12[0,1,2,3,6,5,4,7]
...
; AVX512-FCP-NEXT:    vpternlogq {{.*#+}} zmm2 = zmm2 ^ (zmm5 & (zmm2 ^ zmm8))
...
; AVX512DQ-FCP-NEXT:    vpternlogq {{.*#+}} zmm2 = zmm2 ^ (zmm5 & (zmm2 ^ zmm8))
