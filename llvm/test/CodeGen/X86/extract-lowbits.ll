...
; X86-BMI2-NEXT:    adcl $-1, %eax
; X86-BMI2-NEXT:    movl {{[0-9]+}}(%esp), %edx
; X86-BMI2-NEXT:    andl %eax, %edx
; X86-BMI2-NEXT:    movl {{[0-9]+}}(%esp), %eax
...
; X64-NOBMI-NEXT:    movq %rsi, %rcx
; X64-NOBMI-NEXT:    movq %rdi, %rax
; X64-NOBMI-NEXT:    movl $1, %edx
; X64-NOBMI-NEXT:    # kill: def $cl killed $cl killed $rcx
; X64-NOBMI-NEXT:    shlq %cl, %rdx
; X64-NOBMI-NEXT:    leal -1(%rdx), %ecx
; X64-NOBMI-NEXT:    andl %ecx, %eax
...
; X86-BMI2-NEXT:    movzbl {{[0-9]+}}(%esp), %ecx
; X86-BMI2-NEXT:    movl $-1, %eax
; X86-BMI2-NEXT:    shlxl %ecx, %eax, %edx
...
; X86-BMI2-NEXT:    movl $-1, %eax
; X86-BMI2-NEXT:    shlxl %edx, %eax, %esi
; X86-BMI2-NEXT:    xorl %eax, %eax
...
; X86-BMI2-NEXT:    movl $-1, %ecx
; X86-BMI2-NEXT:    shrxl %edx, %ecx, %esi
; X86-BMI2-NEXT:    xorl %ecx, %ecx
; X86-BMI2-NEXT:    testb $32, %dl
; X86-BMI2-NEXT:    movl %esi, %edx
...
; X64-BMI1-NEXT:    movq %rdi, %rax
; X64-BMI1-NEXT:    negb %cl
; X64-BMI1-NEXT:    movl $4294967295, %edx # imm = 0xFFFFFFFF
; X64-BMI1-NEXT:    # kill: def $cl killed $cl killed $rcx
; X64-BMI1-NEXT:    shrq %cl, %rdx
; X64-BMI1-NEXT:    andl %edx, %eax
...
; X86-NEXT:    movl $1073741823, %esi # imm = 0x3FFFFFFF
...
; X64-NOBMI:       # %bb.0:
; X64-NOBMI-NEXT:    movabsq $4611686018427387903, %rcx # imm = 0x3FFFFFFFFFFFFFFF
; X64-NOBMI-NEXT:    movq (%rdi), %rax
; X64-NOBMI-NEXT:    andq %rcx, %rax
; X64-NOBMI-NEXT:    retq
;
