...
; SSE-NEXT:    paddsw %xmm1, %xmm2
; SSE-NEXT:    movdqa (%rsi), %xmm1
; SSE-NEXT:    paddsw %xmm0, %xmm1
; SSE-NEXT:    movdqa %xmm1, (%rdx)
; SSE-NEXT:    movq %xmm2, 16(%rdx)
; SSE-NEXT:    retq
;
; AVX1-LABEL: v12i16:
; AVX1:       # %bb.0:
...
; AVX-NEXT:    addb %cl, %sil
; AVX-NEXT:    sarb $7, %sil
; AVX-NEXT:    addl $-128, %esi
; AVX-NEXT:    addb %cl, %al
...
; AVX-NEXT:    addw %cx, %ax
; AVX-NEXT:    cmovnol %eax, %esi
; AVX-NEXT:    movw %si, (%rdx)
; AVX-NEXT:    retq
...
; SSE-NEXT:    movdqa {{.*#+}} xmm0 = [15,15,15,15,15,15,15,15,15,15,15,15,15,15,15,15]
...
; SSE2-NEXT:    movdqa {{.*#+}} xmm3 = [9223372036854775808,9223372036854775808]
...
; SSSE3-NEXT:    movdqa {{.*#+}} xmm3 = [9223372036854775808,9223372036854775808]
...
; AVX512BW-NEXT:    vpblendmq {{\.?LCPI[0-9]+_[0-9]+}}(%rip){1to2}, %xmm0, %xmm0 {%k2}
; AVX512BW-NEXT:    vpblendmq %xmm0, %xmm1, %xmm0 {%k1}
; AVX512BW-NEXT:    retq
...
; SSSE3-NEXT:    pshufd {{.*#+}} xmm0 = xmm11[1,1,3,3]
...
; SSSE3-NEXT:    pshufd {{.*#+}} xmm1 = xmm1[1,1,3,3]
; SSSE3-NEXT:    pand %xmm1, %xmm13
; SSSE3-NEXT:    pshufd {{.*#+}} xmm1 = xmm12[1,1,3,3]
...
; SSE41-NEXT:    pshufd {{.*#+}} xmm0 = xmm0[1,1,3,3]
; SSE41-NEXT:    pand %xmm0, %xmm12
; SSE41-NEXT:    pshufd {{.*#+}} xmm9 = xmm11[1,1,3,3]
; SSE41-NEXT:    por %xmm12, %xmm9
; SSE41-NEXT:    pshufd {{.*#+}} xmm0 = xmm4[1,1,3,3]
...
; SSE41-NEXT:    pshufd {{.*#+}} xmm13 = xmm9[0,0,2,2]
; SSE41-NEXT:    pcmpeqd %xmm4, %xmm0
; SSE41-NEXT:    pshufd {{.*#+}} xmm0 = xmm0[1,1,3,3]
; SSE41-NEXT:    pand %xmm0, %xmm13
; SSE41-NEXT:    pshufd {{.*#+}} xmm4 = xmm9[1,1,3,3]
; SSE41-NEXT:    por %xmm13, %xmm4
...
; AVX-NEXT:    sarq $63, %r8
; AVX-NEXT:    testb %dl, %dl
; AVX-NEXT:    cmovneq %r8, %rsi
; AVX-NEXT:    xorq %r11, %r8
; AVX-NEXT:    testb %dl, %dl
; AVX-NEXT:    cmoveq %rcx, %r8
; AVX-NEXT:    movq %rdi, 16(%rax)
