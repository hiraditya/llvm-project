...
; SSE41-NEXT:    movdqa {{.*#+}} xmm1 = [129,129,129,129,u,u,u,u,u,u,u,u,u,u,u,u]
...
; SSE2-NEXT:    movdqa {{.*#+}} xmm0 = [129,129,129,129,u,u,u,u,u,u,u,u,u,u,u,u]
...
; SSE2-NEXT:    psubb %xmm0, %xmm1
; SSE2-NEXT:    pminub %xmm0, %xmm1
; SSE2-NEXT:    movdqa {{.*#+}} xmm2 = [129,129,129,129,u,u,u,u,u,u,u,u,u,u,u,u]
...
; SSE41-NEXT:    pmovzxbd {{.*#+}} xmm0 = [129,129,129,129]
...
; SSE2-NEXT:    movdqa {{.*#+}} xmm1 = [129,129,129,129]
...
; SSE41-NEXT:    pmovzxbd {{.*#+}} xmm1 = [129,129,129,129]
...
; SSE41-NEXT:    pcmpeqq %xmm2, %xmm4
; SSE41-NEXT:    pmovsxwq {{.*#+}} xmm2 = [18446744073709551487,18446744073709551487]
...
; SSE2-NEXT:    movdqa {{.*#+}} xmm2 = [18446744073709551487,18446744073709551487]
; SSE2-NEXT:    pcmpeqd %xmm2, %xmm1
; SSE2-NEXT:    pcmpeqd %xmm2, %xmm0
; SSE2-NEXT:    movdqa %xmm0, %xmm2
; SSE2-NEXT:    shufps {{.*#+}} xmm2 = xmm2[1,3],xmm1[1,3]
...
; SSE2-NEXT:    pshufd {{.*#+}} xmm1 = xmm3[2,2,3,3]
...
; SSE41-NEXT:    pmovsxbw {{.*#+}} xmm2 = [65448,65448,65448,65448,65448,65448,65448,65448]
...
; SSE2:       # %bb.0:
; SSE2-NEXT:    movdqa {{.*#+}} xmm2 = [88,88,88,88,u,u,u,u]
; SSE2-NEXT:    pcmpeqw %xmm0, %xmm2
; SSE2-NEXT:    movdqa {{.*#+}} xmm1 = [65448,65448,65448,65448,u,u,u,u]
...
; SSE41:       # %bb.0:
; SSE41-NEXT:    movdqa {{.*#+}} xmm2 = [88,88,88,88,u,u,u,u,u,u,u,u,u,u,u,u]
; SSE41-NEXT:    pcmpeqb %xmm0, %xmm2
; SSE41-NEXT:    movdqa {{.*#+}} xmm1 = [168,168,168,168,u,u,u,u,u,u,u,u,u,u,u,u]
; SSE41-NEXT:    pcmpeqb %xmm0, %xmm1
...
; SSE2:       # %bb.0:
; SSE2-NEXT:    movdqa {{.*#+}} xmm2 = [88,88,88,88,u,u,u,u,u,u,u,u,u,u,u,u]
; SSE2-NEXT:    pcmpeqb %xmm0, %xmm2
; SSE2-NEXT:    movdqa {{.*#+}} xmm1 = [168,168,168,168,u,u,u,u,u,u,u,u,u,u,u,u]
...
; SSE41-NEXT:    pcmpeqb %xmm0, %xmm1
; SSE41-NEXT:    pcmpeqd %xmm2, %xmm2
; SSE41-NEXT:    movdqa {{.*#+}} xmm3 = [168,168,168,168,u,u,u,u,u,u,u,u,u,u,u,u]
...
; SSE2-NEXT:    pcmpeqb %xmm0, %xmm1
; SSE2-NEXT:    movdqa {{.*#+}} xmm2 = [168,168,168,168,u,u,u,u,u,u,u,u,u,u,u,u]
; SSE2-NEXT:    pcmpeqb %xmm0, %xmm2
...
; SSE41:       # %bb.0:
; SSE41-NEXT:    pmovsxbw {{.*#+}} xmm2 = [88,88,88,88,88,88,88,88]
; SSE41-NEXT:    pcmpeqw %xmm0, %xmm2
; SSE41-NEXT:    pcmpeqd %xmm1, %xmm1
; SSE41-NEXT:    pmovsxbw {{.*#+}} xmm3 = [65448,65448,65448,65448,65448,65448,65448,65448]
...
; SSE2-NEXT:    pcmpeqw %xmm0, %xmm2
; SSE2-NEXT:    pcmpeqd %xmm1, %xmm1
; SSE2-NEXT:    movdqa {{.*#+}} xmm3 = [65448,65448,65448,65448,u,u,u,u]
