...
; ZVFH-NEXT:    vfnmsub.vv v9, v8, v10
...
; ZVFHMIN-NEXT:    vfmacc.vv v11, v8, v10
...
; ZVFHMIN-NEXT:    vsetvli zero, zero, e32, mf2, ta, ma
; ZVFHMIN-NEXT:    vfmacc.vv v11, v8, v9
; ZVFHMIN-NEXT:    vsetvli zero, zero, e16, mf4, ta, ma
; ZVFHMIN-NEXT:    vfncvt.f.f.w v8, v11
; ZVFHMIN-NEXT:    ret
...
; ZVFH-NEXT:    vfnmsub.vv v10, v8, v9
...
; ZVFHMIN-NEXT:    vfmacc.vv v12, v14, v10
...
; ZVFHMIN-NEXT:    vfmacc.vv v16, v20, v8
...
; ZVFH:       # %bb.0:
; ZVFH-NEXT:    vsetvli a0, zero, e16, m2, ta, ma
; ZVFH-NEXT:    vfnmsub.vf v10, fa0, v8
...
; ZVFHMIN-NEXT:    vfmacc.vv v24, v0, v16
...
; ZVFH-NEXT:    vfnmsub.vv v24, v8, v16
...
; ZVFHMIN-NEXT:    vsetvli zero, zero, e32, m8, ta, ma
; ZVFHMIN-NEXT:    vfmacc.vv v24, v16, v8
...
; ZVFH:       # %bb.0:
; ZVFH-NEXT:    vsetvli a0, zero, e16, m8, ta, ma
; ZVFH-NEXT:    vfnmsub.vf v16, fa0, v8
