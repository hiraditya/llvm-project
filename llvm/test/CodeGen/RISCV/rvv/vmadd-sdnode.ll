...
; CHECK-NEXT:    vmadd.vv v12, v16, v8
...
; CHECK-NEXT:    vmadd.vv v24, v16, v8
...
; CHECK-NEXT:    vmadd.vv v12, v10, v8
; CHECK-NEXT:    vmv.v.v v8, v12
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vmadd.vv v16, v12, v8
; CHECK-NEXT:    vmv.v.v v8, v16
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vmadd.vv v24, v8, v16
; CHECK-NEXT:    vmv.v.v v8, v24
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vmadd.vv v12, v8, v10
; CHECK-NEXT:    vmv.v.v v8, v12
; CHECK-NEXT:    ret
