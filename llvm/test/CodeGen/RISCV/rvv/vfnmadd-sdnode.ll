...
; ZVFBFA-NEXT:    vfnmadd.vv v9, v8, v10
...
; ZVFBFA-NEXT:    vfnmadd.vv v10, v8, v9
...
; ZVFBFMIN-NEXT:    vfmadd.vv v12, v14, v10
...
; ZVFBFA-NEXT:    vfnmadd.vv v12, v10, v8
...
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vfnmadd.vf v10, fa0, v8
...
; ZVFBFMIN-NEXT:    vxor.vx v0, v16, a0
; ZVFBFMIN-NEXT:    vxor.vx v8, v24, a0
...
; ZVFBFMIN-NEXT:    vl8r.v v24, (a0) # vscale x 64-byte Folded Reload
; ZVFBFMIN-NEXT:    vsetvli zero, zero, e32, m8, ta, ma
; ZVFBFMIN-NEXT:    vfmadd.vv v0, v24, v8
; ZVFBFMIN-NEXT:    vsetvli zero, zero, e16, m4, ta, ma
; ZVFBFMIN-NEXT:    vfncvtbf16.f.f.w v8, v16
...
; ZVFBFA-NEXT:    vfnmadd.vv v24, v8, v16
...
; ZVFBFMIN-NEXT:    vs8r.v v0, (a1) # vscale x 64-byte Folded Spill
; ZVFBFMIN-NEXT:    vsetvli a1, zero, e16, m8, ta, ma
; ZVFBFMIN-NEXT:    vxor.vx v0, v8, a0
; ZVFBFMIN-NEXT:    vxor.vx v8, v24, a0
; ZVFBFMIN-NEXT:    csrr a0, vlenb
; ZVFBFMIN-NEXT:    slli a0, a0, 3
; ZVFBFMIN-NEXT:    add a0, sp, a0
...
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m8, ta, ma
; ZVFBFA-NEXT:    vfnmadd.vf v16, fa0, v8
