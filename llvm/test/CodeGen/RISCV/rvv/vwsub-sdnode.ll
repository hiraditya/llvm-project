...
; CHECK-NEXT:    vwsubu.wv v9, v8, v10
; CHECK-NEXT:    vmv1r.v v8, v9
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vwsub.wv v10, v8, v12
...
; CHECK-NEXT:    vwsubu.wv v10, v8, v12
; CHECK-NEXT:    vmv2r.v v8, v10
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vwsub.wv v12, v8, v16
...
; CHECK-NEXT:    vwsubu.wv v12, v8, v16
; CHECK-NEXT:    vmv4r.v v8, v12
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    vwsub.wv v16, v8, v24
...
; CHECK-NEXT:    vwsubu.wv v16, v8, v24
; CHECK-NEXT:    vmv8r.v v8, v16
; CHECK-NEXT:    ret
