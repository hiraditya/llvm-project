...
; NO_FOLDING2-NEXT:    vfwadd.wv v12, v11, v10
; NO_FOLDING2-NEXT:    vfwsub.wv v11, v8, v10
; NO_FOLDING2-NEXT:    vse32.v v9, (a0)
; NO_FOLDING2-NEXT:    vse32.v v12, (a1)
...
; NO_FOLDING2-NEXT:    vse64.v v12, (a1)
; NO_FOLDING2-NEXT:    vse64.v v11, (a2)
; NO_FOLDING2-NEXT:    ret
;
...
; NO_FOLDING-NEXT:    vfmadd.vv v9, v12, v11
...
; NO_FOLDING-NEXT:    vfsub.vv v12, v8, v9
; NO_FOLDING-NEXT:    vfmadd.vv v9, v11, v8
; NO_FOLDING-NEXT:    vse64.v v10, (a0)
; NO_FOLDING-NEXT:    vse64.v v9, (a1)
; NO_FOLDING-NEXT:    vse64.v v12, (a2)
; NO_FOLDING-NEXT:    ret
;
...
; FOLDING-NEXT:    vfsub.vv v12, v8, v9
; FOLDING-NEXT:    vfmadd.vv v9, v11, v8
; FOLDING-NEXT:    vse64.v v10, (a0)
; FOLDING-NEXT:    vse64.v v9, (a1)
; FOLDING-NEXT:    vse64.v v12, (a2)
; FOLDING-NEXT:    ret
  %c = fpext <2 x float> %a to <2 x double>
  %d = fpext <2 x float> %b to <2 x double>
  %d2 = fpext <2 x float> %b2 to <2 x double>
...
; NO_FOLDING-NEXT:    vfwcvt.f.f.v v8, v9
; NO_FOLDING-NEXT:    vsetvli zero, zero, e64, m1, ta, ma
; NO_FOLDING-NEXT:    vfmadd.vv v10, v8, v8
; NO_FOLDING-NEXT:    vse64.v v10, (a0)
; NO_FOLDING-NEXT:    ret
;
...
; FOLDING-NEXT:    vfwcvt.f.f.v v8, v9
; FOLDING-NEXT:    vsetvli zero, zero, e64, m1, ta, ma
; FOLDING-NEXT:    vfmadd.vv v10, v8, v8
; FOLDING-NEXT:    vse64.v v10, (a0)
; FOLDING-NEXT:    ret
  %c = fpext <2 x float> %a to <2 x double>
  %d = fpext <2 x float> %b to <2 x double>
